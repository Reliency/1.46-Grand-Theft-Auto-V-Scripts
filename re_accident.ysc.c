	...
	while (true)
	{
		...
		if (unk_0x1F85F8C7CC4639AE())
		{
			...
			switch (iLocal_70)
			{
				...
				case 2:
					if (((unk_0xDC5D81351D6A4DDB(iLocal_78) && unk_0xD61D0CA14AE902DF(iLocal_78, 1)) && iLocal_98 < 5) && !bLocal_95)
					{
						func_12();
					}
					func_1();
...
void func_1()
{
	if (iLocal_280 && !iLocal_281)
	{
		...
		while (iLocal_97 < 11)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_88[iLocal_97]))
			{
				unk_0xB29E08C7AB729BAD(iLocal_88[iLocal_97], false);
			}
			iLocal_97++;
		}
		if (!unk_0x7112137033807390(iLocal_80, 0))
		{
			unk_0x70B1045E099298C1(iLocal_80, 0f);
			unk_0xB29E08C7AB729BAD(iLocal_80, false);
		}
		if (unk_0xDC5D81351D6A4DDB(iLocal_89))
		{
			unk_0xB29E08C7AB729BAD(iLocal_89, false);
		}
		...
		{
			unk_0x77F0486CE0E598D5(iLocal_275, 0);
			unk_0x8E88E73F74A9FF79(false, false, 3000, 1, 0, 0);
		...
		if (unk_0xCE3CB618AFE55EFB(iLocal_84))
		{
			unk_0xE1623437A3194332(&iLocal_84);
		}
		if (unk_0xCE3CB618AFE55EFB(iLocal_85))
		{
			unk_0xE1623437A3194332(&iLocal_85);
		}
		if (unk_0xCE3CB618AFE55EFB(iLocal_86))
		{
			unk_0xE1623437A3194332(&iLocal_86);
		}
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_88[0]) || unk_0xDC5D81351D6A4DDB(iLocal_88[1]))
	{
		if (!unk_0x317672E799676CA5(vLocal_75 + Vector(20f, 0f, 0f), 30f) && !unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_75, 80f, 80f, 80f, false, true, 0))
		{
			func_174();
		}
	}
...
void func_12()
{
	if (iLocal_102 == -1)
	{
		iLocal_102 = unk_0xFD34717937104F1C() + 5000;
	}
	if (unk_0xFD34717937104F1C() > iLocal_102)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_80))
		{
			unk_0xB29E08C7AB729BAD(iLocal_80, false);
			unk_0xFAE5E5AC968944E8(iLocal_80, 0, 0f, 0f, 50f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
			if (!unk_0x7112137033807390(iLocal_80, 0))
			{
				unk_0x67697F97F2A7EE10(iLocal_80, 1, 0);
			}
		}
	}
}
...
void func_14()
{
	...
	if (iLocal_61 == 0)
	{
		if (unk_0x08198953697A5A22(&vVar1, Local_68[0 /*5*/]))
		{
			fVar2 = 0f;
			fVar5 = 999999f;
			iVar0 = 0;
			while (iVar0 < Local_68)
			{
				if (iVar0 > 0)
				{
					fVar2 = (fVar2 + unk_0x499324B3EF19C288(Local_68[(iVar0 - 1) /*5*/], Local_68[iVar0 /*5*/], true));
				}
				if (Local_68[iVar0 /*5*/].f_4)
				{
					if (unk_0x08198953697A5A22(&vVar1, Local_68[iVar0 /*5*/]))
					{
						fVar4 = unk_0x499324B3EF19C288(Local_68[iVar0 /*5*/], vVar1, true);
						if (fVar4 < fVar5)
						{
							fVar5 = fVar4;
							fVar6 = fVar2;
	...
	if (iLocal_61 == 1)
	{
		...
		fVar7 = (to_float((unk_0xFD34717937104F1C() - iLocal_63)) / fLocal_69);
		...
		{
			if ((unk_0xFD34717937104F1C() - Local_60[iVar0 /*5*/].f_4) > 1000)
			{
				unk_0x25C7CCF1CBB8C92D(Local_60[iVar0 /*5*/].f_1, 0.4f, 1f);
			}
			if ((unk_0xFD34717937104F1C() - Local_60[iVar0 /*5*/].f_4) > 6000)
			{
				unk_0x18F3ABCEA09948FB(Local_60[iVar0 /*5*/]);
			}
			iVar0++;
		}
	}
...
void func_16(vector3 vParam0, int iParam1)
{
	...
	unk_0x18F3ABCEA09948FB(Local_60[iLocal_65 /*5*/]);
	if (Local_60[iLocal_65 /*5*/].f_4 != 0)
	{
		unk_0x25C7CCF1CBB8C92D(Local_60[iLocal_65 /*5*/].f_1, 0.4f, 1f);
	}
	Local_60[iLocal_65 /*5*/].f_4 = unk_0xFD34717937104F1C();
	Local_60[iLocal_65 /*5*/].f_1 = { vParam0 };
	Local_60[iLocal_65 /*5*/] = unk_0x5F55280D2F9FC5F4(vParam0, iLocal_53, iParam1);
	iLocal_65++;
	if (iLocal_65 >= 31)
	{
		iLocal_65 = 0;
		...
		if (iVar1 == joaat("weapon_petrolcan"))
		{
			if (unk_0xD73B1037F6BD4B90(0, 24) && unk_0x41CA0CDBE31A440F(unk_0xA19140A5C42D8715()))
			{
				if (iLocal_54 == 0)
				{
					...
					iLocal_54 = unk_0xFD34717937104F1C() + 250;
				}
				if (unk_0xFD34717937104F1C() > iLocal_54)
				{
					if (!bLocal_44)
					{
						fVar4 = 9999.9f;
						...
						while (iVar0 < Local_68)
						{
							if (unk_0xCE3CB618AFE55EFB(Local_68[iVar0 /*5*/].f_3))
							{
								fVar2 = unk_0x499324B3EF19C288(vLocal_57, unk_0x1C8DAFF0573242F7(Local_68[iVar0 /*5*/].f_3), true);
								fVar3 = unk_0x499324B3EF19C288(Local_68[iVar0 /*5*/], unk_0x1C8DAFF0573242F7(Local_68[iVar0 /*5*/].f_3), true);
						...
						if (fVar4 < 2f)
						{
							if (iLocal_50 != -1)
							{
								if (unk_0x69E48309C7AE810E((iLocal_51 - iVar5)) > 1)
								{
									iLocal_51 = -1;
								}
								if (iLocal_51 == -1)
								...
								if (unk_0x69E48309C7AE810E((iLocal_51 - iVar5)) < 3 && unk_0x69E48309C7AE810E((iLocal_51 - iVar5)) > 0)
								{
									if (iLocal_51 < iVar5)
									{
										iVar6 = iLocal_51;
										while (iVar6 <= (iVar5 - 1))
										{
											if (unk_0xCE3CB618AFE55EFB(Local_68[iVar6 /*5*/].f_3))
											{
												if (unk_0x1C05D741948BDE08(Local_68[iVar6 /*5*/].f_3) > 0)
												{
													unk_0xE8C2974337833D20(Local_68[iVar6 /*5*/].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (unk_0xCE3CB618AFE55EFB(Local_68[iVar5 /*5*/].f_3))
									{
										if (unk_0x1C05D741948BDE08(Local_68[iVar5 /*5*/].f_3) > 0)
										{
											unk_0xE8C2974337833D20(Local_68[iVar5 /*5*/].f_3, 0);
...
void func_22()
{
	switch (iLocal_71)
	{
		case 0:
			...
			if (Local_283.f_32 <= 0)
			{
				Local_283.f_32 = unk_0x817B152F7462D506();
			}
			func_105(&Local_283, joaat("s_m_m_dockwork_01"));
			func_105(&Local_283, -415509317);
			func_105(&Local_283, joaat("p_amb_phone_01"));
			func_102(&Local_283);
			if ((unk_0x61346376C1469A0E("CONSTRUCTION_ACCIDENT_1", false, -1) && unk_0x39C2D9AB77873F84("re@construction")) && func_98(&Local_283))
			{
				if (unk_0x1095F403F52B42E1(iLocal_80, 0))
				{
					iLocal_78 = unk_0x91A7C8CA5E332C03(iLocal_80, 26, joaat("s_m_m_dockwork_01"), -1, 1, true);
					unk_0x72A0FF8C49CFFC0D(iLocal_78, 0, 1, 0, 0);
					unk_0x72A0FF8C49CFFC0D(iLocal_78, 3, 1, 1, 0);
					unk_0x72A0FF8C49CFFC0D(iLocal_78, 4, 0, 1, 0);
					unk_0x72A0FF8C49CFFC0D(iLocal_78, 8, 0, 0, 0);
					unk_0x3F01127ECD227890(iLocal_78, "re@construction", "idle_c", 1000f, -1000f, -1, 49, 0.4f, 0, 0, 0);
					iLocal_90 = unk_0xFCFC8CC5FF74580D(joaat("p_amb_phone_01"), -455.6561f, -985.8071f, 22.4868f, true, true, false);
					unk_0xA5DE74AE39867B03(joaat("p_amb_phone_01"));
					unk_0x96B71B23D409A3DB(iLocal_90, iLocal_78, unk_0xF622A022C26057AA(iLocal_78, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0x3B7A32E04BBE59A5(iLocal_78, 17, true);
					unk_0xA78BBA5574A997CD(iLocal_78, 1);
					unk_0x1F4E5EFBFE503FB3(iLocal_78, true);
					unk_0x96BFF0680C7B6FD5(iLocal_78, false);
					func_97(&uLocal_108, 3, iLocal_78, "RECONACWorker", 0, 1);
					unk_0x4FE3554969185993(iLocal_78, "S_M_Y_GENERICWORKER_01_WHITE_01");
					iLocal_79 = unk_0x35C6E06B120EB2E3(26, joaat("s_m_m_dockwork_01"), -462.2982f, -978.3272f, 65f, 221.4041f, 1, true);
					unk_0x1F4E5EFBFE503FB3(iLocal_79, true);
					unk_0x98D1B1BD9C3AA456(iLocal_79, true, 1);
					unk_0xB29E08C7AB729BAD(iLocal_79, true);
					unk_0xB3CE71A0BEB6D4C6(iLocal_78, -1143637011);
					unk_0xAD9E9AAB3370CC2C(-1143637011, 24);
					unk_0xAD9E9AAB3370CC2C(-1143637011, 46);
					unk_0xAD9E9AAB3370CC2C(-1143637011, 61);
					unk_0xAD9E9AAB3370CC2C(-1143637011, 136);
					unk_0xAD9E9AAB3370CC2C(-1143637011, 55);
					iLocal_89 = unk_0xFCFC8CC5FF74580D(-415509317, vLocal_274.x, (vLocal_274.y + 0.5f), (vLocal_274.z - 0.25f), true, true, false);
					unk_0x92DDCF53AA47A63D(iLocal_89, 75f);
					unk_0xD6CDDEFB0FD5B191(iLocal_89, false, true, true, false, false, false, 0, false);
					iLocal_279 = unk_0x8E3AC3DF6783369A("scr_sparking_generator", iLocal_89, 0f, 0f, 0.2f, 0f, 0f, 0f, 1f, 0, 0, 0);
					unk_0xB29E08C7AB729BAD(iLocal_89, true);
		...
		case 1:
			...
			if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
			{
				if (!iLocal_92)
				{
					...
					{
						if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -532.2208f, -849.2668f, 19.7038f, -531.6973f, -1065.341f, 60.7893f, 190.8125f, 0, true, 0))
						{
							if (!unk_0x7112137033807390(iLocal_80, 0))
							{
								if (!unk_0xCE3CB618AFE55EFB(iLocal_85))
						...
						if (unk_0xDEAEC99031DCB92A(iLocal_78, unk_0xA19140A5C42D8715(), 1) || unk_0xDEAEC99031DCB92A(iLocal_80, unk_0xA19140A5C42D8715(), 1))
						{
							unk_0xB29E08C7AB729BAD(iLocal_80, false);
							unk_0x9568B1B58F78FF36(iLocal_78);
							unk_0x2F89329397A277BC(&iLocal_107);
							unk_0xCB482EF95FAE4D73(0, 0, 0);
							unk_0x33B5487515BD13D5(0, unk_0xA19140A5C42D8715(), 150f, -1, 0, 0);
							unk_0x301F42EEE3C40328(iLocal_107);
							unk_0xE1072FA2FECBAD96(iLocal_78, iLocal_107);
							unk_0x3A95A0A3221D4208(&iLocal_107);
							func_89();
						}
						unk_0xCACEBBBEAD8F262E(joaat("prop_ld_pipe_single_01"));
						if ((((unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, false, true, 0) && !unk_0x5BFF0F72CC04E4DA(unk_0xA19140A5C42D8715())) && !unk_0xA22CC9D85ECBCC81(unk_0xA19140A5C42D8715())) && func_88(1, 0, 1)) && unk_0x7FC99CCC73354033(joaat("prop_ld_pipe_single_01")))
						{
							if (!func_128())
							{
								if (!unk_0x7112137033807390(unk_0xC409B91AC4749F88(), 0))
								{
									iLocal_83 = unk_0xC409B91AC4749F88();
								}
								func_78(1);
							}
							iLocal_91 = 1;
				...
				else
				{
					if (!unk_0x4915F4759304D5CF(iLocal_78))
					{
						if (unk_0x5D7DFE2058701942(iLocal_78, 0))
						{
							if (!unk_0x7112137033807390(iLocal_80, 0) && !unk_0xCE3CB618AFE55EFB(iLocal_85))
							{
								iLocal_85 = func_90(iLocal_80, 0, 0);
							}
						}
						else if (!unk_0xCE3CB618AFE55EFB(iLocal_84))
						{
							if (unk_0xCE3CB618AFE55EFB(iLocal_85))
							{
								unk_0xE1623437A3194332(&iLocal_85);
					...
					if (!unk_0x4915F4759304D5CF(iLocal_78))
					{
						if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_78, vLocal_76, 0, 1, 0))
						{
							if (!bLocal_93)
							{
								func_42();
					...
					else
					{
						...
						if (unk_0x4915F4759304D5CF(iLocal_78) || unk_0x7112137033807390(iLocal_80, 0))
						{
							func_89();
						}
					}
					if (!unk_0x1095F403F52B42E1(iLocal_81, 0))
					{
						if (unk_0xCE3CB618AFE55EFB(iLocal_86))
						{
							unk_0xE1623437A3194332(&iLocal_86);
					...
					if (iLocal_103 >= 3)
					{
						if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0) && unk_0x52BDE3D9BF787D4C(unk_0xA19140A5C42D8715(), joaat("bulldozer")))
						{
							if (unk_0xCE3CB618AFE55EFB(iLocal_86))
							{
								...
								if (!unk_0x4915F4759304D5CF(iLocal_78) && !unk_0x7112137033807390(iLocal_80, 0))
								{
									if (unk_0x5D7DFE2058701942(iLocal_78, 0) && !unk_0xCE3CB618AFE55EFB(iLocal_85))
									{
										iLocal_85 = func_90(iLocal_80, 0, 0);
									}
								}
						...
						else if (!unk_0x4915F4759304D5CF(iLocal_78) && !unk_0x7112137033807390(iLocal_80, 0))
						{
							if (unk_0x5D7DFE2058701942(iLocal_78, 0) && unk_0xCE3CB618AFE55EFB(iLocal_85))
							{
								unk_0xE1623437A3194332(&iLocal_85);
				...
				if (!unk_0x7112137033807390(iLocal_80, 0))
				{
					if (unk_0x463E3A48A46C9195(iLocal_80))
					{
						iLocal_97 = 0;
						while (iLocal_97 < 11)
						{
						...
						if (!unk_0x4915F4759304D5CF(iLocal_78))
						{
							...
							{
								unk_0x1F4E5EFBFE503FB3(iLocal_78, true);
								unk_0x13E0A8160525AE55(iLocal_78, 116, false);
								unk_0x13E0A8160525AE55(iLocal_78, 29, false);
								if (!bLocal_95)
								{
									func_40();
									wait(0);
								...
								if (!unk_0x4915F4759304D5CF(iLocal_78))
								{
									unk_0x6259CDB47862A4F3(iLocal_78, 99, 0);
								}
								if (!unk_0x7112137033807390(iLocal_80, 0))
								{
									unk_0xB29E08C7AB729BAD(iLocal_80, false);
...
void func_42()
{
	switch (iLocal_103)
	{
		case 0:
			if (!unk_0x4915F4759304D5CF(iLocal_78))
			{
				if ((unk_0xFD34717937104F1C() - iLocal_101) > 3000)
				{
		...
		case 2:
			if (!unk_0x4915F4759304D5CF(iLocal_78))
			{
				if ((unk_0xFD34717937104F1C() - iLocal_101) > 5000 && !func_23())
				{
					if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
					{
						iLocal_106 = unk_0x8F474E419F56E48D(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0));
					}
					if (unk_0x5D7DFE2058701942(iLocal_78, 0))
					{
						if (unk_0x1095F403F52B42E1(iLocal_81, 0))
						{
							...
							else if (!unk_0xCE3CB618AFE55EFB(iLocal_86))
							{
								iLocal_86 = func_90(iLocal_81, 0, 0);
								if (unk_0xCE3CB618AFE55EFB(iLocal_85))
								{
		...
		case 3:
			if (unk_0xFD34717937104F1C() - iLocal_101) > unk_0x22C775856F4633CA(5000, 8000)
			{
				if (!func_23())
				{
...
void func_43()
{
	...
	{
		case 0:
			unk_0x994F699AB446B8E4(vLocal_274 + Vector(0f, 1f, 0f), 1f, 1f, 1f);
			wait(0);
			unk_0xAD256D3DFA3A2FAF(1f);
			unk_0x3D879C2CE78801D5(vLocal_273, 1f);
			wait(0);
			unk_0x3D879C2CE78801D5(vLocal_273 - Vector(0f, 4f, 0f), 1f);
			wait(0);
			unk_0x3D879C2CE78801D5(vLocal_273 - Vector(0f, 8f, 0f), 1f);
			wait(0);
			unk_0x3D879C2CE78801D5(vLocal_274, 1f);
		...
		case 2:
			if ((unk_0xFD34717937104F1C() - iLocal_105) > iLocal_73 || func_45())
			{
				if (unk_0x059A39F1D399060B(iLocal_279))
				{
					unk_0x82E95CCADC55C11E(iLocal_279, 0);
				}
				func_44();
				if (!bLocal_95)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_78) && !unk_0x7112137033807390(iLocal_80, 0))
					{
						if (!unk_0x5860446BFB759B77(iLocal_78, iLocal_80, -1, 0, false) && !unk_0x5860446BFB759B77(iLocal_78, iLocal_80, 0, 0, false))
						{
							func_40();
							wait(0);
							func_24(&uLocal_108, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
				...
				unk_0xE537EBD7B736A4E2(-460.3019f, -870.3607f, 21.89325f, -508.4859f, -981.1199f, 27.32087f, 36.5625f, 0, true, 1);
				unk_0x4E27F73A7FFC8871(3, -539.4481f, -962.3162f, 22.4918f, 4, 0f, &uLocal_278, 0, 0);
				settimera(0);
				iLocal_99 = 3;
			}
			break;
...
void func_46()
{
	...
	switch (iLocal_98)
	{
		case 0:
			if (iLocal_103 >= 2)
			{
				if (!unk_0x4915F4759304D5CF(iLocal_78) && !unk_0x7112137033807390(iLocal_80, 0))
				{
					...
					unk_0xC0AC848E56940C34(&iLocal_90);
					if (unk_0x5860446BFB759B77(iLocal_78, iLocal_80, -1, 0, false) || unk_0x5860446BFB759B77(iLocal_78, iLocal_80, 0, 0, false))
					{
						if (unk_0x5860446BFB759B77(iLocal_78, iLocal_80, -1, 0, false))
						{
							bLocal_94 = true;
							vLocal_77 = { unk_0xE2BBD32891C18569(iLocal_80, false) + Vector(0f, -1f, -3f) };
						}
						else
						{
							vLocal_77 = { unk_0xE2BBD32891C18569(iLocal_80, false) + Vector(0f, 1.5f, -3f) };
						}
						if (unk_0xA60C975CBAB69F34(unk_0xC409B91AC4749F88(), vLocal_77, 4.2f, 4f, 5f, false, true, 0))
						{
							if (!bLocal_93)
							{
								func_40();
		...
		case 1:
			if (!unk_0x4915F4759304D5CF(iLocal_78) && !unk_0x7112137033807390(iLocal_80, 0))
			{
				if (!unk_0x7112137033807390(iLocal_81, 0))
				{
					unk_0xD6CDDEFB0FD5B191(iLocal_81, false, true, true, false, false, false, 0, false);
				}
				unk_0xD6CDDEFB0FD5B191(iLocal_78, false, true, false, false, false, false, 0, false);
				unk_0xB29E08C7AB729BAD(iLocal_80, false);
				unk_0x2F89329397A277BC(&iLocal_107);
				if (bLocal_94)
				{
				...
				unk_0xE1072FA2FECBAD96(iLocal_78, iLocal_107);
				unk_0x3A95A0A3221D4208(&iLocal_107);
				unk_0xD738221C247C8B71(iLocal_78, true);
				iLocal_101 = unk_0xFD34717937104F1C();
				iLocal_98++;
			}
			break;
		...
		case 2:
			if (!unk_0x4915F4759304D5CF(iLocal_78))
			{
				if ((unk_0xFD34717937104F1C() - iLocal_101) > 500 && !unk_0x5D7DFE2058701942(iLocal_78, 0))
				{
					iLocal_73 = 0;
					if (unk_0x1095F403F52B42E1(iLocal_80, 0))
					{
		...
		case 3:
			if (!unk_0x4915F4759304D5CF(iLocal_78))
			{
				if (unk_0xA60C975CBAB69F34(iLocal_78, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, false, true, 0) || (unk_0xFD34717937104F1C() - iLocal_101) > 10000)
				{
		...
		case 4:
			if (!unk_0x4915F4759304D5CF(iLocal_78))
			{
				if (unk_0xA60C975CBAB69F34(iLocal_78, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, false, true, 0) || (unk_0xFD34717937104F1C() - iLocal_101) > 10000)
				{
					if (!unk_0x7112137033807390(iLocal_80, 0))
					{
						unk_0xB29E08C7AB729BAD(iLocal_80, false);
		...
		case 5:
			if ((unk_0xFD34717937104F1C() - iLocal_101) > 3000)
			{
				...
				if (!unk_0x4915F4759304D5CF(iLocal_78))
				{
					...
					if (!unk_0x7112137033807390(iLocal_81, 0))
					{
						unk_0xD6CDDEFB0FD5B191(iLocal_81, false, false, false, false, false, false, 0, false);
					}
					unk_0xD6CDDEFB0FD5B191(iLocal_78, false, false, false, false, false, false, 0, false);
					unk_0x2D2E827C6C3D6D26(iLocal_78, 1);
					unk_0x96BFF0680C7B6FD5(iLocal_78, true);
					unk_0xA78BBA5574A997CD(iLocal_78, 0);
					unk_0x1F4E5EFBFE503FB3(iLocal_78, false);
					unk_0xB3CE71A0BEB6D4C6(iLocal_78, -455129387);
					unk_0x9568B1B58F78FF36(unk_0xA19140A5C42D8715());
					unk_0x2F89329397A277BC(&iLocal_107);
					unk_0x3F01127ECD227890(0, "re@construction", "Out_Of_Breath", 2f, -2f, -1, 0, 0, 0, 0, 0);
					unk_0x4C9989F866EF6731(iLocal_107, 1);
					unk_0x301F42EEE3C40328(iLocal_107);
					unk_0xE1072FA2FECBAD96(iLocal_78, iLocal_107);
					unk_0x3A95A0A3221D4208(&iLocal_107);
				}
		...
		case 6:
			if (!unk_0x4915F4759304D5CF(iLocal_78))
			{
				if ((unk_0xFD34717937104F1C() - iLocal_101) > 6400)
				{
					vVar0 = { -477.2774f, -990.0638f, 23.5497f };
					if (unk_0xDC5D81351D6A4DDB(unk_0xC409B91AC4749F88()))
					{
						if (unk_0xA60C975CBAB69F34(unk_0xC409B91AC4749F88(), -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
						{
					...
					{
						if (unk_0xA60C975CBAB69F34(iLocal_83, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
						{
							vVar0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
					...
					{
						if (unk_0xA60C975CBAB69F34(iLocal_81, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
						{
							vVar0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
					...
					unk_0x307C534FCD355232(0, "WORLD_HUMAN_PICNIC", vVar0, 304.8172f, 0, 1, 0);
					unk_0x301F42EEE3C40328(iLocal_107);
					unk_0xE1072FA2FECBAD96(iLocal_78, iLocal_107);
					unk_0x3A95A0A3221D4208(&iLocal_107);
...
int func_76(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_77(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_77(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
...
void func_91()
{
	if (func_94(1000))
	{
		...
		if (!unk_0x7112137033807390(iLocal_80, 0))
		{
			unk_0x4C9B98D31D89D901(iLocal_80, 0f, 1f, 1f, 200f, 800f, 1);
		}
		bLocal_282 = true;
		iLocal_72 = 8;
	}
	switch (iLocal_72)
	{
		case 0:
			...
			unk_0x3521B10FB737CE36(vLocal_75, 50f, 0);
			unk_0x01AF8CB960828C2B(vLocal_75, 30f, 0, 0, 0, 0, false, 0);
			unk_0x9827D9AC8985F888(vLocal_75, 100f, 0);
			if (!unk_0x7112137033807390(unk_0xC409B91AC4749F88(), 0))
			{
				if (unk_0xA60C975CBAB69F34(unk_0xC409B91AC4749F88(), vLocal_75, 8f, 8f, 8f, false, true, 0))
				{
					iLocal_82 = unk_0xC409B91AC4749F88();
					unk_0x1F7948851FB36E88(iLocal_82, true, 0);
					unk_0x4C842FAB634AC89E(&iLocal_82);
				}
			}
			if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -473.1686f, -984.6405f, 22.487f, 15f, 15f, 5f, false, true, 0))
			{
				unk_0x4299736016AECE26(unk_0xA19140A5C42D8715(), -477.3538f, -972.67f, 22.5494f, 1, false, 0, 1);
				unk_0x92DDCF53AA47A63D(unk_0xA19140A5C42D8715(), 237.4839f);
			}
			iLocal_276 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, -0.1371f, -0.0346f, -29.6605f, 28f, 1, 2);
			iLocal_277 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, 69.4831f, -0.0346f, -40.8884f, 28f, 1, 2);
			unk_0xBC1542DDC31676C2(iLocal_276, "HAND_SHAKE", 0.3f);
			unk_0xBC1542DDC31676C2(iLocal_277, "HAND_SHAKE", 0.3f);
			func_93();
			unk_0x930701157A4B9374(iLocal_276, true);
			unk_0x8E88E73F74A9FF79(true, false, 3000, 1, 0, 0);
			wait(500);
			unk_0xD21CD2A6F93F44A6(iLocal_277, iLocal_276, 3500, 1, 1);
		...
		case 1:
			if ((unk_0xFD34717937104F1C() - iLocal_104) > 3500)
			{
				unk_0xE11F00B4AC919F45(-1, "WEAKEN", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				unk_0xE11F00B4AC919F45(iLocal_100, "WIND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				unk_0xDDCF77D7F7484413(iLocal_88[0], 1);
				func_92(iLocal_276);
				func_92(iLocal_277);
				iLocal_276 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", -455.4617f, -990.631f, 61.6885f, -89.0761f, -0.0146f, -49.881f, 80.5355f, 1, 2);
				iLocal_277 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", -455.4543f, -990.6208f, 61.012f, -89.0759f, -0.0146f, -47.8226f, 80.5355f, 1, 2);
				unk_0xBC1542DDC31676C2(iLocal_276, "HAND_SHAKE", 0.3f);
				unk_0xBC1542DDC31676C2(iLocal_277, "HAND_SHAKE", 0.3f);
				unk_0xD21CD2A6F93F44A6(iLocal_277, iLocal_276, 4000, 1, 0);
				if (!unk_0x4915F4759304D5CF(iLocal_78))
				{
					unk_0x9568B1B58F78FF36(iLocal_78);
					unk_0x8CBE3882704F529D(iLocal_78, -461.4785f, -984.8583f, 28.0809f, 30000, 2080, 2);
				}
				if (unk_0xDC5D81351D6A4DDB(iLocal_90))
				{
					unk_0xF334C9B245CD323D(iLocal_90, 1, true);
					unk_0xC0AC848E56940C34(&iLocal_90);
				}
				iLocal_104 = unk_0xFD34717937104F1C();
				iLocal_72 = 2;
		...
		case 2:
			if ((unk_0xFD34717937104F1C() - iLocal_104) > 1500)
			{
				unk_0xE11F00B4AC919F45(-1, "CABLE_SNAPS", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				iLocal_104 = unk_0xFD34717937104F1C();
				iLocal_72 = 3;
			}
			break;
		...
		case 3:
			if ((unk_0xFD34717937104F1C() - iLocal_104) > 500)
			{
				if (unk_0xDC5D81351D6A4DDB(iLocal_88[0]))
				{
					unk_0xB29E08C7AB729BAD(iLocal_88[0], false);
					unk_0xFAE5E5AC968944E8(iLocal_88[0], 0, 0f, 0f, 5f, 0f, -2f, 2f, 0, 1, 1, 1, 0, 1);
					unk_0x8D5247FDD68E4EC4(iLocal_88[0], 11, 0);
					unk_0x8D5247FDD68E4EC4(iLocal_88[0], 18, 0);
					unk_0x8D5247FDD68E4EC4(iLocal_88[0], 19, 0);
					unk_0x8D5247FDD68E4EC4(iLocal_88[0], 23, 0);
					unk_0x8D5247FDD68E4EC4(iLocal_88[0], 9, 0);
					unk_0x8D5247FDD68E4EC4(iLocal_88[0], 12, 0);
					unk_0x8D5247FDD68E4EC4(iLocal_88[0], 17, 0);
					unk_0xF593FC0961E061E6("scr_reconstruct_pipefall_debris", iLocal_88[0], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
				}
				iLocal_104 = unk_0xFD34717937104F1C();
				iLocal_72 = 4;
			}
		...
		case 4:
			if ((unk_0xFD34717937104F1C() - iLocal_104) > 2000)
			{
				func_92(iLocal_276);
				func_92(iLocal_277);
				iLocal_276 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 25.437f, -0.0087f, -118.3831f, 34f, 1, 2);
				iLocal_277 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 2.0695f, -0.0087f, -120.2811f, 34f, 1, 2);
				unk_0xBC1542DDC31676C2(iLocal_276, "HAND_SHAKE", 0.3f);
				unk_0xBC1542DDC31676C2(iLocal_277, "HAND_SHAKE", 0.3f);
				unk_0xD21CD2A6F93F44A6(iLocal_277, iLocal_276, 1000, 3, 3);
				unk_0x5DE59A67B5F326CF(iLocal_100);
				iLocal_104 = unk_0xFD34717937104F1C();
				iLocal_72 = 5;
			}
			break;
		...
		case 5:
			if ((unk_0xFD34717937104F1C() - iLocal_104) > 500)
			{
				...
				{
					unk_0xB29E08C7AB729BAD(iLocal_80, false);
					unk_0xE11F00B4AC919F45(-1, "PIPES_LAND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
					unk_0x4C9B98D31D89D901(iLocal_80, 0f, 1f, 1f, 200f, 800f, 1);
					if (!unk_0x4915F4759304D5CF(iLocal_78))
					{
						unk_0x53FF9BDD8529ACD2(iLocal_78);
					}
					unk_0x3F01127ECD227890(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0, 0, 0, 0);
					unk_0xF593FC0961E061E6("scr_reconstruct_pipe_impact", iLocal_80, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
					func_24(&uLocal_108, "CONACAU", "CONAC_SCREAM", 4, 0, 0, 0);
					if (unk_0x37B568B777BC65F9(iLocal_276) && unk_0x37B568B777BC65F9(iLocal_277))
					{
						unk_0xBC1542DDC31676C2(iLocal_276, "HAND_SHAKE", 1.5f);
						unk_0xBC1542DDC31676C2(iLocal_277, "HAND_SHAKE", 1.5f);
					}
					iLocal_104 = unk_0xFD34717937104F1C();
					iLocal_72 = 6;
				}
		...
		case 6:
			if ((unk_0xFD34717937104F1C() - iLocal_104) > 500)
			{
				func_92(iLocal_276);
				func_92(iLocal_277);
				iLocal_276 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", -459.2609f, -987.5602f, 24.2611f, 0.583f, 0.2617f, -32.7532f, 49.9914f, 1, 2);
				iLocal_277 = unk_0x4AD86AC07DD005D4("DEFAULT_SCRIPTED_CAMERA", -459.0622f, -987.2584f, 24.2661f, 5.0301f, 0.2617f, -36.7308f, 49.9914f, 1, 2);
				unk_0xBC1542DDC31676C2(iLocal_276, "HAND_SHAKE", 0.5f);
				unk_0xBC1542DDC31676C2(iLocal_277, "HAND_SHAKE", 0.5f);
				unk_0xD21CD2A6F93F44A6(iLocal_277, iLocal_276, 2500, 3, 3);
				if (!unk_0x4915F4759304D5CF(iLocal_78))
				{
					unk_0x8CBE3882704F529D(iLocal_78, unk_0xE2BBD32891C18569(iLocal_78, true) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_104 = unk_0xFD34717937104F1C();
				iLocal_72 = 7;
			}
		...
		case 7:
			if ((unk_0xFD34717937104F1C() - iLocal_104) > 2200 && !iLocal_96)
			{
			...
			if ((unk_0xFD34717937104F1C() - iLocal_104) > 2500)
			{
				if (unk_0x1095F403F52B42E1(iLocal_80, 0))
				{
					unk_0xB29E08C7AB729BAD(iLocal_80, true);
				}
				iLocal_72 = 8;
			}
			break;
		...
		case 8:
			...
			if (unk_0xDC5D81351D6A4DDB(iLocal_88[0]))
			{
				unk_0xC0AC848E56940C34(&(iLocal_88[0]));
			}
			if (unk_0x1095F403F52B42E1(iLocal_80, 0))
			{
				unk_0x70B1045E099298C1(iLocal_80, 250f);
				unk_0x4299736016AECE26(iLocal_80, vLocal_75, 1, false, 0, 1);
				unk_0x92DDCF53AA47A63D(iLocal_80, 80f);
				unk_0x39F8A3E01BC1A69B(vLocal_75, 50f, 0);
			}
			if (!unk_0x4915F4759304D5CF(iLocal_78))
			{
				unk_0x9568B1B58F78FF36(iLocal_78);
				unk_0x53FF9BDD8529ACD2(iLocal_78);
				unk_0x3F01127ECD227890(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			unk_0x930701157A4B9374(iLocal_276, false);
			unk_0x8E88E73F74A9FF79(false, false, 3000, 1, 0, 0);
			unk_0x77F0486CE0E598D5(iLocal_276, 0);
			unk_0x77F0486CE0E598D5(iLocal_277, 0);
			unk_0x962CF6A9EA6FDCAC(unk_0xD4E735F4B6A956AC(), true, 0);
			unk_0xD87B76260C547F31(0f);
			unk_0xDC374DA4DC566237(true);
			unk_0x85685830EFB9A55E(true);
			...
			func_2(0, 1, 1, 0, 0);
			iLocal_101 = unk_0xFD34717937104F1C();
			unk_0xA5DE74AE39867B03(1668676931);
			iLocal_88[1] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -457.8815f, -988.9059f, 22.9554f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[1], -0.1939f, 105.0058f, 77.3964f, 2, 1);
			iLocal_88[2] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -451.5131f, -986.8079f, 24.6947f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[2], 24.3941f, 32.5423f, 80.6862f, 2, 1);
			iLocal_88[3] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -450.8099f, -985.9972f, 24.7104f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[3], 24.1841f, 110.287f, 78.4357f, 2, 1);
			iLocal_88[4] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -456.6558f, -987.3979f, 22.9537f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[4], -0.0264f, 29.5754f, 79.1811f, 2, 1);
			iLocal_88[5] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -456.1279f, -988.4162f, 22.9889f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[5], -0.6337f, 108.4339f, 77.9539f, 2, 1);
			iLocal_88[6] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -457.0807f, -987.3059f, 23.7564f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[6], 0.0929f, 74.2657f, 79.3839f, 2, 1);
			iLocal_88[7] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -456.6558f, -983.7804f, 22.9712f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[7], -0.0264f, 29.5754f, 80.9061f, 2, 1);
			iLocal_88[8] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -455.3279f, -983.1712f, 22.9564f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[8], -0.1087f, 109.7339f, 80.9789f, 2, 1);
			iLocal_88[9] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -456.1632f, -983.9359f, 23.7964f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[9], -0.3321f, 74.1907f, 81.6089f, 2, 1);
			iLocal_88[10] = unk_0xDAD26B7BC6DCE4C1(joaat("prop_ld_pipe_single_01"), -454.644f, -994.1709f, 23.3329f, true, true, false);
			unk_0x76D3D51F5F66367F(iLocal_88[10], 5.7811f, 104.6058f, 104.6964f, 2, 1);
			iLocal_97 = 0;
			while (iLocal_97 < 11)
			{
				if (unk_0xDC5D81351D6A4DDB(iLocal_88[iLocal_97]))
				{
					unk_0x9018100BC4DCB099(iLocal_88[iLocal_97], 1);
					unk_0xB29E08C7AB729BAD(iLocal_88[iLocal_97], true);
				}
				iLocal_97++;
			}
			if (bLocal_282)
...
void func_109()
{
	...
	{
		unk_0xFC00A668AFC2126D(joaat("utillitruck2"), true);
		unk_0xBF6EED5D6E0CD9BF(0.1f);
		unk_0x60DEFBFF740D4C09(3, false);
		unk_0xF66A39BBE7B3C278(vLocal_74 + Vector(50f, 50f, 50f), vLocal_74 - Vector(50f, 50f, 50f), 0, 1, 1, 1);
		vLocal_75 = { -455.6561f, -985.8071f, 22.4868f };
		iLocal_80 = unk_0x48CFBECB146FD1A1(joaat("utillitruck2"), vLocal_75, 80f, true, true, false);
		unk_0xC19EDC1D7179164C(iLocal_80, false, true, 0);
		unk_0x14293208022014FA(iLocal_80, 3);
		unk_0x6202B241A8864FC2(iLocal_80, 1, true);
		unk_0x6202B241A8864FC2(iLocal_80, 2, true);
		unk_0x6202B241A8864FC2(iLocal_80, 3, false);
		unk_0x6202B241A8864FC2(iLocal_80, 4, true);
		unk_0x6202B241A8864FC2(iLocal_80, 5, true);
		unk_0x6202B241A8864FC2(iLocal_80, 6, false);
		unk_0x6202B241A8864FC2(iLocal_80, 7, true);
		unk_0xB29E08C7AB729BAD(iLocal_80, true);
		unk_0xD6CDDEFB0FD5B191(iLocal_80, false, false, false, true, false, false, 0, false);
		unk_0xA45E1AA8B9CF45AD(iLocal_80, 10000);
		unk_0x117F5CD9634D61A9(iLocal_80, 5f);
		iLocal_81 = unk_0x48CFBECB146FD1A1(joaat("bulldozer"), -472.9444f, -966.671f, 22.5534f, 181.8365f, true, true, false);
		unk_0xFDD15D670AD33E10(vLocal_75, 10f, 1, 0, 0, false);
		iLocal_88[0] = unk_0xDAD26B7BC6DCE4C1(1668676931, -453.2f, -986.1f, 59.45f, true, true, false);
		unk_0x92DDCF53AA47A63D(iLocal_88[0], 90f);
		unk_0xB29E08C7AB729BAD(iLocal_88[0], true);
		unk_0xD6CDDEFB0FD5B191(iLocal_88[0], true, true, true, true, false, false, 0, false);
		unk_0xA45E1AA8B9CF45AD(iLocal_88[0], 10000000);
...
int func_115()
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		...
		if (vmag2(unk_0x57323E573695B13F(unk_0xA19140A5C42D8715())) > 1369f && !func_126())
		{
			return 0;
		}
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_146(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_174()
{
	if (iLocal_280)
	{
		if (!iLocal_281)
		{
			...
			if (!unk_0x4915F4759304D5CF(iLocal_78))
			{
				unk_0x13E0A8160525AE55(iLocal_78, 317, true);
			}
			if (!unk_0x7112137033807390(iLocal_83, 0))
			{
				if (!unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_83, 0) && !unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_83, 50f, 50f, 50f, 0, 1, 0))
				{
