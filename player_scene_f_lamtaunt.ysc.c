	...
	while (iLocal_289 && func_124(2, 0))
	{
		...
		switch (iLocal_98)
		{
			...
			case 2:
				if (func_120())
				{
					func_119(&uLocal_100, 0, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
...
void func_3(int iParam0)
{
	...
	{
		if (!iLocal_369 && unk_0xDEAEC99031DCB92A(iParam0, unk_0xA19140A5C42D8715(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_97(75, unk_0xE2BBD32891C18569(iParam0, false), 250f, -1);
	...
	fVar4 = vdist2(unk_0xE2BBD32891C18569(iParam0, true), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true));
	if (fVar4 > (8f * 8f))
	{
		iLocal_367 = -1;
	}
	else if (unk_0x958D2327555FAEA5(iParam0))
	{
		iLocal_367 = -1;
	}
	else
	{
		...
		if (iLocal_367 > 0)
		{
			if (iLocal_368 == 0)
			{
				if (iLocal_367 + 15000 < unk_0xFD34717937104F1C())
				{
			...
			else if (iLocal_367 + 10000 < unk_0xFD34717937104F1C())
			{
...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int iParam5, int iParam6)
{
	...
	{
		if (unk_0x69C0BB7D03EE045D((vVar1.z - vVar0.z)) > 2f)
		{
			return 0;
		}
	}
	else if (!unk_0x1A8481A7E865EC7C(iParam0) || !unk_0x7E65E323A95E4187(iParam0))
	{
		return 0;
	}
	bVar5 = false;
	...
	if (!bVar5)
	{
		iVar6 = unk_0x2BDB423A5E45639B(iParam0);
	...
	if (unk_0x445EC9E7EACB710E(&cVar7))
	{
		iVar8 = 1;
	}
	else
...
{
	if (unk_0x80F19C5850FA5765(sParam0, iParam1))
	{
		return 1;
	}
...
int func_26(char* sParam0, char* sParam1, var uParam2)
{
	...
	if (func_24(sParam0, 7))
	{
		...
		while (iVar6 < *uParam2)
		{
			if (!unk_0x429D45A6C6520026(uParam2[iVar6 /*4*/]))
			{
				iVar7 = 0;
				while (iVar7 < Var3)
				{
					if (!unk_0x429D45A6C6520026(&(Var3[iVar7 /*4*/])))
					{
						if (unk_0x3CAC2741CC1A631F(uParam2[iVar6 /*4*/], &(Var3[iVar7 /*4*/])))
						{
							iVar8 = iVar7;
							while (iVar8 <= (Var3 - 1))
							{
		...
		iVar9 = unk_0x22C775856F4633CA(0, iVar5 + 1);
...
int func_75(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14682)
	{
		if (Global_14513.f_1 == 6)
		{
			...
			func_76(1);
			func_79(Global_14494, "DISPLAY_VIEW", 1f, to_float(Global_14493), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (Global_2458186)
							{
								if (iVar1 == 14)
								{
									func_77(Global_14494, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2390[iVar1 /*15*/].f_10), to_float(Global_16885), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2952[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_77(Global_14494, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2390[iVar1 /*15*/].f_10), to_float(Global_16890), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71205)
								{
									...
									func_77(Global_14494, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2390[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14513)
									...
									func_77(Global_14494, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2390[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2390[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_77(Global_14494, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2390[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_77(Global_14494, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_2390[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2952[iVar0] = 1;
						}
					}
...
int func_112(int iParam0, int iParam1)
{
	...
	if (unk_0xDC5D81351D6A4DDB(*iParam0))
	{
		...
		{
			case 0:
				if (unk_0x411C28019DEA5CEF(*iParam0, &cLocal_349, &(Local_359[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_366;
					fVar2 = -1f;
					fVar3 = -1f;
					if (unk_0x2472F234B4C92639(&cLocal_349, &(Local_359[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					if (unk_0x33CECDD9E141E18E(Global_90657) > fVar1)
					{
						...
						if (unk_0x4915F4759304D5CF(*iParam0))
						{
							...
							unk_0x71CBFF70987FE89A(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
							unk_0xF757C0D3A087F145(*iParam0, -668482597, false, 1, 0);
							unk_0x3A3E4B7C6FBE305D(*iParam0, 0, 0);
							unk_0x605B33FCA1A64391(*iParam0, 2);
						}
						wait(0);
						iLocal_292[iParam1] = 1;
						return 1;
			...
			case 1:
				if (unk_0xF9D4EF1338E38AFB(*iParam0, 2106541073) != 1)
				{
					unk_0x956B3CF461C0C1C9(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
					iLocal_292[iParam1] = 2;
					return 1;
				}
				fVar5 = vmag(vLocal_298[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (vdist2(unk_0xE2BBD32891C18569(*iParam0, true), vLocal_295) >= fVar5)
				{
					if (!func_117() && !unk_0x1A8481A7E865EC7C(*iParam0))
					{
						unk_0x956B3CF461C0C1C9(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
						iLocal_292[iParam1] = 2;
						return 1;
				...
				if (unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), *iParam0) || unk_0x967743032563101F(*iParam0, 0))
				{
			...
			case 2:
				...
				if (unk_0xF9D4EF1338E38AFB(*iParam0, 713668775) != 1)
				{
					...
					{
						fLocal_300[iParam1] = (vmag(vLocal_298[iParam1 /*3*/]) * 0.75f);
					}
					unk_0x9E0C8614EFFB96CB(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 1077936128, 1086324736);
			...
			case 3:
				...
				if (unk_0xE31BE476074BBE8F(sLocal_365))
				{
					unk_0x66E6A13BAFFFB63C(sLocal_365, false);
				}
				if (vdist2(unk_0xE2BBD32891C18569(*iParam0, true), vLocal_295 + vLocal_298[iParam1 /*3*/]) < (fLocal_300[iParam1] * fLocal_300[iParam1]))
				{
					if (unk_0xCFA037D3F2BAF3E3(vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 1))
					{
						unk_0xB62205D12F35BF49(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					if (unk_0xF9D4EF1338E38AFB(*iParam0, 1647992574) == 1)
					{
					}
					else if (unk_0x1EB91C63EC75FAAD(vVar6, 0, &vVar7, 14))
					{
						if (vdist2(unk_0xE2BBD32891C18569(*iParam0, true), vVar7) > 100f)
						{
							unk_0x956B3CF461C0C1C9(*iParam0, vVar7, 1f, -1, 0.25f, iVar0, 1193033728);
							iLocal_292[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				unk_0x80E7C4A78224C8F9(5, iLocal_293, 1862763509);
				unk_0x80E7C4A78224C8F9(5, 1862763509, iLocal_293);
				unk_0x80E7C4A78224C8F9(5, iLocal_293, Global_88331);
				unk_0x80E7C4A78224C8F9(5, Global_88331, iLocal_293);
				unk_0xB943C83C5BDB3DBB(*iParam0, 15f, 0);
...
Vector3 func_113(vector3 vParam0, float fParam1, float fParam2)
{
	...
	while (iVar3 < 10)
	{
		vVar0 = { unk_0xF59B9063EDAC7451(-fParam1, fParam1), unk_0xF59B9063EDAC7451(-fParam1, fParam1), 0f };
		if (((vVar0.x * vVar0.x) + (vVar0.y * vVar0.y)) <= fVar1)
		{
			fVar2 = (fParam2 / 2f);
			vVar0.z = unk_0xF59B9063EDAC7451(-fVar2, fVar2);
...
Vector3 func_114(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_115(vVar0, unk_0xF59B9063EDAC7451(0f, fParam1)) };
	...
	if (!func_121())
	{
		if (unk_0xFE5DE0C3200E00F2(Global_90657))
		{
			...
			while (iVar0 < iLocal_290)
			{
				...
				{
					unk_0xE5565DEAABF9D588(iLocal_290[iVar0], Global_90657, &cLocal_349, &(Local_359[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_292[iVar0] = 0;
				}
				else
				{
...
int func_123()
{
	...
	if (unk_0xFE5DE0C3200E00F2(Global_90656))
	{
		...
		while (iVar0 < iLocal_290)
		{
			if (!unk_0x4915F4759304D5CF(iLocal_290[iVar0]))
			{
				unk_0xE5565DEAABF9D588(iLocal_290[iVar0], Global_90656, &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
		{
			func_119(&uLocal_100, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
		}
...
void func_132()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_290)
		{
			...
			{
				unk_0xCACEBBBEAD8F262E(iLocal_291[iVar0]);
				if (!unk_0x7FC99CCC73354033(iLocal_291[iVar0]))
				{
					bVar2 = false;
					unk_0xCACEBBBEAD8F262E(iLocal_291[iVar0]);
				}
		...
		if (!unk_0x429D45A6C6520026(&cLocal_349))
		{
			unk_0x6D68030C791111E0(&cLocal_349);
			if (!unk_0x39C2D9AB77873F84(&cLocal_349))
			{
				bVar2 = false;
				unk_0x6D68030C791111E0(&cLocal_349);
			}
	...
	if (unk_0xDC5D81351D6A4DDB(Global_93018))
	{
		...
		{
			unk_0x1F7948851FB36E88(Global_93018, true, 1);
		}
		func_133(&Global_93018, Global_88331);
		unk_0x13E0A8160525AE55(Global_93018, 132, true);
		unk_0x13E0A8160525AE55(Global_93018, 317, true);
		func_133(&Global_93018, Global_88331);
	}
	unk_0x94E87D83163B4BEB("TAUNTERS", &iLocal_293);
	iVar0 = 0;
	while (iVar0 < iLocal_290)
	{
		if (iLocal_291[iVar0] != 0)
		{
			iLocal_290[iVar0] = unk_0x35C6E06B120EB2E3(iLocal_294, iLocal_291[iVar0], vLocal_295 + vLocal_297[iVar0 /*3*/], 0f, 1, true);
			unk_0x92DDCF53AA47A63D(iLocal_290[iVar0], (fLocal_296 + fLocal_299[iVar0]));
			unk_0x8695E04AA104690A(iLocal_290[iVar0], 0);
			unk_0xDFA901280292A2FB(iLocal_290[iVar0], iLocal_293);
			unk_0x3F01127ECD227890(iLocal_290[iVar0], &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
			unk_0x13E0A8160525AE55(iLocal_290[iVar0], 317, true);
			if (iLocal_294 == 6)
			{
				unk_0xF0188A1B49D79AF7(iLocal_290[iVar0], joaat("weapon_stungun"), 1000, false, true);
			}
		}
		iVar0++;
	}
...
void func_134()
{
	...
	{
		case 218:
			vLocal_297[0 /*3*/] = { unk_0xF59B9063EDAC7451(-10f, 10f), unk_0xF59B9063EDAC7451(-10f, 10f), 0f };
			vLocal_297[1 /*3*/] = { unk_0xF59B9063EDAC7451(-10f, 10f), unk_0xF59B9063EDAC7451(-10f, 10f), 0f };
			vLocal_298[0 /*3*/] = { -77.3f, -4.1f, 1f };
			vLocal_298[1 /*3*/] = { vLocal_298[0 /*3*/] };
			vLocal_298[iLocal_290 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_299[0] = unk_0xF59B9063EDAC7451(-180f, 180f);
			fLocal_299[1] = unk_0xF59B9063EDAC7451(-180f, 180f);
			fLocal_300[0] = 30f;
...
void func_145()
{
	...
	while (iVar0 < iLocal_291)
	{
		if (iLocal_291[iVar0] != 0)
		{
			unk_0x7E4E83D33161D01A(&(iLocal_290[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_291)
	{
		if (iLocal_291[iVar0] != 0)
		{
			unk_0xA5DE74AE39867B03(iLocal_291[iVar0]);
		}
		iVar0++;
	}
	unk_0x3E11F609741642B7(iLocal_293);
	if (!unk_0xE31BE476074BBE8F(sLocal_365))
	{
		unk_0x66E6A13BAFFFB63C(sLocal_365, true);
	}
