...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (unk_0x7112137033807390(iLocal_91, 0) && !iLocal_95 == 7)
			{
		...
		switch (iLocal_95)
		{
			case 0:
				if ((unk_0x1F85F8C7CC4639AE() && !func_33()) && !func_12())
				{
					if (func_11())
					{
						iLocal_91 = unk_0x35C6E06B120EB2E3(26, iLocal_88, vLocal_89, fLocal_90, 1, true);
						unk_0x1F4E5EFBFE503FB3(iLocal_91, true);
						iLocal_92 = unk_0xFCFC8CC5FF74580D(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, true, true, false);
						unk_0x92DDCF53AA47A63D(iLocal_92, (233.8288f + 180f));
						unk_0x73774776D23F43BA(iLocal_91, 0, 0, 0, false);
						iLocal_95 = 1;
					}
				}
				else
			...
			case 1:
				iLocal_97 = unk_0x70788DC3D80C9DEB(vLocal_89 + Vector(1f, 0f, 0f), 0f, 0f, fLocal_90, 2);
				unk_0xE5565DEAABF9D588(iLocal_91, iLocal_97, sLocal_94, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0xE8ECBF07062D9721("MNT_DNC", iLocal_91);
				iLocal_95 = 2;
				break;
			
			case 2:
				if (unk_0x8BA6959DEE57D88C(iLocal_97, "MNT_DNC") == 1)
				{
					unk_0xB1F733E33792528A(iLocal_97);
					iLocal_95 = 3;
				}
				break;
			
			case 3:
				vVar0 = { unk_0xE2BBD32891C18569(iLocal_91, true) };
				unk_0x82416ADE738F7F1F(iLocal_91, 3f);
				if (func_10(unk_0xA19140A5C42D8715(), iLocal_91) < 10f)
				{
					unk_0x887BF9EA318C40F3(unk_0xA19140A5C42D8715(), 1, iLocal_91, 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0x887BF9EA318C40F3(iLocal_91, 1, unk_0xA19140A5C42D8715(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(iLocal_91, unk_0xA19140A5C42D8715(), 1) < 25f)
				{
					if (!unk_0xCE3CB618AFE55EFB(iLocal_96))
					{
						func_5(&iLocal_96, &iLocal_91, 0);
						unk_0x570128B7829A8EAA(iLocal_96, 3);
					}
				}
				else if (unk_0xCE3CB618AFE55EFB(iLocal_96))
				{
					func_4(&iLocal_96);
				}
				if (unk_0x33CECDD9E141E18E(iLocal_97) > 0.9999999f)
				{
					iLocal_95 = 1;
				}
				if (unk_0x685AE6AF34B35D3B(iLocal_91))
				{
					unk_0xBFEB7064EC105B59(iLocal_97);
					iLocal_95 = 4;
				}
				if (((((unk_0x4915F4759304D5CF(iLocal_91) || unk_0x9809FE4B550B1EFE(vVar0, 50f, 1)) || unk_0x9809FE4B550B1EFE(vVar0, 50f, 0)) || unk_0x0AF5F990243ADDFB(vVar0, 20f, 20f, 20f, 0)) || unk_0x6D7FFF527E125F24(-1, vVar0, 50f)) || (((unk_0x669ABFB25D991447(unk_0xD4E735F4B6A956AC(), iLocal_91) || unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), iLocal_91)) && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vVar0, true) < 25f) && func_1(iLocal_91, unk_0xA19140A5C42D8715(), 1126825984, 0)))
				{
					unk_0xBFEB7064EC105B59(iLocal_97);
					iLocal_95 = 4;
					iLocal_93 = 1;
			...
			case 4:
				...
				if (!unk_0x685AE6AF34B35D3B(iLocal_91))
				{
					if (iLocal_93 == 1)
					{
						unk_0x956B3CF461C0C1C9(iLocal_91, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						unk_0x956B3CF461C0C1C9(iLocal_91, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
					unk_0xD738221C247C8B71(iLocal_91, true);
					iLocal_95 = 6;
				}
				break;
			
			case 6:
				if (unk_0xF9D4EF1338E38AFB(iLocal_91, 713668775) != 1 && unk_0xF9D4EF1338E38AFB(iLocal_91, 713668775) != 0)
				{
					unk_0x1F4E5EFBFE503FB3(iLocal_91, false);
					if (iLocal_93 == 1)
					{
						unk_0x33B5487515BD13D5(iLocal_91, unk_0xA19140A5C42D8715(), 100f, -1, 0, 0);
					}
					else
					{
						unk_0x1CBE3F8ED90509B2(iLocal_91, 1193033728, 0);
					}
					unk_0xD738221C247C8B71(iLocal_91, true);
					iLocal_95 = 5;
				}
			...
			case 5:
				if ((unk_0xCDDABFAF231CF3DD(iLocal_91) && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iLocal_91, true), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), true) > 50f) && !unk_0x1F85F8C7CC4639AE())
				{
					func_36(1);
				}
				break;
...
int func_1(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_3(unk_0xE2BBD32891C18569(iParam1, true) - unk_0xE2BBD32891C18569(iParam0, true)) };
	...
	{
		vVar1 = { func_3(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
		...
		if (unk_0xDC5D81351D6A4DDB(*iParam1))
		{
			if (!unk_0x4915F4759304D5CF(*iParam1))
			{
				*iParam0 = func_6(*iParam1, bParam2, 145);
				if (bParam2 == 0)
				{
					unk_0xAD8FB9E563A1FF80(*iParam0, 7);
				}
			}
		}
	}
...
int func_7(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_8(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_8(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
...
int func_11()
{
	...
	unk_0x6D68030C791111E0(sLocal_94);
	if (unk_0x7FC99CCC73354033(iLocal_88) && unk_0x39C2D9AB77873F84(sLocal_94))
	{
		return 1;
	}
	return 0;
...
int func_12()
{
	...
	{
		if (vmag2(unk_0x57323E573695B13F(unk_0xA19140A5C42D8715())) > 1369f && !func_26())
		{
			return 0;
		}
	}
...
void func_36(bool bParam0)
{
	...
	{
		unk_0xC0AC848E56940C34(&iLocal_92);
	}
	if (unk_0xCE3CB618AFE55EFB(iLocal_96))
	{
		func_4(&iLocal_96);
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_91))
	{
		if (bParam0)
		{
			unk_0x680F17660351F21B(&iLocal_91);
		}
		else
		{
			unk_0x7E4E83D33161D01A(&iLocal_91);
		}
	}
