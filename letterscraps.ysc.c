	...
	switch (iLocal_43)
	{
				...
				if (unk_0x3A83743561B4F70C())
				{
					if (!func_19())
					{
						if (((!unk_0xB39808C1DCE0DCFA() && !func_13()) && !func_12()) && !func_11())
						{
							...
							iLocal_55 = unk_0xB00CD6895BDB01A0("LETTER_SCRAPS");
							while (!unk_0x0FA486DE15EB3004(iLocal_55))
							{
								wait(0);
							}
							unk_0x31A9E530D137684F(iLocal_55, "SET_LETTER_TEXT");
							func_10(sLocal_57[0]);
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				...
				unk_0xE9F9BA9108F437C7(iLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_51)
				{
					...
					{
						unk_0xE391E726EE1618FD((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_52);
					}
				}
				else
				{
			...
			case 0:
				*iParam5 = unk_0xB00CD6895BDB01A0("MIDSIZED_MESSAGE");
				if (unk_0x0FA486DE15EB3004(*iParam5))
				{
					...
					if (iParam3 == 6)
					{
						unk_0xE11F00B4AC919F45(iVar0, "PEYOTE_COMPLETED", "HUD_AWARDS", true);
					}
					else
					{
						unk_0xE11F00B4AC919F45(iVar0, "COLLECTED", "HUD_AWARDS", true);
					}
					*iParam4++;
				}
				break;
...
int func_39(var uParam0, var uParam1, vector3 vParam2)
{
	...
	{
		if ((vdist2(vParam2, unk_0x40C0A7A7BE434951((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_59(13)) || func_59(14))
		{
...
int func_54(int iParam0)
{
	...
	if (func_55(unk_0xA19140A5C42D8715()))
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			...
			{
				if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), unk_0x40C0A7A7BE434951(iParam0)) < (5f * 5f) || unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), unk_0xD60FCDE689E95D76(iParam0)))
				{
					return 1;
				}
			}
...
void func_74()
{
	...
	unk_0x86795B44CE5FE021(&iLocal_55);
