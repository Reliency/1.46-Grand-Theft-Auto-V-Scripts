...
void __EntryFunction__()
{
	...
	iLocal_373 = unk_0x410D194E9495C303(iLocal_368);
	iLocal_374 = unk_0x410D194E9495C303(iLocal_369);
	...
	while (true)
	{
		...
		func_464();
		if (unk_0xDC5D81351D6A4DDB(Local_48.f_2))
		{
...
void func_1()
{
	...
	switch (Local_43.f_1)
	{
		case 0:
			...
			if (unk_0x3CAC2741CC1A631F(sVar0, sLocal_381))
			{
				func_503(1);
			}
			else
...
void func_2(bool bParam0)
{
	if (Local_45.f_4 == 1)
	{
		...
		{
			if (unk_0xDC5D81351D6A4DDB(Local_45))
			{
				if (func_463(Local_45))
				{
					unk_0x1F4E5EFBFE503FB3(Local_45, false);
					unk_0x83055D7E96024509(Local_45, false);
				}
...
void func_10(bool bParam0)
{
	...
	{
		unk_0x98D1B1BD9C3AA456(Local_48.f_2, false, 1);
	}
	if (bParam0)
	{
		func_7(&(Local_48.f_2));
	...
	unk_0x5DE59A67B5F326CF(Local_48.f_6);
	unk_0x5DE59A67B5F326CF(Local_48.f_7);
	Local_48 = 0;
}
...
void func_17()
{
	switch (Local_43.f_1)
	{
		case 0:
			if (func_463(Local_48.f_2))
			{
				...
				if (func_220(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", 8, 0, 0, 0))
				{
					...
					iLocal_189 = unk_0xFD34717937104F1C() + 5000;
					Local_43.f_1 = 1;
				}
			}
			else
		...
		case 1:
			if ((unk_0xFD34717937104F1C() > iLocal_189 && !func_18()) || !func_463(Local_48.f_2))
			{
				func_19();
			}
			break;
...
void func_24()
{
	...
	{
		func_26(13, floor(Global_106070.f_10166.f_3853));
	}
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_92(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_92(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_70(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_70(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_70(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_70(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x3B61940560400F58(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_103(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x4BE6499482BEE1D8(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_103(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x4BE6499482BEE1D8(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x6182A22F4D99005E(iVar1, 6, -1, 0, -1, func_92(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_233()
{
	...
	if (Local_43.f_3 == 1)
	{
		...
		while (!unk_0xDC5D81351D6A4DDB(Local_48.f_2))
		{
			func_364();
			wait(0);
		}
		...
		unk_0xCACEBBBEAD8F262E(iLocal_377);
		unk_0xCACEBBBEAD8F262E(iLocal_370);
		...
		{
			func_342(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), 1112014848, 12, 5000, 0, 0);
		}
		Local_43.f_3 = 0;
	}
	if (Local_43.f_1 == 0)
	{
		...
		if (func_353(1, 1093140480, 0))
		{
			if (bLocal_180)
			{
				...
				wait(3000);
				if (unk_0xDC5D81351D6A4DDB(Local_48.f_2) && unk_0x4915F4759304D5CF(Local_48.f_2))
				{
					unk_0x2707FEFAC6A09493(Local_48.f_2);
				}
				if (func_463(Local_48.f_2))
				{
					unk_0x6259CDB47862A4F3(Local_48.f_2, 110, 0);
					unk_0xE216F8B2802ABABF(Local_48.f_2, "Orleans", 0, 0, 0);
				}
				unk_0x951C97E6FA1A90E2(vLocal_49, 0);
				wait(0);
				unk_0x4789FEFEDF029858("SF_TheLastOne", 0);
			...
			else
			{
				...
				if (func_463(Local_48.f_2))
				{
					unk_0x6259CDB47862A4F3(Local_48.f_2, 110, 0);
					unk_0xE216F8B2802ABABF(Local_48.f_2, "Orleans", 0, 0, 0);
					unk_0x1D7FD491D1DD3BD9(Local_48.f_2, 0, 1, 1);
					unk_0x1D7FD491D1DD3BD9(Local_48.f_2, 1, 1, 0);
					unk_0x1D7FD491D1DD3BD9(Local_48.f_2, 8, 1, 0);
					unk_0x1D7FD491D1DD3BD9(Local_48.f_2, 7, 1, 0);
				}
			...
			func_8(0);
			func_2(1);
			iLocal_411 = unk_0xFD34717937104F1C() + 500;
			iLocal_412 = 1;
			iVar0 = unk_0xC409B91AC4749F88();
			unk_0xFDD15D670AD33E10(vLocal_386, 200f, 1, 0, 0, false);
			iLocal_197 = (unk_0x6E7BF7DB6762E140() - 300);
			iLocal_198 = 1;
			if (func_330(iVar0))
			{
				unk_0x4299736016AECE26(iVar0, vLocal_386, 1, false, 0, 1);
				unk_0x92DDCF53AA47A63D(iVar0, fLocal_387);
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			iLocal_385 = unk_0xC409B91AC4749F88();
			if (!func_330(iLocal_385) && unk_0x7FC99CCC73354033(iLocal_377))
			{
				iLocal_385 = unk_0x48CFBECB146FD1A1(iLocal_377, vLocal_386, fLocal_387, true, true, false);
				if (func_330(iLocal_385))
				{
					unk_0xEA847E35BAC71F2A(iLocal_385, 1);
				}
			}
		}
		if (func_329())
		{
			if (iLocal_198)
			{
				if (unk_0x95BED12E084A8F9A() > iLocal_197)
				{
		...
		if (func_463(Local_48.f_2))
		{
			if (unk_0x0FFE9FEDC2E0AC88("Orleans", 0))
			{
				...
				unk_0x13E0A8160525AE55(Local_48.f_2, 185, true);
				unk_0xCB6F83EEDBCC77C4(Local_48.f_2, 0);
				unk_0x2F89329397A277BC(&iVar1);
				unk_0x3F01127ECD227890(0, sLocal_380, "leadout_sas_3_rcm_sas", 1000f, -8f, -1, 17039368, 0, 0, 1, 0);
				unk_0x3F01127ECD227890(0, sLocal_380, "sas_idle_sit", 1000f, -1000f, -1, 17039369, 0, 0, 1, 0);
				unk_0x301F42EEE3C40328(iVar1);
				unk_0xE1072FA2FECBAD96(Local_48.f_2, iVar1);
				unk_0x3A95A0A3221D4208(&iVar1);
				unk_0x3A3E4B7C6FBE305D(Local_48.f_2, 1, 0);
				unk_0x8C26EBB3525646D4(Local_48.f_2, 0);
				unk_0x786985E3CB4F1F52(Local_48.f_2, 1, 0.81f, 0.733f, 1);
				unk_0x786985E3CB4F1F52(Local_48.f_2, 0, 0.94f, 0.59f, 1);
				if (func_463(unk_0xA19140A5C42D8715()) && unk_0x0FFE9FEDC2E0AC88("FRANKLIN", 0))
				{
					unk_0x22DD1D053CFF9707(unk_0xA19140A5C42D8715(), Local_48.f_2, -1, 2050, 4);
					unk_0x22DD1D053CFF9707(Local_48.f_2, unk_0xA19140A5C42D8715(), -1, 2050, 4);
				}
			}
			if (iLocal_412)
			{
				if (unk_0xFD34717937104F1C() > iLocal_411)
				{
					unk_0x72A0FF8C49CFFC0D(Local_48.f_2, 0, 1, 1, 0);
					unk_0x72A0FF8C49CFFC0D(Local_48.f_2, 1, 1, 0, 0);
					unk_0x72A0FF8C49CFFC0D(Local_48.f_2, 8, 1, 0, 0);
					unk_0x72A0FF8C49CFFC0D(Local_48.f_2, 7, 1, 0, 0);
					iLocal_412 = 0;
				}
			}
		}
...
void func_246()
{
	...
	unk_0x575CF00E129E0CE1(Local_48.f_3, 1f);
...
void func_247(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_218(unk_0x61D2332983ACC05C(), 1);
			if (iVar4 != -1)
			{
...
void func_273(int iParam0, var uParam1)
{
	...
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x3D2A81E3C295D501(iParam0, func_278(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
int func_353(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		...
		{
			if (!func_358(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_361()
{
	...
	{
		unk_0xCACEBBBEAD8F262E(iLocal_376);
		if (unk_0x7FC99CCC73354033(iLocal_376))
		{
			Local_46 = unk_0xDAD26B7BC6DCE4C1(iLocal_376, vLocal_388, true, true, false);
			if (unk_0xDC5D81351D6A4DDB(Local_46))
			{
				unk_0x76D3D51F5F66367F(Local_46, vLocal_389, 2, 1);
				unk_0xA5DE74AE39867B03(iLocal_376);
				unk_0xB29E08C7AB729BAD(Local_46, true);
			}
			else
			{
				return 0;
...
{
	unk_0xB29E08C7AB729BAD(iParam0, !bParam1);
...
int func_364()
{
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		Local_48.f_2 = unk_0x35C6E06B120EB2E3(25, iLocal_370, Local_47.f_1[1 /*14*/].f_1, 0f, 1, true);
	}
	else
	{
		Local_48.f_2 = unk_0x35C6E06B120EB2E3(25, iLocal_370, Local_47.f_1[0 /*14*/].f_1, 0f, 1, true);
	}
	if (func_463(Local_48.f_2))
	{
		iLocal_188 = func_365(unk_0xA19140A5C42D8715(), Local_48.f_2, 0f);
		unk_0x98D1B1BD9C3AA456(Local_48.f_2, true, 1);
		unk_0x92B3AAAC52CC36E1(Local_48.f_2, false);
		unk_0x96BFF0680C7B6FD5(Local_48.f_2, false);
		unk_0x1F4E5EFBFE503FB3(Local_48.f_2, true);
		unk_0xF0188A1B49D79AF7(Local_48.f_2, joaat("weapon_unarmed"), -1, true, true);
		unk_0x8C26EBB3525646D4(Local_48.f_2, 0);
		unk_0x72A0FF8C49CFFC0D(Local_48.f_2, 0, 1, 0, 0);
		unk_0x72A0FF8C49CFFC0D(Local_48.f_2, 1, 0, 0, 0);
		unk_0x72A0FF8C49CFFC0D(Local_48.f_2, 8, 0, 0, 0);
		unk_0x13E0A8160525AE55(Local_48.f_2, 185, true);
		unk_0x3B7A32E04BBE59A5(Local_48.f_2, 46, true);
		unk_0x605FF8F1D0D5E4DE(Local_48.f_2, true);
		unk_0xAAB061EFC631505C(Local_48.f_2, true);
		unk_0xB4F2B588B54261BF(Local_48.f_2, 1);
		func_232(&uLocal_199, 3, Local_48.f_2, "ORLEANS", 0, 1);
		func_363(Local_48.f_2, 0);
		Local_48 = 0;
		Local_48.f_1 = 2;
		Local_48.f_4 = 0;
		Local_48.f_5 = unk_0x7A3ECD08D6D1D554();
		Local_48.f_6 = unk_0x7A3ECD08D6D1D554();
		Local_48.f_7 = unk_0x7A3ECD08D6D1D554();
		Local_48.f_11 = 0;
		return 1;
	}
	return 0;
...
int func_367()
{
	if ((unk_0x7FC99CCC73354033(iLocal_370) && unk_0x39C2D9AB77873F84(sLocal_379)) && unk_0x39C2D9AB77873F84(sLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_371()
{
	if (Local_43.f_3 == 1)
	{
		...
		{
			unk_0x4299736016AECE26(unk_0xA19140A5C42D8715(), vLocal_402, 1, false, 0, 1);
			unk_0x92DDCF53AA47A63D(unk_0xA19140A5C42D8715(), fLocal_403);
		}
		while (!func_362())
		{
			wait(0);
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			if (unk_0x6D7FFF527E125F24(-1, unk_0xE2BBD32891C18569(Local_48.f_2, true), 4f) || iLocal_171)
			{
			...
			else
			{
				func_245(4);
				func_397();
				iLocal_364 = unk_0xFD34717937104F1C() + 3000;
				Local_43.f_1 = 3;
				func_11(&(Local_48.f_3));
			}
		}
		else if (unk_0x6D7FFF527E125F24(-1, unk_0xE2BBD32891C18569(Local_48.f_2, true), 4f))
		{
			if (unk_0xFD34717937104F1C() > iLocal_186)
			{
				iLocal_185++;
				iLocal_186 = unk_0xFD34717937104F1C() + 1000;
				func_396(807, 1, 0);
			}
			if ((iLocal_179 && iLocal_185 > 0) || (!iLocal_179 && iLocal_185 > 1))
			{
				if (func_463(Local_48.f_2))
				{
					unk_0x6259CDB47862A4F3(Local_48.f_2, 99, 0);
				}
		...
		else
		{
			...
			{
				Local_47 = 0;
				if (Local_47.f_352 == 0 && !unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
				{
					Local_47.f_352 = 2;
				}
				else
			...
			if (func_379(unk_0xA19140A5C42D8715(), Local_47.f_1[10 /*14*/].f_5, 100f))
			{
				unk_0x9D7A6D81C3BE2AAE("sas_2_rcm_t7", 8);
			}
			if (iLocal_170 == 0)
			{
				...
				iLocal_170 = 1;
				iLocal_184 = unk_0xFD34717937104F1C() + 1000;
			}
			else if (iLocal_183 == 0)
			{
				if (iLocal_184 < unk_0xFD34717937104F1C())
				{
					func_377("SAS1_H0", -1);
					iLocal_183 = 1;
				}
			...
			else if (iLocal_178 == 0)
			{
				if (Local_47.f_352 < 5)
				{
					...
					{
						func_232(&uLocal_199, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
			...
			else if (iLocal_179 == 0)
			{
				...
				{
					if (!func_18() && unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_392, 35f, 35f, 35f, false, true, 0))
					{
						func_374();
						func_232(&uLocal_199, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
						if (func_220(&uLocal_199, "SAS1AUD", "SAS1_CHASE3", 7, 0, 0, 0))
						{
							unk_0x0D0784EB08BB4C22(Local_48.f_2, -1536.6f, 4543.7f, 45.5f, -1538.2f, 4536.2f, 48.6f, 5f, 0, 0);
							iLocal_179 = 1;
						}
					}
				}
			...
			if (iLocal_168 == 0)
			{
				if (!func_373(&uLocal_63, unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true)))
				{
					func_378("SAS1_C2", 7500, 0);
					iLocal_168 = 1;
					iLocal_172 = unk_0xFD34717937104F1C() + 30000;
				}
			}
			else if (unk_0xFD34717937104F1C() > iLocal_172)
			{
				if (func_373(&uLocal_63, unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true)))
				{
					iLocal_168 = 0;
...
void func_372()
{
	unk_0x4F93066CECE72793();
	func_11(&(Local_48.f_3));
	if (func_373(&uLocal_115, unk_0xE2BBD32891C18569(Local_48.f_2, false)))
	{
		bLocal_180 = false;
	}
	else
...
void func_374()
{
	...
	while (iVar0 < iLocal_60)
	{
		...
		{
			unk_0x33B5487515BD13D5(Local_59[iVar0 /*16*/], unk_0xA19140A5C42D8715(), 500f, -1, 0, 0);
			func_4(&(Local_59[iVar0 /*16*/]), 1, 0, 1);
		}
		iVar0++;
	}
...
bool func_376(int iParam0, int iParam1)
{
	...
	return (unk_0xFD34717937104F1C() - Local_42[iParam0 /*13*/].f_4) < iParam1;
}
...
void func_380()
{
	if (unk_0xB3CB9098064F83A7(unk_0xE2BBD32891C18569(Local_48.f_2, true), 1.5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			func_381();
	...
	else if (unk_0xB3CB9098064F83A7(unk_0xE2BBD32891C18569(Local_48.f_2, true), 5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			if (!func_18())
...
void func_381()
{
	...
	{
		unk_0x5DE59A67B5F326CF(Local_48.f_6);
		unk_0x6020229E34827A69(Local_48.f_6, "WOUNDED", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
		Local_48.f_10 = 1;
	}
}
...
void func_385(int iParam0)
{
	...
	switch (iParam0->f_1)
	{
		case 1:
			...
			else if (func_386(*iParam0, unk_0xA19140A5C42D8715(), iParam0->f_15, 1))
			{
	...
	switch (Local_48)
	{
		case 1:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					unk_0x4299736016AECE26(Local_48.f_2, uParam0->f_1, 1, false, 0, 1);
					if (*uParam0 == 1)
					{
						func_394(Local_48.f_2, uParam0->f_5);
					}
					Local_48.f_4 = (unk_0xFD34717937104F1C() + iVar1);
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					else if (unk_0xFD34717937104F1C() > Local_48.f_4)
					{
						Local_48 = 2;
						Local_48.f_1 = 0;
					}
		...
		case 2:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					Local_48.f_12 = (unk_0xFD34717937104F1C() + 60000);
					Local_48.f_4 = 0;
					Local_48.f_1 = 1;
				}
				else if (fVar0 == -1f || func_386(Local_48.f_2, unk_0xA19140A5C42D8715(), fVar0, 1))
				{
				...
				else if (unk_0xCE3CB618AFE55EFB(Local_48.f_3))
				{
					iVar2 = (unk_0x1C05D741948BDE08(Local_48.f_3) - 5);
					if (iVar2 > 0)
					{
						unk_0xE8C2974337833D20(Local_48.f_3, iVar2);
					}
					else
					{
						func_11(&(Local_48.f_3));
				...
				else if (unk_0xFD34717937104F1C() > Local_48.f_12)
				{
					Local_48.f_11 = 1;
				}
				else if (unk_0xFD34717937104F1C() > Local_48.f_4)
				{
					if ((unk_0x57269F5E44F5F616(Local_48.f_6) && unk_0x57269F5E44F5F616(Local_48.f_6)) && unk_0x57269F5E44F5F616(Local_48.f_7))
					{
						unk_0x6020229E34827A69(Local_48.f_5, "ALERT", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
						unk_0xDFA43CC865F81873(unk_0xE2BBD32891C18569(Local_48.f_2, true), 30f, 6);
					}
					Local_48.f_4 = unk_0xFD34717937104F1C() + 7500;
				}
		...
		case 3:
			if (func_463(Local_48.f_2))
			{
				...
				{
					func_363(Local_48.f_2, 1);
					unk_0x71CBFF70987FE89A(Local_48.f_2, uParam0->f_5, 3f, -1, 1193033728, 1056964608);
					if ((unk_0x57269F5E44F5F616(Local_48.f_6) && unk_0x57269F5E44F5F616(Local_48.f_6)) && unk_0x57269F5E44F5F616(Local_48.f_7))
					{
						unk_0x6020229E34827A69(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
					}
					Local_48.f_10 = 0;
					if (!unk_0xCE3CB618AFE55EFB(Local_48.f_3))
					{
						Local_48.f_3 = func_324(Local_48.f_2, 1, 0, 5);
						unk_0x575CF00E129E0CE1(Local_48.f_3, 1f);
					}
					...
					{
						unk_0xE8C2974337833D20(Local_48.f_3, 255);
					}
					if (Local_47.f_352 == (Local_47.f_353 - 1))
					{
						unk_0x92B3AAAC52CC36E1(Local_48.f_2, true);
						unk_0x96BFF0680C7B6FD5(Local_48.f_2, true);
						unk_0x6259CDB47862A4F3(Local_48.f_2, 110, 0);
					}
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					{
						unk_0x3F01127ECD227890(Local_48.f_2, sLocal_379, "tlo_leap_out", 8f, -8f, -1, 512, 0, 0, 0, 0);
						Local_48.f_1 = 2;
					}
					...
					else if ((unk_0x57269F5E44F5F616(Local_48.f_6) && unk_0x57269F5E44F5F616(Local_48.f_6)) && unk_0x57269F5E44F5F616(Local_48.f_7))
					{
						if (Local_48.f_10 == 0)
						{
							unk_0x6020229E34827A69(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
					...
					if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
					{
						...
						if (func_330(iVar3) && unk_0xC556072C29E00F04(iVar3, Local_48.f_2))
						{
							Local_48 = 6;
							Local_48.f_1 = 0;
						}
				...
				{
					unk_0x9568B1B58F78FF36(Local_48.f_2);
					if (Local_47.f_352 < (Local_47.f_353 - 1))
					{
						if ((unk_0x57269F5E44F5F616(Local_48.f_6) && unk_0x57269F5E44F5F616(Local_48.f_6)) && unk_0x57269F5E44F5F616(Local_48.f_7))
						{
							unk_0x6020229E34827A69(Local_48.f_7, "COUGH", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
						}
						Local_48 = 4;
						Local_48.f_1 = 0;
					}
		...
		case 4:
			...
			if (func_463(Local_48.f_2))
			{
				if (unk_0xCE3CB618AFE55EFB(Local_48.f_3))
				{
					...
					iVar4 = (unk_0x1C05D741948BDE08(Local_48.f_3) - iVar5);
					if (iVar4 > 0)
					{
						unk_0xE8C2974337833D20(Local_48.f_3, iVar4);
					}
					else
					{
						func_11(&(Local_48.f_3));
		...
		case 5:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					unk_0xE1072FA2FECBAD96(Local_48.f_2, iVar6);
					func_374();
					Local_48.f_1 = 1;
					Local_48.f_9 = 0;
				}
				else if (Local_48.f_1 == 1)
				{
					if (Local_48.f_9 == 0)
					{
						if (func_386(unk_0xA19140A5C42D8715(), Local_48.f_2, 20f, 1))
						{
							unk_0x6259CDB47862A4F3(Local_48.f_2, 110, 0);
							unk_0xDFA901280292A2FB(Local_48.f_2, -2065892691);
							unk_0x13E0A8160525AE55(Local_48.f_2, 185, true);
							func_374();
							iLocal_366 = 0;
					...
					{
						if (unk_0xFD34717937104F1C() > iLocal_367)
						{
							if (func_390(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", sLocal_365[iLocal_366], 7, 0, 0))
							{
								iLocal_367 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(3000, 5000));
								iLocal_366 = unk_0x22C775856F4633CA(0, 4);
							}
						}
					}
					func_389();
		...
		case 6:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					unk_0x92B3AAAC52CC36E1(Local_48.f_2, true);
					unk_0x96BFF0680C7B6FD5(Local_48.f_2, true);
					unk_0x6259CDB47862A4F3(Local_48.f_2, 120, 0);
					func_363(Local_48.f_2, 1);
					if (!unk_0xCE3CB618AFE55EFB(Local_48.f_3))
					{
						Local_48.f_3 = func_324(Local_48.f_2, 1, 0, 5);
					...
					iLocal_171 = 1;
					unk_0xDA4D3941AFF8EF12(Local_48.f_2, unk_0xA19140A5C42D8715(), 0, 16);
					func_374();
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
...
void func_389()
{
	if (unk_0xDEAEC99031DCB92A(Local_48.f_2, unk_0xA19140A5C42D8715(), 1))
	{
		unk_0x6259CDB47862A4F3(Local_48.f_2, 99, 0);
	}
}
...
void func_391()
{
	if (iLocal_191 < 0)
	{
		iLocal_191 = unk_0xFD34717937104F1C() + 7000;
		iLocal_192 = -1;
	}
	else if (unk_0xFD34717937104F1C() > iLocal_191)
	{
...
void func_392()
{
	if (iLocal_192 < 0)
	{
		iLocal_192 = unk_0xFD34717937104F1C() + 7000;
		iLocal_191 = -1;
	}
	else if (unk_0xFD34717937104F1C() > iLocal_192)
	{
		if ((!func_18() && !unk_0x8187CC9EB2D7CFE6()) && !unk_0x9661F58DC617631D(unk_0xA19140A5C42D8715()))
		{
...
int func_393(var uParam0)
{
	...
	vVar0 = { func_336(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) - uParam0->f_1) };
	...
	if ((vVar0.x * vVar1.x) + (vVar0.y * vVar1.y)) < cos(to_float(uParam0->f_11))
	{
		...
		return !unk_0x3E0F7A5430506B61(vVar2, vVar3, 0, 1, 0, 0, 0, 0, 0);
	}
	return 0;
}
...
void func_400()
{
	unk_0xA5DE74AE39867B03(iLocal_378);
}
...
void func_402()
{
	...
	while (iVar0 < iLocal_60)
	{
		Local_59[iVar0 /*16*/] = unk_0x35C6E06B120EB2E3(25, iLocal_378, Local_59[iVar0 /*16*/].f_11, Local_59[iVar0 /*16*/].f_14, 1, true);
		if (func_463(Local_59[iVar0 /*16*/]))
		{
			unk_0x1F4E5EFBFE503FB3(Local_59[iVar0 /*16*/], true);
			unk_0xB4F2B588B54261BF(Local_59[iVar0 /*16*/], 1);
			unk_0x9E0C8614EFFB96CB(Local_59[iVar0 /*16*/], Local_59[iVar0 /*16*/].f_11, 15f, 1077936128, 1086324736);
			unk_0x3B7A32E04BBE59A5(Local_59[iVar0 /*16*/], 46, true);
			unk_0xD66FF6E7D7FCE47A(Local_59[iVar0 /*16*/], joaat("weapon_cougar"), -1, true);
...
bool func_403()
{
	return unk_0x7FC99CCC73354033(iLocal_378);
}

void func_404()
{
	unk_0xCACEBBBEAD8F262E(iLocal_378);
}
...
void func_405()
{
	...
	if (unk_0xFD34717937104F1C() > iLocal_187 && iLocal_187 > 0)
	{
		if (func_236(unk_0xA19140A5C42D8715()))
		{
			unk_0x962CF6A9EA6FDCAC(unk_0xD4E735F4B6A956AC(), true, 0);
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_442())
		{
			...
			if (func_463(Local_45))
			{
				unk_0x13E0A8160525AE55(Local_45, 185, true);
				unk_0xCB6F83EEDBCC77C4(Local_45, 0);
			}
			iLocal_61 = unk_0x3841F2F038129676(vLocal_390, 75f);
			unk_0x570128B7829A8EAA(iLocal_61, 5);
			unk_0xE8C2974337833D20(iLocal_61, 128);
			unk_0x264E87C905AE790B(iLocal_61, false);
			unk_0xFDD15D670AD33E10(vLocal_404, 100f, 1, 0, 0, false);
			unk_0xFDD15D670AD33E10(vLocal_405, 100f, 1, 0, 0, false);
			unk_0xFDD15D670AD33E10(vLocal_406, 100f, 1, 0, 0, false);
			unk_0xFDD15D670AD33E10(vLocal_407, 100f, 1, 0, 0, false);
			iLocal_167 = 0;
			iLocal_168 = 0;
			iLocal_169 = 0;
			iLocal_174 = 0;
			...
			iLocal_181 = 1;
			iLocal_182 = 1;
			iLocal_196 = (unk_0xFD34717937104F1C() + 40000);
	...
	if (Local_43.f_1 == 1)
	{
		...
		else if ((func_426(Local_45, 0, 70f, 170f, 1, 0, 0, 0) || !func_379(Local_45, vLocal_397, 1.5f)) || unk_0x685AE6AF34B35D3B(Local_45))
		{
			unk_0xDFA901280292A2FB(Local_45, -2065892691);
			unk_0xDA4D3941AFF8EF12(Local_45, unk_0xA19140A5C42D8715(), 0, 16);
			func_397();
			func_245(6);
			Local_43.f_9 = 3;
			Local_43.f_1 = 3;
		...
		{
			bVar0 = func_373(&uLocal_63, unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true));
			if (iLocal_182 && func_379(unk_0xA19140A5C42D8715(), vLocal_388, 250f))
			{
				func_368();
				func_404();
				iLocal_182 = 0;
			...
			else if (iLocal_175 == 0)
			{
				...
				{
					func_232(&uLocal_199, 4, Local_45, "HUNTER", 0, 1);
					if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), Local_45, 25f, 25f, 25f, 0, 1, 0))
					{
			...
			else if (iLocal_167 == 0)
			{
				...
				if (func_18())
				{
					if (func_407(unk_0xA19140A5C42D8715(), Local_45) > 25f)
					{
						func_397();
					}
				}
			...
			else
			{
				if (iLocal_169 == 0)
				{
					if (func_379(unk_0xA19140A5C42D8715(), vLocal_388, 5f))
					{
						func_232(&uLocal_199, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
				...
				if (iLocal_176 == 0)
				{
					if (func_379(unk_0xA19140A5C42D8715(), Local_47.f_1[0 /*14*/].f_1, 40f))
					{
						if (func_364())
						{
							func_11(&iLocal_61);
							Local_48.f_3 = func_324(Local_48.f_2, 1, 0, 5);
							unk_0x575CF00E129E0CE1(Local_48.f_3, 1f);
							unk_0x7A15C6C664F7334E(Local_48.f_5, "ALERT", -1541.965f, 4692.725f, 44.0651f, "SASQUATCH_01_SOUNDSET", 0, 0, 0);
							unk_0xDFA43CC865F81873(unk_0xE2BBD32891C18569(Local_48.f_2, true), 30f, 6);
							unk_0x8CBE3882704F529D(unk_0xA19140A5C42D8715(), Local_47.f_1[0 /*14*/].f_1, 6000, 1024, 2);
							iLocal_176 = 1;
							iLocal_190 = -1;
							func_406();
						}
				...
				else if (iLocal_177 == 0)
				{
					if (!func_18())
					{
						if (iLocal_190 < 0)
						{
							iLocal_190 = unk_0xFD34717937104F1C() + 2000;
						}
						else if (unk_0xFD34717937104F1C() > iLocal_190)
						{
							func_232(&uLocal_199, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
...
void func_406()
{
	...
	unk_0xFDD15D670AD33E10(vLocal_404, 50f, 1, 0, 0, false);
	unk_0xFDD15D670AD33E10(vLocal_405, 50f, 1, 0, 0, false);
	unk_0xFDD15D670AD33E10(vLocal_406, 50f, 1, 0, 0, false);
	unk_0xFDD15D670AD33E10(vLocal_407, 20f, 1, 0, 0, false);
	iVar0 = unk_0xC409B91AC4749F88();
	if (unk_0xDC5D81351D6A4DDB(iVar0) && !unk_0x7112137033807390(iVar0, 0))
	{
		...
		{
			unk_0x4299736016AECE26(iVar0, vLocal_383, 1, false, 0, 1);
			unk_0x92DDCF53AA47A63D(iVar0, fLocal_384);
			unk_0x99F546A9200EA026(iVar0, 1084227584);
		}
	}
}
...
void func_409()
{
	if (iLocal_173)
	{
		if (!func_330(Local_44.f_35[0]) && func_407(unk_0xA19140A5C42D8715(), Local_45) < 25f)
		{
			func_397();
...
void func_413()
{
	if (func_463(Local_45) && func_463(unk_0xA19140A5C42D8715()))
	{
		if (func_386(unk_0xA19140A5C42D8715(), Local_45, 50f, 1))
		{
			...
			if (unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), Local_45))
			{
...
int func_421(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_336(unk_0xE2BBD32891C18569(iParam1, true) - unk_0xE2BBD32891C18569(iParam0, true)) };
	...
	{
		vVar1 = { func_336(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_431(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_336(vParam1 - unk_0xE2BBD32891C18569(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_433()
{
	...
	{
		if (unk_0x411C28019DEA5CEF(Local_45, sLocal_379, "hunter_leadout", 3))
		{
			if (unk_0xE5B5A1FFAA0834BD(Local_45, sLocal_379, "hunter_leadout") > 0.9f)
			{
				if (unk_0x39C2D9AB77873F84(sLocal_379))
				{
					unk_0x2F89329397A277BC(&iVar0);
					unk_0x3F01127ECD227890(0, sLocal_379, "hunter_idle", 8f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x4C9989F866EF6731(iVar0, 1);
					unk_0x301F42EEE3C40328(iVar0);
					unk_0xE1072FA2FECBAD96(Local_45, iVar0);
...
void func_434()
{
	...
	while (iVar0 < Local_42)
	{
		if (!(Local_42[iVar0 /*13*/].f_11 == 3 && unk_0xFD34717937104F1C() < Local_42[iVar0 /*13*/].f_10))
		{
...
int func_435(var uParam0)
{
	...
	if (!func_236(uParam0->f_1) || !func_236(uParam0->f_2))
	{
		if (uParam0->f_5 != 0)
		{
			iVar5 = unk_0x7C00B4755E048785(uParam0->f_5, &iVar1, &vVar2, &uVar3, &uVar4);
			uParam0->f_5 = 0;
		}
	...
	vVar7 = { unk_0xE2BBD32891C18569(uParam0->f_1, true) };
	vVar8 = { unk_0xE2BBD32891C18569(uParam0->f_2, true) };
	if (uParam0->f_3 > 0f)
	{
		vVar9 = { func_336(vVar8 - vVar7) };
		fVar10 = func_422(unk_0xFA0A034A8C86C35E(uParam0->f_1), vVar9);
		if (fVar10 <= cos(fVar6))
		{
			if (uParam0->f_5 != 0)
			{
	...
	if (uParam0->f_5 == 0)
	{
		vVar7 = { unk_0x505186370955851F(uParam0->f_1, 31086, 0f, 0.6f, 0f) };
		uParam0->f_7 = { vVar8 + unk_0x57323E573695B13F(uParam0->f_2) * FtoV(unk_0xDE089748C4C76C96()) };
		vVar0 = { uParam0->f_7 - vVar7 * Vector(1.25f, 1.25f, 1.25f) + vVar7 };
		uParam0->f_5 = unk_0x931DC90E31FA1705(vVar7, vVar0, 511, 0, 7);
		return 2;
	}
	bVar12 = false;
	iVar5 = unk_0x7C00B4755E048785(uParam0->f_5, &iVar1, &vVar2, &uVar3, &uVar4);
	...
	{
		fVar13 = unk_0x69C0BB7D03EE045D((unk_0xEAA5CEF8875FEEED(uParam0->f_1) * unk_0xDE089748C4C76C96()));
		fVar13 = 0f;
		fVar11 = unk_0x499324B3EF19C288(uParam0->f_7, vVar2, false);
		...
		if (bVar12 && unk_0x69C0BB7D03EE045D((uParam0->f_7.f_2 - vVar2.z)) > 1f)
		{
			bVar12 = false;
		}
		uParam0->f_6 = bVar12;
...
void func_438()
{
	unk_0xA5DE74AE39867B03(iLocal_371);
	unk_0xA5DE74AE39867B03(iLocal_372);
	unk_0xA5DE74AE39867B03(iLocal_373);
	unk_0xA5DE74AE39867B03(iLocal_374);
	unk_0xA5DE74AE39867B03(iLocal_375);
}
...
void func_439(bool bParam0)
{
	if (Local_45.f_4 == 0)
	{
		if (bParam0)
		{
			if (func_463(unk_0xA19140A5C42D8715()) && !func_352())
			{
				unk_0x4299736016AECE26(unk_0xA19140A5C42D8715(), vLocal_393, 1, false, 0, 1);
				unk_0x92DDCF53AA47A63D(unk_0xA19140A5C42D8715(), fLocal_394);
				unk_0xD87B76260C547F31(0f);
				unk_0xAA32DD4848CF93E0(0f, 1065353216);
			}
			if (func_463(Local_44.f_28[0]))
			{
				...
				unk_0x4299736016AECE26(Local_45, vLocal_395, 1, false, 0, 1);
				unk_0x92DDCF53AA47A63D(Local_45, fLocal_396);
			}
			else
			{
				Local_45 = unk_0x35C6E06B120EB2E3(26, iLocal_371, vLocal_395, fLocal_396, 1, true);
			...
			if (func_441(Local_45, 1862763509, iLocal_368))
			{
				if (func_463(unk_0xA19140A5C42D8715()))
				{
					unk_0x22DD1D053CFF9707(Local_45, unk_0xA19140A5C42D8715(), -1, 1024, 2);
				}
			}
		}
		func_440();
...
void func_440()
{
	...
	if (!unk_0xF93654E07E20E3CF(Local_45.f_2))
	{
		Local_45.f_2 = unk_0x4B3DFBACE939C0B8(joaat("pickup_weapon_sniperrifle"), vLocal_398, vLocal_399, iVar0, 100, 0, 1, 0);
	}
	if (!unk_0xF93654E07E20E3CF(Local_45.f_3))
	{
		if (vLocal_400.z != 0f)
		{
			Local_45.f_3 = unk_0x4B3DFBACE939C0B8(joaat("pickup_weapon_pumpshotgun"), vLocal_400, vLocal_401, iVar0, 48, 0, 1, 0);
		}
	}
}
...
int func_441(int iParam0, int iParam1, int iParam2)
{
	if (func_463(iParam0))
	{
		...
		unk_0x13E0A8160525AE55(iParam0, 132, true);
		unk_0x1F4E5EFBFE503FB3(iParam0, true);
		unk_0x83055D7E96024509(iParam0, true);
		unk_0x96BFF0680C7B6FD5(iParam0, false);
		if (iParam2 != joaat("weapon_unarmed"))
		{
			unk_0xF0188A1B49D79AF7(iParam0, iParam2, 100, true, true);
...
int func_442()
{
	if (((((((unk_0x7FC99CCC73354033(iLocal_371) && unk_0x7FC99CCC73354033(iLocal_372)) && unk_0x7FC99CCC73354033(iLocal_373)) && unk_0x7FC99CCC73354033(iLocal_374)) && unk_0x7FC99CCC73354033(iLocal_375)) && unk_0xE4821F58D6594AAF(iLocal_372)) && unk_0x39C2D9AB77873F84(sLocal_379)) && unk_0x39C2D9AB77873F84(sLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_443()
{
	unk_0xCACEBBBEAD8F262E(iLocal_371);
	unk_0xCACEBBBEAD8F262E(iLocal_372);
	unk_0xCACEBBBEAD8F262E(iLocal_373);
	unk_0xCACEBBBEAD8F262E(iLocal_374);
	unk_0xCACEBBBEAD8F262E(iLocal_375);
	unk_0x45BAD633963B31EC(iLocal_372, 3);
	unk_0x6D68030C791111E0(sLocal_379);
	unk_0x6D68030C791111E0(sLocal_380);
}
...
void func_452()
{
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_353(1, 1093140480, 0))
		{
			...
			if (func_463(Local_44.f_28[0]))
			{
				unk_0xE216F8B2802ABABF(Local_44.f_28[0], "Hunter", 0, 0, 0);
				iLocal_62 = func_454(Local_44.f_28[0], 1, 0, 0, 0, 0);
				if (unk_0xDC5D81351D6A4DDB(iLocal_62))
				{
					unk_0xE216F8B2802ABABF(iLocal_62, "SAS_SniperRifle", 0, 0, 0);
				}
			}
			func_350(500, 0);
			unk_0x2E989BFBA0D3CC0E(vLocal_408, vLocal_409, false, 0);
			unk_0x66E6A13BAFFFB63C("WORLD_HUMAN_HIKER", false);
			unk_0x66E6A13BAFFFB63C("WORLD_MOUNTAIN_LION_WANDER", false);
			func_453();
			unk_0x80D42964D19AF118(0);
			wait(0);
			unk_0x4789FEFEDF029858("SF_TheLastOne", 0);
			...
			unk_0xFDD15D670AD33E10(-1561.793f, 4668.806f, 48.04337f, 218.9074f, 1, 0, 0, false);
			func_443();
			if (func_236(unk_0xA19140A5C42D8715()))
			{
		...
		if (func_463(Local_44.f_28[0]))
		{
			if (unk_0x0FFE9FEDC2E0AC88("Hunter", 0))
			{
				...
				if (func_441(Local_45, 1862763509, iLocal_368))
				{
					if (unk_0x39C2D9AB77873F84(sLocal_379))
					{
						unk_0x3F01127ECD227890(Local_45, sLocal_379, "hunter_leadout", 1000f, -8f, -1, iLocal_382, 0, 0, 0, 0);
					}
				}
			}
		}
	...
	if (Local_43.f_1 == 3)
	{
		if (unk_0xD246C1DFC9B0EBC2())
		{
			...
			func_494(&Local_44, 0, 1);
			func_5(&iLocal_62);
			iLocal_187 = unk_0xFD34717937104F1C() + 500;
			func_245(2);
			func_234();
		}
	}
...
int func_455(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	...
	while (func_276(iVar2, iVar6) != 0)
	{
		if (!unk_0x7112137033807390(iParam0, 0))
		{
			if (unk_0x15763A17141CD6EE(iParam0, iVar2, func_276(iVar2, iVar6)))
			{
				if (func_458(func_276(iVar2, iVar6)))
				{
					iVar7 = unk_0x73929A7BB3EF0A64(func_276(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_276(iVar2, iVar6) != 0)
	{
		if (!unk_0x7112137033807390(iParam0, 0))
		{
			if (unk_0x15763A17141CD6EE(iParam0, iVar2, func_276(iVar2, iVar6)))
			{
				unk_0x9D1B97F26237B39F(iVar1, func_276(iVar2, iVar6));
...
void func_460()
{
	...
	if ((((unk_0x61346376C1469A0E("SCRIPT\SAS_BANK_01", false, -1) && unk_0x61346376C1469A0E("SCRIPT\SAS_BANK_02", false, -1)) && unk_0x61346376C1469A0E("SAS_BANK_03", false, -1)) && func_362()) && func_361())
	{
		if (unk_0x82F5C60F6EF07777("AZ_DISTANT_SASQUATCH"))
		{
			unk_0x7B68A43B688620B5("AZ_DISTANT_SASQUATCH", 0, 1);
		}
		unk_0x8DB49F2EDD326F53(iLocal_378, true);
		if (func_463(unk_0xA19140A5C42D8715()))
		{
			func_232(&uLocal_199, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
		}
		if (func_499())
		{
			...
			{
				iVar1 = unk_0x7353FDD251A636E0(unk_0xA19140A5C42D8715(), joaat("weapon_pumpshotgun"));
				if (unk_0x4C62B1A93B2409FA(unk_0xA19140A5C42D8715(), iVar1) < 8)
				{
					unk_0xF0188A1B49D79AF7(unk_0xA19140A5C42D8715(), joaat("weapon_pumpshotgun"), 8, true, true);
				}
			}
			else
			{
...
int func_495(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0x35C6E06B120EB2E3(25, iLocal_38, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
			if (func_463(uParam0->f_28[0]))
			{
				unk_0xF0188A1B49D79AF7(uParam0->f_28[0], joaat("weapon_sniperrifle"), 100, true, true);
...
void func_500()
{
	...
	unk_0x8DB49F2EDD326F53(iLocal_378, false);
	func_10(0);
	func_8(0);
	func_2(0);
	func_449(&iLocal_385);
	unk_0x8C15CE28B371C038(vLocal_408, vLocal_409, 0);
	unk_0x66E6A13BAFFFB63C("WORLD_HUMAN_HIKER", true);
	unk_0x66E6A13BAFFFB63C("WORLD_MOUNTAIN_LION_WANDER", true);
...
void func_501()
{
	unk_0xA5DE74AE39867B03(iLocal_370);
}
...
int func_505(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_508())
	{
		...
		{
			iVar2 = func_318(unk_0x61D2332983ACC05C());
			if (iVar2 > -1)
			{
