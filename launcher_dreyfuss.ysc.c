...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0xA19140A5C42D8715()) && func_126(iParam0->f_28[0])) && !func_145()) && (unk_0xFD34717937104F1C() - iParam0->f_60) > iParam6) && func_169(unk_0xA19140A5C42D8715(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_189(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (!unk_0x429D45A6C6520026(sParam1))
		{
			...
			{
				if (func_169(unk_0xA19140A5C42D8715(), vParam2, 1) <= 100f)
				{
					func_192(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_169(unk_0xA19140A5C42D8715(), vParam2, 1) > 120f)
				{
					func_194(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_200(uParam1) || !unk_0x411C28019DEA5CEF(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), unk_0xE2BBD32891C18569(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
		...
		case 2:
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_35[0]))
			{
				...
				if (func_126(uParam0->f_35[0]))
				{
					...
					unk_0xFC00A668AFC2126D(iLocal_53, true);
				}
			}
			if (bVar2)
			{
...
void func_267(int iParam0, bool bParam1)
{
	...
	func_268(sVar0);
	unk_0xFC00A668AFC2126D(iLocal_53, false);
