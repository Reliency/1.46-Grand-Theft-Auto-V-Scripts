...
void func_12()
{
	if (Global_14491 == 0)
	{
		if (func_11(2, Global_14482, 0))
		{
			...
			uLocal_21 = unk_0xD8015A504E3ED13A();
			while (!unk_0x5BFB8B9A58F76839(uLocal_21))
			{
				wait(0);
			}
			Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_259 = iLocal_18[unk_0x7C261B004A9EEB72(uLocal_21)];
		...
		while (iVar2 < 9)
		{
			if (Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_124[iVar2] == 1)
			{
				if (iVar0[iVar2] == 0)
				{
					...
					{
						iVar3 = iVar2;
						func_20(Global_14494, "SET_DATA_SLOT", to_float(13), to_float(iVar1), to_float(Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_104[iVar3]), -1f, -1f, &(Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_7[iVar3 /*4*/]), 0, 0, 0, 0);
					}
				}
			}
			iVar2++;
...
void func_22()
{
	func_9(Global_14494, "SET_INPUT_EVENT", to_float(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_24()
{
	func_9(Global_14494, "SET_INPUT_EVENT", to_float(1), -1082130432, -1082130432, -1082130432, -1082130432);
	unk_0xE11F00B4AC919F45(-1, "Menu_Navigate", &Global_14502, 1);
	func_25();
}
			...
			if (Global_3188[Global_14513 /*2811*/][iVar2 /*281*/].f_280 == 1)
			{
				if (iVar0[iVar2] == 0)
				{
					if (iVar2 == 0)
					{
						...
						{
							iVar3 = iVar2;
							func_20(Global_14494, "SET_DATA_SLOT", to_float(2), to_float(iVar1), -1f, -1f, -1f, &(Global_3188[Global_14513 /*2811*/][iVar3 /*281*/].f_2), 0, 0, 0, 0);
						}
					}
				}
			}
