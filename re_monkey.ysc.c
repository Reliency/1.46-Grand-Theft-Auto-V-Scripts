...
void func_45()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				iLocal_58[iVar1] = unk_0xFCFC8CC5FF74580D(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, true, true, false);
				unk_0xE8B3104D1CB25CDC(iLocal_58[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				unk_0x76D3D51F5F66367F(iLocal_58[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				iLocal_58[iVar1] = unk_0xFCFC8CC5FF74580D(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, true, true, false);
				unk_0xE8B3104D1CB25CDC(iLocal_58[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				unk_0x76D3D51F5F66367F(iLocal_58[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				iLocal_58[iVar1] = unk_0xFCFC8CC5FF74580D(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, true, true, false);
				unk_0xE8B3104D1CB25CDC(iLocal_58[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				unk_0x76D3D51F5F66367F(iLocal_58[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_49()
{
	...
	else if (iLocal_46 == 2)
	{
		...
		{
			if (unk_0xD61D0CA14AE902DF(iLocal_48, 1))
			{
				func_144();
			}
		}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_50())
				{
					...
					{
						if (unk_0xC20797B09D6FF0A4(30f, 31086, 0.8f, 0.7f, 0.25f, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
							iLocal_69 = unk_0xFD34717937104F1C() + 2000;
							iLocal_47++;
						}
					}
				}
			...
			case 2:
				if (iLocal_69 < unk_0xFD34717937104F1C())
				{
					iLocal_52 = 1;
					iLocal_47++;
				}
...
int func_51()
{
	...
	{
		unk_0xCACEBBBEAD8F262E(1813637474);
		if (unk_0x7FC99CCC73354033(1813637474))
		{
			iLocal_48 = unk_0x35C6E06B120EB2E3(26, 1813637474, vLocal_49, fLocal_50, 1, true);
			unk_0xA5DE74AE39867B03(1813637474);
			iLocal_58[0] = unk_0xFCFC8CC5FF74580D(joaat("prop_cs_spray_can"), vLocal_59, true, true, false);
			unk_0x96B71B23D409A3DB(iLocal_58[0], iLocal_48, unk_0xF622A022C26057AA(iLocal_48, 28422), 0f, -0.01f, -0.02f, vLocal_66, 1, 1, 0, 0, 2, 1);
			unk_0xD738221C247C8B71(iLocal_48, true);
			unk_0x13E0A8160525AE55(iLocal_48, 42, true);
			iLocal_53 = func_62(iLocal_48, 0, 145);
			func_52(1);
			unk_0xDFA901280292A2FB(iLocal_48, 1862763509);
			unk_0x82416ADE738F7F1F(iLocal_48, 2.5f);
		}
	}
	return 0;
}
...
int func_63(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_64(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_64(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
...
{
	func_66();
	if (!unk_0x1F85F8C7CC4639AE() && iLocal_51 < 3)
	{
		func_144();
	}
}
...
void func_66()
{
	...
	if (func_44(iLocal_48))
	{
		...
		vVar2 = { unk_0xE2BBD32891C18569(iLocal_48, false) };
		fVar4 = 7.5f;
		vVar5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			vVar3 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false) };
			bVar6 = unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0);
			bVar7 = unk_0x5BFF0F72CC04E4DA(unk_0xA19140A5C42D8715());
		}
		if (iLocal_51 < 3)
		{
			if (unk_0x9809FE4B550B1EFE(vVar2, fVar4, 0) || unk_0x0AF5F990243ADDFB(vVar2 - vVar5, vVar2 + vVar5, 0))
			{
				iLocal_51 = 3;
			}
		}
		...
		{
			case 0:
				unk_0x6D68030C791111E0(sLocal_62);
				if (unk_0x39C2D9AB77873F84(sLocal_62))
				{
					unk_0x1F4E5EFBFE503FB3(iLocal_48, true);
					unk_0x3F01127ECD227890(iLocal_48, sLocal_62, sLocal_63, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_76(unk_0xA19140A5C42D8715(), iLocal_48, 35f))
				{
					unk_0x2F89329397A277BC(&iLocal_68);
					unk_0x3F01127ECD227890(0, sLocal_62, sLocal_64, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sLocal_62, sLocal_65, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0x301F42EEE3C40328(iLocal_68);
					unk_0xE1072FA2FECBAD96(iLocal_48, iLocal_68);
					unk_0x3A95A0A3221D4208(&iLocal_68);
					unk_0x4DC885EA8D6AF7FC(sLocal_62);
					iLocal_51++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_76(unk_0xA19140A5C42D8715(), iLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				unk_0xC2C4AE9DB4A0BEF3(iLocal_48, 8, true);
				unk_0xC2C4AE9DB4A0BEF3(iLocal_48, 32, true);
				unk_0x2F89329397A277BC(&iLocal_68);
			...
			case 5:
				...
				if (!unk_0x1A8481A7E865EC7C(iLocal_48) && vdist2(vVar2, unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false)) > 2500f)
				{
					iLocal_67 = unk_0x931DC90E31FA1705(vVar3, vVar2, 1, 0, 7);
					iLocal_51++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0x7C00B4755E048785(iLocal_67, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
	...
	else if (unk_0xDC5D81351D6A4DDB(iLocal_48))
	{
		unk_0xB29E08C7AB729BAD(iLocal_48, false);
	}
}
...
int func_67()
{
	...
	{
		case 0:
			if (unk_0x411C28019DEA5CEF(iLocal_48, sLocal_62, sLocal_65, 3))
			{
				fLocal_54 = 0.349f;
				iLocal_55 = 900;
				vLocal_57 = { vVar0 };
			...
			else if (unk_0x411C28019DEA5CEF(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				fLocal_54 = unk_0xE5B5A1FFAA0834BD(iLocal_48, sLocal_62, sLocal_64);
				fLocal_54 = func_71(fLocal_54, 0.2f, 0.349f);
				if (fLocal_54 != 0.2f)
				{
					fVar2 = ((1f / (0.349f - 0.161f)) * to_float(900));
					iLocal_55 = round(((fLocal_54 - 0.161f) * fVar2));
					vLocal_57 = { unk_0xE2BBD32891C18569(iLocal_48, false) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			unk_0x3F01127ECD227890(iLocal_48, sLocal_62, sLocal_64, 4f, -8f, -1, 0, fLocal_54, 1, 0, 0);
			iLocal_69 = unk_0xFD34717937104F1C();
			func_70(&iLocal_53);
			func_69();
			if (unk_0xDC5D81351D6A4DDB(iLocal_58[0]))
			{
				unk_0xF334C9B245CD323D(iLocal_58[0], 1, true);
			}
			iLocal_56++;
			break;
		
		case 2:
			if (unk_0x411C28019DEA5CEF(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				iVar3 = (unk_0xFD34717937104F1C() - iLocal_69);
				fVar4 = (to_float(iVar3) / to_float(iLocal_55));
				fVar5 = (fLocal_54 - ((fLocal_54 - 0.161f) * fVar4));
				fVar5 = func_71(fVar5, 0.161f, fLocal_54);
				unk_0x9F547C61053A0649(iLocal_48, sLocal_62, sLocal_64, fVar5);
				fVar6 = (fVar4 - 0.12f);
				fVar6 = func_71(fVar6, 0f, 0.8f);
				vVar7 = { func_68(vLocal_57, vVar1, fVar6) };
				unk_0x4299736016AECE26(iLocal_48, vVar7, 0, true, 0, 1);
				if (fVar5 == 0.161f)
				{
					unk_0xB29E08C7AB729BAD(iLocal_48, false);
					return 1;
...
void func_69()
{
	if (iLocal_60 != 0)
	{
		unk_0x82E95CCADC55C11E(iLocal_60, 0);
		iLocal_60 = 0;
	}
}
...
void func_72()
{
	...
	if (unk_0x411C28019DEA5CEF(iLocal_48, sLocal_62, sLocal_64, 3))
	{
		fVar0 = unk_0xE5B5A1FFAA0834BD(iLocal_48, sLocal_62, sLocal_64);
		if (fVar0 < 0.383793f)
		{
			func_69();
		}
	...
	else if (unk_0x411C28019DEA5CEF(iLocal_48, sLocal_62, sLocal_65, 3))
	{
		fVar0 = unk_0xE5B5A1FFAA0834BD(iLocal_48, sLocal_62, sLocal_65);
		if (fVar0 < 0.1124f)
		{
			func_69();
		}
...
void func_73()
{
	if (iLocal_60 == 0)
	{
		iLocal_60 = unk_0x8E3AC3DF6783369A(sLocal_61, iLocal_58[0], vLocal_66, vLocal_66, 1f, 0, 0, 0);
		unk_0xFFF683C953C75A82(iLocal_60, 1f, 1f, 1f, 0);
		unk_0x74FFC2C2C163D497(iLocal_60, 0.2f);
	}
}
...
bool func_75()
{
	return (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -334.4651f, -93.42171f, 48.57328f, -332.2641f, -82.78552f, 45.8103f, 3f, 0, true, 0) && !unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -329.1134f, -83.87273f, 45.79989f, -331.0937f, -88.05348f, 48.71878f, 3f, 0, true, 0));
}
...
int func_76(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0xDC5D81351D6A4DDB(iParam0) && unk_0xDC5D81351D6A4DDB(iParam1))
	{
		...
		return vdist2(unk_0xE2BBD32891C18569(iParam0, false), unk_0xE2BBD32891C18569(iParam1, false)) <= fVar0;
	}
	return 0;
}
...
int func_77(int iParam0)
{
	...
	{
		func_70(&iLocal_53);
		unk_0x33B5487515BD13D5(iLocal_48, unk_0xA19140A5C42D8715(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}
...
int func_89(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
		{
			...
			if (vmag2(unk_0x57323E573695B13F(unk_0xA19140A5C42D8715())) > 1369f && !func_143())
			{
				return 0;
			}
		}
