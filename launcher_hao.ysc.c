...
void __EntryFunction__()
{
	...
	iLocal_54 = unk_0xF66A39BBE7B3C278(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			if (!func_197(-72.323f, -1258.643f, 28.648f, unk_0xE2BBD32891C18569(Var0.f_35[0], true), 1056964608))
			{
...
int func_181(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0xA19140A5C42D8715()) && func_126(uParam0->f_28[0])) && !func_145()) && (unk_0xFD34717937104F1C() - uParam0->f_60) > iParam6) && func_185(unk_0xA19140A5C42D8715(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_186(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (!unk_0x429D45A6C6520026(sParam1))
		{
			...
			{
				if (func_185(unk_0xA19140A5C42D8715(), vParam2, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_185(unk_0xA19140A5C42D8715(), vParam2, 1) > 120f)
				{
					func_191(iParam0);
				}
			}
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_217(unk_0xE2BBD32891C18569(iParam1, true) - unk_0xE2BBD32891C18569(iParam0, true)) };
	...
	{
		vVar1 = { func_217(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_224(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_217(vParam1 - unk_0xE2BBD32891C18569(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_235(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_242(&iVar0) || !unk_0x39C2D9AB77873F84(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_35[0]))
			{
				...
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 0, 2, false);
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 1, 1, false);
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 2, 1, false);
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 3, 1, false);
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 4, 1, false);
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 6, 0, false);
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 7, 2, false);
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 10, 0, false);
				unk_0x1EE56D43DA30ADC6(uParam0->f_35[0], 23, 20, false);
				unk_0x8D79809AF5D42F43(uParam0->f_35[0], 18, true);
				unk_0x8D79809AF5D42F43(uParam0->f_35[0], 17, true);
				unk_0x8D79809AF5D42F43(uParam0->f_35[0], 22, true);
		...
		case 3:
			...
			{
				iVar5 = unk_0x4F9AEAB2CC029A5C(uParam0->f_35[0], "chassis_dummy");
				vVar6 = { unk_0xB31A4B66C16032CC(uParam0->f_35[0], iVar5) };
				iVar2 = unk_0x70788DC3D80C9DEB(vVar6, unk_0x288B716F47E9BBBC(uParam0->f_35[0], 2), 2);
				unk_0xDA16255FBFC16B28(iVar2, true);
				unk_0x52CEAE2B7DAC257E(iVar2, false);
				unk_0xE5565DEAABF9D588(uParam0->f_28[0], iVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_257(int iParam0, bool bParam1)
{
	...
	unk_0xE70AC26DFC59863A(iLocal_54, 0);
	if (bParam1)
	{
		func_193(*iParam0);
	}
