			...
			if (!iLocal_97)
			{
				...
				else
				{
					...
					if (!unk_0x7112137033807390(iVar0, 0))
					{
						...
						unk_0xFAE5E5AC968944E8(iVar0, 1, 0f, 0f, -1f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
						unk_0x731722E696597BD1(unk_0xA19140A5C42D8715(), iVar0, 20f, 786603);
						iLocal_99 = 1;
					}
				}
				iLocal_97 = 1;
			...
			switch (Global_2409250)
			{
				case 0:
					...
					if (func_4() || func_3())
					{
						...
						{
							if (unk_0x37B568B777BC65F9(iLocal_94))
							{
								unk_0xCE2F428A0EEBBE18(0, 0, 3, 0);
							}
							if (unk_0x37B568B777BC65F9(iLocal_94))
							{
								unk_0x77F0486CE0E598D5(iLocal_94, 1);
							}
						}
						return 1;
					}
				...
				case 1:
					if ((func_4() || !func_2(-258271821)) || func_3())
					{
						if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
						{
							iVar0 = unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0);
							unk_0xB29E08C7AB729BAD(iVar0, false);
							unk_0x92B3AAAC52CC36E1(iVar0, true);
						}
				...
				case 7:
					...
					if (unk_0x39C2D9AB77873F84("GET_UP@DIRECTIONAL@TRANSITION@PRONE_TO_SEATED@INJURED"))
					{
						if (!unk_0x411C28019DEA5CEF(unk_0xA19140A5C42D8715(), "GET_UP@DIRECTIONAL@TRANSITION@PRONE_TO_SEATED@INJURED", "front", 3))
						{
							...
							{
								unk_0x3F01127ECD227890(unk_0xA19140A5C42D8715(), "GET_UP@DIRECTIONAL@TRANSITION@PRONE_TO_SEATED@INJURED", "front", 8f, -8f, -1, 2, 0, 0, 0, 0);
							}
						...
						{
							unk_0x3F01127ECD227890(unk_0xA19140A5C42D8715(), "get_up@directional@movement@from_seated@standard", "get_up_l_0", 8f, -8f, -1, 2, 0, 0, 0, 0);
						}
	...
	if (Global_2409250 == 0)
	{
		if (Global_2409250.f_27)
		{
			if (func_9())
			{
				if (!unk_0x37B568B777BC65F9(iLocal_94))
				{
					if (unk_0x37B568B777BC65F9(iLocal_95))
					{
						unk_0x77F0486CE0E598D5(iLocal_95, 0);
					}
					iLocal_94 = unk_0x57FC10C74CC15F22("DEFAULT_SCRIPTED_CAMERA", false);
					func_8(Global_2409250.f_26, iLocal_94);
					unk_0xBC1542DDC31676C2(iLocal_94, "HAND_SHAKE", 0.2f);
					unk_0x930701157A4B9374(iLocal_94, true);
...
void func_8(int iParam0, int iParam1)
{
	...
	{
		case 0:
			unk_0x057123F3A835FE47(iParam1, -1589.074f, -3015.353f, -74.8535f);
			unk_0xC831502E35848BE4(iParam1, -15.8449f, 0f, 78.0001f, 2);
			unk_0xF62A5A3CB8DB2402(iParam1, 25.1368f);
			break;
		
		case 2:
			unk_0x057123F3A835FE47(iParam1, -1589.807f, -3008.426f, -74.9934f);
			unk_0xC831502E35848BE4(iParam1, -17.1168f, 0f, 104.7282f, 2);
			unk_0xF62A5A3CB8DB2402(iParam1, 34.7654f);
			break;
		
		case 4:
			unk_0x057123F3A835FE47(iParam1, -1592.237f, -3008.188f, -78.166f);
			unk_0xC831502E35848BE4(iParam1, -3.025f, 0f, 121.1804f, 2);
			unk_0xF62A5A3CB8DB2402(iParam1, 35.9f);
			break;
	}
}
			...
			case 6:
				if (func_6(unk_0xD4E735F4B6A956AC(), 0, 0))
				{
					if (Global_2409250.f_1 == 0)
					{
						...
						iLocal_100 = unk_0xFFCC7EBF88BDEE54();
						Global_2409250.f_1++;
					}
					if (Global_2409250.f_1 == 1)
					{
						if (!func_96(Global_2409250) || unk_0x1893BEC593409B02(unk_0xFFCC7EBF88BDEE54(), iLocal_100) > 20000)
						{
							Global_2409250.f_16 = 1;
							func_95();
						}
	...
	else if (((((!unk_0x05EFB6A616B6FADE(Global_1048576.f_8, 0) && !unk_0x05EFB6A616B6FADE(Global_2524719.f_382.f_5, 3)) && (!Global_2405069 || (Global_2405069 && Global_2449169.f_1.f_2826.f_13 > 0))) && !func_92()) && !func_87()) && !func_86())
	{
		if (unk_0x8B1574454E8C2421(joaat("am_mp_property_int")) <= 0 && !unk_0x653C5F9B95C5F892("AM_MP_PROPERTY_INT", Global_1048576.f_1164, 1, 0))
		{
			...
			else
			{
				...
				{
					func_61(&Var1, 2);
					if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), Var1, Var1.f_3, Var1.f_6, 0, true, 0))
					{
						if (!Global_1589747[unk_0xD4E735F4B6A956AC() /*790*/].f_661)
						{
							unk_0xD75A4240F0AD8613("AM_MP_PROPERTY_INT");
	...
	if (func_71(iParam0) || func_72(iParam0, 0, 0))
	{
		if (func_6(iParam1, 1, 1))
		{
			if (unk_0x499324B3EF19C288(Global_1049778[iParam0 /*1951*/].f_146.f_47, func_79(unk_0xD4E735F4B6A956AC()), !bParam2) <= 75f)
			{
				...
				if (unk_0x54F6F5A823224519(unk_0xEE978C39384D834F(iParam1), Var0[0 /*6*/], Var0[1 /*6*/], Var0[0 /*6*/].f_3.f_2, 0, true, 0))
				{
					return 1;
				}
				else if (bParam3)
				...
				if (bParam2)
				{
					...
					if (unk_0x54F6F5A823224519(unk_0xEE978C39384D834F(iParam1), Var0[0 /*6*/], Var0[1 /*6*/], 30f, 0, true, 0))
					{
						return 1;
					}
					if (unk_0x71364F510A1CB69F())
...
int func_76(var uParam0, int iParam1, float fParam2)
{
	...
	if (iParam1 == 2 && !func_77(uParam0->f_31, -1))
	{
		...
		{
			if (unk_0x0C4DF083566CCC1C(func_79(unk_0xD4E735F4B6A956AC()), uParam0->f_1742.f_153, uParam0->f_1742.f_153.f_3, uParam0->f_1742.f_153.f_6, 0, true))
			{
				return 1;
			}
		}
	...
	{
		vVar0 = { func_79(unk_0xD4E735F4B6A956AC()) };
		if (unk_0x499324B3EF19C288(func_79(unk_0xD4E735F4B6A956AC()), uParam0->f_146.f_47, true) <= 40f)
		{
			if ((unk_0x0C4DF083566CCC1C(func_79(unk_0xD4E735F4B6A956AC()), uParam0->f_146.f_57[0 /*8*/], uParam0->f_146.f_57[0 /*8*/].f_3, uParam0->f_146.f_57[0 /*8*/].f_6, 0, true) || unk_0x0C4DF083566CCC1C(func_79(unk_0xD4E735F4B6A956AC()), uParam0->f_146.f_57[1 /*8*/], uParam0->f_146.f_57[1 /*8*/].f_3, uParam0->f_146.f_57[1 /*8*/].f_6, 0, true)) || unk_0x0C4DF083566CCC1C(func_79(unk_0xD4E735F4B6A956AC()), uParam0->f_146.f_57[2 /*8*/], uParam0->f_146.f_57[2 /*8*/].f_3, uParam0->f_146.f_57[2 /*8*/].f_6, 0, true))
			{
				return 1;
			}
			else if (unk_0x499324B3EF19C288(vVar0, uParam0->f_146.f_1592, true) < (uParam0->f_146.f_1595 + fParam2) && (vVar0.z > uParam0->f_146.f_57[2 /*8*/].f_2 && vVar0.z < uParam0->f_146.f_57[2 /*8*/].f_3.f_2))
			{
				return 1;
			}
		}
...
void func_150()
{
	...
	if (unk_0x37B568B777BC65F9(iLocal_94))
	{
		unk_0x77F0486CE0E598D5(iLocal_94, 0);
	}
	if (unk_0x37B568B777BC65F9(iLocal_95))
	{
		unk_0x77F0486CE0E598D5(iLocal_95, 0);
