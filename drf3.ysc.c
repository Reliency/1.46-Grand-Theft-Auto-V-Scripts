...
{
	iParam0->f_1 = (func_62(unk_0x05EFB6A616B6FADE(*iParam0, 4)) - fParam1);
...
void func_84(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	while (iVar4 < 47)
	{
		if (unk_0x429D45A6C6520026(uParam1[iVar4 /*4*/]))
		{
			iVar4 = 47;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0x429D45A6C6520026(uParam4[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0x429D45A6C6520026(uParam7[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
...
struct<4> func_100(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_105(&(Global_106070.f_19933), 8) && iParam1) && iParam0 != 4) && func_103(3) > 0) && unk_0xF59B9063EDAC7451(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
...
int func_111(char* sParam0)
{
	...
	if (unk_0x3CAC2741CC1A631F(sParam0, "DRF_SOL1"))
	{
		iVar0 = 1;
	}
	else if (unk_0x3CAC2741CC1A631F(sParam0, "DRF_EXILE"))
	{
		iVar0 = 2;
	}
	else if (unk_0x3CAC2741CC1A631F(sParam0, "DRF_SOL2"))
	{
		iVar0 = 1;
	}
	else if (unk_0x3CAC2741CC1A631F(sParam0, "DRF_MIC2"))
	{
		iVar0 = 1;
	}
	return iVar0;
