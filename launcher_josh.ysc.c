...
void func_190()
{
	...
	{
		case 0:
			if ((unk_0xFD34717937104F1C() - iLocal_222) > 100 && bLocal_223 == 0)
			{
				iLocal_56 = 1;
			}
			break;
...
int func_200(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_199(unk_0xA19140A5C42D8715()) && func_199(iParam0->f_28[0])) && !func_144()) && (unk_0xFD34717937104F1C() - iParam0->f_60) > iParam6) && func_211(unk_0xA19140A5C42D8715(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_202(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (!unk_0x429D45A6C6520026(sParam1))
		{
			...
			{
				if (func_211(unk_0xA19140A5C42D8715(), vParam2, 1) <= 100f)
				{
					func_205(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_211(unk_0xA19140A5C42D8715(), vParam2, 1) > 120f)
				{
					func_207(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_215(uParam1) || !unk_0x411C28019DEA5CEF(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_215(uParam1) && uParam1->f_4 == 0) && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), unk_0xE2BBD32891C18569(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_229(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_231(unk_0xE2BBD32891C18569(iParam1, true) - unk_0xE2BBD32891C18569(iParam0, true)) };
	...
	{
		vVar1 = { func_231(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_238(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_231(vParam1 - unk_0xE2BBD32891C18569(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_199(uParam0->f_28[0]))
			{
				...
				iLocal_54 = unk_0x70788DC3D80C9DEB(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0xDA16255FBFC16B28(iLocal_54, true);
				unk_0xE5565DEAABF9D588(uParam0->f_28[0], iLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
int func_268(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			unk_0x2E989BFBA0D3CC0E(-1112.67f, 287.38f, 62.85f, -1096.41f, 297.5f, 65.59f, false, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				unk_0xA5DE74AE39867B03(iVar0[iVar1]);
...
void func_283(int iParam0, bool bParam1)
{
	...
	if (unk_0xCE3CB618AFE55EFB(iLocal_224))
	{
		unk_0xE1623437A3194332(&iLocal_224);
	}
