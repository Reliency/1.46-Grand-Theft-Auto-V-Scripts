...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (Global_106070.f_24958.f_2)
		{
			...
			case 2:
				if (!unk_0x2BCD0524CDEE1FD2(iLocal_213))
				{
...
void func_110(int iParam0, var uParam1)
{
	...
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x3D2A81E3C295D501(iParam0, func_115(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x8798F3E6AE76AF63(iVar5, &Var7) && !func_112(Var7.f_1)) && iVar9 < 50)
			{
...
int func_127(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_143(iVar0))
		{
			...
			{
				fVar1 = unk_0x499324B3EF19C288(vParam0, func_128(iVar0, 0), true);
...
void func_146(int iParam0)
{
	...
	iLocal_213 = start_new_script_with_args(&Var0, &Local_43, 8, 25000);
		...
		while (iVar7 < 2)
		{
			if (iVar6[iVar7] != 0)
			{
					...
					if (unk_0xDC5D81351D6A4DDB(uVar5[iVar8]))
					{
						if (unk_0x8F474E419F56E48D(uVar5[iVar8]) == iVar6[iVar7])
						{
							if (!unk_0x7112137033807390(uVar5[iVar8], 0))
							{
								if (!unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
								{
									if (vdist2(unk_0xE2BBD32891C18569(uVar5[iVar8], 1), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1)) < 6400f)
									{
										return 0;
									}
								}
				...
				if (unk_0xDC5D81351D6A4DDB(iVar9))
				{
					if (!unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
					{
						if (vdist2(unk_0xE2BBD32891C18569(iVar9, 1), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1)) < 6400f)
						{
							return 0;
						}
					}
...
int func_220(int iParam0, int iParam1, float fParam2)
{
	...
	if (!unk_0x7112137033807390(iParam0, 0))
	{
		...
		if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iParam0, 1), Var0, true) < fVar1)
		{
			return 1;
		}
		else if (Var0.f_4 != -1)
...
int func_227(float fParam0, bool bParam1)
{
	...
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		...
		while (iVar6 < 63)
		{
			...
			{
				func_228(iVar1, &Var0);
				fVar4 = unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), Var0.f_6, true);
				if (fVar4 < fVar3)
				{
					bVar7 = true;
					if (bParam1)
...
int func_238()
{
	...
	vVar0 = { func_239(unk_0xA6580F898F4E801C()) };
	fVar1 = Local_43.f_3;
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
...
void func_241()
{
	...
	if (iLocal_219 != 0)
	{
		...
		{
			case 1:
				iLocal_214 = unk_0xB00CD6895BDB01A0("MIDSIZED_MESSAGE");
				iLocal_219 = 2;
				break;
			...
			case 2:
				...
				if (unk_0x0FA486DE15EB3004(iLocal_214))
				{
					unk_0x31A9E530D137684F(iLocal_214, "SHOW_SHARD_MIDSIZED_MESSAGE");
					unk_0x390B339C943A8A54("BBS_MP");
					unk_0xD481829E3E36543B();
					unk_0x390B339C943A8A54(sVar0);
					unk_0x4FDA9E6EF359F8A9(sLocal_218);
					unk_0xD481829E3E36543B();
			...
			case 3:
				if (unk_0x0FA486DE15EB3004(iLocal_214))
				{
					unk_0xE9F9BA9108F437C7(iLocal_214, 255, 255, 255, 255, 0);
				...
				if ((unk_0xFD34717937104F1C() - iLocal_217) > 7000)
				{
					if (!iLocal_46)
					{
						unk_0x31A9E530D137684F(iLocal_214, "SHARD_ANIM_OUT");
				...
				if ((unk_0xFD34717937104F1C() - iLocal_217) > 7500)
				{
					iLocal_219 = 4;
				}
				break;
			...
			case 4:
				unk_0x86795B44CE5FE021(&iLocal_214);
				iLocal_46 = 0;
				func_242();
				break;
			}
