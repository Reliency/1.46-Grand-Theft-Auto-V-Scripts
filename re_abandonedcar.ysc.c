...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if ((unk_0x1F85F8C7CC4639AE() && !unk_0x122A8778D4027A82(unk_0xD4E735F4B6A956AC(), 0)) || iLocal_243)
		{
			if (!func_229())
			{
				if (func_228())
			...
			switch (iLocal_49)
			{
				...
				case 1:
					...
					if (!unk_0x7112137033807390(iLocal_234, 0))
					{
						if (unk_0x5D7DFE2058701942(iLocal_234, 0))
						{
							func_212();
						}
					}
					if (!unk_0x7112137033807390(iLocal_235, 0))
					{
						if (unk_0x5D7DFE2058701942(iLocal_235, 0))
						{
							func_212();
						}
					}
					...
					if (!iLocal_243)
					{
						...
						{
							if (func_197(unk_0xA19140A5C42D8715(), unk_0xE2BBD32891C18569(iLocal_236, true), 1) < IntToFloat(iLocal_256) && !unk_0xCDDABFAF231CF3DD(iLocal_236))
							{
								if (!iLocal_250)
								{
									func_195();
									...
									if (unk_0xCE3CB618AFE55EFB(iLocal_233))
									{
										unk_0x264E87C905AE790B(iLocal_233, true);
									}
									iLocal_250 = 1;
								}
							}
					...
					else
					{
						...
						if (!iLocal_245)
						{
							if (!unk_0x7112137033807390(iLocal_236, 0))
							{
								...
								{
									if (!unk_0x4915F4759304D5CF(iLocal_234))
									{
										unk_0x2F89329397A277BC(&iLocal_253);
										unk_0xA2EBCD9385E56019(0, iLocal_236, -1, -1, 2f, 524296, 0);
										unk_0xDA4D3941AFF8EF12(0, unk_0xA19140A5C42D8715(), 0, 16);
										unk_0x301F42EEE3C40328(iLocal_253);
										unk_0xE1072FA2FECBAD96(iLocal_234, iLocal_253);
										unk_0x3A95A0A3221D4208(&iLocal_253);
										unk_0xD738221C247C8B71(iLocal_234, true);
									}
									iLocal_245 = 1;
								}
							}
...
void func_2()
{
	if (!unk_0x7112137033807390(iLocal_234, 0))
	{
		if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, 10f, 10f, 10f, 0, 1, 0) && !unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			if ((timerb() > 3000 && iLocal_254 == 0) && !func_3())
			{
				func_184(&uLocal_66, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
				unk_0x22DD1D053CFF9707(iLocal_234, unk_0xA19140A5C42D8715(), 4000, 0, 2);
				unk_0x80E7C4A78224C8F9(5, iLocal_63, 1862763509);
				settimerb(0);
				iLocal_254++;
			}
...
void func_4()
{
	...
	if (!iLocal_249)
	{
		if (!unk_0x4915F4759304D5CF(iLocal_234))
		{
			...
			else if (timera() > 4000)
			{
				if (!unk_0x4915F4759304D5CF(iLocal_234))
				{
					unk_0xDA4D3941AFF8EF12(iLocal_234, unk_0xA19140A5C42D8715(), 0, 16);
					unk_0xD738221C247C8B71(iLocal_234, true);
				}
			...
			if (!unk_0x4915F4759304D5CF(iLocal_234))
			{
				if ((iLocal_257 >= 1 && unk_0x97722E4EBB9BA577(unk_0xA19140A5C42D8715(), 0)) && iLocal_246)
				{
					unk_0x3F01127ECD227890(iLocal_234, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0, 0, 0, 0);
					unk_0x9444470D6D9ADB88(sLocal_259);
	...
	else
	{
		...
		{
			case 0:
				if (unk_0xCE3CB618AFE55EFB(iLocal_231))
				{
					if (unk_0x4915F4759304D5CF(iLocal_234))
					{
						unk_0xE1623437A3194332(&iLocal_231);
					}
				}
				wait(2000);
				iLocal_260++;
			...
			case 1:
				...
				{
					func_165();
					iLocal_64 = unk_0x9D22BD3C08954356(923.5159f, 3203.386f, 40.173f, 30f, 13, 127);
					func_158(1);
					unk_0x9662BE461F9FDF9E(500);
					wait(2000);
					if (unk_0xDC5D81351D6A4DDB(iLocal_234))
					{
						unk_0x7E4E83D33161D01A(&iLocal_234);
					}
					iLocal_260++;
				}
				else
			...
			case 2:
				...
				unk_0x4299736016AECE26(unk_0xA19140A5C42D8715(), 923.5159f, 3203.386f, 40.173f, 1, false, 0, 1);
				...
				iLocal_237 = unk_0x73D3AC2ACEE773CD(0, 1063.595f, 3227.571f, 39.3899f, 1);
				iVar0 = unk_0x91A7C8CA5E332C03(iLocal_237, 26, iLocal_240, -1, 1, true);
				iVar0 = iVar0;
				if (!iLocal_248)
				{
					if (unk_0x61346376C1469A0E("Train_Horn", false, -1))
					{
						unk_0x6020229E34827A69(-1, "Warning_Once", iLocal_237, "TRAIN_HORN", 0, 0);
					}
				}
			...
			case 3:
				unk_0xE2F714507B54AC4D(iLocal_64);
...
{
	iParam0->f_1 = (func_39(unk_0x05EFB6A616B6FADE(*iParam0, 4)) - fParam1);
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_54(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_54(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_66(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_66(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_66(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_66(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_103(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x3B61940560400F58(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_97(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x4BE6499482BEE1D8(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_97(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x4BE6499482BEE1D8(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x6182A22F4D99005E(iVar1, 6, -1, 0, -1, func_54(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_167()
{
	if ((unk_0x4915F4759304D5CF(iLocal_234) && unk_0x4915F4759304D5CF(iLocal_235)) && !iLocal_249)
	{
		func_15();
	}
	if (iLocal_50 == 1)
	{
		if (!iLocal_249)
		{
			if (!unk_0x4915F4759304D5CF(iLocal_234))
			{
				if (!unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, 50f, 50f, 50f, 0, 1, 0))
				{
					func_15();
				}
			}
	...
	{
		if (!unk_0x4915F4759304D5CF(iLocal_234) && !unk_0x4915F4759304D5CF(iLocal_235))
		{
			if (!unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, 200f, 200f, 200f, 0, 1, 0) && !unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, 200f, 200f, 200f, 0, 1, 0))
			{
				func_15();
			}
		}
...
void func_168()
{
	if (!unk_0x4915F4759304D5CF(iLocal_234))
	{
		if (iLocal_50 == 1)
		{
			if (!unk_0x97722E4EBB9BA577(unk_0xA19140A5C42D8715(), 0))
			{
				if (!unk_0x10E54C268D1B3FED(iLocal_234, unk_0xA19140A5C42D8715(), 8f, 8f, 8f, 0, 1, 0) || !unk_0xA60C975CBAB69F34(iLocal_234, vLocal_59, 215f, 215f, 215f, false, true, 0))
				{
					if ((unk_0x669ABFB25D991447(unk_0xD4E735F4B6A956AC(), iLocal_234) || unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), iLocal_234)) || !unk_0xA60C975CBAB69F34(iLocal_234, vLocal_59, 215f, 215f, 215f, false, true, 0))
					{
						if (unk_0x852B8F739A2072BE(unk_0xA19140A5C42D8715(), 6) || !unk_0xA60C975CBAB69F34(iLocal_234, vLocal_59, 215f, 215f, 215f, false, true, 0))
						{
							unk_0x33B5487515BD13D5(iLocal_234, unk_0xA19140A5C42D8715(), 1000f, -1, 0, 0);
							unk_0xD738221C247C8B71(iLocal_234, true);
							func_195();
							wait(0);
...
void func_169()
{
	if (iLocal_50 == 1)
	{
		if (!unk_0x4915F4759304D5CF(iLocal_234))
		{
			if (!unk_0xE4459E8ECF72920C(iLocal_234))
			{
				if (iLocal_260 < 3)
				{
					if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, 20f, 20f, 10f, 0, 1, 0))
					{
						if (func_174())
						{
							func_173(0);
	...
	else if (iLocal_50 == 2)
	{
		if (!unk_0x7112137033807390(iLocal_234, 0))
		{
			if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_174())
				{
					func_173(0);
		...
		else if (!unk_0x7112137033807390(iLocal_235, 0))
		{
			if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_235, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_174())
				{
					func_173(0);
		...
		if (!func_3())
		{
			if (!iLocal_252)
			{
				if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, 30f, 30f, 10f, 0, 1, 0))
				{
					if (func_194() == 0)
					{
			...
			if (iLocal_258 < unk_0xFD34717937104F1C())
			{
				if (func_172())
				{
					if (!unk_0x4915F4759304D5CF(iLocal_234))
					{
						if (!unk_0xE4459E8ECF72920C(iLocal_234))
						{
							...
							iLocal_258 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(4500, 5000));
						}
					}
				}
				else if (!unk_0x4915F4759304D5CF(iLocal_235))
				{
					if (!unk_0xE4459E8ECF72920C(iLocal_235))
					{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_234))
	{
		if (!unk_0xE4459E8ECF72920C(iLocal_234))
		{
			if ((unk_0x685AE6AF34B35D3B(iLocal_234) || unk_0x97722E4EBB9BA577(iLocal_234, joaat("weapon_stungun"))) || unk_0xDEAEC99031DCB92A(iLocal_234, unk_0xA19140A5C42D8715(), 1))
			{
				func_195();
				unk_0xDCB46BFC2265476A(iLocal_234);
			}
			if (!unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, vLocal_62, 0, 1, 0) || !unk_0xA60C975CBAB69F34(iLocal_234, vLocal_59, 290f, 290f, 290f, false, true, 0))
			{
...
void func_175()
{
	...
	if (unk_0xCE3CB618AFE55EFB(iLocal_232))
	{
		if (unk_0x4915F4759304D5CF(iLocal_235))
		{
			unk_0xE1623437A3194332(&iLocal_232);
		}
	}
}
...
void func_176()
{
	if (!unk_0x4915F4759304D5CF(iLocal_234))
	{
		if (unk_0x5D7DFE2058701942(iLocal_234, 0))
		{
			if (unk_0x1095F403F52B42E1(unk_0xCAEB6CE71A2C7212(iLocal_234, 0), 0))
			{
				if (unk_0x411C28019DEA5CEF(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 3))
				{
					if ((((((((unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.1f && unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.075f) || (unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.25f && unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.225f)) || (unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.38f && unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.355f)) || (unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.53f && unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.505f)) || (unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.638f && unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.613f)) || (unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.7f && unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.675f)) || (unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.833f && unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.808f)) || (unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 1f && unk_0xE5B5A1FFAA0834BD(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.983f))
					{
						unk_0xFAE5E5AC968944E8(unk_0xCAEB6CE71A2C7212(iLocal_234, 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
						unk_0x6020229E34827A69(-1, "SUSPENSION_SCRIPT_FORCE", unk_0xCAEB6CE71A2C7212(iLocal_234, 0), 0, 0, 0);
					}
				}
		...
		if (!unk_0x4915F4759304D5CF(iLocal_235))
		{
			if (unk_0xDEAEC99031DCB92A(iLocal_235, unk_0xA19140A5C42D8715(), 1))
			{
				unk_0x3F01127ECD227890(iLocal_235, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0, 0, 0, 0);
			}
		}
	}
}
...
void func_177()
{
	if (!unk_0x7112137033807390(iLocal_236, 0))
	{
		if ((!unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0) || unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_236, 0)) || iLocal_50 == 2)
		{
			if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_236, vLocal_61, 0, 1, 0) || iLocal_242)
			{
				if (iLocal_50 == 1)
				{
					vLocal_55 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) - Vector(-1f, 8.8f, 0f) };
					unk_0x1EB91C63EC75FAAD(vLocal_55, 0, &vLocal_55, 0);
					vLocal_56 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) + Vector(-1f, 0f, 8.8f) };
					unk_0x1EB91C63EC75FAAD(vLocal_56, 0, &vLocal_56, 0);
					vLocal_57 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) + Vector(-1f, 8.8f, 0f) };
					unk_0x1EB91C63EC75FAAD(vLocal_57, 0, &vLocal_57, 0);
					vLocal_58 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) - Vector(-1f, 0f, 8.8f) };
					unk_0x1EB91C63EC75FAAD(vLocal_58, 0, &vLocal_58, 0);
					if (!unk_0x317672E799676CA5(vLocal_55, 2f))
					{
						iLocal_234 = unk_0x35C6E06B120EB2E3(19, iLocal_240, vLocal_55 - Vector(1f, 0f, 0f), func_182(vLocal_55, func_183(unk_0xD4E735F4B6A956AC())), 1, true);
					}
					else if (!unk_0x317672E799676CA5(vLocal_56, 2f))
					{
						iLocal_234 = unk_0x35C6E06B120EB2E3(19, iLocal_240, vLocal_56 - Vector(1f, 0f, 0f), func_182(vLocal_56, func_183(unk_0xD4E735F4B6A956AC())), 1, true);
					}
					else if (!unk_0x317672E799676CA5(vLocal_57, 2f))
					{
						iLocal_234 = unk_0x35C6E06B120EB2E3(19, iLocal_240, vLocal_57 - Vector(1f, 0f, 0f), func_182(vLocal_57, func_183(unk_0xD4E735F4B6A956AC())), 1, true);
					}
					else if (!unk_0x317672E799676CA5(vLocal_58, 2f))
					{
						iLocal_234 = unk_0x35C6E06B120EB2E3(19, iLocal_240, vLocal_58 - Vector(1f, 0f, 0f), func_182(vLocal_58, func_183(unk_0xD4E735F4B6A956AC())), 1, true);
					}
					if (!unk_0x4915F4759304D5CF(iLocal_234))
					{
						unk_0x4FE3554969185993(iLocal_234, "A_M_M_HillBilly_01_WHITE_MINI_02");
						unk_0xF0188A1B49D79AF7(iLocal_234, joaat("weapon_stungun"), -1, true, true);
						unk_0x6909FCF0DF666AF6(iLocal_234, 100);
						unk_0x13E0A8160525AE55(iLocal_234, 137, true);
						unk_0x13E0A8160525AE55(iLocal_234, 188, true);
						unk_0x13E0A8160525AE55(iLocal_234, 286, true);
						unk_0xEBF6A988BD8D2BCB(unk_0xA19140A5C42D8715(), 10000);
						unk_0x3B7A32E04BBE59A5(iLocal_234, 0, false);
						unk_0x3B7A32E04BBE59A5(iLocal_234, 27, true);
						unk_0x3B7A32E04BBE59A5(iLocal_234, 13, true);
						unk_0x3B7A32E04BBE59A5(iLocal_234, 50, true);
						unk_0x8AA21BBDA4DB2C4F(iLocal_234, 2);
						unk_0xF19FB7DA7E62392D(iLocal_234, 2);
						unk_0xF63074D1E750B871(iLocal_234, 0);
						unk_0xAD1633AA7B12B33B(iLocal_234, 2, 11f);
						unk_0xAD1633AA7B12B33B(iLocal_234, 13, 1f);
						unk_0x605FF8F1D0D5E4DE(iLocal_234, true);
						unk_0xDFA901280292A2FB(iLocal_234, iLocal_63);
						func_181(&uLocal_66, 4, iLocal_234, "RAPIST", 0, 1);
						unk_0x049C3912F75FDAA4(unk_0xA19140A5C42D8715(), -8f);
						unk_0x1F4E5EFBFE503FB3(iLocal_234, true);
						if (!unk_0xCE3CB618AFE55EFB(iLocal_231))
						{
							iLocal_231 = func_178(iLocal_234, 1, 145);
						}
						unk_0xE1623437A3194332(&iLocal_233);
						unk_0x2F89329397A277BC(&iLocal_253);
						unk_0x22DD1D053CFF9707(0, unk_0xA19140A5C42D8715(), -1, 0, 2);
						unk_0x9295936F52859375(0, unk_0xA19140A5C42D8715(), unk_0xA19140A5C42D8715(), 3f, 1, 3f, 1082130432, 1, 0, -957453492);
						unk_0xDA4D3941AFF8EF12(0, unk_0xA19140A5C42D8715(), 0, 16);
						unk_0x301F42EEE3C40328(iLocal_253);
						unk_0xE1072FA2FECBAD96(iLocal_234, iLocal_253);
						unk_0x3A95A0A3221D4208(&iLocal_253);
						unk_0xD738221C247C8B71(iLocal_234, true);
						unk_0x3A3E4B7C6FBE305D(iLocal_234, 0, 0);
						iLocal_243 = 1;
					}
				}
				else if (iLocal_50 == 2)
				{
					...
					if (!unk_0x4915F4759304D5CF(iLocal_235))
					{
						...
						unk_0x6259CDB47862A4F3(iLocal_235, 200, 0);
						unk_0x2F89329397A277BC(&iLocal_253);
						...
						unk_0xDA4D3941AFF8EF12(0, unk_0xA19140A5C42D8715(), 0, 16);
						unk_0x301F42EEE3C40328(iLocal_253);
						unk_0xE1072FA2FECBAD96(iLocal_235, iLocal_253);
						unk_0x3A95A0A3221D4208(&iLocal_253);
						unk_0xD738221C247C8B71(iLocal_235, true);
					}
					func_195();
					wait(0);
					if (!unk_0x4915F4759304D5CF(iLocal_234) && !unk_0x4915F4759304D5CF(iLocal_235))
...
int func_179(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_180(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_180(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
...
void func_198()
{
	if (unk_0x1095F403F52B42E1(iLocal_236, 0))
	{
		if (!func_229())
		{
			if (func_197(unk_0xA19140A5C42D8715(), unk_0xE2BBD32891C18569(iLocal_236, true), 1) < IntToFloat(iLocal_255))
			{
				if (unk_0xCE3CB618AFE55EFB(iLocal_233))
				{
					unk_0xE1623437A3194332(&iLocal_233);
				...
				unk_0x264E87C905AE790B(iLocal_233, false);
				if (!unk_0x7112137033807390(unk_0xC409B91AC4749F88(), 0))
				{
					iLocal_238 = unk_0xC409B91AC4749F88();
				}
				func_200(1);
				func_199(1);
			}
	...
	if (iLocal_50 == 1)
	{
		if (!unk_0x7112137033807390(iLocal_234, 0))
		{
			if ((((unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_234, 13f, 13f, 13f, 0, 1, 0) && !unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0)) || unk_0xDEAEC99031DCB92A(unk_0xA19140A5C42D8715(), iLocal_234, 1)) || unk_0xDEAEC99031DCB92A(iLocal_234, unk_0xA19140A5C42D8715(), 1)) || unk_0x317672E799676CA5(unk_0xE2BBD32891C18569(iLocal_234, true), 2f))
			{
				iLocal_242 = 1;
				settimerb(0);
				if (!unk_0x7112137033807390(iLocal_234, 0))
				{
					...
					if (!unk_0x4915F4759304D5CF(iLocal_234))
					{
						unk_0x22DD1D053CFF9707(iLocal_234, unk_0xA19140A5C42D8715(), 30000, 0, 2);
					}
				}
			}
		}
...
void func_211()
{
	if (!unk_0x7112137033807390(iLocal_236, 0))
	{
		if (iLocal_50 == 1)
		{
			if (!unk_0xA60C975CBAB69F34(iLocal_236, vLocal_59, 15f, 15f, 15f, false, true, 0))
			{
				func_14();
			}
		}
		...
		{
			if ((((((((unk_0xDEAEC99031DCB92A(iLocal_236, unk_0xA19140A5C42D8715(), 1) || unk_0x8AB262F7134A8443(unk_0xA19140A5C42D8715(), vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f), 0, 1)) || unk_0x0510543C0447D02F(2, vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0x0510543C0447D02F(4, vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0x0510543C0447D02F(0, vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0x0510543C0447D02F(1, vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0x7394AC2F67EAA91C(vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || unk_0xF0AB7FB93B889653(vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f))) || (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_236, 50f, 50f, 50f, 0, 1, 2) && unk_0x0099F119B7ADB4B3(unk_0xD4E735F4B6A956AC())))
			{
				if (!unk_0x7112137033807390(unk_0xC409B91AC4749F88(), 0))
				{
					iLocal_238 = unk_0xC409B91AC4749F88();
...
void func_214()
{
	unk_0xFC00A668AFC2126D(joaat("surfer"), true);
	if (iLocal_50 == 1)
	{
		unk_0xF66A39BBE7B3C278(vLocal_59 - Vector(20f, 50f, 50f), vLocal_59 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
	}
	else if (iLocal_50 == 2)
	{
		unk_0xF66A39BBE7B3C278(vLocal_59 - Vector(50f, 100f, 100f), vLocal_59 + Vector(50f, 100f, 100f), 0, 1, 1, 1);
	}
	unk_0x01AF8CB960828C2B(vLocal_54, 50f, 0, 0, 0, 0, false, 0);
	unk_0xBF6EED5D6E0CD9BF(0.1f);
	unk_0xCACEBBBEAD8F262E(iLocal_240);
	...
	unk_0x7B5129A25EE58E36(sLocal_259);
	unk_0x789152CB302E8726(0);
	unk_0x8969D02DEDC106D2("RE_ABANDONED_VEHICLE_SCENE");
	while (((((!unk_0x7FC99CCC73354033(iLocal_240) || !unk_0x7FC99CCC73354033(iLocal_241)) || !unk_0x39C2D9AB77873F84("random@train_tracks")) || !unk_0x39C2D9AB77873F84("amb@world_human_guard_patrol@male@idle_b")) || !unk_0x7B5129A25EE58E36(sLocal_259)) || !unk_0x2F8EAF18929E1E59("RE_ABANDONED_VEHICLE_SCENE"))
	{
		wait(0);
	}
	if (func_194() == 0)
	{
		func_181(&uLocal_66, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
	}
	else if (func_194() == 1)
	{
		func_181(&uLocal_66, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
	}
	else if (func_194() == 2)
	{
		func_181(&uLocal_66, 2, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
	}
	unk_0x60DEFBFF740D4C09(3, false);
	unk_0x60DEFBFF740D4C09(5, false);
	iLocal_236 = unk_0x48CFBECB146FD1A1(iLocal_241, vLocal_59, fLocal_60, true, true, false);
	unk_0xA45E1AA8B9CF45AD(iLocal_236, 10000);
	unk_0x5295DD2937F76AD3(iLocal_236);
	unk_0x117F5CD9634D61A9(iLocal_236, 5f);
	unk_0xA5DE74AE39867B03(iLocal_241);
	unk_0xA95C9BC9CAF4C02D(iLocal_236, "RE_ABANDONED_VEHICLE_MOTORHOME", 0);
	unk_0x5508F45F9C7B6E03(iLocal_236, 3);
	unk_0x94E87D83163B4BEB("Redneck", &iLocal_63);
	unk_0x80E7C4A78224C8F9(5, iLocal_63, 1862763509);
	unk_0x80E7C4A78224C8F9(5, -1533126372, iLocal_63);
	unk_0x80E7C4A78224C8F9(5, iLocal_63, -1533126372);
	if (iLocal_50 == 1)
	{
		unk_0xD6B4F40F1425E83F(iLocal_236, 0, 1, 0);
		unk_0xD6B4F40F1425E83F(iLocal_236, 1, 1, 0);
		unk_0x4C9B98D31D89D901(iLocal_236, vLocal_59, 0f, 1700f, 1);
		unk_0xC19EDC1D7179164C(iLocal_236, false, true, 0);
		unk_0x6EB2D9504928F849(iLocal_236, 2);
	}
	else if (iLocal_50 == 2)
	{
		unk_0xC19EDC1D7179164C(iLocal_236, false, true, 0);
		unk_0x6EB2D9504928F849(iLocal_236, 1);
		iLocal_234 = unk_0x91A7C8CA5E332C03(iLocal_236, 26, iLocal_240, -1, 1, true);
		unk_0x72A0FF8C49CFFC0D(iLocal_234, 0, 0, 2, 0);
		unk_0x72A0FF8C49CFFC0D(iLocal_234, 2, 1, 2, 0);
		unk_0x72A0FF8C49CFFC0D(iLocal_234, 3, 1, 0, 0);
		unk_0x72A0FF8C49CFFC0D(iLocal_234, 4, 0, 0, 0);
		unk_0x72A0FF8C49CFFC0D(iLocal_234, 8, 0, 0, 0);
		unk_0x1F4E5EFBFE503FB3(iLocal_234, true);
		unk_0xDFA901280292A2FB(iLocal_234, iLocal_63);
		unk_0xF0188A1B49D79AF7(iLocal_234, joaat("weapon_sawnoffshotgun"), -1, false, true);
		unk_0x3B7A32E04BBE59A5(iLocal_234, 1, false);
		unk_0xD461381B293D9B46(iLocal_234, 25);
		unk_0x605FF8F1D0D5E4DE(iLocal_234, true);
		unk_0x4FE3554969185993(iLocal_234, "A_M_M_HillBilly_02_WHITE_MINI_01");
		func_181(&uLocal_66, 4, iLocal_234, "INCESTBRO1", 0, 1);
		iLocal_235 = unk_0x91A7C8CA5E332C03(iLocal_236, 26, iLocal_240, 0, 1, true);
		unk_0x72A0FF8C49CFFC0D(iLocal_235, 0, 0, 0, 0);
		unk_0x72A0FF8C49CFFC0D(iLocal_235, 2, 0, 0, 0);
		unk_0x72A0FF8C49CFFC0D(iLocal_235, 3, 0, 2, 0);
		unk_0x72A0FF8C49CFFC0D(iLocal_235, 4, 1, 0, 0);
		unk_0x72A0FF8C49CFFC0D(iLocal_235, 8, 0, 0, 0);
		unk_0x6259CDB47862A4F3(iLocal_235, 100000000, 0);
		unk_0x1F4E5EFBFE503FB3(iLocal_235, true);
		unk_0xDFA901280292A2FB(iLocal_235, iLocal_63);
		unk_0xF0188A1B49D79AF7(iLocal_235, joaat("weapon_pistol"), -1, false, true);
		unk_0x3B7A32E04BBE59A5(iLocal_235, 1, false);
		unk_0xD461381B293D9B46(iLocal_235, 25);
		unk_0x605FF8F1D0D5E4DE(iLocal_235, true);
		unk_0x4FE3554969185993(iLocal_235, "A_M_M_HillBilly_02_WHITE_MINI_02");
		func_181(&uLocal_66, 5, iLocal_235, "INCESTBRO2", 0, 1);
		unk_0x3F01127ECD227890(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		unk_0x3F01127ECD227890(iLocal_235, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		unk_0xA5DE74AE39867B03(iLocal_240);
	}
	iLocal_51 = 1;
}
...
int func_216()
{
	...
	{
		if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_48) < (75f * 75f))
		{
			return 1;
		}
		if (vmag2(unk_0x57323E573695B13F(unk_0xA19140A5C42D8715())) > 1369f && !func_227())
		{
			return 0;
		}
	}
...
void func_230()
{
	if (iLocal_52)
	{
		...
		unk_0xEEF61BF551977B0E(sLocal_259);
		...
		if (!unk_0x7112137033807390(iLocal_238, 0))
		{
			if (!unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_238, 0) && !unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_238, 50f, 50f, 50f, 0, 1, 0))
			{
				func_258(iLocal_238, 0, 145);
			}
		}
		if (!unk_0x4915F4759304D5CF(iLocal_234) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
		{
			unk_0x8B2245B665912C02(iLocal_234);
			unk_0x33B5487515BD13D5(iLocal_234, unk_0xA19140A5C42D8715(), 1000f, -1, 0, 0);
			unk_0xD738221C247C8B71(iLocal_234, true);
		}
		if (!unk_0x4915F4759304D5CF(iLocal_235) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
		{
			unk_0x8B2245B665912C02(iLocal_235);
			unk_0x33B5487515BD13D5(iLocal_235, unk_0xA19140A5C42D8715(), 1000f, -1, 0, 0);
			unk_0xD738221C247C8B71(iLocal_235, true);
		}
	}
	func_231(-1);
...
{
	return (shift_right(iParam0, 26) & 31 * func_240(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
Vector3 func_311()
{
	...
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		fVar0 = unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_261, true);
		iLocal_263 = 1;
		if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_262, true) < fVar0)
		{
			fVar0 = unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_262, true);
			iLocal_263 = 2;
		}
		if (iLocal_263 == 1)
		{
