...
void func_1()
{
	...
	unk_0x48C681EE670D7077(iLocal_87, 241.3494f, 361.0303f, 105.9036f, &uVar0, &fVar1);
	switch (iLocal_86)
	{
		case 0:
			iLocal_91 = 0;
		...
		case 1:
			...
			{
				if (!iLocal_91 && (unk_0xFD34717937104F1C() - iLocal_88) > 15000)
				{
				...
				if (!iLocal_93 && !unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, true, 0))
				{
					if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, true, 0))
					{
						if (!unk_0x317672E799676CA5(242.1f, 360.7f, 105.7f, 1.5f))
						{
							fVar1 = 0f;
						}
						if (unk_0x69C0BB7D03EE045D(fVar1) <= 0.05f && !iLocal_93)
						{
							func_3(109, 6);
							func_3(109, 1);
							iLocal_92 = 1;
...
{
	return (shift_right(iParam0, 26) & 31 * func_25(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
	...
	switch (iLocal_86)
	{
		...
		case 1:
			if (unk_0x0FFE9FEDC2E0AC88("Michael", 0))
			{
				...
				unk_0xF757C0D3A087F145(unk_0xA19140A5C42D8715(), -1871534317, 0, 1, 1);
			}
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_82(unk_0x8F474E419F56E48D(iParam0), 14, iVar0, unk_0xEF84BAF28F219386(iParam0, 0, iParam2, iParam3)))
			{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_71(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_71(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_83(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_83(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_83(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_83(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x3B61940560400F58(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_114(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x4BE6499482BEE1D8(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_114(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x4BE6499482BEE1D8(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x6182A22F4D99005E(iVar1, 6, -1, 0, -1, func_71(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_209(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		...
		{
			if (!func_216(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_258()
{
	...
	{
		func_319(13, floor(Global_106070.f_10166.f_3853));
	}
...
int func_325(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_331())
	{
		...
		{
			iVar2 = func_326(unk_0x61D2332983ACC05C());
			if (iVar2 > -1)
			{
