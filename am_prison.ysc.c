...
int func_28()
{
	switch (Local_115)
	{
		case 0:
			...
			{
				Local_115.f_4 = unk_0xF66A39BBE7B3C278(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
			}
		...
		case 1:
			if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), 1693.164f, 2559.616f, 44.5649f) >= 1030225f)
			{
				Local_115 = 2;
			}
			break;
		...
		case 2:
			if (Global_1573964 || func_23(3))
			{
				unk_0xE70AC26DFC59863A(Local_115.f_4, 0);
			}
			return 1;
			break;
	}
