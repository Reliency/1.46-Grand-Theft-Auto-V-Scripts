...
void func_33()
{
	...
	func_41(Global_14494, "SET_DATA_SLOT_EMPTY", to_float(13), -1082130432, -1082130432, -1082130432, -1082130432);
	if (func_15())
	{
		if (Global_2458116)
		{
			func_40(Global_14494, "SET_DATA_SLOT", to_float(13), to_float(0), to_float(12), -1f, -1f, &Local_42, 0, 0, 0, 0);
		}
		else
		{
			func_40(Global_14494, "SET_DATA_SLOT", to_float(13), to_float(0), to_float(12), -1f, -1f, &Local_39, 0, 0, 0, 0);
		}
	}
	else
	{
		func_40(Global_14494, "SET_DATA_SLOT", to_float(13), to_float(0), to_float(12), -1f, -1f, &Local_45, 0, 0, 0, 0);
	}
	func_41(Global_14494, "DISPLAY_VIEW", to_float(13), -1082130432, -1082130432, -1082130432, -1082130432);
	func_37(&Local_36);
	if (func_15())
	{
...
void func_35(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	if (iParam1 == 1)
	{
		func_40(Global_14494, "SET_SOFT_KEYS", to_float(iParam0), 0f, to_float(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	...
	if (Global_14501)
	{
		func_40(Global_14494, "SET_SOFT_KEYS", to_float(iParam0), 1f, to_float(iParam1), -1f, -1f, sParam2, 0, 0, 0, 0);
		unk_0x2BCFB39E86340DAA(iParam4, iParam3);
		func_36(iParam5, 1);
		return;
	}
	func_40(Global_14494, "SET_SOFT_KEYS", to_float(iParam0), 1f, to_float(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	unk_0x2BCFB39E86340DAA(iParam4, iParam3);
	func_36(iParam5, 1);
}
