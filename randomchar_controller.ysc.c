				...
				if (!func_42(74))
				{
					...
					else if (func_22(iLocal_56))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (unk_0xCE3CB618AFE55EFB(Global_25834[iVar3 /*23*/].f_19))
								{
									unk_0x0798CD089167D3C1(Global_25834[iVar3 /*23*/].f_19, 1);
									unk_0xE14767EA16F946A4(Global_25834[iVar3 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
{
	return (shift_right(iParam0, 26) & 31 * func_30(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (!func_76(iVar0) || iVar0 == 52)
	{
		if (!unk_0x05EFB6A616B6FADE(Global_106070.f_18546.f_390[iLocal_52], iLocal_51))
		{
			...
			else if (Global_105157[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (unk_0x05EFB6A616B6FADE(Global_25834[iLocal_54[Global_105157[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
...
void func_77(int iParam0)
{
	...
	if (unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 0) && !unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 3))
	{
		if (!Global_106070.f_18546[iParam0 /*6*/].f_1)
		{
			...
			if (iParam0 == 57)
			{
				iVar2 = unk_0x22C775856F4633CA(3, 11);
				iVar2 *= 30;
	...
	else if (Global_105157[iParam0 /*10*/].f_3)
	{
		...
		if (!func_114() && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false), Var0.f_6, false) > fVar13)
		{
			Global_105157[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	iVar14 = 0;
	if ((((iVar12 && !unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 3)) && unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 0)) && unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 1)) && unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 2))
	{
	...
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (!func_44(35))
		{
			if (unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 2) && !unk_0x05EFB6A616B6FADE(Global_106070.f_18546[iParam0 /*6*/], 3))
			{
				...
				{
					if (vdist2(Var0.f_6, unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true)) < 81f)
					{
						sVar16 = "";
						...
						if (!unk_0x429D45A6C6520026(sVar16))
						{
