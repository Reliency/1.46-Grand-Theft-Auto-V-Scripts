...
void __EntryFunction__()
{
	...
	iLocal_78 = unk_0x09990A2B9C8684F0();
	...
	while (true)
	{
		...
		switch (iVar1)
		{
					...
					if (iVar1 != 2)
					{
						if ((!unk_0x95129531A8C1F3B9() && !bVar0) && !func_68(5))
						{
							...
							if (func_64())
							{
								...
								switch (iLocal_102)
								{
									...
									case 2:
										...
										if (func_53(&iLocal_114) > 15f)
										{
											...
											fLocal_107 = (unk_0xF59B9063EDAC7451(10f, 40f) + func_53(&iLocal_114));
											iLocal_102 = 3;
										}
										else if (iLocal_108)
										{
								...
								if (((unk_0xD73B1037F6BD4B90(0, 86) && !unk_0xEE9EA5C5862BBFA3(unk_0xA19140A5C42D8715())) && !Global_25610) && (unk_0xFD34717937104F1C() - iLocal_105) > 3000)
								{
									iVar4 = func_62();
									if (iVar4 == 0)
									{
										...
										unk_0xD75A4240F0AD8613(&vLocal_97);
										func_79(&iLocal_114);
										iVar2 = 0;
									}
									else if (iVar4 == 2)
							...
							else
							{
								...
								if (((unk_0xFD34717937104F1C() - iLocal_106) > 60000 && !func_58("TC_HOWTOSTART")) && iLocal_112)
								{
									iLocal_112 = 0;
								}
								if (bLocal_110)
			...
			case 4:
				...
				if (unk_0xB1FDFCECA75CE4A7(&vLocal_97))
				{
			...
			case 8:
				if (func_64())
				{
					if (!func_21())
					{
						...
						iLocal_96 = start_new_script(&vLocal_97, 25000);
						unk_0x4659F4154D948B01(&vLocal_97);
			...
			case 10:
				if (!unk_0x2BCD0524CDEE1FD2(iLocal_96))
				{
			...
			case 11:
				...
				if (!func_3())
				{
					...
					if (iLocal_96 != 0)
					{
						if (unk_0x2BCD0524CDEE1FD2(iLocal_96))
						{
							unk_0xDD77F5FE884350EE(iLocal_96);
							iLocal_96 = 0;
						}
					}
					func_79(&iLocal_114);
...
void func_12()
{
	...
	{
		func_14(13, floor(Global_106070.f_10166.f_3853));
	}
...
float func_53(int iParam0)
{
	if (func_57(iParam0))
	{
		...
		{
			return (func_54(unk_0x05EFB6A616B6FADE(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
int func_62()
{
	...
	else
	{
		...
		iVar1 = round(unk_0x2F78D19B3446544E(iVar0));
		iVar2 = unk_0x24A1A7BF4ED94B71(iVar0);
...
{
	iParam0->f_1 = (func_54(unk_0x05EFB6A616B6FADE(*iParam0, 4)) - fParam1);
...
void func_83()
{
	...
	if (unk_0x245B8CF1349B3FDF(&vLocal_97) != 0)
	{
		unk_0x4659F4154D948B01(&vLocal_97);
	}
	if (unk_0xCE3CB618AFE55EFB(iLocal_101))
