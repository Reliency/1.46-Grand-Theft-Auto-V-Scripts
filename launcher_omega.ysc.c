...
void func_182(int iParam0)
{
	...
	if ((unk_0xFD34717937104F1C() - iLocal_58) > 1250)
	{
		if (func_126(iParam0->f_28[0]) && !unk_0x1A8481A7E865EC7C(iParam0->f_28[0]))
		{
			if (func_126(unk_0xA19140A5C42D8715()) && !func_183(unk_0xA19140A5C42D8715(), iParam0->f_28[0], 50f, 1))
			{
				...
				unk_0x92DDCF53AA47A63D(iParam0->f_28[0], fVar2);
			}
		}
...
void func_184()
{
	...
	unk_0x31A9E530D137684F(iLocal_56, "SET_COLOUR");
	...
	unk_0x31A9E530D137684F(iLocal_56, "SET_DISTANCE");
	unk_0xD8B5988E85F72BE5(10f);
	unk_0x271C1332F482646C();
	unk_0x7AF4A31FB51D0A4D(iLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x84829313FB8AC81C(iLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0xFD34717937104F1C() - iLocal_58) > 1250)
	{
		unk_0x7A15C6C664F7334E(iLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_58 = unk_0xFD34717937104F1C();
	}
}
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	...
	if (!*uParam6 == 3)
	{
		if (func_173(2))
		{
			if (!func_145())
			{
				if ((func_126(unk_0xA19140A5C42D8715()) && func_126(iParam0->f_28[0])) && func_192(unk_0xA19140A5C42D8715(), vParam1, 1) < 20f)
				{
			...
			if (func_192(unk_0xA19140A5C42D8715(), vParam1, 1) < 20f && *uParam6 == 1)
			{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !unk_0x411C28019DEA5CEF(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), unk_0xE2BBD32891C18569(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_221(unk_0xE2BBD32891C18569(iParam1, true) - unk_0xE2BBD32891C18569(iParam0, true)) };
	...
	{
		vVar1 = { func_221(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_228(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_221(vParam1 - unk_0xE2BBD32891C18569(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_240()
{
	iLocal_56 = unk_0xB00CD6895BDB01A0("digiscanner");
	while (!unk_0x0FA486DE15EB3004(iLocal_56))
	{
		wait(0);
	}
	...
	if (unk_0xA41DC7627220D3D5("digiscanner"))
	{
		iLocal_57 = unk_0x88A337F7A8A721B3("digiscanner");
	}
	iLocal_59 = unk_0x7A3ECD08D6D1D554();
	iLocal_58 = unk_0xFD34717937104F1C();
}
...
int func_242(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			unk_0x413F34FCFABEDE4B(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, false, 1);
			unk_0x01AF8CB960828C2B(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, false, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_251(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				uParam0->f_41[0] = unk_0xFCFC8CC5FF74580D(iVar0[1], 2468.51f, 3437.39f, 55f, true, true, false);
			}
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_41[1]))
			{
				uParam0->f_41[1] = unk_0xFCFC8CC5FF74580D(iVar0[2], 2468.51f, 3437.39f, 57f, true, true, false);
			}
...
void func_265(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 45)
	{
		unk_0x413F34FCFABEDE4B(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, true, 1);
	}
	if (bParam1)
	{
