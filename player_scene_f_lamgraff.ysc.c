...
int func_2()
{
	...
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_267))
		{
			if (unk_0x411C28019DEA5CEF(Global_93018, &sLocal_271, &cLocal_303, 3))
			{
				...
				fVar0 = unk_0x33CECDD9E141E18E(iLocal_312);
				if (!iLocal_266)
				{
				...
				if (fVar0 < 0.2812f)
				{
					if (iLocal_313 != 0)
					{
						unk_0x82E95CCADC55C11E(iLocal_313, 0);
						iLocal_313 = 0;
					}
				}
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_313 == 0)
					{
						iLocal_313 = unk_0x8E3AC3DF6783369A("scr_lamgraff_paint_spray", iLocal_267, 0f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
						unk_0xFFF683C953C75A82(iLocal_313, fLocal_314, fLocal_315, fLocal_316, 0);
					}
				}
...
int func_20()
{
	...
	if (!unk_0x4915F4759304D5CF(Global_93018))
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_267))
		{
			if (unk_0x411C28019DEA5CEF(Global_93018, &sLocal_271, &cLocal_287, 3))
			{
				if (unk_0x463E3A48A46C9195(Global_93018))
				{
					unk_0xFB5A34FAABB4D147(Global_93018, 0, 0);
				...
				else
				{
					...
					{
						iLocal_312 = unk_0x70788DC3D80C9DEB(vLocal_269, 0f, 0f, fLocal_270, 2);
						unk_0xDA16255FBFC16B28(iLocal_312, true);
					}
					unk_0xE5565DEAABF9D588(Global_93018, iLocal_312, &sLocal_271, &cLocal_303, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
...
void func_31()
{
	...
	while (!unk_0xDC5D81351D6A4DDB(Global_93018) || !unk_0x7FC99CCC73354033(iLocal_268))
	{
		wait(0);
	}
	...
	if (unk_0xDC5D81351D6A4DDB(Global_93018))
	{
		...
		unk_0xDFA901280292A2FB(Global_93018, 1862763509);
	}
	unk_0x1F7948851FB36E88(Global_93018, true, 1);
	unk_0x13E0A8160525AE55(Global_93018, 132, true);
	unk_0xE5D9346AE3BC7E41(Global_93018, 16);
	func_33(&Global_93018, Global_88331);
	func_32(&uLocal_100, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
	iLocal_267 = unk_0xFCFC8CC5FF74580D(iLocal_268, unk_0xE2BBD32891C18569(Global_93018, true), true, true, false);
	unk_0x96B71B23D409A3DB(iLocal_267, Global_93018, unk_0xF622A022C26057AA(Global_93018, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_38(uParam1, 17, 1785177548, 1785177548, unk_0xF59B9063EDAC7451(-5f, 5f), unk_0xF59B9063EDAC7451(-5f, 5f), 0f, unk_0xF59B9063EDAC7451(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_38(uParam1, 144, 1785177548, 1785177548, unk_0xF59B9063EDAC7451(-5f, 5f), unk_0xF59B9063EDAC7451(-5f, 5f), 0f, unk_0xF59B9063EDAC7451(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_38(uParam1, 43, 1785177548, 1785177548, unk_0xF59B9063EDAC7451(-5f, 5f), unk_0xF59B9063EDAC7451(-5f, 5f), 0f, unk_0xF59B9063EDAC7451(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
