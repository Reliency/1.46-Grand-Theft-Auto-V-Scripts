	...
	if (Global_88350 != 8)
	{
		if (Global_88351 == -1)
		{
			...
			if (func_7())
			{
				...
				iVar12 = unk_0x22C775856F4633CA(0, iVar9);
				switch (iVar12)
				{
					case 0:
						iVar11 = 19;
...
void func_8(vector3 vParam0, vector3 vParam1, var uParam2)
{
	...
	{
		if (unk_0x4D5840190FB73885(vParam0, vParam1, 1, 1))
		{
			*uParam2++;
			if (*uParam2 > 6)
			{
		...
		else if ((unk_0x0510543C0447D02F(0, vParam0, vParam1) || unk_0x0510543C0447D02F(2, vParam0, vParam1)) || unk_0x7D4400F91582CA08(vParam0, vParam1, joaat("weapon_grenadelauncher"), 1))
		{
			Global_88350 = 5;
		}
	}
...
void func_9(vector3 vParam0, vector3 vParam1)
{
	...
	if (unk_0xF990CFC0F1D94A39(unk_0xA19140A5C42D8715(), &iVar0, 1))
	{
		...
		{
			if (unk_0x0510543C0447D02F(3, vParam0, vParam1))
			{
				Global_88350 = 2;
			}
		}
...
void func_12(vector3 vParam0, vector3 vParam1, var uParam2)
{
	...
	{
		if (unk_0xC10AB2F83514403D(unk_0xA19140A5C42D8715(), vParam0, vParam1, 0, 1, 0))
		{
			if (*uParam2 < 0)
			{
				*uParam2 = unk_0xFD34717937104F1C();
			}
			else if (unk_0xFD34717937104F1C() > *uParam2 + 10000)
			{
				Global_88350 = 1;
			}
		}
...
void func_13(vector3 vParam0, vector3 vParam1)
{
	...
	if (unk_0xF990CFC0F1D94A39(unk_0xA19140A5C42D8715(), &iVar0, 1))
	{
		...
		{
			if (unk_0x7D4400F91582CA08(vParam0, vParam1, iVar0, 1))
			{
				Global_88350 = 0;
			}
		}
...
void func_32(var uParam0, int iParam1, var uParam2, var uParam3, vector3 vParam4, char* sParam5)
{
	...
	else if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		*uParam2 = unk_0xDA3A4E46D189F555(unk_0xA19140A5C42D8715());
		if (!unk_0x429D45A6C6520026(sParam5))
		{
			...
			{
				*uParam3 = unk_0xB68EB57358F46F86(vParam4, sParam5);
			}
		}
		func_34(iParam1);
		*uParam0 = 0;
	...
	if (unk_0x893915B076B1DDF7(*uParam2) && unk_0x2A8A410BC14B59BC(*uParam2))
	{
		...
		else if (!unk_0x429D45A6C6520026(sParam5))
		{
			vVar1 = { unk_0x449423FDF0CA7A13(*uParam2, 0f, 0f, 0f) };
...
{
	iParam0->f_1 = (func_36(unk_0x05EFB6A616B6FADE(*iParam0, 4)) - fParam1);
...
int func_41(int iParam0, vector3 vParam1, float fParam2)
{
	...
	if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vParam1, true) >= (100f * fParam2))
	{
		return 0;
	}
	if (Global_93282)
...
void func_47()
{
	...
	func_48(&uLocal_153, 0, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
}
...
int func_69()
{
	...
	while (iVar6 < 11)
	{
		...
		if (unk_0x37A8EF89184DBA23(vVar1, 10f, iVar0, 0))
		{
			iVar7 = unk_0x78CED56884DEF3D7(vVar1, 10f, iVar0, 0, 0, 1);
			if (unk_0xDC5D81351D6A4DDB(iVar7))
			{
				if (iVar3 == 825812850)
				{
					unk_0x76D3D51F5F66367F(iVar7, 0f, 0f, 21f, 2, 1);
				}
				unk_0xAA1FF14A8DC5C352(&iVar7);
			}
		}
		if (iVar2 != 226)
		{
		}
		else if (!unk_0x3C43F06C8C621742(iVar3))
		{
		}
		else
		{
			unk_0x6417FCFC98785F84(iVar3, 3, 1, 1);
			unk_0x2A934A66F44B6595(iVar3, 0f, 1, 1);
			if (((iVar6 != 6 && iVar6 != 7) && iVar6 != 8) && iVar6 != 9)
			{
				unk_0xAC827E2E972FD69A(iVar3);
			}
		}
		iVar6++;
	}
...
void func_74(int iParam0)
{
	...
	{
		if (unk_0xF9D4EF1338E38AFB(*iParam0, -2017877118) != 0)
		{
