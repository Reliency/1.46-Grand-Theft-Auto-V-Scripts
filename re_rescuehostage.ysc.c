		...
		if (unk_0x1F85F8C7CC4639AE())
		{
			switch (iLocal_45)
			{
				...
				case 1:
					if (iLocal_60 == 0)
					{
						iLocal_60 = unk_0xCA6D6C3767072568(99, -104.982f, 6408.737f, 30.4905f, 180000f);
					}
					func_104();
					...
					else if (!unk_0x4915F4759304D5CF(iLocal_50))
					{
						func_99();
						func_98();
					}
					...
					else
					{
						if (Local_93[1 /*10*/].f_7)
						{
							...
							if (unk_0xCE3CB618AFE55EFB(iLocal_54))
							{
								unk_0xE1623437A3194332(&iLocal_54);
							}
							func_50(&Local_93, 1);
							func_48();
						}
						if (!unk_0x4915F4759304D5CF(iLocal_49))
						{
							if (bLocal_68)
							{
								if (unk_0xFE5DE0C3200E00F2(iLocal_63))
								{
									if (unk_0x33CECDD9E141E18E(iLocal_63) == 1f)
									{
										if (!unk_0x4915F4759304D5CF(iLocal_49))
										{
											unk_0x2D2E827C6C3D6D26(iLocal_49, 1);
											unk_0x6259CDB47862A4F3(iLocal_49, 0, 0);
										}
									}
								}
							}
				...
				case 2:
					iLocal_52 = unk_0x4C059EBFED753303(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), 35f, 0, 101383);
					if (unk_0x1095F403F52B42E1(iLocal_52, 0))
					{
						if (!bLocal_92)
						{
					...
					if (!iLocal_78)
					{
						if (unk_0x4E27F73A7FFC8871(7, vLocal_46, 2, 0f, &uLocal_80, 0, 0))
						{
							iLocal_78 = 1;
						}
					}
				...
				case 3:
					if (iLocal_76)
					{
						if (timera() > 5000)
						{
							if (!unk_0x4915F4759304D5CF(iLocal_49))
							{
								unk_0xD738221C247C8B71(iLocal_49, true);
								func_22();
							}
							func_157();
						}
					...
					else
					{
						...
						if (!unk_0x4915F4759304D5CF(iLocal_49))
						{
							if (unk_0xFD34717937104F1C() > iLocal_62 + 100)
							{
						...
						iLocal_52 = unk_0x4C059EBFED753303(vLocal_46, 5f, joaat("ambulance"), 0);
						if (unk_0x1095F403F52B42E1(iLocal_52, 0))
						{
							settimera(0);
							iLocal_76 = 1;
						}
						iLocal_51 = unk_0x0EF06F8835DF897A(vLocal_46, 1.5f, 1.5f, 1.5f, -1);
						...
						{
							if (unk_0x4E27F73A7FFC8871(5, vLocal_46, 2, 0f, &uLocal_81, 0, 0))
							{
								iLocal_78 = 1;
							}
						}
						if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_46) > 5625f && !unk_0x317672E799676CA5(vLocal_46, 10f))
						{
							func_22();
						}
					}
...
void func_3()
{
	if (func_4())
	{
		if (!unk_0x4915F4759304D5CF(iLocal_49))
		{
			unk_0x1F4E5EFBFE503FB3(iLocal_49, false);
			unk_0x1659AF2827EC9D40(iLocal_49, vLocal_46, 50f, -1, 0, 0);
			unk_0xD738221C247C8B71(iLocal_49, true);
			unk_0x7E4E83D33161D01A(&iLocal_49);
			func_48();
		}
		if (!unk_0x4915F4759304D5CF(iLocal_50))
		{
			unk_0x1F4E5EFBFE503FB3(iLocal_50, false);
			unk_0x1659AF2827EC9D40(iLocal_50, vLocal_46, 50f, -1, 0, 0);
			unk_0xD738221C247C8B71(iLocal_50, true);
			unk_0x7E4E83D33161D01A(&iLocal_50);
			func_48();
		}
	}
	if (!unk_0x4915F4759304D5CF(iLocal_49))
	{
		if (unk_0xDEAEC99031DCB92A(iLocal_49, unk_0xA19140A5C42D8715(), 1))
		{
			if (unk_0x685AE6AF34B35D3B(iLocal_49))
			{
				unk_0x6259CDB47862A4F3(iLocal_49, 0, 0);
			}
		}
		else if (unk_0x685AE6AF34B35D3B(iLocal_49))
		{
			unk_0x1F4E5EFBFE503FB3(iLocal_49, false);
			unk_0x1659AF2827EC9D40(iLocal_49, vLocal_46, 50f, -1, 0, 0);
			unk_0xD738221C247C8B71(iLocal_49, true);
	...
	if (!unk_0x4915F4759304D5CF(iLocal_50))
	{
		...
		{
			if (unk_0x685AE6AF34B35D3B(iLocal_50))
			{
				unk_0x6259CDB47862A4F3(iLocal_50, 0, 0);
			}
		}
		else if (unk_0x685AE6AF34B35D3B(iLocal_50))
		{
			unk_0x1F4E5EFBFE503FB3(iLocal_50, false);
			unk_0x1659AF2827EC9D40(iLocal_50, vLocal_46, 50f, -1, 0, 0);
			unk_0xD738221C247C8B71(iLocal_50, true);
	...
	else if (!unk_0x4915F4759304D5CF(iLocal_49))
	{
		unk_0x1F4E5EFBFE503FB3(iLocal_49, false);
		unk_0x1659AF2827EC9D40(iLocal_49, vLocal_46, 50f, -1, 0, 0);
		unk_0xD738221C247C8B71(iLocal_49, true);
...
bool func_4()
{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_49))
	{
		if (unk_0x9809FE4B550B1EFE(unk_0x505186370955851F(iLocal_49, 31086, 0f, 0f, 0f), 15f, 1))
		{
			bVar0 = true;
		}
		vVar1 = { vVar1 + unk_0x505186370955851F(iLocal_49, 31086, 0f, 0f, 0f) };
		vVar2 = { vVar2 + unk_0x505186370955851F(iLocal_49, 31086, 0f, 0f, 0f) };
		...
		if (unk_0x8DAA6481F6FEA36F(-1, -90.68654f, 6411.883f, 36.00729f, -103.86f, 6398.848f, 30.19453f, 23f) || unk_0x6D7FFF527E125F24(-1, unk_0x505186370955851F(iLocal_49, 31086, 0f, 0f, 0f), 20f))
		{
			bLocal_90 = true;
			bVar0 = true;
		}
		if (unk_0x2C519F22A9CF540C(unk_0x505186370955851F(iLocal_49, 31086, 0f, 0f, 0f), 6f))
		{
			bVar0 = true;
			bLocal_90 = true;
		}
...
void func_29()
{
	...
	{
		func_31(13, floor(Global_106070.f_10166.f_3853));
	}
...
int func_47()
{
	if (!iLocal_73)
	{
		...
		if (!unk_0x4915F4759304D5CF(iLocal_49))
		{
			if (iLocal_64 == -1)
			{
				unk_0x2D2E827C6C3D6D26(iLocal_49, 0);
				unk_0xBC40131FF085AF73(5, 0.5f);
				unk_0x51F47E0ABCFD733B(5, 1f);
				unk_0x7B3450F1D3D17EAA(iLocal_49, 1);
				unk_0x2C3F3D88E305DCA7(iLocal_49, 1);
				unk_0x3F01127ECD227890(iLocal_49, sLocal_99, "girl_villian_shot", 8f, -2f, -1, 10, 0, 0, 0, 0);
				iLocal_64 = unk_0x70788DC3D80C9DEB(vLocal_66, vLocal_67, 2);
				if (!unk_0x4915F4759304D5CF(iLocal_50))
				{
					unk_0xDFA901280292A2FB(iLocal_50, iLocal_55);
					if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -91.30704f, 6391.854f, 30.6403f, -102.5595f, 6403.103f, 32.45444f, 8.5f, 0, true, 0))
					{
						unk_0xE5565DEAABF9D588(iLocal_50, iLocal_64, sLocal_99, "bystander_villian_shot", 1000f, -2f, 5, 0, 1148846080, 0);
					}
					else
					{
						unk_0x1F4E5EFBFE503FB3(iLocal_50, false);
				...
				unk_0xE5565DEAABF9D588(iLocal_49, iLocal_64, sLocal_99, "girl_villian_shot", 1000f, -2f, 5, 0, 1148846080, 0);
			}
			else if (unk_0xFE5DE0C3200E00F2(iLocal_64))
			{
				if (unk_0x33CECDD9E141E18E(iLocal_64) > 0.1f)
				{
					func_3();
				}
				if (!iLocal_70)
				{
					if (bLocal_79)
					{
						if (unk_0x33CECDD9E141E18E(iLocal_64) > 0.5f)
						{
				...
				if (unk_0x33CECDD9E141E18E(iLocal_64) == 1f)
				{
					iLocal_64 = unk_0x70788DC3D80C9DEB(vLocal_66, vLocal_67, 2);
					func_1(iLocal_49, "WHIMPER", "WAVELOAD_PAIN_FEMALE", 24);
					unk_0xDA16255FBFC16B28(iLocal_64, true);
					if (!unk_0x4915F4759304D5CF(iLocal_50))
					{
						if (bLocal_79)
						{
							unk_0xE5565DEAABF9D588(iLocal_50, iLocal_64, sLocal_99, "bystander_helping_girl_loop", 1000f, -2f, 5, 0, 1148846080, 0);
						}
						else
						{
							unk_0x2F89329397A277BC(&iLocal_71);
							unk_0x22DD1D053CFF9707(0, iLocal_49, -1, 1024, 2);
							unk_0x8F65948C5AFB744E(0, iLocal_49, 20000, 3f, 1f, 1073741824, 0);
							unk_0xB3E1967E66494060(0, -1);
							unk_0x301F42EEE3C40328(iLocal_71);
							unk_0xE1072FA2FECBAD96(iLocal_50, iLocal_71);
						}
						unk_0xD738221C247C8B71(iLocal_50, true);
						unk_0xDFA901280292A2FB(iLocal_50, iLocal_57);
					}
					unk_0xE5565DEAABF9D588(iLocal_49, iLocal_64, sLocal_99, "girl_helping_girl_loop", 1000f, -2f, 5, 0, 1148846080, 0);
					unk_0xD738221C247C8B71(iLocal_49, true);
					unk_0xDFA901280292A2FB(iLocal_49, iLocal_57);
					unk_0x2D2E827C6C3D6D26(iLocal_49, 1);
...
void func_51()
{
	if (((((((((((unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -91.30704f, 6391.854f, 30.6403f, -102.5595f, 6403.103f, 32.45444f, 8.5f, 0, true, 0) && unk_0x85E4CC19842B6048(iLocal_48, unk_0xA19140A5C42D8715())) || (func_61(iLocal_48, &uLocal_58, &iLocal_59, 0, 0, 1077936128, 0) && unk_0x85E4CC19842B6048(iLocal_48, unk_0xA19140A5C42D8715()))) || (func_60(1) && unk_0x85E4CC19842B6048(iLocal_48, unk_0xA19140A5C42D8715()))) || func_58()) || func_57()) || func_4()) || func_56()) || unk_0x685AE6AF34B35D3B(iLocal_48)) || func_55()) || func_54()) || func_52(iLocal_48))
	{
		if (!unk_0x51421B7F2A039FED(unk_0xA19140A5C42D8715()))
		{
			if (!unk_0xDAA9E4FC4EBF1081(iLocal_48, joaat("weapon_stungun"), 0))
			{
				if (!unk_0x4915F4759304D5CF(iLocal_49))
				{
					if (!unk_0x685AE6AF34B35D3B(iLocal_48))
					{
						iLocal_63 = unk_0x70788DC3D80C9DEB(vLocal_66, vLocal_67, 2);
						unk_0xDA16255FBFC16B28(iLocal_63, false);
						unk_0xE5565DEAABF9D588(iLocal_49, iLocal_63, sLocal_99, "girl_girl_shot", 4f, -4f, 5, 0, 1148846080, 0);
						unk_0xE5565DEAABF9D588(iLocal_48, iLocal_63, sLocal_99, "villian_girl_shot", 4f, -4f, 5, 0, 1148846080, 0);
						unk_0xD738221C247C8B71(iLocal_49, true);
						unk_0x2D2E827C6C3D6D26(iLocal_49, 0);
					}
				}
				if (!unk_0x4915F4759304D5CF(iLocal_50))
				{
					unk_0x2D2E827C6C3D6D26(iLocal_50, 1);
				}
				bLocal_68 = true;
			}
			else
			{
				unk_0x6259CDB47862A4F3(iLocal_48, 50, 0);
			}
		}
	}
	else if (timera() > 6000)
	{
		if ((unk_0x669ABFB25D991447(unk_0xD4E735F4B6A956AC(), iLocal_48) && unk_0x85E4CC19842B6048(iLocal_48, unk_0xA19140A5C42D8715())) || (unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), iLocal_48) && unk_0x85E4CC19842B6048(iLocal_48, unk_0xA19140A5C42D8715())))
		{
			if (unk_0xCE3CB618AFE55EFB(iLocal_53))
			{
				unk_0x264E87C905AE790B(iLocal_53, true);
			}
			if (!iLocal_72)
			{
				if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -91.30704f, 6391.854f, 30.6403f, -102.5595f, 6403.103f, 32.45444f, 8.5f, 0, true, 0))
		...
		else if (unk_0x3CAC2741CC1A631F(sLocal_84, "NULL"))
		{
...
int func_52(int iParam0)
{
	...
	if (unk_0x15763A17141CD6EE(unk_0xA19140A5C42D8715(), iVar0, joaat("component_at_ar_flsh")))
	{
		if (unk_0xEC7D2A8BF4D29D1B(unk_0xA19140A5C42D8715(), iVar0, joaat("component_at_ar_flsh")))
		{
			bVar1 = true;
		}
	}
	else if (unk_0x15763A17141CD6EE(unk_0xA19140A5C42D8715(), iVar0, joaat("component_at_pi_flsh")))
	{
		if (unk_0xEC7D2A8BF4D29D1B(unk_0xA19140A5C42D8715(), iVar0, joaat("component_at_pi_flsh")))
		{
			bVar1 = true;
		}
	}
	if (bVar1)
	{
		...
		{
			if (vdist(unk_0xE2BBD32891C18569(iParam0, true), func_53(unk_0xD4E735F4B6A956AC())) < 8f)
			{
				return 1;
			}
		}
...
int func_54()
{
	if (func_95())
	{
		if (unk_0xFD34717937104F1C() > (iLocal_91 + 60000))
		{
			bLocal_92 = true;
			return 1;
		}
	}
	else if (unk_0xFD34717937104F1C() > (iLocal_91 + 120000))
	{
		bLocal_92 = true;
		return 1;
	}
...
int func_55()
{
	...
	fVar0 = 75f;
	iVar4 = unk_0x0EF06F8835DF897A(unk_0xE2BBD32891C18569(iLocal_48, false), fVar0, fVar0, fVar0, -1);
	if (!unk_0x4915F4759304D5CF(iVar4))
	{
		if (unk_0x8F474E419F56E48D(iVar4) == joaat("s_f_y_cop_01") || unk_0x8F474E419F56E48D(iVar4) == joaat("s_m_y_cop_01"))
		{
			return 1;
		}
	}
	iVar5 = unk_0x4C059EBFED753303(unk_0xE2BBD32891C18569(iLocal_48, false), fVar0, 0, 66561);
	if (unk_0x1095F403F52B42E1(iVar5, 0))
	{
		return 1;
	}
	iVar3 = unk_0xA4C9135FF4C7C4D2(iLocal_48, &uVar1);
	if (iVar3 > 0)
	{
		iVar2 = 0;
		while (iVar2 < iVar3)
		{
			if (unk_0x1095F403F52B42E1(uVar1[iVar2], 0))
			{
				if (((unk_0x8F474E419F56E48D(uVar1[iVar2]) == joaat("police") || unk_0x8F474E419F56E48D(uVar1[iVar2]) == joaat("pranger")) || unk_0x8F474E419F56E48D(uVar1[iVar2]) == joaat("sheriff")) || unk_0x8F474E419F56E48D(uVar1[iVar2]) == joaat("sheriff2"))
				{
					return 1;
				}
			}
...
int func_56()
{
	if (unk_0x10E54C268D1B3FED(iLocal_48, unk_0xA19140A5C42D8715(), 2f, 2f, 1.5f, 0, 1, 0))
	{
		if (unk_0xCCF89CDD3583210D(unk_0xD4E735F4B6A956AC(), iLocal_48))
		{
			return 1;
		}
	}
...
bool func_57()
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		if (unk_0x8F474E419F56E48D(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0)) == joaat("bulldozer"))
		{
			if (!unk_0x4915F4759304D5CF(iLocal_50))
			{
				if (unk_0xC556072C29E00F04(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), iLocal_50))
				{
					bVar0 = true;
				}
			}
			if (!unk_0x4915F4759304D5CF(iLocal_49))
			{
				if (unk_0xC556072C29E00F04(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), iLocal_49))
				{
					bVar0 = true;
				}
			}
			if (!unk_0x4915F4759304D5CF(iLocal_48))
			{
				if (unk_0xC556072C29E00F04(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), iLocal_48))
				{
					bVar0 = true;
				}
			}
...
bool func_58()
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		unk_0xDFCF5BB9A4E3B293(unk_0x8F474E419F56E48D(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0)), &uVar3, &Var4);
		fVar6 = Var4.f_1;
		if (unk_0xD53D19F97BC843F7(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0)))
		{
			if (unk_0xF515D4FED124BAAE(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), &iVar8))
			{
				unk_0xDFCF5BB9A4E3B293(unk_0x8F474E419F56E48D(iVar8), &uVar3, &Var4);
		...
		{
			if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_48, (fVar6 + 17f), (fVar6 + 17f), 6f, 0, 1, 0))
			{
				bVar1 = true;
			}
		}
		...
		{
			if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_48, (fVar6 + 12f), (fVar6 + 12f), 6f, 0, 1, 0))
			{
				bVar1 = true;
			}
		}
		...
		{
			if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_48, (fVar6 + 8f), (fVar6 + 8f), 6f, 0, 1, 0))
			{
				bVar1 = true;
			}
		}
	...
	if (bVar1)
	{
		vVar2 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) - vLocal_46 };
		fVar5 = unk_0x0C1B8F3F6EFDC58B(vVar2.x, vVar2.y);
		if (func_59(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), fVar5, 15f))
		{
			bVar0 = true;
		}
		vVar2 = { vLocal_46 - unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
		fVar5 = unk_0x0C1B8F3F6EFDC58B(vVar2.x, vVar2.y);
		if (func_59(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), fVar5, 15f))
		{
			bVar0 = true;
	...
	iVar7 = unk_0xC409B91AC4749F88();
	if (unk_0xDC5D81351D6A4DDB(iVar7))
	{
		if (unk_0x54F6F5A823224519(iVar7, -91.56341f, 6391.747f, 30.6397f, -101.2611f, 6401.7f, 32.45449f, 7.5f, 0, true, 0))
		{
			bVar0 = true;
		}
	}
...
void func_68()
{
	if (((unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -62.6571f, 6447.08f, 40.49928f, -153.6411f, 6354.579f, 23.99063f, 144.25f, 0, true, 0) || unk_0x317672E799676CA5(vLocal_46, 15f)) || bLocal_68) || func_4())
	{
		iLocal_53 = func_79(iLocal_48, 1, 0);
		if (unk_0xCE3CB618AFE55EFB(iLocal_53))
		{
			unk_0x264E87C905AE790B(iLocal_53, false);
		}
		func_69(1);
		iLocal_91 = unk_0xFD34717937104F1C();
...
int func_81(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_82(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_82(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
...
int func_83()
{
	...
	{
		if (vmag2(unk_0x57323E573695B13F(unk_0xA19140A5C42D8715())) > 1369f && !func_90())
		{
			return 0;
		}
	}
...
void func_96()
{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_48))
	{
		unk_0xB0D7019224A3A443(iLocal_48, 156, true);
		if (unk_0xFE5DE0C3200E00F2(iLocal_63))
		{
			if (unk_0x33CECDD9E141E18E(iLocal_63) > 0.1f)
			{
				if (!iLocal_74)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_49))
					{
						unk_0x83822BA17AE692DE(iLocal_48, unk_0x505186370955851F(iLocal_49, 31086, 0f, 0f, -0.1f), 0);
					}
					iLocal_74 = 1;
					iLocal_72 = 1;
					func_97();
		...
		if (unk_0xFE5DE0C3200E00F2(iLocal_63))
		{
			if (unk_0x33CECDD9E141E18E(iLocal_63) > 0.6f)
			{
				func_97();
			}
		}
...
void func_97()
{
	if (!iLocal_75)
	{
		if (!unk_0x4915F4759304D5CF(iLocal_48))
		{
			...
			unk_0x80E7C4A78224C8F9(5, iLocal_56, iLocal_55);
			unk_0x80E7C4A78224C8F9(5, iLocal_55, iLocal_56);
			unk_0x80E7C4A78224C8F9(0, iLocal_57, iLocal_55);
			unk_0x80E7C4A78224C8F9(2, iLocal_57, iLocal_56);
			unk_0x80E7C4A78224C8F9(2, iLocal_56, iLocal_57);
			if (unk_0x10E54C268D1B3FED(iLocal_48, unk_0xA19140A5C42D8715(), 50f, 50f, 50f, 0, 1, 0))
			{
				unk_0xDA4D3941AFF8EF12(iLocal_48, unk_0xA19140A5C42D8715(), 0, 16);
				unk_0xB4F2B588B54261BF(iLocal_48, 1);
			}
			else
			{
				unk_0x33B5487515BD13D5(iLocal_48, unk_0xA19140A5C42D8715(), 200f, -1, 0, 0);
			}
			unk_0xD738221C247C8B71(iLocal_48, true);
...
void func_99()
{
	...
	func_102();
	unk_0xA177613398FB538B(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), &vLocal_46, 1, 1077936128, 0);
	...
	if (iLocal_72)
	{
		if (!unk_0x090D7069CA715CAA(iLocal_50, joaat("weapon_pistol"), 0) && unk_0x4915F4759304D5CF(iLocal_48))
		{
			if (!bLocal_92)
			{
				iLocal_45 = 2;
		...
		else
		{
			if (!unk_0x4915F4759304D5CF(iLocal_50))
			{
				if (!unk_0x4915F4759304D5CF(iLocal_48))
				{
					unk_0x33B5487515BD13D5(iLocal_50, iLocal_48, 100f, -1, 0, 0);
				}
				else
				{
					unk_0x33B5487515BD13D5(iLocal_50, unk_0xA19140A5C42D8715(), 100f, -1, 0, 0);
				}
				unk_0xD738221C247C8B71(iLocal_50, true);
				if (!bLocal_92)
				{
...
void func_102()
{
	...
	if (bLocal_90 == 0)
	{
		if (!unk_0x4915F4759304D5CF(iLocal_50) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
		{
			if (iLocal_72)
			{
				unk_0x2F89329397A277BC(&iLocal_71);
				unk_0x8F65948C5AFB744E(0, unk_0xA19140A5C42D8715(), 20000, 5f, 2f, 1073741824, 0);
				unk_0x22DD1D053CFF9707(0, unk_0xA19140A5C42D8715(), -1, 2048, 2);
				unk_0x3F01127ECD227890(0, sLocal_99, "bystander_bystander_angry", 8f, -8f, 1500, 0, 0, 0, 0, 0);
				unk_0x33B5487515BD13D5(0, unk_0xA19140A5C42D8715(), 150f, -1, 0, 0);
				unk_0x301F42EEE3C40328(iLocal_71);
				unk_0xE1072FA2FECBAD96(iLocal_50, iLocal_71);
				unk_0x3A95A0A3221D4208(&iLocal_71);
				unk_0xD738221C247C8B71(iLocal_50, true);
			}
			else
			{
				unk_0x2F89329397A277BC(&iLocal_71);
				unk_0x71CBFF70987FE89A(0, vLocal_46, 1f, 20000, 1193033728, 1056964608);
				unk_0x8CBE3882704F529D(0, vLocal_46, -1, 2048, 2);
				unk_0x3F01127ECD227890(0, sLocal_99, "bystander_bystander_angry", 8f, -8f, 1500, 0, 0, 0, 0, 0);
				unk_0x301F42EEE3C40328(iLocal_71);
				unk_0xE1072FA2FECBAD96(iLocal_50, iLocal_71);
				unk_0x3A95A0A3221D4208(&iLocal_71);
...
void func_103()
{
	...
	else if (!unk_0xF59ACE94F067B46D(iLocal_49))
	{
		unk_0x5999C3F8663B8F28(iLocal_49, 4, 0f, 0);
	}
}

void func_104()
{
	if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_46, 50f, 50f, 25f, false, true, 0))
	{
		iLocal_98 = 0;
	}
	else
...
int func_106()
{
	...
	unk_0x6D68030C791111E0(sLocal_99);
	if (((unk_0x7FC99CCC73354033(iVar0) && unk_0x7FC99CCC73354033(iVar2)) && unk_0x7FC99CCC73354033(iVar1)) && unk_0x39C2D9AB77873F84(sLocal_99))
	{
		unk_0xFDD15D670AD33E10(vLocal_46, 5f, 1, 1, 0, false);
		iLocal_49 = unk_0x35C6E06B120EB2E3(5, iVar2, vLocal_46, fLocal_47, 1, true);
		unk_0x2C3F3D88E305DCA7(iLocal_49, 1);
		unk_0x4FE3554969185993(iLocal_49, sVar3);
		unk_0x13E0A8160525AE55(iLocal_49, 20, true);
		iLocal_48 = unk_0x35C6E06B120EB2E3(22, iVar0, vLocal_46, fLocal_47, 1, true);
		unk_0x6259CDB47862A4F3(iLocal_48, 125, 0);
		unk_0x2E591DECDC7041D0(iLocal_48, 125);
		unk_0xC2C4AE9DB4A0BEF3(iLocal_48, 128, true);
		unk_0x2C3F3D88E305DCA7(iLocal_48, 1);
		unk_0x13E0A8160525AE55(iLocal_48, 42, true);
		unk_0x3677CB0D846A1308(iLocal_48, 1.5f);
		unk_0x605FF8F1D0D5E4DE(iLocal_48, true);
		unk_0xF26F4E13A8AEC5EB(iLocal_48, 40f);
		unk_0x13E0A8160525AE55(iLocal_48, 20, true);
		unk_0xB7DFE0AB2CC355C4(iLocal_48, fLocal_85);
		unk_0xF148D9E6972D9816(iLocal_48, fLocal_86);
		unk_0x75D8561E738F40B4(iLocal_48, fLocal_87);
		unk_0x753D02CBEE1BB1AC(iLocal_48, fLocal_88);
		iLocal_50 = unk_0x35C6E06B120EB2E3(4, iVar1, -98.113f, 6405.354f, 30.6005f, fLocal_47, 1, true);
		...
		iLocal_61 = unk_0xF66A39BBE7B3C278(Vector(31.64024f, 6405.058f, -98.41389f) - Vector(40f, 40f, 40f), Vector(31.64024f, 6405.058f, -98.41389f) + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		unk_0x96BFF0680C7B6FD5(iLocal_50, false);
		unk_0x605FF8F1D0D5E4DE(iLocal_50, true);
		vLocal_46.z = (vLocal_46.z + 1f);
		vLocal_66 = { vLocal_46 };
		vLocal_67 = { 0f, 0f, fLocal_47 };
		iLocal_63 = unk_0x70788DC3D80C9DEB(vLocal_66, vLocal_67, 2);
		unk_0xDA16255FBFC16B28(iLocal_63, true);
		unk_0xE5565DEAABF9D588(iLocal_48, iLocal_63, sLocal_99, "villian_struggle_loop", 1000f, -4f, 5, 0, 1148846080, 0);
		unk_0xE5565DEAABF9D588(iLocal_49, iLocal_63, sLocal_99, "girl_struggle_loop", 1000f, -4f, 5, 0, 1148846080, 0);
		iLocal_65 = unk_0x70788DC3D80C9DEB(vLocal_66, vLocal_67, 2);
		unk_0xDA16255FBFC16B28(iLocal_65, true);
		unk_0xE5565DEAABF9D588(iLocal_50, iLocal_65, sLocal_99, "bystander_taking_cover", 1000f, -1.5f, 5, 0, 1148846080, 0);
		unk_0x13E0A8160525AE55(iLocal_50, 185, true);
		unk_0xF0188A1B49D79AF7(iLocal_48, joaat("weapon_pistol"), -1, true, true);
		unk_0xB6544ED6F57109F3(iLocal_48, 1);
		unk_0x94E87D83163B4BEB("re_rescuehostage relManager", &iLocal_57);
		unk_0x94E87D83163B4BEB("re_rescuehostage relBadGuy", &iLocal_56);
		iLocal_55 = unk_0x35546CE87C5336BC(unk_0xA19140A5C42D8715());
		unk_0x80E7C4A78224C8F9(5, iLocal_56, iLocal_55);
		unk_0x80E7C4A78224C8F9(5, iLocal_55, iLocal_56);
		unk_0xDFA901280292A2FB(iLocal_50, iLocal_57);
		unk_0xDFA901280292A2FB(iLocal_48, iLocal_56);
		unk_0x1F4E5EFBFE503FB3(iLocal_49, true);
		unk_0x1F4E5EFBFE503FB3(iLocal_50, true);
		unk_0x1F4E5EFBFE503FB3(iLocal_48, true);
		unk_0x3B7A32E04BBE59A5(iLocal_50, 11, true);
		unk_0x3B7A32E04BBE59A5(iLocal_50, 17, true);
		unk_0x3B7A32E04BBE59A5(iLocal_50, 13, false);
		unk_0x3B7A32E04BBE59A5(iLocal_50, 5, false);
		unk_0x66C4C6EF44050EA5(iLocal_50, 0);
		unk_0x3B7A32E04BBE59A5(iLocal_49, 11, true);
		unk_0x66C4C6EF44050EA5(iLocal_49, 0);
		unk_0x3B7A32E04BBE59A5(iLocal_49, 13, false);
		unk_0x3B7A32E04BBE59A5(iLocal_49, 5, false);
		func_108(&Local_93, 0, unk_0xA19140A5C42D8715(), sLocal_82, 0, 1);
...
{
	return (shift_right(iParam0, 26) & 31 * func_129(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_157()
{
	...
	if (iLocal_45 != 0)
	{
		unk_0x3E11F609741642B7(iLocal_56);
		unk_0x3E11F609741642B7(iLocal_57);
		unk_0x8057BB9AEDA8114F(20000);
		unk_0xE70AC26DFC59863A(iLocal_61, 0);
		unk_0x7F5747E66B1395AE(iLocal_60);
		func_107(0);
	}
	if (!unk_0x4915F4759304D5CF(iLocal_48) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		unk_0x33B5487515BD13D5(iLocal_48, unk_0xA19140A5C42D8715(), 100f, -1, 0, 0);
		unk_0xD738221C247C8B71(iLocal_48, true);
		wait(0);
	}
	func_158(-1);
