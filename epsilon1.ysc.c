...
void __EntryFunction__()
{
	...
	{
		unk_0x14293208022014FA(Local_81.f_35[0], 1);
	}
...
void func_1()
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			if (unk_0x3CAC2741CC1A631F(sLocal_89, "DEFAULT"))
			{
				func_341(1);
			}
			else
...
void func_5()
{
	...
	{
		unk_0xB0D7019224A3A443(unk_0xA19140A5C42D8715(), 334, true);
	}
...
void func_20()
{
	...
	{
		func_6(13, floor(Global_106070.f_10166.f_3853));
	}
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_87(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_87(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_65(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_65(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_65(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_65(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x3B61940560400F58(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_98(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x4BE6499482BEE1D8(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_98(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x4BE6499482BEE1D8(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x6182A22F4D99005E(iVar1, 6, -1, 0, -1, func_87(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_214()
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			func_236(unk_0xA19140A5C42D8715(), vLocal_256, 201.2074f, 0, 1);
			if (!unk_0xE6F861B0A4D50CE0())
			{
				unk_0x543A213BF1AB6832(vLocal_256, 100f, 1);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_88))
			{
				iLocal_88 = unk_0x48CFBECB146FD1A1(iLocal_87, 1970.362f, 2859.594f, 49.2307f, 151.6095f, 1, 1, 0);
			}
			if (func_213(iLocal_85))
			{
				unk_0x96BFF0680C7B6FD5(iLocal_85, false);
				unk_0xDFA901280292A2FB(iLocal_85, 1862763509);
				unk_0xD738221C247C8B71(iLocal_85, true);
				if (func_213(iLocal_88))
				{
					unk_0x9174BE523666C5A0(iLocal_88, 0, 0);
					unk_0x8B55653F1DAE7C6F(iLocal_88, 0, 0);
					unk_0x99F546A9200EA026(iLocal_88, 1084227584);
					unk_0xEEF67CF6BF9A762A(iLocal_88, 0);
					unk_0xB73B76000B84C882(iLocal_85, iLocal_88, -1);
					unk_0x14293208022014FA(iLocal_88, 3);
					unk_0xC19EDC1D7179164C(iLocal_88, true, 1, 0);
				}
			}
			if (func_213(unk_0xA19140A5C42D8715()))
			{
				unk_0x3F01127ECD227890(unk_0xA19140A5C42D8715(), sLocal_90, "back_armsdown", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 1:
			if (unk_0xE6F861B0A4D50CE0())
			{
				if (unk_0xD3512CB88BB3513F())
				{
					...
					iLocal_264 = unk_0x74677C414DD7F53C(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, 0, 2);
					unk_0x930701157A4B9374(iLocal_264, true);
					iLocal_265 = unk_0x74677C414DD7F53C(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, 0, 2);
				...
				if (func_213(iLocal_88))
				{
					if (func_234(iLocal_85, iLocal_88, -1))
					{
						if (iLocal_263)
						{
							...
							{
								unk_0x731722E696597BD1(iLocal_85, iLocal_88, fLocal_258, 786599);
								func_217(unk_0xA19140A5C42D8715(), 30000, 0);
								unk_0xCE2F428A0EEBBE18(0, 0, 3, 0);
								unk_0x930701157A4B9374(iLocal_265, false);
								func_238(0);
								iLocal_83 = 2;
							}
							else if (timera() > 10000)
							{
								if (!unk_0xC3553172354FFB69(iLocal_265))
								{
									unk_0x930701157A4B9374(iLocal_265, true);
									unk_0x930701157A4B9374(iLocal_264, false);
									unk_0x1D7183E3760DB4E5(iLocal_265, 1970.766f, 2872.221f, 49.47233f, 5.712656f, 0f, -160.9523f, 50f, 5000, 3, 3, 2);
								}
							}
						}
						else if (func_213(unk_0xA19140A5C42D8715()))
						{
							if (unk_0xF9D4EF1338E38AFB(unk_0xA19140A5C42D8715(), -2017877118) == 1)
							{
								...
								settimera(0);
								func_216(2000, 0);
								unk_0x1D7183E3760DB4E5(iLocal_264, 1966.352f, 2861.772f, 50.31656f, 4.433831f, 0f, -30.38087f, 50f, 10000, 0, 0, 2);
							}
						}
					}
					else
...
void func_237()
{
	if (!unk_0xDC5D81351D6A4DDB(iLocal_85))
	{
		iLocal_85 = unk_0x35C6E06B120EB2E3(26, iLocal_86, vLocal_257, 0f, 1, true);
	}
	if (func_213(iLocal_85))
	{
		unk_0x83055D7E96024509(iLocal_85, true);
	...
	switch (iLocal_83)
	{
		case 0:
			...
			if (func_274(1, 1093140480, 0))
			{
				...
				{
					unk_0xE216F8B2802ABABF(Local_81.f_35[0], sLocal_84, 0, joaat("bison"), 0);
				}
				func_273();
				...
				unk_0x01AF8CB960828C2B(-1630.38f, 4200.79f, 83.01f, 70f, 0, 0, 0, 0, false, 0);
				iLocal_83 = 1;
			}
			break;
...
void func_285()
{
	...
	unk_0x6D68030C791111E0(sLocal_90);
	while (((!unk_0x39C2D9AB77873F84(sLocal_90) || !unk_0xD744813D9841CA9A(0)) || !unk_0x7FC99CCC73354033(iLocal_87)) || !unk_0x7FC99CCC73354033(iLocal_86))
	{
		wait(0);
	}
	unk_0xBF6EED5D6E0CD9BF(0.1f);
	unk_0x3FECB22F4BA29165(128, 0);
	func_235(&uLocal_91, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
	if (func_213(unk_0xA19140A5C42D8715()))
	{
...
void func_316()
{
	...
	if (func_340())
	{
		...
		func_338(&iLocal_88);
		unk_0xA5DE74AE39867B03(iLocal_87);
		unk_0xA5DE74AE39867B03(iLocal_86);
	...
	unk_0xBF6EED5D6E0CD9BF(1f);
	func_339(&iLocal_85, 1, 0, 1);
	unk_0x4DC885EA8D6AF7FC(sLocal_90);
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar15)
			{
				if (iVar8 < 50)
				{
					...
					{
						if (!unk_0x3B61940560400F58(Var9) && !func_289(Var9.f_1))
						{
							if (iVar7 == 0)
							{
...
bool func_334(int iParam0)
{
	...
	while (iVar0 < unk_0x0AD363FF0CEF93B1())
	{
		if (unk_0x8798F3E6AE76AF63(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (unk_0x3B61940560400F58(Var1) || func_289(Var1.f_1))
				{
					return 0;
				}
			}
...
int func_343(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_349())
	{
		...
		{
			iVar2 = func_344(unk_0x61D2332983ACC05C());
			if (iVar2 > -1)
			{
