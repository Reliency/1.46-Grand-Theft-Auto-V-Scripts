...
void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		unk_0x413F34FCFABEDE4B(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), false, 1);
		unk_0xF54514EACB543898(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0xFDD15D670AD33E10(vVar1, 40f, 1, 0, 0, false);
	}
	else if (Var0 == 34)
	{
		iLocal_57 = func_243();
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_205(329.513f, 3402.691f, 36.258f, unk_0xE2BBD32891C18569(Var0.f_35[1], true), 1056964608))
				{
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0xA19140A5C42D8715()) && func_126(iParam0->f_28[0])) && !func_145()) && (unk_0xFD34717937104F1C() - iParam0->f_60) > iParam6) && func_189(unk_0xA19140A5C42D8715(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_176(2))
		{
			if (!func_145())
			{
				if (((func_126(unk_0xA19140A5C42D8715()) && func_126(iParam0->f_28[0])) && func_126(iParam0->f_28[1])) && func_189(unk_0xA19140A5C42D8715(), vParam1, 1) < 20f)
				{
			...
			else if (((func_192(sParam3) && !*uParam8 == 1) && func_126(unk_0xA19140A5C42D8715())) && func_189(unk_0xA19140A5C42D8715(), vParam1, 1) >= 20f)
			{
				func_288("pause conversation");
				func_191(1);
				*uParam8 = 1;
			}
			if (func_189(unk_0xA19140A5C42D8715(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_194(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (!unk_0x429D45A6C6520026(sParam1))
		{
			...
			{
				if (func_189(unk_0xA19140A5C42D8715(), vParam2, 1) <= 100f)
				{
					func_197(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(unk_0xA19140A5C42D8715(), vParam2, 1) > 120f)
				{
					func_199(iParam0);
				}
			}
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_226(unk_0xE2BBD32891C18569(iParam1, true) - unk_0xE2BBD32891C18569(iParam0, true)) };
	...
	{
		vVar1 = { func_226(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_233(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_226(vParam1 - unk_0xE2BBD32891C18569(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_35[1]))
			{
				...
				unk_0xFC00A668AFC2126D(iVar0[1], true);
			}
...
int func_256(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			unk_0x6D68030C791111E0("rcmminute1");
			unk_0xFDD15D670AD33E10(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, false);
			iLocal_51 = 1;
			break;
		...
		case 3:
			if (unk_0x39C2D9AB77873F84("rcmminute1"))
			{
				...
				if (func_126(uParam0->f_28[1]))
				{
					...
					unk_0x13E0A8160525AE55(uParam0->f_28[1], 185, true);
				}
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
void func_271(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0x413F34FCFABEDE4B(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), true, 1);
	}
	else if (*iParam0 == 34)
	{
