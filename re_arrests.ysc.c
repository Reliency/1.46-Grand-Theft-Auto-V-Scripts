	...
	while (true)
	{
		...
		switch (iLocal_46)
		{
			...
			case 1:
				if (func_100())
				{
					unk_0xE537EBD7B736A4E2(2551.038f, 4708.613f, 32.6775f, 2536.979f, 5022.179f, 43.8519f, 300f, 0, true, 1);
...
void func_1()
{
	...
	{
		unk_0xB0D7019224A3A443(iLocal_53, 129, true);
	}
	if (func_86(iLocal_53))
	{
		if (unk_0x97722E4EBB9BA577(iLocal_53, 0))
		{
			bLocal_284 = true;
		}
	}
	if (!unk_0x4915F4759304D5CF(iLocal_52) && (iLocal_47 != 2 && iLocal_47 != 1))
	{
		if (!unk_0x4915F4759304D5CF(iLocal_53))
		{
			switch (iLocal_50)
			{
				case 0:
					...
					if (timera() > 10)
					{
						if (!bLocal_68)
						{
							if (unk_0xF9D4EF1338E38AFB(iLocal_52, 1227113341) == 7)
							{
								unk_0x8F65948C5AFB744E(iLocal_52, iLocal_53, -1, 1f, 3f, 1073741824, 0);
							}
						}
					}
					if (timera() > 4000)
					{
						if (!bLocal_68)
						{
							if (unk_0xF9D4EF1338E38AFB(iLocal_53, 1805844857) == 7)
							{
								if (unk_0xF9D4EF1338E38AFB(iLocal_53, -2017877118) == 1)
								{
									unk_0xFB5A34FAABB4D147(iLocal_53, 2, 1);
								}
								unk_0x33B5487515BD13D5(iLocal_53, iLocal_52, 150f, -1, 0, 0);
							}
						}
					}
					fVar2 = unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iLocal_52, true), unk_0xE2BBD32891C18569(iLocal_53, true), true);
					if (timera() > 8000 || fVar2 < 1.5f)
					{
						iVar3 = func_82();
						if (iVar3 == 1)
						{
							unk_0x8F65948C5AFB744E(iLocal_52, iLocal_53, -1, 1f, 0.01f, 1073741824, 0);
						}
					}
					...
					if (timera() > 2000)
					{
						if (iVar3 || iLocal_270 == 1)
						{
							if (!func_81())
							{
								...
								bLocal_282 = (unk_0x685AE6AF34B35D3B(iLocal_53) || unk_0xC35EE16DB41A098F(iLocal_53));
								if (!unk_0x22B3625D717A4563(iLocal_52, joaat("weapon_pistol"), 0))
								{
									unk_0xF0188A1B49D79AF7(iLocal_52, joaat("weapon_pistol"), -1, false, true);
								}
								unk_0xB20B772FD9DE1847(iLocal_52, joaat("weapon_pistol"), true);
								vLocal_64 = { unk_0xE2BBD32891C18569(iLocal_53, true) };
								unk_0x9568B1B58F78FF36(iLocal_52);
								unk_0x2F89329397A277BC(&iLocal_67);
								if (!bLocal_282 && fVar2 > 2f)
								{
									unk_0xAF36EFD37EE8B02A(0, vLocal_64.x, vLocal_64.y, (vLocal_64.z + 4f), 1000, 1566631136);
								}
								unk_0x22DD1D053CFF9707(0, iLocal_53, -1, 2048, 2);
								unk_0x9295936F52859375(0, iLocal_53, iLocal_53, 1f, 0, 3f, 1082130432, 1, 0, -957453492);
								unk_0x9C24BCD3EFB3BF4C(0, iLocal_53, 5000, 0);
								unk_0x301F42EEE3C40328(iLocal_67);
								unk_0xE1072FA2FECBAD96(iLocal_52, iLocal_67);
								unk_0x3A95A0A3221D4208(&iLocal_67);
								unk_0xDCB46BFC2265476A(iLocal_52);
								unk_0xD738221C247C8B71(iLocal_52, true);
								settimera(0);
								iLocal_240 = unk_0xFD34717937104F1C();
								if (bLocal_282)
								{
									unk_0x9568B1B58F78FF36(iLocal_53);
									unk_0x8B2245B665912C02(iLocal_53);
									iLocal_50 = 4;
								}
								else
								{
					...
					{
						if (!unk_0x4915F4759304D5CF(iLocal_52) && !unk_0x7112137033807390(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), 0))
						{
							if (unk_0xC556072C29E00F04(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), iLocal_52))
							{
								unk_0x9568B1B58F78FF36(iLocal_52);
								iLocal_50 = 1;
								unk_0xB3E1967E66494060(iLocal_52, 500);
							}
						}
					}
					break;
				...
				case 1:
					if (unk_0xF9D4EF1338E38AFB(iLocal_52, -982327190) == 7)
					{
						unk_0x8F65948C5AFB744E(iLocal_52, iLocal_53, -1, 1f, 3f, 1073741824, 0);
						iLocal_50 = 0;
					}
				...
				case 2:
					if ((unk_0xFD34717937104F1C() - iLocal_240) > 1000)
					{
						vVar1 = { 0f, 0f, (unk_0x552C823E1D2A019C(iLocal_53) * 3f) };
						unk_0x956B3CF461C0C1C9(iLocal_53, vVar1, 2f, -1, 1f, 1024, 1193033728);
						iLocal_50 = 3;
					}
					break;
				
				case 3:
					if ((unk_0xFD34717937104F1C() - iLocal_240) > 4500)
					{
						iLocal_50 = 4;
					}
					break;
				...
				case 4:
					bLocal_68 = true;
					unk_0x2F89329397A277BC(&iLocal_67);
					unk_0x3F01127ECD227890(0, sLocal_250, "idle_2_hands_up", 2f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sLocal_250, "kneeling_arrest_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x301F42EEE3C40328(iLocal_67);
					unk_0xE1072FA2FECBAD96(iLocal_53, iLocal_67);
					unk_0x3A95A0A3221D4208(&iLocal_67);
					unk_0xDCB46BFC2265476A(iLocal_53);
					unk_0xD738221C247C8B71(iLocal_53, true);
					unk_0x1C09E70D9D927D95(iLocal_53, 1);
					iLocal_50 = 5;
					break;
				...
				case 5:
					if (iLocal_48 == 3)
					{
						if (unk_0xF9D4EF1338E38AFB(iLocal_52, 242628503) == 7)
						{
							unk_0x9568B1B58F78FF36(iLocal_52);
							if (!unk_0x22B3625D717A4563(iLocal_52, joaat("weapon_pistol"), 0))
							{
							...
							unk_0xB20B772FD9DE1847(iLocal_52, joaat("weapon_pistol"), true);
							unk_0x2F89329397A277BC(&iLocal_67);
							unk_0x9C24BCD3EFB3BF4C(0, iLocal_53, -1, 0);
							unk_0x301F42EEE3C40328(iLocal_67);
							unk_0xE1072FA2FECBAD96(iLocal_52, iLocal_67);
							unk_0x3A95A0A3221D4208(&iLocal_67);
							unk_0xD738221C247C8B71(iLocal_52, true);
				...
				case 6:
					if (unk_0x1095F403F52B42E1(iLocal_55, 0) && !unk_0x4915F4759304D5CF(iLocal_54))
					{
						unk_0xF6B71D006EE5D90F(iLocal_55, 1);
						if (unk_0xF9D4EF1338E38AFB(iLocal_52, -2017877118) == 7)
						{
							if (unk_0xF9D4EF1338E38AFB(iLocal_54, -1273030092) == 7)
							{
								if (unk_0x5860446BFB759B77(iLocal_53, iLocal_55, 2, 0, false))
								{
									if (!unk_0x4915F4759304D5CF(iLocal_53))
									{
										if (!unk_0xB10F7FE89663CB5B(iLocal_53, iLocal_55))
										{
											if (!unk_0x967743032563101F(iLocal_53, 0))
											{
												if (unk_0xF9D4EF1338E38AFB(iLocal_53, -1794415470) == 7)
												{
													unk_0x2F89329397A277BC(&iLocal_67);
													unk_0x3F01127ECD227890(0, sLocal_250, "kneeling_arrest_get_up", 8f, -2f, -1, 0, 0, 0, 0, 0);
													unk_0x301F42EEE3C40328(iLocal_67);
													unk_0xE1072FA2FECBAD96(iLocal_53, iLocal_67);
													unk_0x3A95A0A3221D4208(&iLocal_67);
													unk_0x80E7C4A78224C8F9(0, iLocal_66, iLocal_65);
													unk_0x80E7C4A78224C8F9(0, iLocal_65, iLocal_66);
												}
											}
										}
									}
									...
									{
										unk_0x3EE01DAA2DCBF34D(iLocal_52);
										if (!unk_0x967743032563101F(iLocal_52, 0))
										{
											if (unk_0x1095F403F52B42E1(iLocal_55, 0))
											{
												if (!func_81())
												{
													if (func_71(&uLocal_72, "REARRAU", "REARR_INCAR", 4, iLocal_246, 0, 0))
													{
														...
														{
															if (unk_0xC42DE41AEED00E7B(iLocal_54, iLocal_53, 180f))
															{
														...
														else if (unk_0xC42DE41AEED00E7B(iLocal_54, iLocal_53, 180f))
														{
															vLocal_283 = { -2.978f, -0.75f, 1f };
														}
														else
														...
														unk_0x2F89329397A277BC(&iLocal_67);
														unk_0xBB2EBD7F469C8767(0, unk_0x3201284584C7CD83(iLocal_55, vLocal_283), iLocal_53, 0.75f, false, 0.5f, 4f, true, 0, 0, -957453492, 60000);
														unk_0x9C24BCD3EFB3BF4C(0, iLocal_53, -1, 0);
														unk_0x301F42EEE3C40328(iLocal_67);
														unk_0xE1072FA2FECBAD96(iLocal_52, iLocal_67);
														unk_0x3A95A0A3221D4208(&iLocal_67);
														unk_0xD738221C247C8B71(iLocal_52, true);
														unk_0x06DE7D435FAAC96A(iLocal_55, 0);
														iLocal_238 = 8000;
														settimerb(0);
				...
				case 7:
					if (!unk_0x4915F4759304D5CF(iLocal_52))
					{
						if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, 35f, 35f, 35f, 0, 1, 0))
						{
							if ((unk_0xFD34717937104F1C() - iLocal_269) > 8000)
							{
								if (!func_81())
								{
									unk_0x22DD1D053CFF9707(iLocal_52, unk_0xA19140A5C42D8715(), 6000, 2048, 2);
						...
						if (unk_0x1095F403F52B42E1(iLocal_55, 0))
						{
							if (iLocal_62)
							{
								if (func_69(iLocal_52, iLocal_55) == 2)
								{
									unk_0xA2EBCD9385E56019(iLocal_53, iLocal_55, -1, 2, 1f, 1, 0);
								}
								else
								{
									unk_0xA2EBCD9385E56019(iLocal_53, iLocal_55, -1, 1, 1f, 1, 0);
								}
								iLocal_50 = 8;
							}
							else if (iLocal_61)
							{
								fVar4 = unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iLocal_53, true), unk_0xE2BBD32891C18569(iLocal_55, true), true);
								if (fVar4 < 4f && iLocal_273 == 0)
								{
									unk_0x4C43F30A5B741870(iLocal_53, iLocal_55, 60000, 0.5f, vLocal_283.x, vLocal_283.y, 1f, 1);
									iLocal_273 = 1;
								}
								else if (fVar4 < 3f)
								{
							...
							else if (!unk_0x411C28019DEA5CEF(iLocal_53, sLocal_250, "kneeling_arrest_get_up", 3))
							{
								if (func_69(iLocal_52, iLocal_55) == 2)
								{
								...
								if (bLocal_284)
								{
									unk_0x6D9BE0B9D5BA1106(iLocal_53, "MOVE_M@BAIL_BOND_TAZERED", 1048576000);
								}
								else
								{
									unk_0x6D9BE0B9D5BA1106(iLocal_53, "MOVE_M@BAIL_BOND_NOT_TAZERED", 1048576000);
								}
								iLocal_61 = 1;
							}
						}
					...
					if (unk_0x1095F403F52B42E1(iLocal_55, 0))
					{
						if (!unk_0x4915F4759304D5CF(iLocal_54))
						{
							if (unk_0xB10F7FE89663CB5B(iLocal_53, iLocal_55))
							{
								...
								if (unk_0xB10F7FE89663CB5B(iLocal_52, iLocal_55))
								{
									unk_0x731722E696597BD1(iLocal_54, iLocal_55, 10f, 786603);
									unk_0xD738221C247C8B71(iLocal_54, true);
									unk_0x1F4E5EFBFE503FB3(iLocal_52, false);
									func_169();
								}
								else if (unk_0xF9D4EF1338E38AFB(iLocal_52, -1794415470) == 7)
								{
									unk_0x9568B1B58F78FF36(iLocal_52);
									unk_0xA2EBCD9385E56019(iLocal_52, iLocal_55, 20000, 0, 1f, 1, 0);
									unk_0xD738221C247C8B71(iLocal_52, true);
								}
							}
						}
		...
		if (!unk_0x4915F4759304D5CF(iLocal_53))
		{
			...
			else
			{
				if (iLocal_47 == 1 || iLocal_47 == 3)
				{
					if (!func_81())
					{
						if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iLocal_53, true), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), true) < 20f)
						{
							func_71(&uLocal_72, "REARRAU", sLocal_266, 4, iLocal_246, 0, 0);
						}
					}
				}
				if (unk_0x411C28019DEA5CEF(iLocal_53, sLocal_250, "kneeling_arrest_idle", 3))
				{
					unk_0x2F89329397A277BC(&iLocal_67);
					unk_0x3F01127ECD227890(0, sLocal_250, "kneeling_arrest_get_up", 2f, -2f, -1, 0, 0, 0, 0, 0);
...
void func_2()
{
	...
	vVar1 = { 40f, 40f, 20f };
	if (unk_0xFD34717937104F1C() > iLocal_247 + 1000)
	{
		if (!unk_0x4915F4759304D5CF(iLocal_52))
		{
			if (!unk_0x10E54C268D1B3FED(iLocal_52, unk_0xA19140A5C42D8715(), vVar1, 0, 1, 0))
			{
				iVar0++;
			}
		}
		...
		if (!unk_0x4915F4759304D5CF(iLocal_53))
		{
			if (!unk_0x10E54C268D1B3FED(iLocal_53, unk_0xA19140A5C42D8715(), vVar1, 0, 1, 0))
			{
				iVar0++;
			}
		}
...
void func_3(bool bParam0)
{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_52))
	{
		switch (iLocal_48)
		{
			case 0:
				if ((iLocal_237 == 3 || iLocal_50 == 5) || iLocal_50 == 6)
				{
					if (!func_81())
					{
						unk_0x9568B1B58F78FF36(iLocal_52);
						unk_0x2F89329397A277BC(&iLocal_67);
						unk_0x8CBE3882704F529D(0, unk_0xE2BBD32891C18569(iLocal_53, false), 10000, 0, 2);
						unk_0x3F01127ECD227890(0, sLocal_250, sVar0, 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x3F01127ECD227890(0, sLocal_250, sVar1, 16f, -8f, -1, 1, 0, 0, 0, 0);
						unk_0x301F42EEE3C40328(iLocal_67);
						unk_0xE1072FA2FECBAD96(iLocal_52, iLocal_67);
						unk_0x3A95A0A3221D4208(&iLocal_67);
						iLocal_48 = 1;
			...
			case 1:
				if (unk_0x411C28019DEA5CEF(iLocal_52, sLocal_250, sVar1, 3))
				{
					if (!unk_0x4915F4759304D5CF(iLocal_53))
					{
						if (!func_81())
			...
			case 2:
				if (!func_81())
				{
					if (func_10())
					{
						if (unk_0x1095F403F52B42E1(iLocal_55, 0))
						{
							unk_0x4BD8CDEEE2A48382(iLocal_55, 0);
							unk_0x06DE7D435FAAC96A(iLocal_55, 1);
						}
						unk_0x9568B1B58F78FF36(iLocal_52);
						unk_0x2F89329397A277BC(&iLocal_67);
						unk_0x3F01127ECD227890(0, sLocal_250, sVar2, 8f, -1.5f, -1, 0, 0, 0, 0, 0);
						unk_0x301F42EEE3C40328(iLocal_67);
						unk_0xE1072FA2FECBAD96(iLocal_52, iLocal_67);
						unk_0x3A95A0A3221D4208(&iLocal_67);
						unk_0x3A3E4B7C6FBE305D(iLocal_52, 0, 0);
						func_8();
						iLocal_48 = 3;
					}
				}
			...
			case 3:
				...
				{
					if (unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), iLocal_53))
					{
						if (!func_81())
						{
				...
				if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, 35f, 35f, 35f, 0, 1, 0))
				{
					unk_0x887BF9EA318C40F3(iLocal_52, 1, unk_0xA19140A5C42D8715(), 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0x887BF9EA318C40F3(unk_0xA19140A5C42D8715(), 1, iLocal_52, 31086, 0f, 0f, 0f, 0, -1, -1);
					if (timerb() > iLocal_238 || iLocal_254)
					{
						if (iLocal_47 == 3 || iLocal_47 == 0)
						{
							if (!unk_0x4915F4759304D5CF(iLocal_53))
							{
								...
								{
									unk_0x22DD1D053CFF9707(iLocal_52, unk_0xA19140A5C42D8715(), 500, 2048, 2);
									func_71(&uLocal_72, "REARRAU", "REARR_PLEAVE", 4, iLocal_246, 0, 0);
									iLocal_238 = 8000;
								}
							}
						...
						else
						{
							...
							else if (!func_81())
							{
								unk_0x22DD1D053CFF9707(iLocal_52, unk_0xA19140A5C42D8715(), 6000, 2048, 2);
								func_71(&uLocal_72, "REARRAU", "REARR_PLEAVE", 4, iLocal_246, 0, 0);
								iLocal_238 = unk_0x22C775856F4633CA(8, 22);
								iLocal_238 *= 30000;
							}
							settimerb(0);
						}
				...
				if (iLocal_50 != 8)
				{
					if (unk_0x1095F403F52B42E1(iLocal_55, 0))
					{
						if (!unk_0x4915F4759304D5CF(iLocal_53))
						{
							if (!unk_0xE0FD180CD24C0B67(iLocal_53, iLocal_55, 0))
							{
								func_68();
							}
						}
...
void func_4()
{
	if (!iLocal_254)
	{
		...
		unk_0x2F89329397A277BC(&iLocal_67);
		unk_0x3F01127ECD227890(0, sLocal_251, "enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x3F01127ECD227890(0, sLocal_251, sLocal_252, 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x3F01127ECD227890(0, sLocal_251, "exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x3F01127ECD227890(0, sLocal_250, "kneeling_arrest_idle", 8f, -8f, -1, 9, 0, 0, 0, 0);
		unk_0x301F42EEE3C40328(iLocal_67);
		unk_0xE1072FA2FECBAD96(iLocal_53, iLocal_67);
		unk_0x3A95A0A3221D4208(&iLocal_67);
		iLocal_254 = 1;
	}
	else if (unk_0x411C28019DEA5CEF(iLocal_53, sLocal_251, "enter", 3))
	{
		if (func_5())
		{
	...
	else if (unk_0x411C28019DEA5CEF(iLocal_53, sLocal_251, "exit", 3))
	{
	}
	else if (unk_0x411C28019DEA5CEF(iLocal_53, sLocal_251, sLocal_252, 3))
	{
...
int func_5()
{
	if (unk_0xFD34717937104F1C() > iLocal_256 + 6000)
	{
		iLocal_256 = unk_0xFD34717937104F1C();
		return 1;
	}
	return 0;
}
...
void func_6()
{
	...
	{
		unk_0x2F89329397A277BC(&iLocal_67);
		unk_0x3F01127ECD227890(0, sLocal_250, "radio_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x3F01127ECD227890(0, sLocal_250, "radio_chatter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x3F01127ECD227890(0, sLocal_250, "radio_exit", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		unk_0x9C24BCD3EFB3BF4C(0, iLocal_53, -1, 0);
		unk_0x301F42EEE3C40328(iLocal_67);
		unk_0xE1072FA2FECBAD96(iLocal_52, iLocal_67);
		unk_0x3A95A0A3221D4208(&iLocal_67);
	...
	else if (unk_0x411C28019DEA5CEF(iLocal_52, sLocal_250, "radio_chatter", 3))
	{
		if (func_5())
		{
	...
	else if (unk_0x411C28019DEA5CEF(iLocal_52, sLocal_250, "radio_exit", 3))
	{
		iLocal_255 = 0;
		func_8();
	}
	...
	switch (iLocal_49)
	{
		case 0:
			if (!bLocal_68)
			{
				...
				unk_0x7112137033807390(iLocal_52, 0);
				unk_0x7112137033807390(iLocal_53, 0);
				if (unk_0xDC5D81351D6A4DDB(iLocal_52) && unk_0xDC5D81351D6A4DDB(iLocal_53))
				{
					unk_0x4C43F30A5B741870(iLocal_52, iLocal_53, -1, 3f, 0f, 0f, 1f, 0);
				}
				settimerb(0);
			}
			break;
		...
		case 2:
			if (unk_0x1095F403F52B42E1(iLocal_55, 0))
			{
				if ((unk_0xFD34717937104F1C() - iLocal_279) > 20000)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_54))
					{
						if (unk_0xF9D4EF1338E38AFB(iLocal_54, -1273030092) == 7)
						{
							unk_0xA2EBCD9385E56019(iLocal_52, iLocal_55, -1, 0, 1f, 1, 0);
							iLocal_49 = 3;
						}
					}
				}
...
int func_10()
{
	...
	{
		if (unk_0x5D260ECB08BF5B88(unk_0xE2BBD32891C18569(iLocal_52, false), 1, &vVar0, 1, 3f, 0f))
		{
			if (unk_0xD76E6AC477D93A67(&vVar0, &vVar2, &uVar3, 0f, 180f, 50f, true, 1, 1))
			{
				iLocal_55 = unk_0x48CFBECB146FD1A1(iVar4, vVar2, 0f, true, true, false);
				iLocal_54 = unk_0x91A7C8CA5E332C03(iLocal_55, 6, joaat("s_m_y_ranger_01"), -1, 1, true);
				unk_0x13E0A8160525AE55(iLocal_54, 294, true);
				if (!unk_0x22B3625D717A4563(iLocal_54, joaat("weapon_pistol"), 0))
				{
					unk_0xF0188A1B49D79AF7(iLocal_54, joaat("weapon_pistol"), -1, false, true);
				}
				unk_0xB20B772FD9DE1847(iLocal_54, joaat("weapon_pistol"), true);
				unk_0xDFA901280292A2FB(iLocal_54, iLocal_65);
				unk_0x14293208022014FA(iLocal_55, 3);
				unk_0x1F4E5EFBFE503FB3(iLocal_54, true);
				unk_0x99F546A9200EA026(iLocal_55, 1084227584);
				unk_0x1D63F9FDAAC001A5(iLocal_55, 1);
				unk_0x3FB92963BD0665CB(iLocal_55, 1);
				vVar0 = { unk_0xE2BBD32891C18569(iLocal_55, true) };
				vVar1 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) - vVar0 };
				unk_0x92DDCF53AA47A63D(iLocal_55, unk_0x0C1B8F3F6EFDC58B(vVar1.x, vVar1.y));
				unk_0x5D260ECB08BF5B88(unk_0xE2BBD32891C18569(iLocal_52, false), 1, &vVar0, 1, 3f, 0f);
				if (unk_0x499324B3EF19C288(vVar0, 2528.563f, 2639.115f, 36.9446f, true) < 75f)
				{
					vVar0 = { 2473.601f, 2496.765f, 40.87f };
				}
				if (unk_0x499324B3EF19C288(2538.71f, 2592.007f, 36.9446f, vVar0, true) < 16f)
				{
					vVar0 = { 2473.601f, 2496.765f, 40.87f };
				}
				unk_0xD776C8F3311B26BC(iLocal_54, iLocal_55, vVar0, 4, 7f, 786471, 5f, -1f, 1);
				unk_0x625FB4B0328423D9(iLocal_55, 4f);
				unk_0x06DE7D435FAAC96A(iLocal_55, 1);
				iLocal_71 = 1;
...
int func_11()
{
	...
	{
		case 0:
			if (unk_0xF9D4EF1338E38AFB(iLocal_52, 242628503) == 7 || unk_0xFD34717937104F1C() > iLocal_240 + 15000)
			{
				if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, 25f, 25f, 25f, 0, 1, 0))
				{
					if (!unk_0x4915F4759304D5CF(iLocal_52))
					{
						unk_0x9568B1B58F78FF36(iLocal_52);
						...
						{
							unk_0x8F65948C5AFB744E(0, iLocal_53, -1, 3.5f, 2f, 1073741824, 0);
						}
		...
		case 1:
			if (unk_0xF9D4EF1338E38AFB(iLocal_52, 242628503) == 1)
			{
				if (unk_0x5100CFEF9EA1B0E5(iLocal_52) > 0)
				{
					if (!func_81())
					{
						if (iLocal_239 < 2)
						{
							...
							if (unk_0xCE3CB618AFE55EFB(iLocal_56))
							{
								unk_0xF46EDCACB3804F87(iLocal_56, true);
							}
						}
						else
						{
		...
		case 2:
			...
			unk_0x0177431263151C4E(iLocal_52, unk_0xA19140A5C42D8715(), 100);
			break;
...
void func_12()
{
	...
	bVar0 = unk_0xDEAEC99031DCB92A(iLocal_53, unk_0xA19140A5C42D8715(), 1);
	bVar1 = func_53();
	if (bVar1)
	{
	}
				...
				if (iLocal_47 == 2 || bLocal_68 == 1)
				{
					switch (iLocal_241)
					{
						case 8:
							...
							unk_0xF46EDCACB3804F87(iLocal_57, true);
							if (!unk_0x7112137033807390(iLocal_53, 0) && unk_0x411C28019DEA5CEF(iLocal_53, sLocal_250, "kneeling_arrest_idle", 3))
							{
								unk_0x2F89329397A277BC(&iLocal_67);
								unk_0x3F01127ECD227890(0, sLocal_250, "kneeling_arrest_get_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
								unk_0x301F42EEE3C40328(iLocal_67);
								unk_0xE1072FA2FECBAD96(iLocal_53, iLocal_67);
								unk_0x3A95A0A3221D4208(&iLocal_67);
								iLocal_241 = 9;
						...
						case 9:
							...
							if (unk_0xF9D4EF1338E38AFB(iLocal_53, 242628503) == 7)
							{
								iLocal_241 = 0;
							}
							break;
						...
						case 0:
							...
							if (unk_0x10E54C268D1B3FED(iLocal_53, unk_0xA19140A5C42D8715(), 75f, 75f, 75f, 0, 1, 0))
							{
								unk_0x605FF8F1D0D5E4DE(iLocal_53, true);
								iLocal_241 = 3;
							}
							break;
						...
						case 1:
							...
							if (unk_0xA60C975CBAB69F34(iLocal_53, unk_0xE2BBD32891C18569(iLocal_52, false), 4f, 4f, 3f, false, true, 0))
							{
								iLocal_241 = 2;
							}
							else
							{
								unk_0x9568B1B58F78FF36(iLocal_53);
								unk_0x2F89329397A277BC(&iLocal_67);
								unk_0x8CBE3882704F529D(0, unk_0xE2BBD32891C18569(iLocal_52, false), 1000, 0, 2);
								unk_0x956B3CF461C0C1C9(0, unk_0xE2BBD32891C18569(iLocal_52, false), 2f, -1, 3f, 0, 1193033728);
								unk_0x301F42EEE3C40328(iLocal_67);
								unk_0xE1072FA2FECBAD96(iLocal_53, iLocal_67);
								unk_0x3A95A0A3221D4208(&iLocal_67);
								iLocal_241 = 2;
						...
						case 2:
							...
							if (unk_0xA60C975CBAB69F34(iLocal_53, unk_0xE2BBD32891C18569(iLocal_52, false), 4f, 4f, 3f, false, true, 0))
							{
								if (unk_0xF9D4EF1338E38AFB(iLocal_53, 242628503) == 7 || func_71(&uLocal_72, "REARRAU", sLocal_263, 4, iLocal_246, 0, 0))
								{
									iLocal_241 = 6;
								}
							}
							else if (unk_0xF9D4EF1338E38AFB(iLocal_53, 242628503) == 7)
							{
								unk_0x2F89329397A277BC(&iLocal_67);
								unk_0x8CBE3882704F529D(0, unk_0xE2BBD32891C18569(iLocal_52, false), 1000, 0, 2);
								unk_0x956B3CF461C0C1C9(0, unk_0xE2BBD32891C18569(iLocal_52, false), 2f, -1, 3f, 0, 1193033728);
						...
						case 3:
							...
							if (unk_0x10E54C268D1B3FED(iLocal_53, unk_0xA19140A5C42D8715(), 5f, 5f, 3f, 0, 1, 0))
							{
								iLocal_241 = 4;
							}
							else if (unk_0x10E54C268D1B3FED(iLocal_53, unk_0xA19140A5C42D8715(), 75f, 75f, 75f, 0, 1, 0))
							{
								if (!func_81())
								{
									unk_0x9568B1B58F78FF36(iLocal_53);
						...
						case 4:
							...
							if (unk_0x10E54C268D1B3FED(iLocal_53, unk_0xA19140A5C42D8715(), 9f, 9f, 9f, 0, 1, 0))
							{
								iLocal_280 = unk_0xFD34717937104F1C();
								iLocal_241 = 7;
							}
							break;
						...
						case 7:
							...
							if (!unk_0x85875A8777624591(iLocal_53, unk_0xA19140A5C42D8715()))
							{
								unk_0x22DD1D053CFF9707(iLocal_53, unk_0xA19140A5C42D8715(), -1, 2064, 2);
							}
							if (!unk_0xC42DE41AEED00E7B(iLocal_53, unk_0xA19140A5C42D8715(), 30f))
							{
								unk_0x0177431263151C4E(iLocal_53, unk_0xA19140A5C42D8715(), -1);
							}
							if ((unk_0xFD34717937104F1C() - iLocal_280) > 2000)
							{
								iLocal_241 = 5;
							}
							break;
						...
						case 5:
							...
							if (unk_0x411C28019DEA5CEF(iLocal_53, sLocal_250, "Thanks_Male_05", 3) || unk_0xF9D4EF1338E38AFB(iLocal_53, 242628503) == 7)
							{
								if (!func_81())
								{
									if (iLocal_239 < 2)
									{
										...
										unk_0x3F01127ECD227890(iLocal_53, sLocal_250, "Thanks_Male_05", 16f, -16f, -1, 16, 0, 0, 0, 0);
									}
									else
									{
...
int func_53()
{
	...
	if (unk_0x1095F403F52B42E1(iLocal_55, 0))
	{
		if (unk_0x10E54C268D1B3FED(iLocal_55, iLocal_53, fVar0, fVar0, fVar0, 0, 1, 0))
		{
			return 1;
		}
	}
	iVar1 = unk_0x0EF06F8835DF897A(unk_0xE2BBD32891C18569(iLocal_53, false), fVar0, fVar0, fVar0, -1);
	...
	iVar2 = unk_0x4C059EBFED753303(unk_0xE2BBD32891C18569(iLocal_53, false), fVar0, 0, 1024);
...
void func_54()
{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_53))
	{
		bVar0 = unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), iLocal_53);
		bVar1 = unk_0xDEAEC99031DCB92A(iLocal_53, unk_0xA19140A5C42D8715(), 1);
		if (((bVar1 || func_67()) || func_65()) || bVar0)
		{
			func_64();
			if (bLocal_68)
			{
				if (((bVar0 || bVar1) && !unk_0x685AE6AF34B35D3B(iLocal_53)) && !unk_0x5D7DFE2058701942(iLocal_53, 0))
				{
					unk_0x9568B1B58F78FF36(iLocal_53);
					unk_0x26B833B644E45223(iLocal_53, 500, 2000, 0, 0, 0, 0);
					unk_0xCE889E9ADEDDE843(iLocal_53, -1);
					unk_0xD738221C247C8B71(iLocal_53, true);
				}
				else if (!unk_0x5D7DFE2058701942(iLocal_53, 0) && !unk_0x685AE6AF34B35D3B(iLocal_53))
				{
					unk_0x9568B1B58F78FF36(iLocal_53);
					unk_0xCE889E9ADEDDE843(iLocal_53, -1);
					unk_0xD738221C247C8B71(iLocal_53, true);
				...
				if (!func_81())
				{
					if (!unk_0x4915F4759304D5CF(iLocal_52) && iLocal_274 == 0)
					{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_52))
	{
		...
		if (unk_0xDC5D81351D6A4DDB(iLocal_54))
		{
			if (!unk_0x4915F4759304D5CF(iLocal_54))
			{
				if ((unk_0xDEAEC99031DCB92A(iLocal_54, unk_0xA19140A5C42D8715(), 1) && unk_0x24A1A7BF4ED94B71(iLocal_54) < 190) || (unk_0xDEAEC99031DCB92A(iLocal_54, unk_0xA19140A5C42D8715(), 1) && unk_0x685AE6AF34B35D3B(iLocal_54)))
				{
					iVar2 = 1;
				}
				if (unk_0xDC5D81351D6A4DDB(iLocal_55) && unk_0xDEAEC99031DCB92A(iLocal_55, unk_0xA19140A5C42D8715(), 1))
				{
					iVar2 = 1;
				}
			}
		...
		if ((((((unk_0xDEAEC99031DCB92A(iLocal_52, unk_0xA19140A5C42D8715(), 1) && unk_0x24A1A7BF4ED94B71(iLocal_52) < 190) || func_58()) || unk_0x122A8778D4027A82(unk_0xD4E735F4B6A956AC(), 0)) || func_57()) || (unk_0xDEAEC99031DCB92A(iLocal_52, unk_0xA19140A5C42D8715(), 1) && unk_0x685AE6AF34B35D3B(iLocal_52))) || iVar2 == 1)
		{
			func_60(1);
	...
	{
		if (unk_0xDEAEC99031DCB92A(iLocal_52, unk_0xA19140A5C42D8715(), 1))
		{
			if (iLocal_275 == 0)
			{
				iLocal_275 = 1;
	...
	if (iLocal_275)
	{
		if ((unk_0xFD34717937104F1C() - iLocal_278) > 5000)
		{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_52) && !unk_0x4915F4759304D5CF(iLocal_53))
	{
		if (unk_0xDEAEC99031DCB92A(iLocal_52, unk_0xA19140A5C42D8715(), 1) && unk_0xDEAEC99031DCB92A(iLocal_53, unk_0xA19140A5C42D8715(), 1))
		{
			if (unk_0x24A1A7BF4ED94B71(iLocal_52) < 190 && unk_0x24A1A7BF4ED94B71(iLocal_53) < 190)
			{
				func_64();
				func_60(1);
				iLocal_47 = 1;
		...
		if (!unk_0x10E54C268D1B3FED(iLocal_53, iLocal_52, 110f, 110f, 40f, 0, 1, 0))
		{
			if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, 20f, 20f, 20f, 0, 1, 0))
			{
				func_55();
				wait(0);
				func_71(&uLocal_72, "REARRAU", "REARR_PORUN", 4, iLocal_246, 0, 0);
			}
			else if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_53, 40f, 40f, 40f, 0, 1, 0))
			{
				func_55();
				wait(0);
	...
	if (unk_0x4915F4759304D5CF(iLocal_53))
	{
		if (!unk_0x4915F4759304D5CF(iLocal_52))
		{
			if (!unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, 100f, 100f, 40f, 0, 1, 0))
			{
				func_169();
			}
		}
...
int func_58()
{
	...
	vVar0 = { 3f, 3f, 3f };
	vVar1 = { -3f, -3f, -3f };
	if (unk_0x9809FE4B550B1EFE(unk_0x505186370955851F(iLocal_52, 31086, 0f, 0f, 0f), 0.5f, 1))
	{
		if (unk_0x4915F4759304D5CF(iLocal_53))
		{
			return 1;
		}
		else if (!unk_0x9809FE4B550B1EFE(unk_0x505186370955851F(iLocal_53, 31086, 0f, 0f, 0f), 2f, 1))
		{
			return 1;
		}
	}
	if (unk_0x2C519F22A9CF540C(unk_0x505186370955851F(iLocal_52, 31086, 0f, 0f, 0f), 3f))
	{
		return 1;
	}
	if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, 5f, 5f, 5f, 0, 1, 0))
	{
		if (!unk_0x4915F4759304D5CF(iLocal_52))
		{
			if (unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), iLocal_52) || unk_0x669ABFB25D991447(unk_0xD4E735F4B6A956AC(), iLocal_52))
			{
		...
		if (!unk_0x4915F4759304D5CF(iLocal_53))
		{
			if (unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), iLocal_53) || unk_0x669ABFB25D991447(unk_0xD4E735F4B6A956AC(), iLocal_53))
			{
				if (unk_0xF990CFC0F1D94A39(unk_0xA19140A5C42D8715(), &iVar2, 1))
				{
					if (iVar2 != joaat("weapon_unarmed"))
	...
	vVar0 = { vVar0 + unk_0x505186370955851F(iLocal_52, 31086, 0f, 0f, 0f) };
	vVar1 = { vVar1 + unk_0x505186370955851F(iLocal_52, 31086, 0f, 0f, 0f) };
	if (((unk_0x7D4400F91582CA08(vVar1, vVar0, joaat("weapon_smokegrenade"), 1) || unk_0x7D4400F91582CA08(vVar1, vVar0, joaat("weapon_grenade"), 1)) || unk_0x7D4400F91582CA08(vVar1, vVar0, joaat("weapon_stickybomb"), 1)) || unk_0x7D4400F91582CA08(vVar1, vVar0, joaat("vehicle_weapon_tank"), 1))
	{
		return 1;
	}
	return 0;
...
void func_60(int iParam0)
{
	if (!unk_0x4915F4759304D5CF(iLocal_52))
	{
		...
		if (!bLocal_59)
		{
			...
			unk_0xDF341226C0B8BAC3(unk_0xD4E735F4B6A956AC(), 0);
			unk_0x96BFF0680C7B6FD5(iLocal_52, true);
			if (unk_0xCE3CB618AFE55EFB(iLocal_56))
			{
				unk_0xF46EDCACB3804F87(iLocal_56, false);
			}
			if (iParam0 == 1)
			{
				if (!unk_0x4915F4759304D5CF(iLocal_53))
				{
					if (unk_0xF9D4EF1338E38AFB(iLocal_53, 1805844857) == 7)
					{
						...
						{
							unk_0x2F89329397A277BC(&iLocal_67);
							unk_0x3F01127ECD227890(0, sLocal_250, "kneeling_arrest_escape", 8f, -8f, -1, 4096, 0, 0, 0, 0);
							unk_0x33B5487515BD13D5(0, iLocal_52, 150f, -1, 0, 0);
							unk_0x301F42EEE3C40328(iLocal_67);
							unk_0xE1072FA2FECBAD96(iLocal_53, iLocal_67);
							unk_0x3A95A0A3221D4208(&iLocal_67);
							unk_0xF757C0D3A087F145(iLocal_53, -530524, false, 0, 0);
							unk_0xD738221C247C8B71(iLocal_53, true);
						}
						else
						{
				...
				if ((!unk_0x7112137033807390(iLocal_53, 0) && !unk_0x4915F4759304D5CF(iLocal_53)) && !unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
				{
					if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iLocal_53, true), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), true) < 20f)
					{
						if (!func_81())
			...
			unk_0x3A95A0A3221D4208(&iLocal_67);
			unk_0xD738221C247C8B71(iLocal_52, true);
			unk_0xD759B92031944D46(iLocal_52, 1, 0);
			if (unk_0x1095F403F52B42E1(iLocal_55, 0))
			{
...
void func_61()
{
	if (unk_0xDC5D81351D6A4DDB(iLocal_54))
	{
		if (!unk_0x4915F4759304D5CF(iLocal_54))
		{
			...
			unk_0xDA4D3941AFF8EF12(0, unk_0xA19140A5C42D8715(), 0, 16);
			unk_0x301F42EEE3C40328(iLocal_67);
			unk_0xE1072FA2FECBAD96(iLocal_54, iLocal_67);
			unk_0x3A95A0A3221D4208(&iLocal_67);
			unk_0xD738221C247C8B71(iLocal_54, true);
...
void func_64()
{
	if (!unk_0x4915F4759304D5CF(iLocal_53))
	{
		if (unk_0xCE3CB618AFE55EFB(iLocal_57))
		{
			unk_0xF46EDCACB3804F87(iLocal_57, false);
		}
		unk_0xDCB46BFC2265476A(iLocal_53);
	}
}
...
int func_65()
{
	if (!unk_0x7112137033807390(iLocal_52, 0))
	{
		if (bLocal_68)
		{
			if (unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), iLocal_52))
			{
				if ((unk_0xFD34717937104F1C() - iLocal_268) > 1000)
				{
					func_66();
				}
			}
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		if (unk_0xC556072C29E00F04(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), iLocal_53))
		{
			if (bLocal_68)
			{
				if (iLocal_50 != 7)
				{
					if (vdist(unk_0xE2BBD32891C18569(iLocal_53, true), vLocal_64) > 2.5f)
					{
						return 1;
					}
				}
		...
		switch (iLocal_239)
		{
			...
			case 1:
				if (!func_81())
				{
					if (!unk_0x4915F4759304D5CF(iLocal_53))
					{
						...
						unk_0xD738221C247C8B71(iLocal_53, true);
						unk_0x6259CDB47862A4F3(iLocal_53, 101, 0);
			...
			case 2:
				if (!unk_0x4915F4759304D5CF(iLocal_52))
				{
					if (!unk_0x4915F4759304D5CF(iLocal_53))
					{
						unk_0x80E7C4A78224C8F9(2, iLocal_66, iLocal_65);
						unk_0x80E7C4A78224C8F9(2, iLocal_65, iLocal_66);
						unk_0xDA4D3941AFF8EF12(iLocal_52, iLocal_53, 0, 16);
					}
					else
					{
						unk_0x1CBE3F8ED90509B2(iLocal_52, 1193033728, 0);
						func_169();
					}
					unk_0xD738221C247C8B71(iLocal_52, true);
				}
...
int func_69(int iParam0, int iParam1)
{
	...
	if (unk_0x1095F403F52B42E1(iParam1, 0))
	{
		...
		vVar1 = { unk_0x3201284584C7CD83(iParam1, 1f, -0.5f, 0f) };
		vVar3 = { vVar1 - vVar0 };
		vVar2 = { unk_0x3201284584C7CD83(iParam1, -1f, -0.5f, 0f) };
		vVar4 = { vVar2 - vVar0 };
...
void func_70()
{
	if (!func_81())
	{
		if (!iLocal_281)
		{
			if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, 30f, 30f, 30f, 0, 1, 0))
			{
		...
		else if (timerb() > 8000)
		{
			...
			else if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_53, 10f, 10f, 10f, 0, 1, 0))
			{
				func_71(&uLocal_72, "REARRAU", sLocal_260, 4, iLocal_246, 0, 0);
			}
			else if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, 10f, 10f, 10f, 0, 1, 0))
			{
				func_71(&uLocal_72, "REARRAU", sLocal_260, 4, iLocal_246, 0, 0);
			}
			else
...
int func_82()
{
	if (unk_0x10E54C268D1B3FED(iLocal_53, iLocal_52, 3.5f, 3.5f, 3.5f, 0, 1, 0) || func_85())
	{
...
int func_83(float fParam0)
{
	...
	if (unk_0xE855D5CB766BC836(unk_0xE2BBD32891C18569(iLocal_53, true), &uVar0, &vVar1))
	{
...
void func_87()
{
	if ((unk_0xFD34717937104F1C() - iLocal_245) > 500)
	{
		if ((iLocal_47 != 1 && iLocal_47 != 3) && iLocal_47 != 2)
		{
			if (unk_0xCE3CB618AFE55EFB(iLocal_57))
			{
				unk_0xF46EDCACB3804F87(iLocal_57, iLocal_242);
				if (bLocal_242 == 1)
				{
					bLocal_242 = false;
				}
		...
		if (!bLocal_59)
		{
			if (unk_0xCE3CB618AFE55EFB(iLocal_56))
			{
				unk_0xF46EDCACB3804F87(iLocal_56, iLocal_243);
				if (bLocal_243 == 1)
				{
					bLocal_243 = false;
				}
	...
	if (!bLocal_277 == bLocal_276)
	{
		if (bLocal_276)
		{
			if (unk_0xCE3CB618AFE55EFB(iLocal_57))
			{
				unk_0x264E87C905AE790B(iLocal_57, true);
			}
			if (unk_0xCE3CB618AFE55EFB(iLocal_56))
			{
		...
		else
		{
			if (unk_0xCE3CB618AFE55EFB(iLocal_57))
			{
				unk_0x264E87C905AE790B(iLocal_57, false);
			}
			if (unk_0xCE3CB618AFE55EFB(iLocal_56))
			{
...
int func_88(float fParam0)
{
	...
	if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_271, vLocal_272, 194.75f, 0, true, 0))
	{
		return 1;
	}
	if (!unk_0x4915F4759304D5CF(iLocal_52))
	{
		if (unk_0x10E54C268D1B3FED(iLocal_52, unk_0xA19140A5C42D8715(), vVar2, 0, 1, 0))
		{
			iVar0 = 1;
		}
		else
	...
	if (!unk_0x4915F4759304D5CF(iLocal_53))
	{
		if (unk_0x10E54C268D1B3FED(iLocal_53, unk_0xA19140A5C42D8715(), vVar2, 0, 1, 0))
		{
			iVar0 = 1;
		}
		else
...
int func_100()
{
	...
	if (!unk_0x4915F4759304D5CF(iLocal_52))
	{
		if (!unk_0x4915F4759304D5CF(iLocal_53))
		{
			if ((unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_52, fVar0, fVar0, fVar0, 0, 1, 0) || unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_53, fVar0, fVar0, fVar0, 0, 1, 0)) || unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_271, vLocal_272, 194.75f, 0, true, 0))
			{
				if (!unk_0xCE3CB618AFE55EFB(iLocal_57))
				{
...
int func_102(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_103(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_103(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
...
int func_104()
{
	...
	unk_0x6D68030C791111E0(sLocal_250);
	unk_0x6D68030C791111E0(sLocal_251);
	unk_0x4069FC25AC4F1CFB("MOVE_M@BAIL_BOND_NOT_TAZERED");
	unk_0x4069FC25AC4F1CFB("MOVE_M@BAIL_BOND_TAZERED");
	if ((((((unk_0x7FC99CCC73354033(iVar0) && unk_0x7FC99CCC73354033(iVar1)) && unk_0x7FC99CCC73354033(joaat("prop_ld_binbag_01"))) && unk_0x39C2D9AB77873F84(sLocal_250)) && unk_0x39C2D9AB77873F84(sLocal_251)) && unk_0xD7AFBCBD45CE1D9D("MOVE_M@BAIL_BOND_NOT_TAZERED")) && unk_0xD7AFBCBD45CE1D9D("MOVE_M@BAIL_BOND_TAZERED"))
	{
		iLocal_52 = unk_0x35C6E06B120EB2E3(6, iVar0, vVar2, fVar4, 1, true);
		unk_0x13E0A8160525AE55(iLocal_52, 294, true);
		unk_0xD759B92031944D46(iLocal_52, 1, 0);
		unk_0x1C09E70D9D927D95(iLocal_52, 1);
		unk_0x1F4E5EFBFE503FB3(iLocal_52, true);
		func_106(&uLocal_72, 1, iLocal_52, "ArrestCop", 0, 1);
		unk_0x98D1B1BD9C3AA456(iLocal_52, true, 1);
		unk_0xB4F2B588B54261BF(iLocal_52, 1);
		iLocal_53 = unk_0x35C6E06B120EB2E3(26, iVar1, vVar3, fVar5, 1, true);
		unk_0xD759B92031944D46(iLocal_53, 1, 0);
		unk_0x13E0A8160525AE55(iLocal_53, 42, true);
		unk_0x13E0A8160525AE55(iLocal_53, 281, true);
		unk_0x1F4E5EFBFE503FB3(iLocal_53, true);
		func_106(&uLocal_72, 2, iLocal_53, sLocal_257, 0, 1);
		unk_0x98D1B1BD9C3AA456(iLocal_53, true, 1);
		if (iLocal_51 == 1)
		{
			unk_0x72A0FF8C49CFFC0D(iLocal_53, 0, 0, 2, 0);
			unk_0x72A0FF8C49CFFC0D(iLocal_53, 2, 0, 0, 0);
			unk_0x72A0FF8C49CFFC0D(iLocal_53, 3, 2, 0, 0);
			unk_0x72A0FF8C49CFFC0D(iLocal_53, 4, 0, 0, 0);
		}
		func_105();
		if (func_48() == 0)
		{
			func_106(&uLocal_72, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
		}
		else if (func_48() == 1)
		{
			func_106(&uLocal_72, 0, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
		}
		else if (func_48() == 2)
		{
			func_106(&uLocal_72, 0, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
		}
		if (!unk_0x22B3625D717A4563(iLocal_52, joaat("weapon_pistol"), 0))
		{
			unk_0xF0188A1B49D79AF7(iLocal_52, joaat("weapon_pistol"), -1, false, true);
		...
		unk_0xB20B772FD9DE1847(iLocal_52, joaat("weapon_pistol"), true);
		iLocal_58 = unk_0xFCFC8CC5FF74580D(joaat("prop_ld_binbag_01"), vLocal_63.x, vLocal_63.y, (vLocal_63.z + 100f), true, true, false);
		unk_0x7C73A424F1117528(iLocal_58, false, 0);
		if (vdist(2411.32f, 4958.76f, 45.19f, vLocal_63) < 10f)
		{
			iLocal_51 = 1;
			unk_0x2F89329397A277BC(&iLocal_67);
			unk_0xF611DB4270F0FF07(0, 2473.254f, 4901.651f, 43.1488f, 3f, -1, 2f, 1, vLocal_244, 40000f);
			unk_0x33B5487515BD13D5(0, iLocal_52, 150f, -1, 0, 0);
			unk_0x301F42EEE3C40328(iLocal_67);
			unk_0xE1072FA2FECBAD96(iLocal_53, iLocal_67);
			unk_0xD738221C247C8B71(iLocal_53, true);
		...
		else
		{
			iLocal_51 = 2;
			unk_0x2F89329397A277BC(&iLocal_67);
			unk_0xF611DB4270F0FF07(0, 2531.445f, 2521.749f, 38.2072f, 3f, -1, 2f, 1, vLocal_244, 40000f);
			unk_0x33B5487515BD13D5(0, iLocal_52, 150f, -1, 0, 0);
			unk_0x301F42EEE3C40328(iLocal_67);
			unk_0xE1072FA2FECBAD96(iLocal_53, iLocal_67);
			unk_0xD738221C247C8B71(iLocal_53, true);
...
void func_105()
{
	vLocal_244.x = 0f;
	vLocal_244.y = 10f;
	unk_0x8AA21BBDA4DB2C4F(iLocal_52, 2);
	unk_0x3B7A32E04BBE59A5(iLocal_52, 13, true);
	unk_0x3B7A32E04BBE59A5(iLocal_52, 2, true);
	unk_0x3B7A32E04BBE59A5(iLocal_52, 1, true);
	unk_0x3B7A32E04BBE59A5(iLocal_52, 11, false);
	unk_0xF63074D1E750B871(iLocal_52, 0);
	unk_0x8AA21BBDA4DB2C4F(iLocal_53, 3);
	unk_0x3B7A32E04BBE59A5(iLocal_53, 17, true);
	unk_0x3B7A32E04BBE59A5(iLocal_53, 6, true);
	unk_0x3B7A32E04BBE59A5(iLocal_53, 1, true);
	unk_0x3B7A32E04BBE59A5(iLocal_53, 11, false);
	unk_0xC2C4AE9DB4A0BEF3(iLocal_53, 128, true);
	unk_0xC2C4AE9DB4A0BEF3(iLocal_53, 1, false);
	unk_0x94E87D83163B4BEB("RE_ARREST_COP", &iLocal_65);
	unk_0x94E87D83163B4BEB("RE_ARREST_CRIM", &iLocal_66);
	unk_0xDFA901280292A2FB(iLocal_52, iLocal_65);
	unk_0xDFA901280292A2FB(iLocal_53, iLocal_66);
	unk_0x80E7C4A78224C8F9(4, iLocal_66, iLocal_65);
	unk_0x80E7C4A78224C8F9(3, iLocal_65, 1862763509);
	unk_0x80E7C4A78224C8F9(3, iLocal_66, 1862763509);
	unk_0x80E7C4A78224C8F9(4, iLocal_66, -1533126372);
	unk_0x4FE3554969185993(iLocal_52, sLocal_249);
	unk_0x4FE3554969185993(iLocal_53, sLocal_248);
}
...
int func_107()
{
	...
	{
		if (vmag2(unk_0x57323E573695B13F(unk_0xA19140A5C42D8715())) > 1369f && !func_115())
		{
			return 0;
		}
	}
...
void func_169()
{
	if (unk_0x62558A57CB60EE71())
	{
		...
		{
			if (!unk_0x4915F4759304D5CF(iLocal_53) && !unk_0x7112137033807390(iLocal_53, 0))
			{
				unk_0x7112137033807390(iLocal_52, 0);
				if (unk_0xDC5D81351D6A4DDB(iLocal_52))
				{
					unk_0x1659AF2827EC9D40(iLocal_53, unk_0xE2BBD32891C18569(iLocal_52, true), 9000f, -1, 0, 0);
				}
				else
				{
					unk_0x1659AF2827EC9D40(iLocal_53, unk_0xE2BBD32891C18569(iLocal_53, true), 9000f, -1, 0, 0);
				}
		...
		if (unk_0xDC5D81351D6A4DDB(iLocal_52))
		{
			if (!unk_0x4915F4759304D5CF(iLocal_52))
			{
				unk_0xD738221C247C8B71(iLocal_52, true);
				unk_0x1F4E5EFBFE503FB3(iLocal_52, false);
				unk_0xD5046B4EDFAE3D84(iLocal_52, 1);
				unk_0x96BFF0680C7B6FD5(iLocal_52, true);
			}
		}
		if (unk_0xDC5D81351D6A4DDB(iLocal_54))
...
void func_188()
{
	...
	{
		func_44(13, floor(Global_106070.f_10166.f_3853));
	}
...
void func_199()
{
	if (!bLocal_68 && iLocal_49 == 0)
	{
		if (!unk_0x4915F4759304D5CF(iLocal_52) && !unk_0x4915F4759304D5CF(iLocal_53))
		{
			unk_0x71CBFF70987FE89A(iLocal_52, unk_0xE2BBD32891C18569(iLocal_53, true), 3f, 20000, 1193033728, 1056964608);
			unk_0xD738221C247C8B71(iLocal_52, true);
			wait(0);
		}
	}
