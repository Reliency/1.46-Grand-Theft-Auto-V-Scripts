...
void __EntryFunction__()
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	iLocal_44 = unk_0x99F9E6870B7B7C2D();
	iLocal_45 = unk_0x09990A2B9C8684F0();
	...
	iLocal_105 = -1;
	iLocal_106 = -1;
	sLocal_107 = unk_0x7391BCD755BD8577(2, 195, true);
	...
	else
	{
		if (unk_0x122A8778D4027A82(unk_0xD4E735F4B6A956AC(), 0))
		{
			if (!unk_0x4915F4759304D5CF(Global_105102) && unk_0x1095F403F52B42E1(Global_105101, 0))
			{
				...
				unk_0xD738221C247C8B71(Global_105102, true);
...
char* func_44()
{
	...
	StringCopy(&cVar0, unk_0x86701529BD460750(func_45(vLocal_43.x)), 32);
...
Vector3 func_45(int iParam0)
{
	...
	vVar0 = { 0f, 0f, 0f };
	iVar5 = unk_0x7E568B4236F45F53(iParam0);
	if (iVar5 == 1)
	{
		iVar1 = unk_0x3E6A9ABACA8E5C3B(iParam0);
		if (unk_0x1095F403F52B42E1(iVar1, 0))
		{
			vVar0 = { unk_0xE2BBD32891C18569(iVar1, true) };
		}
	}
	else if (iVar5 == 2)
	{
		iVar2 = unk_0xA2EA4BA455370F3C(unk_0x3E6A9ABACA8E5C3B(iParam0));
		if (!unk_0x4915F4759304D5CF(iVar2))
		{
			vVar0 = { unk_0xE2BBD32891C18569(iVar2, true) };
		}
	}
	else if (iVar5 == 3)
	{
		iVar3 = unk_0x63F4756F241D86B8(unk_0x3E6A9ABACA8E5C3B(iParam0));
		if (unk_0xDC5D81351D6A4DDB(iVar3))
		{
			vVar0 = { unk_0xE2BBD32891C18569(iVar3, true) };
		}
	}
	else if (iVar5 == 4)
	{
	...
	{
		iVar4 = unk_0xDCDC5A624E09D6F2(iParam0);
		if (unk_0xF93654E07E20E3CF(iVar4))
		{
			vVar0 = { unk_0x40C0A7A7BE434951(iVar4) };
		}
	}
	else if (iVar5 == 5)
	{
	...
	if (func_221())
	{
		...
		if (iLocal_808 != 4)
		{
			...
			if (iLocal_808 != 0)
			{
				if (func_205())
				{
					if (unk_0x0FA486DE15EB3004(iLocal_111))
					{
						func_181();
						iLocal_58 = 1;
					}
		...
		switch (iLocal_808)
		{
			case 0:
				if (!unk_0x4915F4759304D5CF(Global_105102) && unk_0x1095F403F52B42E1(Global_105101, 0))
				{
					if (unk_0xB10F7FE89663CB5B(Global_105102, Global_105101))
					{
						if (!unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_enter", 3) && !unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_idle", 3))
						{
...
void func_61()
{
	...
	if (!func_214())
	{
		if (unk_0x0FA486DE15EB3004(iLocal_112))
		{
			if (iLocal_808 != 0)
			{
				sVar0 = unk_0x7391BCD755BD8577(2, 218, true);
				if (!unk_0x3CAC2741CC1A631F(sLocal_107, sVar0))
				{
					sLocal_107 = sVar0;
					iLocal_58 = 1;
				}
		...
		{
			iLocal_112 = unk_0xB00CD6895BDB01A0("instructional_buttons");
		}
	}
	else
	{
		unk_0x86795B44CE5FE021(&iLocal_112);
		iLocal_58 = 1;
	}
}
...
void func_62(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	if (iParam3 == 1 || unk_0x1BFD4084A40BF7E1(2))
	{
		*uParam2 = 0;
		if (unk_0x0FA486DE15EB3004(*iParam0))
		{
			...
			{
				unk_0x31A9E530D137684F(*iParam0, "TOGGLE_MOUSE_BUTTONS");
				unk_0x233A5B4A35140C6B(false);
				unk_0x271C1332F482646C();
			}
			unk_0x31A9E530D137684F(*iParam0, "CLEAR_ALL");
			unk_0x271C1332F482646C();
		}
		func_67(uParam2);
	}
	...
	if (*uParam2 == 0)
	{
		if (!unk_0x0FA486DE15EB3004(*iParam0))
		{
			*iParam0 = unk_0xB00CD6895BDB01A0("instructional_buttons");
		}
		if (unk_0x0FA486DE15EB3004(*iParam0))
		{
			unk_0xEEBD65BF77C64926(*iParam0, "CLEAR_ALL");
			if (unk_0x47C01C0E6F4C1D06())
			{
				unk_0x31A9E530D137684F(*iParam0, "TOGGLE_MOUSE_BUTTONS");
			...
			while (iVar0 < uParam2->f_680)
			{
				if (unk_0x05EFB6A616B6FADE(uParam2->f_676, iVar0))
				{
					...
					if (!unk_0x05EFB6A616B6FADE(uParam2->f_677, iVar0))
					{
						...
						func_66(unk_0x7391BCD755BD8577(iVar1, iVar2, true));
						if (iVar3 < 358)
						{
							func_66(unk_0x7391BCD755BD8577(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_66(unk_0xDD4AF94EF709B596(iVar4, iVar5, true));
					}
			...
			unk_0x31A9E530D137684F(*iParam0, "SET_MAX_WIDTH");
			unk_0xD8B5988E85F72BE5(uParam2->f_686);
			unk_0x271C1332F482646C();
			unk_0x31A9E530D137684F(*iParam0, "DRAW_INSTRUCTIONAL_BUTTONS");
...
{
	unk_0xE9F9BA9108F437C7(iParam0, uParam1->f_4, uParam1->f_5, uParam1->f_6, uParam1->f_7, 0);
}
...
int func_71()
{
	...
	if (unk_0x37B568B777BC65F9(iLocal_68))
	{
		if (unk_0xC3553172354FFB69(iLocal_68))
		{
			return 0;
		}
	}
	...
	switch (iLocal_810)
	{
		...
		case 1:
			if (unk_0x71364F510A1CB69F() && unk_0x2F8EAF18929E1E59("FADE_OUT_WORLD_250MS_SCENE"))
			{
				if (unk_0x1095F403F52B42E1(Global_105101, 0))
				{
					unk_0xDDDEEC84F4F95674(Global_105101, false);
				}
				...
				if (unk_0xDC5D81351D6A4DDB(iLocal_109))
				{
					unk_0xC0AC848E56940C34(&iLocal_109);
					unk_0xA5DE74AE39867B03(iLocal_108);
				}
				if (unk_0xC3553172354FFB69(iLocal_68))
				{
					unk_0x6791B0852A0B022D(0);
					Global_105118 = 0;
					unk_0x930701157A4B9374(iLocal_68, false);
					unk_0x8E88E73F74A9FF79(false, false, 3000, 1, 0, 0);
		...
		case 3:
			if (Global_71221 == -1)
			{
				...
				func_113();
				func_112();
				unk_0xFDD15D670AD33E10(Global_105108, 5f, 1, 0, 0, false);
				func_108(1097859072);
				if (!unk_0x4915F4759304D5CF(Global_105102) && unk_0x1095F403F52B42E1(Global_105101, 0))
				{
					unk_0x4299736016AECE26(Global_105101, Global_105108, 1, false, 0, 1);
					unk_0x92DDCF53AA47A63D(Global_105101, Global_105114);
					unk_0xB29E08C7AB729BAD(Global_105101, true);
				}
				unk_0xD87B76260C547F31(0f);
				unk_0xAA32DD4848CF93E0(0f, 1065353216);
				unk_0x99D88BBC8B927586();
				unk_0xFDD15D670AD33E10(Global_105108, 5000f, 1, 0, 0, false);
		...
		case 6:
			...
			if (iLocal_802 != -1)
			{
				...
				if (bVar1)
				{
					if (((func_53() == 0 && !unk_0x05EFB6A616B6FADE(Global_84115[iLocal_802 /*34*/].f_15, 8)) || (func_53() == 1 && !unk_0x05EFB6A616B6FADE(Global_84115[iLocal_802 /*34*/].f_15, 9))) || (func_53() == 2 && !unk_0x05EFB6A616B6FADE(Global_84115[iLocal_802 /*34*/].f_15, 10)))
					{
						bVar1 = false;
					}
				}
				...
				if (bVar1)
				{
					unk_0x543CE0A9FDA251FB(Global_84115[iLocal_802 /*34*/].f_13, 0, 0);
				}
			}
		...
		case 7:
			...
			if (bVar0)
			{
				...
				if (!unk_0x4915F4759304D5CF(Global_105102) && unk_0x1095F403F52B42E1(Global_105101, 0))
				{
					unk_0xB29E08C7AB729BAD(Global_105101, false);
					unk_0x92DDCF53AA47A63D(Global_105101, Global_105114);
					unk_0x4299736016AECE26(Global_105101, Global_105108, 1, false, 0, 1);
		...
		case 8:
			if (func_155(iLocal_89, 500))
			{
				...
				if (unk_0x1095F403F52B42E1(Global_105101, 0))
				{
					unk_0xDDDEEC84F4F95674(Global_105101, true);
				}
				if (!func_77())
				{
...
void func_78()
{
	...
	switch (iLocal_803)
	{
		case 92:
			vVar0 = { func_80(229, 0) };
			fVar1 = unk_0x499324B3EF19C288(Global_105108, vVar0, true);
			if (fVar1 < 100f)
			{
				vVar0 = { func_79(Global_105108 - vVar0) };
				vVar0 = { (Global_105108 + (vVar0.x * IntToFloat((100 - round(fVar1))))), (Global_105108.f_1 + (vVar0.y * IntToFloat((100 - round(fVar1))))), Global_105108.f_2 };
				unk_0xB40E9D1C648558DD(vVar0, &Global_105108, &Global_105114, 1, 1077936128, 0);
				unk_0x4299736016AECE26(Global_105101, Global_105108, 1, false, 0, 1);
				unk_0x92DDCF53AA47A63D(Global_105101, Global_105114);
			}
			break;
...
float func_84(int iParam0)
{
	if (func_89(iParam0))
	{
		...
		{
			return (func_85(unk_0x05EFB6A616B6FADE(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_85(unk_0x05EFB6A616B6FADE(*iParam0, 4)) - fParam1);
...
int func_90(vector3 vParam0)
{
	...
	if (func_91(0, 4))
	{
		...
		while (iVar1 <= 72)
		{
			fVar2 = vdist2(func_80(iVar1, 0), vParam0);
			if (fVar2 <= 1225f)
			{
				iVar0++;
			}
...
void func_108(float fParam0)
{
	...
	while (!bVar1 && iVar2 < 10)
	{
		...
		{
			bVar1 = false;
			if (unk_0x5D260ECB08BF5B88(Global_105108, iVar2, &vVar3, 1, 3f, 0f))
			{
				iVar2++;
			}
		}
	}
	if (vdist2(vVar3, Global_105108) > 2f)
	{
		unk_0x1EB91C63EC75FAAD(vVar3, 0, &Global_105108, 0);
	}
}
...
int func_109(int iParam0, vector3 vParam1, float fParam2)
{
	...
	while (iVar1 < iVar0)
	{
		*iParam0 = unk_0xEB67B4270D12F60E(vParam1, fParam2, iVar0[iVar1], 67590);
		if (*iParam0 != 0)
		{
			return 1;
		}
...
void func_113()
{
	...
	fVar0 = func_116(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false), Global_105108);
	if (bLocal_64)
	{
	...
	func_114((to_float((iVar1 * 60 + iVar2)) / 60f));
}
...
void func_117()
{
	...
	fVar0 = (((func_116(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false), Global_105108) / 50f) * fLocal_73) * 2.4f);
...
void func_118()
{
	iLocal_103 = (iLocal_103 + round((unk_0xDE089748C4C76C96() * 1000f)));
	if (iLocal_103 > 5000)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
	}
	if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false), vLocal_820, false) > 50f)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
		vLocal_820 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false) };
	}
	iLocal_101 = ceil(fLocal_82);
	if (iLocal_101 != iLocal_102)
	{
		unk_0x31A9E530D137684F(iLocal_111, "SET_TAXI_PRICE");
		unk_0x380580A1A1667F69(iLocal_101);
		unk_0x271C1332F482646C();
		fLocal_83 = vdist(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false), Global_105108);
...
void func_119()
{
	...
	if (!func_37(14))
	{
		fVar1 = unk_0xE1CEAD76228928E4(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), Global_105108);
	...
	if (unk_0xCE3CB618AFE55EFB(*iParam0))
	{
		switch (iLocal_807)
		{
			...
			case 2:
				...
				{
					if (func_122(&Global_105101, unk_0xE2BBD32891C18569(Global_105101, false), vLocal_816, uParam1, fParam2, &iLocal_88, 1000))
					{
						iLocal_807 = 3;
						return 1;
					}
...
int func_122(var uParam0, vector3 vParam1, vector3 vParam2, var uParam3, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_124(vLocal_817, vLocal_818))
	{
		while (!bVar13 && *iParam5 < iVar18)
		{
			...
			if (unk_0xE23D832FD873880A(vParam2, *iParam5, uParam3, fParam4, &iVar6, iVar14, fVar0, fVar1))
			{
				iVar12 = unk_0xD48AF06A1B183940(*uParam3, 1, iVar14, 1077936128, 0);
				if (unk_0x462BCCFC27C23896(iVar12))
				{
					if (unk_0x7085BC35C02B7DAF(*uParam3, 1f, 1, &uVar4, &uVar3, &iVar8, &iVar7, &fVar10, iVar15))
					{
						...
						else if (unk_0xE8509487D07FBBAB(iVar12) || !unk_0x09586DC2AC6A64B7(iVar12))
						{
							fVar9 = 0f;
						}
						else
						{
							...
							if (unk_0xB5645494B7AC0437(*uParam3, &uVar21, &uVar20))
							{
								if (!uVar20 & 64 == 0)
								{
						...
						{
							*uParam3 = { unk_0x2F230B37E9FFF23F(*uParam3, *fParam4, fVar9, 0f, 0f) };
							if (unk_0x1095F403F52B42E1(*uParam0, 0))
							{
								iVar5 = *uParam0;
							}
							if (!unk_0xE0D7C57D5AAFC187(*uParam3, 3f, 3f, 3f, iVar5))
							{
			...
			*iParam5++;
			if (*iParam5 >= iVar19)
			{
				*uParam3 = { vParam2 };
				...
				{
					fVar11 = 1f;
					fVar11 = unk_0xB7EE3366E79BD58B((*uParam3 - 2f), (uParam3->f_1 - 2f), (*uParam3 + 2f), (uParam3->f_1 + 2f));
					if (fVar11 > 1f)
					{
						iLocal_67 = 1;
						uParam3->f_2 = fVar11;
...
{
	return vdist2(vParam1, func_137(iParam0)) < func_136(iParam0);
}
...
int func_141(int iParam0, vector3 vParam1)
{
	switch (iParam0)
	{
		case 76:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -1157.595f, -2726.636f, 12.94464f, -1110.794f, -2679.33f, 22.94466f, 26f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 70:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -1908.065f, 4432.693f, 51.3842f, -1962.212f, 4473.8f, 22.93989f, 70f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 71:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -541.8311f, 2050.599f, 186.3904f, -499.787f, 1968.325f, 228.0183f, 70f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 73:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -179.8588f, 4216.167f, 30.26505f, -246.32f, 4226.653f, 53.77886f, 70f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 74:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 1634.122f, 3858.049f, 28.33912f, 1573.259f, 3800.442f, 48.35476f, 70f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 75:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 2057.873f, 2059.198f, 63.88074f, 1999.045f, 2190.544f, 122.2642f, 110f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 72:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 3028.084f, 2768.167f, 57.72984f, 2944.284f, 2772.836f, 30.23068f, 85f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 106:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 2097.951f, 4820.308f, 55.48169f, 2151.254f, 4726.398f, 31.0732f, 120f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 125:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -763.5086f, -1297.98f, 2.000373f, -864.1372f, -1278.007f, 24.15038f, 85f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 126:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 1137.022f, 89.06853f, 74.89022f, 1267.821f, 292.0106f, 102.9904f, 195f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 127:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 2512.305f, 1519.462f, 28.55504f, 2380.374f, 1521.587f, 58.80984f, 90f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 128:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -193.5583f, 6533.439f, -1.902109f, -299.2512f, 6645.049f, 20.45973f, 120f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 131:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -1171.147f, 4647.89f, 203.7937f, -1280.149f, 4457.597f, 5.653551f, 120f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 132:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -687.974f, 4499.52f, 114.781f, -826.0081f, 4496.864f, 49.88359f, 140f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 134:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -1364.701f, 4490.626f, 49.52477f, -1367.169f, 4340.34f, -1.682158f, 100f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 135:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 2566.189f, 5007.007f, 97.36896f, 2491.714f, 4923.261f, 30.43494f, 80f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 136:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 1009.917f, -163.4684f, 102.1028f, 1113.474f, -221.3295f, 49.8745f, 90f, 0, true))
			{
				return 1;
			}
			break;
...
int func_143(int iParam0, vector3 vParam1)
{
	switch (iParam0)
	{
		...
		case 11:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 1882.79f, 4725.034f, 34.74373f, 1701.497f, 4677.47f, 47.89289f, 159.5f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 21:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -1903.322f, -401.2384f, 19.23456f, -1844.879f, -445.7261f, 73.56197f, 115f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 22:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 794.2453f, 1277.443f, -100f, 833.8215f, 1277.108f, 400f, 19f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 23:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -1015.526f, 6287.513f, -10.94449f, -761.3104f, 5895.014f, 45.33727f, 167.75f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 24:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -72.13491f, -1267.587f, 27.68361f, -72.18015f, -1256.712f, 31f, 30f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 33:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -21.12362f, 4518.907f, 119.7836f, 43.13283f, 4538.929f, 72.58955f, 48f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 39:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -1088.425f, 372.0723f, 62.75896f, -967.03f, 363.5976f, 101.3483f, 75f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 43:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -91.45676f, -1296.975f, 26.15437f, 40.67288f, -1297.459f, 58.29368f, 110f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 47:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -78.38029f, 285.5254f, 102.6286f, -51.1546f, 357.5217f, 122.0617f, 40f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 49:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 420.5196f, 116.2892f, 77.57532f, 212.2937f, 193.6794f, 131.8767f, 250f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 50:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 1140.158f, -540.9644f, 49.99944f, 972.3716f, -535.1002f, 85.64397f, 168.25f, 0, true))
			{
				return 1;
			}
			break;
...
int func_145(int iParam0, vector3 vParam1)
{
	switch (iParam0)
	{
		case 3:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -1535.754f, -922.101f, 4.122119f, -1487.87f, -961.3929f, 26.71922f, 50f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 8:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 53.12898f, -463.9999f, 36.9208f, 99.3761f, -329.3476f, 118.0454f, 125f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 38:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 1420.347f, -2036.558f, 47.36072f, 1341.11f, -2103.844f, 72.32651f, 55f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 48:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -2306.98f, 435.3038f, 171.4666f, -2303.291f, 366.3199f, 179.6018f, 65.5f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 45:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 1324.172f, 1110.748f, 99.65493f, 1523.097f, 1110.473f, 132.8859f, 170f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 60:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, -995.978f, -517.4324f, 11.37763f, -1060.725f, -547.5588f, 65.33043f, 35.75f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 86:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 682.6544f, -968.7439f, 19.97575f, 762.8684f, -964.4064f, 43.03712f, 53f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 87:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 148.8361f, -3029.146f, 4.277727f, 148.1396f, -3342.344f, 22.90379f, 97.75f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 78:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 446.8174f, -1691.708f, 23.28233f, 288.5565f, -1552.352f, 108.3117f, 155f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 79:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 910.9382f, -1749.91f, 14.50614f, 921.7415f, -1455.248f, 99.67125f, 210f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 83:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 2657.302f, 2974.529f, 34.53447f, 2591.657f, 2880.223f, 68.08156f, 78.75f, 0, true))
			{
				return 1;
			}
			break;
		...
		case 84:
			...
			if (unk_0x0C4DF083566CCC1C(vParam1, 83.32325f, -1312.172f, 23.33694f, 148.383f, -1273.553f, 49.46651f, 65f, 0, true))
			{
				return 1;
			}
			break;
	...
	while (iVar4 < 63)
	{
		*iParam1 = iVar4;
		if (unk_0x05EFB6A616B6FADE(Global_106070.f_18546[*iParam1 /*6*/], 0) && !unk_0x05EFB6A616B6FADE(Global_106070.f_18546[*iParam1 /*6*/], 3))
		{
			...
			if (unk_0x05EFB6A616B6FADE(Var5.f_26, func_150()))
			{
				vVar3 = { Var5.f_6 };
				if (uParam0->f_2 == 1f)
				{
...
int func_151(var uParam0, int iParam1, float fParam2)
{
	...
	while (iVar4 < 8)
	{
		if (Global_90260[iVar4 /*17*/])
		{
			...
			{
				if (unk_0xCE3CB618AFE55EFB(Global_25834[Global_90260[iVar4 /*17*/].f_9 /*23*/].f_19))
				{
					vVar3 = { unk_0x1C8DAFF0573242F7(Global_25834[Global_90260[iVar4 /*17*/].f_9 /*23*/].f_19) };
					if (uParam0->f_2 == 1f)
					{
						vVar3.z = 1f;
					}
...
void func_163()
{
	...
	if (!unk_0x4915F4759304D5CF(Global_105102) && unk_0x1095F403F52B42E1(Global_105101, 0))
	{
		if (unk_0xB10F7FE89663CB5B(Global_105102, Global_105101))
		{
			...
			{
				vVar0 = { unk_0xE2BBD32891C18569(Global_105101, true) };
				fVar1 = unk_0x552C823E1D2A019C(Global_105101);
				unk_0xACD687595DC10DD1(Global_105102, Global_105101, vVar0, fVar1, 3, 60f, 0);
			}
		}
	}
}
		...
		if (bLocal_61)
		{
			...
			if (unk_0x1095F403F52B42E1(Global_105101, 0))
			{
				if (!unk_0x4915F4759304D5CF(Global_105102))
				{
					...
					else if (unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_enter", 3) || unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_idle", 3))
					{
						if (unk_0x85875A8777624591(Global_105102, unk_0xA19140A5C42D8715()))
						{
							unk_0x53FF9BDD8529ACD2(Global_105102);
						}
						unk_0x3F01127ECD227890(Global_105102, &cLocal_811, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_exit", 3))
					{
						unk_0x39AA033597761444(Global_105102, &cLocal_811, "leanover_exit", 1.2f);
					...
					else if (!func_2(Global_105102, 242628503))
					{
						...
						else
						{
							...
							unk_0x2F89329397A277BC(&iLocal_800);
							unk_0x990EEDE7014A4F2F(0, Global_105101, Global_105108, fVar1, iVar0, 45f);
							unk_0xACD687595DC10DD1(0, Global_105101, Global_105108, Global_105114, iLocal_110, 60f, 1);
							unk_0x301F42EEE3C40328(iLocal_800);
							unk_0xE1072FA2FECBAD96(Global_105102, iLocal_800);
							unk_0x3A95A0A3221D4208(&iLocal_800);
						}
					}
				}
			}
...
int func_166()
{
	if ((unk_0xA60C975CBAB69F34(Global_105101, Global_105108, 45f, 45f, 20f, false, true, 0) || iLocal_56) || iLocal_808 == 4)
	{
		iLocal_56 = 1;
...
int func_169()
{
	if (!unk_0x4915F4759304D5CF(Global_105102) && unk_0x1095F403F52B42E1(Global_105101, 0))
	{
		if (unk_0xB10F7FE89663CB5B(Global_105102, Global_105101))
		{
			unk_0x6D68030C791111E0(&cLocal_811);
			if (unk_0x39C2D9AB77873F84(&cLocal_811))
			{
				if (unk_0x85875A8777624591(Global_105102, unk_0xA19140A5C42D8715()))
				{
					unk_0x53FF9BDD8529ACD2(Global_105102);
				...
				unk_0x2F89329397A277BC(&iLocal_800);
				unk_0x3F01127ECD227890(0, &cLocal_811, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
				unk_0x3F01127ECD227890(0, &cLocal_811, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
				unk_0x301F42EEE3C40328(iLocal_800);
				unk_0xE1072FA2FECBAD96(Global_105102, iLocal_800);
				unk_0x3A95A0A3221D4208(&iLocal_800);
				return 1;
...
int func_170()
{
	...
	if (unk_0xDC5D81351D6A4DDB(Global_105101))
	{
		if (unk_0x1095F403F52B42E1(Global_105101, 0))
		{
			iLocal_109 = unk_0xFCFC8CC5FF74580D(iLocal_108, unk_0xE2BBD32891C18569(Global_105101, true), true, true, false);
			unk_0x96B71B23D409A3DB(iLocal_109, Global_105101, unk_0x4F9AEAB2CC029A5C(Global_105101, "Chassis"), vLocal_824, vLocal_825, 0, 0, 0, 0, 2, 1);
			unk_0xFCA65EA68014C3B7(Global_105101, 0);
			if (!unk_0xA41DC7627220D3D5("taxi"))
			{
				unk_0xA998025A612085C5("taxi", 0);
				unk_0xDD449E57001A6C13(unk_0x8F474E419F56E48D(iLocal_109));
			}
			iLocal_93 = unk_0x88A337F7A8A721B3("taxi");
		}
	}
	return 0;
}
...
int func_171()
{
	unk_0xCACEBBBEAD8F262E(iLocal_108);
	iLocal_111 = unk_0xB00CD6895BDB01A0("taxi_display");
	iLocal_112 = unk_0xB00CD6895BDB01A0("instructional_buttons");
	unk_0x6D68030C791111E0(&cLocal_811);
	if (((unk_0x7FC99CCC73354033(iLocal_108) && unk_0x0FA486DE15EB3004(iLocal_111)) && unk_0x0FA486DE15EB3004(iLocal_112)) && unk_0x39C2D9AB77873F84(&cLocal_811))
	{
		return 1;
	}
	return 0;
...
void func_172()
{
	...
	if (!unk_0x37B568B777BC65F9(iLocal_68))
	{
		...
		{
			iLocal_68 = unk_0x57FC10C74CC15F22("DEFAULT_SCRIPTED_CAMERA", false);
			unk_0xABE3EC0FA16227B5(iLocal_68, Global_105101, vLocal_822, 1);
			func_176();
			unk_0x1456805A8A37DDD6(iLocal_68, 1);
		}
	}
	else if (!bLocal_60 || bLocal_59)
	{
		if (!func_180() && !func_179(8, -1))
		{
			if (!unk_0xC3553172354FFB69(iLocal_68))
			{
				...
				unk_0x1456805A8A37DDD6(iLocal_68, 1);
				func_174();
				unk_0x930701157A4B9374(iLocal_68, true);
	...
	else if (unk_0xC3553172354FFB69(iLocal_68))
	{
		unk_0x930701157A4B9374(iLocal_68, false);
		unk_0xD87B76260C547F31(0f);
		unk_0xAA32DD4848CF93E0(0f, 1065353216);
...
void func_173()
{
	...
	unk_0x31A9E530D137684F(iLocal_111, "HIGHLIGHT_DESTINATION");
	unk_0x380580A1A1667F69(iLocal_92);
	unk_0x271C1332F482646C();
}
...
void func_174()
{
	...
	if (unk_0xCE3CB618AFE55EFB(vLocal_43.x))
	{
		vVar0 = { unk_0x1C8DAFF0573242F7(vLocal_43.x) };
		if (unk_0x37B568B777BC65F9(iLocal_68) && unk_0xC3553172354FFB69(iLocal_68))
		{
			unk_0x274643B565204371(vVar0.x, vVar0.y);
...
void func_176()
{
	if (unk_0x37B568B777BC65F9(iLocal_68))
	{
		...
		unk_0xF62A5A3CB8DB2402(iLocal_68, fLocal_74);
		unk_0x6F05C2B0A1DB4CAA(iLocal_68, 0.01f);
		unk_0xAC817343D0096E37(iLocal_68, 1);
...
void func_177(int iParam0, int iParam1, vector3 vParam2)
{
	...
	if (!unk_0x7112137033807390(iParam0, 0))
	{
		if (unk_0x37B568B777BC65F9(*iParam1))
		{
			...
			fVar3 = vVar0.y;
			vVar4 = { func_79(unk_0x3201284584C7CD83(Global_105101, vParam2) - unk_0x3201284584C7CD83(Global_105101, vLocal_822)) };
			func_178(vVar4, &fVar1, &fVar2, 1);
			unk_0xC831502E35848BE4(*iParam1, fVar1, fVar3, fVar2, 2);
		}
	}
}
...
void func_181()
{
	...
	iVar0 = 0;
	func_187();
	unk_0x31A9E530D137684F(iLocal_111, "CLEAR_TAXI_DISPLAY");
	unk_0x271C1332F482646C();
	iVar0 = 0;
	while (iVar0 < iLocal_91)
	{
		if (!unk_0xCE3CB618AFE55EFB(vLocal_806[iVar0 /*3*/]))
		{
		}
		else if (func_186(vLocal_806[iVar0 /*3*/]) == -1)
		{
		}
		else if (func_126(unk_0x1C8DAFF0573242F7(vLocal_806[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0))
		{
		}
		else
		{
			unk_0x31A9E530D137684F(iLocal_111, "ADD_TAXI_DESTINATION");
			unk_0x380580A1A1667F69(iVar0);
			unk_0x380580A1A1667F69(unk_0x2A3262E0744CC26E(vLocal_806[iVar0 /*3*/]));
			unk_0x1C828C4226A9FADF(unk_0xF4EBF186645FC104(vLocal_806[iVar0 /*3*/]), &iVar1, &iVar2, &iVar3, &uVar4);
			...
			if (iVar6 == -1)
			{
				...
				unk_0x3290014981450EEA(vLocal_806[iVar0 /*3*/]);
				unk_0xD481829E3E36543B();
			}
			else
			{
				unk_0x390B339C943A8A54("STRING");
				unk_0x4FDA9E6EF359F8A9(func_182(iVar6));
				unk_0xD481829E3E36543B();
			}
			if (unk_0x7E568B4236F45F53(vLocal_806[iVar0 /*3*/]) == 2)
			{
				if (!unk_0x4915F4759304D5CF(unk_0xA2EA4BA455370F3C(unk_0x3E6A9ABACA8E5C3B(vLocal_806[iVar0 /*3*/]))))
				{
					vVar5 = { unk_0xE2BBD32891C18569(unk_0xA2EA4BA455370F3C(unk_0x3E6A9ABACA8E5C3B(vLocal_806[iVar0 /*3*/])), true) };
				}
			}
			else if (unk_0x7E568B4236F45F53(vLocal_806[iVar0 /*3*/]) == 1)
			{
				if (unk_0x1095F403F52B42E1(unk_0x3E6A9ABACA8E5C3B(vLocal_806[iVar0 /*3*/]), 0))
				{
					vVar5 = { unk_0xE2BBD32891C18569(unk_0x3E6A9ABACA8E5C3B(vLocal_806[iVar0 /*3*/]), true) };
				}
			}
			else
			{
				vVar5 = { unk_0x1C8DAFF0573242F7(vLocal_806[iVar0 /*3*/]) };
			}
			func_65(unk_0x86701529BD460750(vVar5));
			if (vLocal_806[iVar0 /*3*/].f_2 == 0)
			{
				if (vLocal_806[iVar0 /*3*/].f_1 != 0)
				{
					unk_0x390B339C943A8A54("STRTNM1");
					unk_0xBFE4763B290E86E9(vLocal_806[iVar0 /*3*/].f_1);
					unk_0xD481829E3E36543B();
				}
			}
			else
			{
				...
				unk_0xBFE4763B290E86E9(vLocal_806[iVar0 /*3*/].f_1);
				unk_0xBFE4763B290E86E9(vLocal_806[iVar0 /*3*/].f_2);
				unk_0xD481829E3E36543B();
			}
			unk_0x271C1332F482646C();
			if (bLocal_60)
	...
	if (bLocal_60)
	{
		unk_0x31A9E530D137684F(iLocal_111, "SHOW_TAXI_DESTINATION");
		unk_0x271C1332F482646C();
		unk_0x31A9E530D137684F(iLocal_111, "HIGHLIGHT_DESTINATION");
		unk_0x380580A1A1667F69(iLocal_92);
		unk_0x271C1332F482646C();
...
int func_186(int iParam0)
{
	...
	if (unk_0xCE3CB618AFE55EFB(iParam0))
	{
		iVar0 = unk_0x2A3262E0744CC26E(iParam0);
	}
	return iVar0;
}
...
void func_187()
{
	...
	func_191(117, 1);
	iLocal_94 = func_188();
	iLocal_95 = unk_0xD56096C1FAFB1971();
...
int func_188()
{
	...
	iVar0 = 0;
	iVar1 = unk_0x5DA399C64755FB10(iLocal_44);
	while (unk_0xCE3CB618AFE55EFB(iVar1))
	{
		...
		iVar1 = unk_0x9FDB378E1AE6ADB4(iLocal_44);
	}
	iVar1 = unk_0x5DA399C64755FB10(iLocal_45);
	while (unk_0xCE3CB618AFE55EFB(iVar1))
	{
		if (func_190(iVar1))
		{
		...
		iVar1 = unk_0x9FDB378E1AE6ADB4(iLocal_45);
	}
	return iVar0;
}
...
void func_191(int iParam0, bool bParam1)
{
	...
	iVar2 = unk_0x5DA399C64755FB10(iParam0);
	iVar3 = 20;
	while (unk_0xCE3CB618AFE55EFB(iVar2))
	{
		if (iLocal_98 >= iVar3)
		{
			wait(0);
				...
				if (func_203(iVar2))
				{
					if (!func_201(&iVar2))
					{
						...
						if (bVar1)
						{
							...
							if (func_190(iVar2))
							{
								iVar4 = unk_0x7E568B4236F45F53(iVar2);
		...
		iLocal_98++;
		iVar2 = unk_0x9FDB378E1AE6ADB4(iParam0);
	}
}
...
void func_193(vector3 vParam0, int iParam1)
{
	...
	if (func_186(vLocal_806[iParam1 /*3*/]) == unk_0x09990A2B9C8684F0())
	{
		iLocal_97 = iParam1;
		vLocal_821 = { unk_0x1C8DAFF0573242F7(vLocal_806[iParam1 /*3*/]) };
	}
}
...
float func_197(int iParam0)
{
	...
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (unk_0xCE3CB618AFE55EFB(iParam0))
		{
			vVar0 = { func_45(iParam0) - unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
		}
	}
	return vmag(vVar0);
}
...
void func_198(int iParam0, var uParam1)
{
	...
	*uParam1 = *iParam0;
	if (!*uParam1 == Global_105106)
	{
		...
		unk_0x962E14F78102F9C7(vVar0, &(uParam1->f_1), &(uParam1->f_2));
	}
	else
	{
...
int func_199(int iParam0)
{
	...
	if (unk_0xCE3CB618AFE55EFB(*iParam0))
	{
		iVar0 = unk_0xF4EBF186645FC104(*iParam0);
...
int func_201(int iParam0)
{
	...
	if (unk_0xECFB9F03690741B8(*iParam0) == 39)
	{
		return 1;
	}
	if (func_202(unk_0x1C8DAFF0573242F7(*iParam0), 0f, 0f, 0f, 0))
	{
		return 1;
	}
...
bool func_205()
{
	...
	bVar0 = false;
	if (!unk_0xCE3CB618AFE55EFB(vLocal_806[iLocal_92 /*3*/]))
	{
	...
	if (timerb() > 250)
	{
		if (!bVar0)
		{
			if (iLocal_95 != unk_0xD56096C1FAFB1971())
			{
				bVar0 = true;
			}
			iLocal_95 = unk_0xD56096C1FAFB1971();
		...
		if (!bVar0)
		{
			if (iLocal_97 != -1)
			{
				if (unk_0xCE3CB618AFE55EFB(vLocal_806[iLocal_97 /*3*/]))
				{
					if (func_186(vLocal_806[iLocal_97 /*3*/]) == unk_0x09990A2B9C8684F0())
					{
						vVar1 = { unk_0x1C8DAFF0573242F7(vLocal_806[iLocal_97 /*3*/]) };
				...
				{
					iVar2 = unk_0x5DA399C64755FB10(unk_0x09990A2B9C8684F0());
					if (unk_0xCE3CB618AFE55EFB(iVar2))
					{
						vVar1 = { unk_0x1C8DAFF0573242F7(iVar2) };
						if (!func_126(vVar1, vLocal_821, 1056964608, 0))
						{
							bVar0 = true;
						}
...
void func_207()
{
	if (iLocal_808 != 0)
	{
		unk_0x7AF4A31FB51D0A4D(iLocal_93);
		unk_0x0A74F1E9CF777638(4);
		unk_0xF997724AC8A71261(1);
		if (unk_0x1095F403F52B42E1(Global_105101, 0))
		{
			unk_0x84829313FB8AC81C(iLocal_111, fLocal_86, fLocal_87, fLocal_84, fLocal_85, 0, 0, 0, 255, 0);
		}
	}
}
			...
			if (iLocal_808 == 2)
			{
				...
				if (!bLocal_64)
				{
					if (unk_0xDF0ADAD7E584090D(2, 179))
					{
						...
						if (!unk_0x4915F4759304D5CF(Global_105102))
						{
							if (!unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_enter", 3))
							{
								if (!unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_idle", 3))
								{
									if (!unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_exit", 3))
									{
										unk_0x9568B1B58F78FF36(Global_105102);
									}
								}
...
void func_210()
{
	...
	unk_0x31A9E530D137684F(iLocal_111, "SET_INPUT_EVENT");
	...
	if (unk_0xCE3CB618AFE55EFB(vLocal_806[iLocal_92 /*3*/]))
	{
		vVar0 = { unk_0x1C8DAFF0573242F7(vLocal_806[iLocal_92 /*3*/]) };
		if (!func_211(vVar0))
		{
			unk_0x274643B565204371(vVar0.x, vVar0.y);
		}
...
int func_221()
{
	...
	if (unk_0x37B568B777BC65F9(iLocal_68))
	{
		...
		unk_0x930701157A4B9374(iLocal_68, false);
		unk_0x77F0486CE0E598D5(iLocal_68, 0);
		unk_0x8E88E73F74A9FF79(false, false, 3000, 1, 0, 0);
		unk_0x7DB63355DA38F64E();
		unk_0x32EC0D046A39CAA9();
		unk_0x8AD2A838D0635CFC(0);
...
{
	if (unk_0xD3C4AB5E628133C1(iParam0, joaat("taxi")))
	{
		return 1;
	}
	return 0;
...
int func_223(int iParam0)
{
	...
	if (func_56(unk_0xA19140A5C42D8715()) != iLocal_71)
	{
		return 1;
	}
	if (!unk_0xDC5D81351D6A4DDB(Global_105101))
...
int func_225()
{
	...
	if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		...
		if (func_229(&iVar0, func_231(), func_230()))
		{
			...
			{
				vLocal_819 = { unk_0xE2BBD32891C18569(Global_105101, true) - unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
				vLocal_819.z = 0f;
				fLocal_72 = vmag(vLocal_819);
				iLocal_71 = func_56(unk_0xA19140A5C42D8715());
				func_226();
				iLocal_96 = func_206();
				iLocal_58 = 1;
				unk_0xD481A812073CCF02(0, 75, 1);
...
void func_232(bool bParam0)
{
	...
	unk_0x86795B44CE5FE021(&iLocal_111);
	unk_0x86795B44CE5FE021(&iLocal_112);
	if (func_233(Global_105102))
	{
		if (unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_enter", 3))
		{
			unk_0x9D03A5503D1FF614(Global_105102, "leanover_enter", &cLocal_811, -2f);
		}
		else if (unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_idle", 3))
		{
			unk_0x9D03A5503D1FF614(Global_105102, "leanover_idle", &cLocal_811, -2f);
		}
		else if (unk_0x411C28019DEA5CEF(Global_105102, &cLocal_811, "leanover_exit", 3))
		{
			unk_0x9D03A5503D1FF614(Global_105102, "leanover_exit", &cLocal_811, -2f);
		}
		if (unk_0x85875A8777624591(Global_105102, unk_0xA19140A5C42D8715()))
		{
			unk_0x53FF9BDD8529ACD2(Global_105102);
	...
	unk_0x4DC885EA8D6AF7FC(&cLocal_811);
	if (iLocal_808 == 4)
	{
		if (iLocal_810 != 10)
		{
