...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 0), 1973.324f, 3815.594f, 31.42936f) < (fVar1 * fVar1))
		{
...
int func_76(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_92(iVar0))
		{
			...
			{
				fVar1 = unk_0x499324B3EF19C288(vParam0, func_77(iVar0, 0), 1);
