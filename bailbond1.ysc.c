...
void __EntryFunction__()
{
	...
	else if (func_422(0))
	{
		...
		{
			func_420(unk_0xA19140A5C42D8715(), vLocal_334, fLocal_115, 0, 0);
	...
	while (true)
	{
		if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
		{
			...
			vLocal_329 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1) };
			func_409();
			func_408();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(unk_0xA19140A5C42D8715(), vLocal_335, fLocal_116, 0, 1);
						if (func_23(Local_68.f_9))
						{
							func_19(unk_0xA19140A5C42D8715(), unk_0xE2BBD32891C18569(Local_68.f_9, 1));
						}
						unk_0xD87B76260C547F31(0f);
						unk_0xAA32DD4848CF93E0(0f, 1065353216);
						if (iLocal_103 == 0)
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(unk_0xA19140A5C42D8715(), vLocal_336, fLocal_117, 0, 1);
						unk_0xD87B76260C547F31(0f);
						unk_0xAA32DD4848CF93E0(0f, 1065353216);
						if (iLocal_103 == 0)
						{
			...
			case 2:
				...
				if (iLocal_67 == 3)
				{
					if (iLocal_60 == 0)
					{
						...
						{
							if (!unk_0xE0FD180CD24C0B67(Local_68.f_9, Local_71[0 /*6*/], 0))
							{
								unk_0x692D5500D82E4F5D(Local_68.f_9, Local_71[0 /*6*/], -1);
							}
						}
					}
				}
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					...
					if (!func_71())
					{
						func_420(unk_0xA19140A5C42D8715(), vLocal_328, 254.9762f, 0, 0);
						unk_0xD87B76260C547F31(0f);
						unk_0xAA32DD4848CF93E0(0f, 1065353216);
						if (iLocal_103 == 0)
						{
...
int func_37()
{
	if (func_59(vLocal_329, Local_75.f_1, 210f))
	{
		...
		if (!unk_0xDC5D81351D6A4DDB(Local_79))
		{
			...
			{
				if (unk_0x37A8EF89184DBA23(Local_79.f_1, 10f, func_48(), 0))
				{
					Local_79 = unk_0x78CED56884DEF3D7(Local_79.f_1, 10f, func_48(), 1, 0, 1);
					if (func_421(Local_79))
					{
						unk_0x4299736016AECE26(Local_79, func_47(), 1, 0, 0, 1);
						unk_0x92DDCF53AA47A63D(Local_79, func_46());
		...
		if (!unk_0xDC5D81351D6A4DDB(Local_80))
		{
			...
			{
				if (unk_0x37A8EF89184DBA23(Local_80.f_1, 10f, func_45(), 0))
				{
					Local_80 = unk_0x78CED56884DEF3D7(Local_80.f_1, 10f, func_45(), 1, 0, 1);
				}
			}
		}
	}
...
void func_49()
{
	...
	if (func_23(Local_75))
	{
		if (func_421(Local_77))
		{
			if (func_58(3))
			{
				iVar0 = unk_0x70788DC3D80C9DEB(func_53(), func_52(), 2);
				unk_0xDA16255FBFC16B28(iVar0, 1);
				unk_0x52CEAE2B7DAC257E(iVar0, 0);
				unk_0xE5565DEAABF9D588(Local_75, iVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				unk_0x341C49A9159E80FB(Local_77, iVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1148846080);
...
int func_58(int iParam0)
{
	switch (iParam0)
	{
		...
		case 2:
			unk_0xCACEBBBEAD8F262E(Local_72.f_5);
			if (unk_0x7FC99CCC73354033(Local_72.f_5))
			{
				return 1;
			}
			break;
...
int func_60(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		...
		{
			if (!func_65(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_67()
{
	if (func_421(Local_68.f_9))
	{
		...
		{
			unk_0x034CA621E59C939F(sLocal_151, Local_68.f_9, 0);
		}
	}
	if (func_421(Local_75))
	{
		if (unk_0x2686487E572FE93A())
		{
			unk_0x034CA621E59C939F(sLocal_150, Local_75, 0);
		}
	}
}
				...
				if (iLocal_62 == 4)
				{
					...
					else if (func_23(Local_75))
					{
						if (!func_64(Local_75, 1805844857))
						{
							...
							{
								if (!unk_0x411C28019DEA5CEF(Local_75, func_102(), func_74(), 3))
								{
									func_73(&Local_75);
	...
	if (iLocal_130 > 0)
	{
		...
		while (iVar0 <= (iLocal_130 - 1))
		{
			if (iLocal_67 == 4)
			{
				...
				{
					unk_0xDFA901280292A2FB(Local_70[iVar0 /*19*/], -2065892691);
					unk_0x1F4E5EFBFE503FB3(Local_70[iVar0 /*19*/], 0);
					if (Global_104779 == 0)
					{
						unk_0xD738221C247C8B71(Local_70[iVar0 /*19*/], 0);
					}
					else
					{
						unk_0xD738221C247C8B71(Local_70[iVar0 /*19*/], 1);
					}
				}
			}
...
void func_114(int iParam0)
{
	...
	{
		unk_0x3F29BBC16DCB8A23(Local_70[iParam0 /*19*/]);
		unk_0x9568B1B58F78FF36(Local_70[iParam0 /*19*/]);
		unk_0x53FF9BDD8529ACD2(Local_70[iParam0 /*19*/]);
		if (func_115(1, 0, 1))
		{
		...
		else if (unk_0x35546CE87C5336BC(Local_70[iParam0 /*19*/]) == iLocal_319)
		{
			unk_0x3677CB0D846A1308(Local_70[iParam0 /*19*/], 30f);
			unk_0xF26F4E13A8AEC5EB(Local_70[iParam0 /*19*/], 30f);
			unk_0x326A31228591B95C(Local_70[iParam0 /*19*/], 30f);
			unk_0xF63074D1E750B871(Local_70[iParam0 /*19*/], 0);
			unk_0x3B7A32E04BBE59A5(Local_70[iParam0 /*19*/], 1, 0);
			unk_0x3B7A32E04BBE59A5(Local_70[iParam0 /*19*/], 3, 1);
			unk_0x3B7A32E04BBE59A5(Local_70[iParam0 /*19*/], 5, 1);
			unk_0x3B7A32E04BBE59A5(Local_70[iParam0 /*19*/], 0, 0);
			unk_0xC2C4AE9DB4A0BEF3(Local_70[iParam0 /*19*/], 512, true);
			unk_0x22DD1D053CFF9707(Local_70[iParam0 /*19*/], unk_0xA19140A5C42D8715(), -1, 0, 2);
			unk_0x0177431263151C4E(Local_70[iParam0 /*19*/], unk_0xA19140A5C42D8715(), -1);
			unk_0x1F4E5EFBFE503FB3(Local_70[iParam0 /*19*/], 1);
			Local_70[iParam0 /*19*/].f_14 = 2;
		}
		else
		{
			unk_0x3B7A32E04BBE59A5(Local_70[iParam0 /*19*/], 5, 0);
			unk_0x22DD1D053CFF9707(Local_70[iParam0 /*19*/], unk_0xA19140A5C42D8715(), -1, 0, 2);
			unk_0x0177431263151C4E(Local_70[iParam0 /*19*/], unk_0xA19140A5C42D8715(), -1);
			unk_0x1F4E5EFBFE503FB3(Local_70[iParam0 /*19*/], 0);
			Local_70[iParam0 /*19*/].f_14 = 4;
		}
	}
}
...
void func_118()
{
	...
	{
		func_121(13, floor(Global_106070.f_10166.f_3853));
	}
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (func_37())
			{
				...
				{
					unk_0xE216F8B2802ABABF(unk_0xA19140A5C42D8715(), sLocal_149, 0, 0, 0);
					if (func_421(Local_75))
					{
						unk_0xE216F8B2802ABABF(Local_75, sLocal_150, 0, 0, 0);
					}
					if (func_421(Local_68.f_9))
					{
						unk_0xE216F8B2802ABABF(Local_68.f_9, sLocal_151, 0, 0, 0);
					}
					if (func_421(Local_77))
					{
						unk_0xE216F8B2802ABABF(Local_77, sLocal_152, 0, 0, 0);
					}
					if (func_421(Local_78))
					{
						unk_0xE216F8B2802ABABF(Local_78, sLocal_153, 0, 0, 0);
					}
		...
		case 1:
			if (func_421(Local_77))
			{
				if (func_23(Local_75))
				{
					if (unk_0x0FFE9FEDC2E0AC88(sLocal_150, 0) && unk_0x0FFE9FEDC2E0AC88(sLocal_152, 0))
					{
						func_49();
					}
				}
			}
			if (unk_0x0FFE9FEDC2E0AC88(sLocal_149, 0))
			{
	...
	if (unk_0xDC5D81351D6A4DDB(Global_96664.f_4))
	{
		if (unk_0x1095F403F52B42E1(Global_96664.f_4, 0))
		{
			if (func_178(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_175(unk_0xE2BBD32891C18569(Global_96664.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	return (shift_right(iParam0, 26) & 31 * func_153(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_203(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_203(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_215(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_215(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_215(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_215(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_252(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x3B61940560400F58(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_246(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x4BE6499482BEE1D8(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_246(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x4BE6499482BEE1D8(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x6182A22F4D99005E(iVar1, 6, -1, 0, -1, func_203(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_309()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		{
			case 0:
				unk_0x80E7C4A78224C8F9(5, 1862763509, iLocal_319);
				unk_0x80E7C4A78224C8F9(5, iLocal_319, 1862763509);
				iLocal_136 = unk_0x24A1A7BF4ED94B71(Local_68.f_9);
				vLocal_337 = { unk_0xE2BBD32891C18569(Local_68.f_9, 0) };
				...
				if (!iLocal_107)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_120, unk_0x22C775856F4633CA(5000, 12000)))
								{
									if (func_105(Local_68.f_9, vLocal_329, 30f))
									{
			...
			case 2:
				...
				iLocal_82 = 1;
				func_320();
				unk_0xAB8B90F57910509D(5, 1862763509, iLocal_319);
				unk_0xAB8B90F57910509D(5, iLocal_319, 1862763509);
				func_110(&(Local_68.f_8));
				iLocal_82 = 1;
				Local_68.f_17 = unk_0xFD34717937104F1C();
				func_318(&uLocal_44, 0, 0);
...
int func_333(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_341() || func_340(Global_4456448.f_152990)) || func_339())
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			...
			if (((unk_0x39CF954DC56E2A1F(iVar0, iVar1) || (unk_0x8F474E419F56E48D(iVar0) == 562680400 && iVar1 != -1)) || (unk_0x8F474E419F56E48D(iVar0) == 1181327175 && iVar1 != -1)) || (((unk_0x8F474E419F56E48D(iVar0) == -1693015116 && iVar1 == 0) && func_337(iVar0, 10)) && unk_0x22D95AF01E737CA1(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
{
	unk_0xDFA901280292A2FB(iParam0, iLocal_319);
		...
		if (!unk_0x51421B7F2A039FED(unk_0xA19140A5C42D8715()))
		{
			switch (Local_68.f_10)
			{
				case 0:
					if (func_105(Local_68.f_9, vLocal_329, 30f))
					{
						if (unk_0x411C28019DEA5CEF(Local_68.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 3))
						{
							unk_0x9D03A5503D1FF614(Local_68.f_9, "prem_producer_argue_a", "ODDJOBS@BAILBOND_QUARRY", -2f);
						}
						Local_68.f_10 = 1;
					}
					break;
				...
				case 1:
					...
					{
						func_38(&Local_72, 1);
						if (!unk_0x0D14162FE6E23CF2(Local_68.f_9))
						{
							unk_0x0EEB301CAA50A123(Local_68.f_9, "WORLD_HUMAN_SMOKING", 0, 1);
				...
				case 30:
					if (!func_64(Local_68.f_9, 242628503))
					{
						...
						unk_0x2F89329397A277BC(&uLocal_142);
						unk_0x59FFABF16840EEA1(0, unk_0xA19140A5C42D8715(), fVar3, 30f);
						unk_0x9C24BCD3EFB3BF4C(0, unk_0xA19140A5C42D8715(), 2000, 0);
						unk_0x301F42EEE3C40328(uLocal_142);
						unk_0xE1072FA2FECBAD96(Local_68.f_9, uLocal_142);
						unk_0x3A95A0A3221D4208(&uLocal_142);
						unk_0x1F4E5EFBFE503FB3(Local_68.f_9, 1);
					}
					break;
				...
				case 13:
					if (func_113(Local_68.f_18, unk_0x22C775856F4633CA(0, 500)))
					{
						if (unk_0xB112D23B8518DD40(Local_68.f_9))
						{
							unk_0x25669F63E9DAC7F9(Local_68.f_9, vLocal_329);
						}
						unk_0xF990CFC0F1D94A39(Local_68.f_9, &iVar0, 1);
						if (iVar0 != joaat("weapon_unarmed"))
						{
				...
				case 14:
					if (!func_64(Local_68.f_9, 1805844857) && !unk_0x8B9D3A1A7C2D3C6B(Local_68.f_9))
					{
						Local_68.f_18 = (unk_0xFD34717937104F1C() - 5000);
						Local_68.f_10 = 13;
					}
				...
				case 15:
					...
					{
						if (((!unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), Local_71[0 /*6*/], 0) && func_105(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) && func_364(unk_0x552C823E1D2A019C(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)) && !func_363(Local_71[0 /*6*/], 2))
						{
							...
							else if (func_113(Local_68.f_18, unk_0x22C775856F4633CA(250, 350)))
							{
								...
								if (unk_0x411C28019DEA5CEF(Local_68.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 3))
								{
									unk_0x9D03A5503D1FF614(Local_68.f_9, "prem_producer_argue_a", "ODDJOBS@BAILBOND_QUARRY", -4f);
								}
								else if (unk_0xB112D23B8518DD40(Local_68.f_9))
								{
									unk_0x25669F63E9DAC7F9(Local_68.f_9, vLocal_329);
								}
								else
								...
								unk_0xA2EBCD9385E56019(Local_68.f_9, Local_71[0 /*6*/], 25000, -1, 3f, 8388608, 0);
								unk_0x1F4E5EFBFE503FB3(Local_68.f_9, 1);
								Local_68.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if ((((unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), Local_71[0 /*6*/], 1) || unk_0x97B2B0016AD3C7C6(Local_68.f_9)) || !func_105(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) || !func_364(unk_0x552C823E1D2A019C(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)) || func_363(Local_71[0 /*6*/], 2))
					{
						Local_68.f_18 = (unk_0xFD34717937104F1C() - 5000);
						Local_68.f_10 = 13;
					}
				...
				case 17:
					if (func_7(Local_71[0 /*6*/]) && unk_0xB10F7FE89663CB5B(Local_68.f_9, Local_71[0 /*6*/]))
					{
				...
				case 21:
					...
					else if (unk_0xE434641F79309B6F(func_360()))
					{
						...
						if (!unk_0x097A982B0640FA32(Local_68.f_9, func_360()))
						{
							unk_0x9854E4DB9C72017F(Local_68.f_9, func_360());
						}
				...
				case 23:
					if (func_362(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_361())
					{
						...
						if (((!unk_0x685AE6AF34B35D3B(Local_68.f_9) && !unk_0x97722E4EBB9BA577(Local_68.f_9, 0)) && !unk_0x97B2B0016AD3C7C6(Local_68.f_9)) && !func_64(Local_68.f_9, -828834893))
						{
							unk_0x22DD1D053CFF9707(Local_68.f_9, unk_0xA19140A5C42D8715(), -1, 0, 2);
							if ((!func_358(Local_68.f_19, 10) && func_105(Local_68.f_9, vLocal_329, 50f)) || !func_113(iLocal_139, 2000))
							{
								...
								else if (((!unk_0x852B8F739A2072BE(unk_0xA19140A5C42D8715(), 6) && !unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), Local_68.f_9)) && !func_361()) || unk_0x4374EED90C523366(Local_68.f_9))
								{
									unk_0x0177431263151C4E(Local_68.f_9, unk_0xA19140A5C42D8715(), -1);
								}
				...
				case 24:
					if (func_362(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_361())
					{
						if (!func_64(Local_68.f_9, -1519143300))
						{
							...
							{
								if ((unk_0x852B8F739A2072BE(unk_0xA19140A5C42D8715(), 6) || unk_0x7591AFB11E7EDDA0(unk_0xD4E735F4B6A956AC(), Local_68.f_9)) || func_361())
								{
									Local_68.f_10 = 23;
								}
							}
...
int func_374(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_184(unk_0xE2BBD32891C18569(iParam1, 1) - unk_0xE2BBD32891C18569(iParam0, 1)) };
	...
	{
		vVar1 = { func_184(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_378()
{
	if (func_59(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), vLocal_328, 100f))
	{
		if (!func_379())
		{
			unk_0x9D7A6D81C3BE2AAE(&vLocal_324, 8);
			func_67();
			iLocal_111 = 1;
		}
	}
	...
	{
		if (!func_59(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), vLocal_328, 120f))
		{
			if (unk_0x7974D616EF03E483())
			{
				unk_0xFB35B0BAD6F5AD8F();
		...
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			...
			if (unk_0x5D7DFE2058701942(Local_68.f_9, 0) && unk_0xCAEB6CE71A2C7212(Local_68.f_9, 0) == iVar0)
			{
				if (!unk_0x122A8778D4027A82(unk_0xD4E735F4B6A956AC(), 0))
				{
					...
					{
						if ((unk_0xFD34717937104F1C() - iLocal_119) > 7500)
						{
							func_384(0);
						}
					}
					...
					{
						if ((unk_0xFD34717937104F1C() - iLocal_119) > 10000)
						{
							func_384(1);
						}
					}
			...
			else
			{
				...
				else if (Local_68.f_10 == 24 && func_64(Local_68.f_9, -1519143300))
				{
					if (func_105(Local_68.f_9, vLocal_329, 25f))
					{
						...
						{
							if (func_113(iLocal_121, unk_0x22C775856F4633CA(2500, 5000)))
							{
								if (func_62())
								{
									func_3();
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_113(iLocal_120, unk_0x22C775856F4633CA(3000, 6000)))
						{
							if (!func_105(Local_68.f_9, vLocal_329, 20f))
							{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_108)
				{
					...
					{
						if (!unk_0xCE3CB618AFE55EFB(iLocal_114))
						{
							if (iLocal_96)
							{
						...
						if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_328, 4f, 4f, 2f, 1, 1, 0))
						{
						}
						...
						if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
						{
							if (func_105(unk_0xA19140A5C42D8715(), vLocal_328, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_105(unk_0xA19140A5C42D8715(), vLocal_328, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
...
void func_393(int iParam0, int iParam1, vector3 vParam2)
{
	...
	fVar2 = 1600f;
	fVar3 = 4900f;
	fVar4 = vdist2(unk_0xE2BBD32891C18569(iParam0, 1), vParam2);
	...
	if (unk_0xCE3CB618AFE55EFB(iParam0))
	{
		if ((unk_0xDC5D81351D6A4DDB(iParam1) && unk_0xDC5D81351D6A4DDB(unk_0xA19140A5C42D8715())) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
		{
			if (unk_0xFAC06EE780B57279(iParam1))
			{
				...
				{
					fVar1 = unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0xE2BBD32891C18569(iParam1, 1), true);
...
int func_395(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	...
	if (!func_105(iParam1, *(uParam3[*iParam4 /*3*/]), 15f))
	{
		if (!func_64(iParam0, -1817882002) && !func_64(iParam0, -72074166))
		{
			if (iLocal_118 < 7)
			{
				unk_0xE49301B2B6F420DE(iParam0, iParam1, *(uParam3[*iParam4 /*3*/]), 35f, 0, iParam2, 786468, 0f, 2f);
			}
			else
			{
	...
	if (func_23(iParam0))
	{
		if (func_7(iParam1))
		{
			if (func_363(iParam1, iParam3))
			{
				...
				unk_0xC19EDC1D7179164C(iParam1, false, 1, 0);
...
int func_415(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_184(vParam1 - unk_0xE2BBD32891C18569(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_424()
{
	...
	func_21();
	unk_0x3E11F609741642B7(iLocal_319);
	func_509();
	func_125(0);
}
...
void func_425(bool bParam0, bool bParam1)
{
	...
	unk_0xE70AC26DFC59863A(iLocal_140, 0);
	unk_0xD9F4F897224699B4();
...
void func_426(bool bParam0)
{
	...
	func_427();
	unk_0xA5DE74AE39867B03(Local_72.f_5);
}
...
int func_471(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_462(unk_0x8F474E419F56E48D(*iParam0), 1) && unk_0x22D95AF01E737CA1(*iParam0, 24) != func_474(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x1EE56D43DA30ADC6(*iParam0, 24, func_474(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_473(iParam0);
	if (func_472(*iParam0))
	{
...
int func_484(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_486(iParam0, uVar1[iVar3], 1) && func_485(unk_0xE2BBD32891C18569(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_168(vParam1, 0f, 0f, 0f, 0)) || unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iParam0, 1), unk_0xE2BBD32891C18569(uVar1[iVar3], 1), true) < 10f)
					{
						unk_0x4C842FAB634AC89E(&iParam0);
						return 1;
					}
...
void func_509()
{
	...
	unk_0x94E87D83163B4BEB("ENEMIES", &iLocal_319);
	unk_0x80E7C4A78224C8F9(5, 1862763509, iLocal_319);
	unk_0x80E7C4A78224C8F9(5, iLocal_319, 1862763509);
	vVar0 = { func_516(Local_63) };
	vVar1 = { func_515(Local_63) };
	unk_0xFF54548CCE498035(vVar0, vVar1);
	iLocal_140 = unk_0xF66A39BBE7B3C278(vVar0, vVar1, 0, 1, 1, 1);
	...
	if (func_23(unk_0xA19140A5C42D8715()))
	{
		func_91(&uLocal_154, 2, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
...
void func_510()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		Local_68.f_10 = 0;
		unk_0xA0DEC6E1399EE624(Local_68.f_9);
		unk_0x3F01127ECD227890(Local_68.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 8f, -2f, -1, 1, 0, 0, 0, 0);
		if (!unk_0xDC5D81351D6A4DDB(Local_72))
		{
			Local_72 = unk_0xFCFC8CC5FF74580D(joaat("prop_phone_ing"), unk_0xE2BBD32891C18569(Local_68.f_9, 0), 1, true, 0);
		}
		if (func_421(Local_72))
		{
			unk_0x96B71B23D409A3DB(Local_72, Local_68.f_9, unk_0xF622A022C26057AA(Local_68.f_9, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		if (func_23(Local_70[iVar0 /*19*/]))
		{
			...
			{
				unk_0xF0188A1B49D79AF7(Local_70[iVar0 /*19*/], Local_70[iVar0 /*19*/].f_5, -1, true, true);
			}
			unk_0x13E0A8160525AE55(Local_70[iVar0 /*19*/], 137, true);
	...
	while (iVar0 <= (iLocal_126 - 1))
	{
		...
		{
			unk_0xC19EDC1D7179164C(Local_71[iVar0 /*6*/], true, 1, 0);
		}
		iVar0++;
	}
}
...
int func_512()
{
	...
	if (iVar1 == iLocal_130)
	{
		...
		while (iVar2 <= (iLocal_130 - 1))
		{
			unk_0xA5DE74AE39867B03(Local_70[iVar2 /*19*/].f_18);
			iVar2++;
		}
	}
	if (iLocal_126 > 0)
...
int func_543(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_554())
	{
		...
		{
			iVar2 = func_544(unk_0x61D2332983ACC05C());
			if (iVar2 > -1)
			{
