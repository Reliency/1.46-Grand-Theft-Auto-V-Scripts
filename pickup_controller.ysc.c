...
void func_3(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_29[iParam0] = unk_0x4B3DFBACE939C0B8(iParam1, func_4(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x464A270B5502D972(iLocal_29[iParam0], 600000);
}
...
void func_7(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_27[iParam0] = unk_0x4B3DFBACE939C0B8(iParam1, func_8(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x464A270B5502D972(iLocal_27[iParam0], 600000);
}
...
void func_11(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_24[iParam0] = unk_0x4B3DFBACE939C0B8(iParam1, func_12(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x464A270B5502D972(iLocal_24[iParam0], 600000);
}
...
void func_14()
{
	switch (Global_25700)
	{
		...
		case 1:
			...
			{
				case 0:
					if (unk_0xF93654E07E20E3CF(iLocal_20[Global_25702]) && unk_0x866C9D94223DE855(iLocal_20[Global_25702]))
					{
						Global_25703 = 0;
					}
					else
				...
				case 1:
					if (unk_0xF93654E07E20E3CF(iLocal_22[Global_25702]) && unk_0x866C9D94223DE855(iLocal_22[Global_25702]))
					{
						Global_25703 = 0;
					}
					else
				...
				case 2:
					if (unk_0xF93654E07E20E3CF(iLocal_23[Global_25702]) && unk_0x866C9D94223DE855(iLocal_23[Global_25702]))
					{
						Global_25703 = 0;
					}
					else
...
void func_16()
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xF93654E07E20E3CF(iLocal_29[iVar0]))
		{
			unk_0xBCFB7F2BD32812C6(iLocal_29[iVar0]);
		}
		iVar0++;
	}
	iLocal_30 = 0;
...
void func_17()
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xF93654E07E20E3CF(iLocal_27[iVar0]))
		{
			unk_0xBCFB7F2BD32812C6(iLocal_27[iVar0]);
		}
		iVar0++;
	}
	iLocal_28 = 0;
...
void func_18()
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xF93654E07E20E3CF(iLocal_24[iVar0]))
		{
			unk_0xBCFB7F2BD32812C6(iLocal_24[iVar0]);
		}
		iVar0++;
	}
	iLocal_25 = 0;
...
void func_19()
{
	...
	while (iVar0 < 102)
	{
		if (unk_0xF93654E07E20E3CF(iLocal_23[iVar0]))
		{
			unk_0xBCFB7F2BD32812C6(iLocal_23[iVar0]);
		}
		iVar0++;
	}
}
...
void func_20()
{
	...
	while (iVar0 < 76)
	{
		if (unk_0xF93654E07E20E3CF(iLocal_22[iVar0]))
		{
			unk_0xBCFB7F2BD32812C6(iLocal_22[iVar0]);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	while (iVar0 < 19)
	{
		if (unk_0xF93654E07E20E3CF(iLocal_21[iVar0]))
		{
			unk_0xBCFB7F2BD32812C6(iLocal_21[iVar0]);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	while (iVar0 < 45)
	{
		if (unk_0xF93654E07E20E3CF(iLocal_20[iVar0]))
		{
			unk_0xBCFB7F2BD32812C6(iLocal_20[iVar0]);
		}
		iVar0++;
	}
}
...
void func_26(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	iLocal_23[iParam0] = unk_0x4B3DFBACE939C0B8(iParam1, func_28(iParam0, 0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x464A270B5502D972(iLocal_23[iParam0], 600000);
	if (bParam4)
	{
		unk_0xE391E726EE1618FD(iLocal_23[iParam0], func_27(iParam0));
	}
}
...
void func_30(int iParam0, vector3 vParam1, bool bParam2, bool bParam3)
{
	...
	iLocal_22[iParam0] = unk_0x4B3DFBACE939C0B8(joaat("pickup_health_standard"), func_32(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x464A270B5502D972(iLocal_22[iParam0], 600000);
	if (bParam3)
	{
		unk_0xE391E726EE1618FD(iLocal_22[iParam0], func_31(iParam0));
	}
}
...
void func_34(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	iLocal_21[iParam0] = unk_0x4B3DFBACE939C0B8(joaat("pickup_weapon_petrolcan"), func_35(iParam0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x464A270B5502D972(iLocal_21[iParam0], 600000);
}
...
void func_37(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_20[iParam0] = unk_0x4B3DFBACE939C0B8(joaat("pickup_armour_standard"), func_39(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x464A270B5502D972(iLocal_20[iParam0], 600000);
	if (bParam3)
	{
		unk_0xE391E726EE1618FD(iLocal_20[iParam0], func_38(iParam0));
	}
}
