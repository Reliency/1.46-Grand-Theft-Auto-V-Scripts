...
void func_1()
{
	...
	if (iLocal_28 == 2)
	{
		...
		{
			if (unk_0x1095F403F52B42E1(iLocal_34, 0))
			{
				if (func_2(iLocal_34, unk_0xA19140A5C42D8715(), 1) > 850f)
				{
					func_3(2);
					return;
				}
	...
	if (iLocal_28 == 3 || iLocal_28 == 4)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_34))
		{
			if (unk_0x1095F403F52B42E1(iLocal_34, 0))
			{
				if (func_2(iLocal_34, unk_0xA19140A5C42D8715(), 1) > 100f)
				{
					func_3(2);
					return;
				}
				else if ((unk_0xEB9F2352179A557A(iLocal_34, 3, 30000) || unk_0xEB9F2352179A557A(iLocal_34, 1, 40000)) || unk_0xEB9F2352179A557A(iLocal_34, 0, 7000))
				{
					func_3(3);
					return;
				}
...
void func_28()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (unk_0xDC5D81351D6A4DDB(iLocal_34))
		{
			unk_0xB29E08C7AB729BAD(iLocal_34, false);
		}
		...
		if (unk_0xDC5D81351D6A4DDB(iLocal_34))
		{
			if (unk_0x1095F403F52B42E1(iLocal_34, 0))
			{
				if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
				{
					unk_0xFBA5AC89E66201B2(unk_0xA19140A5C42D8715(), iLocal_34, 0);
				}
			}
		}
		iLocal_76 = 1;
	...
	if (iLocal_54 == 1)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_34))
		{
			if (unk_0x1095F403F52B42E1(iLocal_34, 0))
			{
				if (!unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 1))
				{
					unk_0x6B6894ACFD0185EF(iLocal_34, 0, 0);
					unk_0x6B6894ACFD0185EF(iLocal_34, 1, 0);
					unk_0x14293208022014FA(iLocal_34, 2);
					unk_0xF0F3162A538A2D92(iLocal_34, 0);
					unk_0xB29E08C7AB729BAD(iLocal_34, true);
					func_29();
				}
			}
		}
...
void func_34()
{
	switch (iLocal_28)
	{
		case 2:
			...
			{
				if (!unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_39, 0))
				{
					unk_0x692D5500D82E4F5D(unk_0xA19140A5C42D8715(), iLocal_39, -1);
				}
			}
			else
			{
			...
			if (func_20() == 2)
			{
				if (unk_0xDC5D81351D6A4DDB(iLocal_34))
				{
					if (unk_0x1095F403F52B42E1(iLocal_34, 0))
					{
						if (!unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
						{
							unk_0x692D5500D82E4F5D(unk_0xA19140A5C42D8715(), iLocal_34, -1);
						}
						unk_0xB29E08C7AB729BAD(iLocal_34, false);
					}
				}
...
void func_36()
{
	...
	{
		case 2:
			unk_0xFDD15D670AD33E10(-1588.1f, 2794.9f, 17.2f, 20f, 1, 0, 0, false);
			...
			if (!unk_0xDC5D81351D6A4DDB(iLocal_34))
			{
				unk_0xFDD15D670AD33E10(vLocal_118, 10f, 1, 0, 0, false);
				iLocal_34 = unk_0x48CFBECB146FD1A1(joaat("cargobob"), vLocal_118, fLocal_122, 1, 1, 0);
				unk_0x65CC6AA03C1AD35A(iLocal_34, 0);
				unk_0xB29E08C7AB729BAD(iLocal_34, true);
				unk_0x98D1B1BD9C3AA456(iLocal_34, 1, 1);
				unk_0xA5DE74AE39867B03(joaat("cargobob"));
				unk_0xFC00A668AFC2126D(joaat("cargobob"), 1);
				unk_0x071AF574B483D05F(iLocal_34, 1);
				unk_0x73D0CBD6409B6E83(iLocal_34, 0);
			...
			if (!unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
			{
				...
				{
					unk_0xFDD15D670AD33E10(-1866.446f, 3071.395f, 31.8104f, 10f, 1, 0, 0, false);
					iLocal_35[0] = unk_0x48CFBECB146FD1A1(joaat("buzzard"), -1866.446f, 3071.395f, 31.8104f, 150.2863f, 1, 1, 0);
					unk_0x98D1B1BD9C3AA456(iLocal_35[0], 1, 1);
					unk_0x65CC6AA03C1AD35A(iLocal_35[0], 1);
					unk_0x99F546A9200EA026(iLocal_35[0], 1084227584);
					unk_0xA95C9BC9CAF4C02D(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					unk_0xA5DE74AE39867B03(joaat("buzzard"));
					unk_0xF0F3162A538A2D92(iLocal_35[0], 0);
				}
			}
			if (func_267())
			{
				if (!unk_0xDC5D81351D6A4DDB(iLocal_39))
				{
					if (func_107())
					{
						if (!unk_0x7C197233F79C2CB8(func_106()) && !unk_0xCA8C103FCD316F89(func_106()))
						{
							...
							unk_0x0BE3742BB3253F0E(iLocal_39, true);
							unk_0x071AF574B483D05F(iLocal_39, 1);
						}
					}
				}
			}
		...
		case 3:
			...
			if (!unk_0xDC5D81351D6A4DDB(iLocal_34))
			{
				...
				unk_0xB29E08C7AB729BAD(iLocal_34, true);
				unk_0x98D1B1BD9C3AA456(iLocal_34, 1, 1);
				unk_0xA7E7312A2DC89797(iLocal_34);
				unk_0xA5DE74AE39867B03(joaat("cargobob"));
				unk_0xFC00A668AFC2126D(joaat("cargobob"), 1);
				unk_0x071AF574B483D05F(iLocal_34, 1);
				unk_0x73D0CBD6409B6E83(iLocal_34, 0);
			...
			if (!unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
			{
				iLocal_31[0] = unk_0x91A7C8CA5E332C03(iLocal_35[0], 26, joaat("s_m_m_pilot_02"), -1, 1, true);
				unk_0xA5DE74AE39867B03(joaat("s_m_m_pilot_02"));
			}
			else if (!unk_0xE0FD180CD24C0B67(iLocal_31[0], iLocal_35[0], 0))
			{
				unk_0x692D5500D82E4F5D(iLocal_31[0], iLocal_35[0], -1);
			}
			unk_0xF0188A1B49D79AF7(unk_0xA19140A5C42D8715(), joaat("gadget_parachute"), -1, false, true);
			unk_0x2958397D2A5C3E73("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", true);
		...
		case 4:
			...
			{
				unk_0xFDD15D670AD33E10(vLocal_118, 10f, 1, 0, 0, false);
				iLocal_34 = unk_0x48CFBECB146FD1A1(joaat("cargobob"), -629.1677f, 2871.31f, 385.0313f, 283.1214f, 1, 1, 0);
				unk_0x98D1B1BD9C3AA456(iLocal_34, 1, 1);
				unk_0xA5DE74AE39867B03(joaat("cargobob"));
				unk_0xFC00A668AFC2126D(joaat("cargobob"), 1);
				unk_0x73D0CBD6409B6E83(iLocal_34, 0);
				unk_0x071AF574B483D05F(iLocal_34, 1);
				unk_0xC19EDC1D7179164C(iLocal_34, true, 1, 0);
				unk_0xA7E7312A2DC89797(iLocal_34);
				unk_0x625FB4B0328423D9(iLocal_34, 30f);
				func_102(iLocal_34, 0);
			}
			unk_0xF0188A1B49D79AF7(unk_0xA19140A5C42D8715(), joaat("gadget_parachute"), -1, false, true);
			break;
		...
		case 5:
			...
			if (!unk_0xDC5D81351D6A4DDB(iLocal_34))
			{
				unk_0xFDD15D670AD33E10(1749.61f, 3272.95f, 40.1533f, 5f, 1, 0, 0, false);
				iLocal_34 = unk_0x48CFBECB146FD1A1(joaat("cargobob"), 1749.61f, 3272.95f, 40.1533f, 51.128f, 1, 1, 0);
				unk_0x98D1B1BD9C3AA456(iLocal_34, 1, 1);
				unk_0xA5DE74AE39867B03(joaat("cargobob"));
				unk_0x071AF574B483D05F(iLocal_34, 1);
				unk_0x73D0CBD6409B6E83(iLocal_34, 0);
			...
			{
				iLocal_36[0] = unk_0x48CFBECB146FD1A1(joaat("sandking"), 1754.951f, 3290.994f, 40.1176f, 182.397f, 1, 1, 0);
				unk_0xB29E08C7AB729BAD(iLocal_36[0], true);
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_8(vParam1, 0f, 0f, 0f, 0)) || unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iParam0, true), unk_0xE2BBD32891C18569(uVar1[iVar3], true), true) < 10f)
					{
...
void func_99()
{
	if (iLocal_80 == 0)
	{
		...
		{
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[0]))
			{
				iLocal_32[0] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -1590.523f, 2796.302f, 15.9184f, 247.0896f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[1]))
			{
				iLocal_32[1] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2303.8f, 3387.99f, 30.034f, 58.5763f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[2]))
			{
				iLocal_32[2] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -1697.329f, 2909.941f, 31.9506f, 245.656f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[3]))
			{
				iLocal_32[3] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -1696.369f, 2905.772f, 31.9454f, 6.3714f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[4]))
			{
				iLocal_32[4] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -1843.707f, 2821.611f, 31.8528f, 271.6265f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[5]))
			{
				iLocal_32[5] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2006.877f, 2955.101f, 31.8103f, 332.0101f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[6]))
			{
				iLocal_32[6] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2010.022f, 2956.805f, 31.8103f, 288.1283f, 1, true);
			}
			if (iLocal_28 != 3)
			{
				if (!unk_0xDC5D81351D6A4DDB(iLocal_32[7]))
				{
					iLocal_32[7] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2140.213f, 3034.609f, 31.81f, 302.4493f, 1, true);
				}
				if (!unk_0xDC5D81351D6A4DDB(iLocal_32[8]))
				{
					iLocal_32[8] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2136.053f, 3031.494f, 31.81f, 38.6856f, 1, true);
				}
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[9]))
			{
				iLocal_32[9] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2035.429f, 3058.876f, 31.8103f, 169.8222f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[10]))
			{
				iLocal_32[10] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2146.467f, 3160.749f, 31.8106f, 356.4766f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[11]))
			{
				iLocal_32[11] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2280.087f, 3172.423f, 31.8103f, 353.663f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_32[12]))
			{
				iLocal_32[12] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_y_marine_01"), -2277.376f, 3177.8f, 31.8103f, 175.0685f, 1, true);
			}
			if (!unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
			{
				iLocal_31[0] = unk_0x35C6E06B120EB2E3(26, joaat("s_m_m_pilot_02"), -1859.831f, 3071.758f, 31.8104f, 139.3607f, 1, true);
				unk_0x73774776D23F43BA(iLocal_31[0], 0, 2, 0, false);
				unk_0x72A0FF8C49CFFC0D(iLocal_31[0], 8, 0, 0, 0);
				unk_0x98D1B1BD9C3AA456(iLocal_31[0], 1, 1);
				unk_0xF0188A1B49D79AF7(iLocal_31[0], joaat("weapon_assaultrifle"), 2000, true, true);
				unk_0xDFA901280292A2FB(iLocal_31[0], iLocal_44);
				unk_0xD461381B293D9B46(iLocal_31[0], 0);
				unk_0x1F4E5EFBFE503FB3(iLocal_31[0], 1);
			...
			while (iLocal_55 <= 12)
			{
				...
				{
					if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_55]))
					{
						unk_0x98D1B1BD9C3AA456(iLocal_32[iLocal_55], 1, 1);
						unk_0xF0188A1B49D79AF7(iLocal_32[iLocal_55], joaat("weapon_assaultrifle"), 2000, true, true);
						unk_0xDFA901280292A2FB(iLocal_32[iLocal_55], iLocal_44);
						unk_0xD461381B293D9B46(iLocal_32[iLocal_55], 10);
						func_101(iLocal_32[iLocal_55], 595);
						func_100(iLocal_32[iLocal_55], 0);
						unk_0x1F4E5EFBFE503FB3(iLocal_32[iLocal_55], 1);
...
void func_115()
{
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
	{
		unk_0x680F17660351F21B(&(iLocal_31[0]));
	}
	iLocal_55 = 0;
	while (iLocal_55 <= 12)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_55]))
		{
			unk_0x680F17660351F21B(&(iLocal_32[iLocal_55]));
		}
		iLocal_55++;
	}
	if (func_20() == 2)
	{
		if (unk_0xDC5D81351D6A4DDB(uLocal_124[0]))
		{
			unk_0x680F17660351F21B(&(uLocal_124[0]));
		}
	}
	if (func_20() == 0)
	{
		if (unk_0xDC5D81351D6A4DDB(uLocal_124[2]))
		{
			unk_0x680F17660351F21B(&(uLocal_124[2]));
		}
	}
	if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
	{
		unk_0x3C50F1F859BA232B(iLocal_35[0], 0);
	}
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_39))
	{
		unk_0x4C842FAB634AC89E(&iLocal_39);
	}
	if (unk_0xDC5D81351D6A4DDB(iLocal_34))
	{
		unk_0x4C842FAB634AC89E(&iLocal_34);
	}
	if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
	{
		unk_0x4C842FAB634AC89E(&(iLocal_35[0]));
	}
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_36[0]))
	{
		unk_0x4C842FAB634AC89E(&(iLocal_36[0]));
	}
	if (unk_0xDC5D81351D6A4DDB(iLocal_42))
	{
		unk_0xC0AC848E56940C34(&iLocal_42);
	}
	if (unk_0xDC5D81351D6A4DDB(iLocal_43))
	{
		unk_0xC0AC848E56940C34(&iLocal_43);
	}
	if (unk_0x37B568B777BC65F9(iLocal_40))
	{
		if (unk_0xC3553172354FFB69(iLocal_40))
		{
			unk_0x8E88E73F74A9FF79(false, false, 3000, 1, 0, 0);
		}
		unk_0x77F0486CE0E598D5(iLocal_40, 0);
	}
}

void func_116()
{
	if (unk_0xCE3CB618AFE55EFB(iLocal_45))
	{
		unk_0xE1623437A3194332(&iLocal_45);
	}
	if (unk_0xCE3CB618AFE55EFB(iLocal_46))
	{
		unk_0xE1623437A3194332(&iLocal_46);
	}
	if (unk_0xCE3CB618AFE55EFB(iLocal_48))
	{
		unk_0xE1623437A3194332(&iLocal_48);
	}
	iLocal_55 = 0;
	while (iLocal_55 <= 12)
	{
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_34))
	{
		if (unk_0x1095F403F52B42E1(iLocal_34, 0))
		{
			if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
			{
				...
				if (iLocal_107 == 1)
				{
					if (unk_0xFD34717937104F1C() < iLocal_68 + 7500)
					{
						unk_0x4F93066CECE72793();
					}
				}
				...
				if (iLocal_28 == 3)
				{
					if (!unk_0xCE3CB618AFE55EFB(uLocal_47[0]))
					{
			...
			else if (iLocal_28 != 5)
			{
				...
				if (iLocal_28 == 3)
				{
					if (unk_0xCE3CB618AFE55EFB(uLocal_47[0]))
					{
						unk_0xE1623437A3194332(&(uLocal_47[0]));
					}
				}
				if (iLocal_28 == 4)
				{
					if (iLocal_78 == 1)
					{
						if (unk_0xFD34717937104F1C() < iLocal_69 + 7500)
						{
							unk_0x4F93066CECE72793();
						}
					}
...
int func_120(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_121(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_121(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
	...
	if (iLocal_54 == 0)
	{
		...
		while (iLocal_55 <= 12)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_55]))
			{
				if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_55]))
				{
					unk_0xD738221C247C8B71(iLocal_32[iLocal_55], true);
					unk_0x7E4E83D33161D01A(&(iLocal_32[iLocal_55]));
				}
			}
			iLocal_55++;
		}
		if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
		{
			unk_0x792676988A48387F(&(iLocal_35[0]));
		}
		if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
		{
			unk_0x7E4E83D33161D01A(&(iLocal_31[0]));
		}
		if (!unk_0x2F8EAF18929E1E59("DH_P_2B_ENTER_CHOPPER"))
		{
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_115 == 0)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_34))
			{
				if (unk_0x1095F403F52B42E1(iLocal_34, 0))
				{
					if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
					{
						if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_118, true) > 800f)
						{
		...
		if (unk_0xDC5D81351D6A4DDB(iLocal_34))
		{
			if (unk_0x1095F403F52B42E1(iLocal_34, 0))
			{
				if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
				{
					if (unk_0x26D28D230F871E8D(iLocal_34))
					{
						if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_118, true) > 800f)
						{
							if (iLocal_111 == 0 && iLocal_78 == 1)
							{
								if (!unk_0x8187CC9EB2D7CFE6())
								{
									if (!func_124() || !unk_0x1BB77F49EA9C72A3())
									{
										func_143(&uLocal_198, 2, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
		...
		if (unk_0xDC5D81351D6A4DDB(iLocal_34))
		{
			if (unk_0x1095F403F52B42E1(iLocal_34, 0))
			{
				if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
				{
					if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_119, 2f, 2f, 2f, 1, true, 0))
					{
					}
					if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, true, 0))
					{
						if (!unk_0x26D28D230F871E8D(iLocal_34) && unk_0x097275D546C9735F(iLocal_34))
						{
							func_127(1, 600);
...
void func_144(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_211(unk_0x61D2332983ACC05C(), 1);
			if (iVar4 != -1)
			{
...
void func_164(int iParam0, var uParam1)
{
	...
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x3D2A81E3C295D501(iParam0, func_169(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x8798F3E6AE76AF63(iVar5, &Var7) && !func_166(Var7.f_1)) && iVar9 < 50)
			{
...
int func_174(var uParam0)
{
	if (!unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		if (func_197())
		{
			*uParam0 = func_180(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false), 6, -1, 0, 1, -1);
...
int func_180(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_196(iVar0))
		{
			...
			{
				fVar1 = unk_0x499324B3EF19C288(vParam0, func_181(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_204(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_223()
{
	if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_119, true) < 500f)
	{
		if (iLocal_89 == 0)
		{
			if (!unk_0xDC5D81351D6A4DDB(iLocal_36[0]))
	...
	{
		if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_119, true) > 550f)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_36[0]))
			{
				unk_0x4C842FAB634AC89E(&(iLocal_36[0]));
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_83[0] == 1)
		{
			...
			if (unk_0xDC5D81351D6A4DDB(iLocal_34))
			{
				if (unk_0x1095F403F52B42E1(iLocal_34, 0))
				{
					if (unk_0x54F6F5A823224519(iLocal_34, 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, true, 0))
					{
						if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
						{
							unk_0xF10B3BC4F73177E5(unk_0xD4E735F4B6A956AC(), 0, 0);
...
void func_228()
{
	iLocal_37 = unk_0xEB67B4270D12F60E(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), 300f, joaat("lazer"), 4);
	iLocal_38 = unk_0xEB67B4270D12F60E(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), 300f, joaat("lazer"), 16386);
	if (unk_0xDC5D81351D6A4DDB(iLocal_37) && unk_0x26D28D230F871E8D(iLocal_37))
	{
		if (!unk_0xCE3CB618AFE55EFB(iLocal_48))
		{
			iLocal_48 = unk_0x6A15DD6A863D5E27(iLocal_37);
			unk_0xF46EDCACB3804F87(iLocal_48, false);
		}
	}
	if (unk_0xDC5D81351D6A4DDB(iLocal_38) && unk_0x26D28D230F871E8D(iLocal_38))
	{
		if (!unk_0xCE3CB618AFE55EFB(iLocal_49))
		{
			iLocal_49 = unk_0x6A15DD6A863D5E27(iLocal_38);
			unk_0xF46EDCACB3804F87(iLocal_49, false);
		}
	}
}
...
void func_229()
{
	if (iLocal_28 == 3)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_34))
		{
			if (unk_0x1095F403F52B42E1(iLocal_34, 0))
			{
				if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
				{
					vLocal_121 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
					if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
					{
						if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
						{
							if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
							{
								if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
								{
									if (func_2(unk_0xA19140A5C42D8715(), iLocal_31[0], 1) < 600f)
									{
										if (unk_0x499324B3EF19C288(vLocal_121, -75.8f, -819.9f, 326f, true) > 1600f && unk_0x499324B3EF19C288(vLocal_121, -2159f, 3067f, 33f, true) < 1000f)
										{
											if (vLocal_121.z > 70f)
											{
												if (iLocal_30 != 2)
										...
										{
											if (unk_0x499324B3EF19C288(vLocal_121, -75.8f, -819.9f, 326f, true) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
											...
											if (unk_0x499324B3EF19C288(vLocal_121, -2159f, 3067f, 33f, true) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
				...
				else if (unk_0x499324B3EF19C288(vLocal_121, -75.8f, -819.9f, 326f, true) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_90[0] = 1;
			...
			if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
			{
				if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
				{
					if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
					{
						if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
						{
							if (func_2(unk_0xA19140A5C42D8715(), iLocal_31[0], 1) < 200f)
							{
								vLocal_120 = { unk_0xE2BBD32891C18569(iLocal_35[0], true) };
								unk_0x9568B1B58F78FF36(iLocal_31[0]);
								unk_0xF4A4E46DFA28BFDE(iLocal_31[0], vLocal_120, 10f, 0, 0);
								unk_0xB943C83C5BDB3DBB(iLocal_31[0], 250f, 0);
								iLocal_81[0] = 1;
							}
						}
					}
				...
				if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
				{
					if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
					{
						if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
						{
							...
							vLocal_120 = { unk_0xE2BBD32891C18569(iLocal_35[0], true) };
							unk_0x9568B1B58F78FF36(iLocal_31[0]);
							unk_0x2F89329397A277BC(&uLocal_367);
							if (!unk_0xE0FD180CD24C0B67(iLocal_31[0], iLocal_35[0], 0))
							{
								unk_0xA2EBCD9385E56019(0, iLocal_35[0], 20000, -1, 2f, 1, 0);
							}
							unk_0x3DF8D785133D0B17(0, iLocal_35[0], 0, 0, vLocal_120.x, vLocal_120.y, (vLocal_120.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1f, 0);
							unk_0x3DF8D785133D0B17(0, iLocal_35[0], 0, unk_0xA19140A5C42D8715(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1f, 0);
							unk_0x301F42EEE3C40328(uLocal_367);
							unk_0xE1072FA2FECBAD96(iLocal_31[0], uLocal_367);
							unk_0x3A95A0A3221D4208(&uLocal_367);
							iLocal_81[0] = 1;
						}
					}
				}
			...
			if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
			{
				if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
				{
					if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
					{
						if (unk_0xE0FD180CD24C0B67(iLocal_31[0], iLocal_35[0], 0))
						{
							if (unk_0xFD34717937104F1C() > (iLocal_67 + 90000))
							{
								if (iLocal_104 == 0)
								{
									unk_0xD461381B293D9B46(iLocal_31[0], 100);
									iLocal_103 = 0;
									iLocal_104 = 1;
								}
							}
							else if (unk_0xFD34717937104F1C() > iLocal_67 + 10000 && !unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
							{
								if (iLocal_104 == 0)
								{
									unk_0xD461381B293D9B46(iLocal_31[0], 100);
							...
							if (func_2(iLocal_35[0], unk_0xA19140A5C42D8715(), 1) < 300f)
							{
								if (iLocal_106 == 0)
								{
									unk_0xB69132EDCA2D8F7D(iLocal_31[0], joaat("vehicle_weapon_space_rocket"));
									unk_0x38881C31FB76F987(iLocal_31[0], -1857128337);
									iLocal_105 = 0;
									iLocal_106 = 1;
								}
							}
							...
							{
								unk_0xB69132EDCA2D8F7D(iLocal_31[0], joaat("vehicle_weapon_player_buzzard"));
								unk_0x38881C31FB76F987(iLocal_31[0], 1566631136);
								iLocal_106 = 0;
								iLocal_105 = 1;
							}
						}
					...
					if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
					{
						if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
						{
							if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
							{
								if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
								{
									unk_0x3DF8D785133D0B17(iLocal_31[0], iLocal_35[0], 0, unk_0xA19140A5C42D8715(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
					{
						if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
						{
							if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
							{
								if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
								{
									unk_0x3DF8D785133D0B17(iLocal_31[0], iLocal_35[0], 0, unk_0xA19140A5C42D8715(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
					{
						if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
						{
							if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
							{
								if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
								{
									unk_0x3DF8D785133D0B17(iLocal_31[0], iLocal_35[0], 0, unk_0xA19140A5C42D8715(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
					{
						if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
						{
							if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
							{
								if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
								{
									unk_0x3DF8D785133D0B17(iLocal_31[0], iLocal_35[0], 0, 0, unk_0x3201284584C7CD83(iLocal_35[0], 20f, 0f, 0f), 4, 10f, 10f, unk_0x552C823E1D2A019C(iLocal_35[0]), round(unk_0x588E4D19036651D1(iLocal_35[0], unk_0xE2BBD32891C18569(iLocal_35[0], true), 1, 1)), 100, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
						...
						if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
						{
							if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
							{
								if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
								{
									if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
									{
										unk_0x3DF8D785133D0B17(iLocal_31[0], iLocal_35[0], 0, unk_0xA19140A5C42D8715(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1f, 0);
										iLocal_102 = 1;
									}
								}
							}
					...
					if (unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
					{
						if (unk_0x1095F403F52B42E1(iLocal_35[0], 0))
						{
							if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
							{
								if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
								{
									unk_0x3DF8D785133D0B17(iLocal_31[0], iLocal_35[0], 0, unk_0xA19140A5C42D8715(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
			...
			if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
			{
				if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
				{
					if (unk_0xE0FD180CD24C0B67(iLocal_31[0], iLocal_35[0], 0))
					{
						if (unk_0xCE3CB618AFE55EFB(uLocal_47[0]))
						{
							unk_0x575CF00E129E0CE1(uLocal_47[0], 1f);
						}
					}
					if (func_2(unk_0xA19140A5C42D8715(), iLocal_31[0], 1) > 600f)
					{
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_31[0]))
	{
		if (!unk_0x4915F4759304D5CF(iLocal_31[0]))
		{
			if (unk_0x4374EED90C523366(iLocal_31[0]))
			{
				unk_0x9568B1B58F78FF36(iLocal_31[0]);
				unk_0x6259CDB47862A4F3(iLocal_31[0], 0, 0);
				if (unk_0xCE3CB618AFE55EFB(uLocal_47[0]))
				{
					unk_0xE1623437A3194332(&(uLocal_47[0]));
				}
...
void func_230()
{
	if (iLocal_85 == 0)
	{
		if ((((func_231(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), 3, 0, 0) || unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1601.514f, 2794.148f, 14.84222f, -1587.692f, 2806.101f, 20.29557f, 16f, 0, true, 0)) || unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1598.278f, 2803.98f, 17.01772f, -1665.98f, 2895.398f, 34.58953f, 14.5f, 0, true, 0)) || unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1648.554f, 2873.74f, 24.85017f, -1673.864f, 2889.698f, 38.18856f, 14.5f, 0, true, 0)) || unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), -1647.446f, 2873.969f, 24.82373f, -1667.316f, 2914.302f, 39.39478f, 14.5f, 0, true, 0))
		{
			iLocal_85 = 1;
		}
	}
	...
	if (iLocal_80 == 1)
	{
				...
				if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_55]))
				{
					if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_55]))
					{
						if (unk_0xDC5D81351D6A4DDB(iLocal_34))
						{
							if (unk_0x1095F403F52B42E1(iLocal_34, 0))
							{
								if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0) || iLocal_87 == 1)
								{
									if (func_2(unk_0xA19140A5C42D8715(), iLocal_32[iLocal_55], 1) < 39f)
									{
										if (iLocal_91[iLocal_55] == 0)
										{
											unk_0x9568B1B58F78FF36(iLocal_32[iLocal_55]);
											unk_0xF4A4E46DFA28BFDE(iLocal_32[iLocal_55], unk_0xE2BBD32891C18569(iLocal_32[iLocal_55], true), 50f, 0, 0);
											unk_0xDA4D3941AFF8EF12(iLocal_32[iLocal_55], unk_0xA19140A5C42D8715(), 0, 16);
											unk_0x3B7A32E04BBE59A5(iLocal_32[iLocal_55], 51, true);
											unk_0x3B7A32E04BBE59A5(iLocal_32[iLocal_55], 43, true);
									...
									else if (iLocal_92[iLocal_55] == 0)
									{
										unk_0x9568B1B58F78FF36(iLocal_32[iLocal_55]);
										unk_0x2F89329397A277BC(&uLocal_367);
										unk_0x956B3CF461C0C1C9(0, unk_0xE2BBD32891C18569(iLocal_34, true), 2f, -1, 20f, 0, 1193033728);
										unk_0xDA4D3941AFF8EF12(0, unk_0xA19140A5C42D8715(), 0, 16);
										unk_0x301F42EEE3C40328(uLocal_367);
										unk_0xE1072FA2FECBAD96(iLocal_32[iLocal_55], uLocal_367);
										unk_0x3A95A0A3221D4208(&uLocal_367);
										iLocal_93[iLocal_55] = 0;
										iLocal_94[iLocal_55] = 0;
								...
								else
								{
									...
									if (func_2(unk_0xA19140A5C42D8715(), iLocal_32[iLocal_55], 1) > 41f && func_2(unk_0xA19140A5C42D8715(), iLocal_32[iLocal_55], 1) < 400f)
									{
										if (iLocal_94[iLocal_55] == 0)
										{
											iLocal_74 = unk_0x22C775856F4633CA(0, 4);
											unk_0x9568B1B58F78FF36(iLocal_32[iLocal_55]);
											unk_0xF4A4E46DFA28BFDE(iLocal_32[iLocal_55], unk_0xE2BBD32891C18569(iLocal_32[iLocal_55], true), 50f, 0, 0);
											unk_0x2F89329397A277BC(&uLocal_367);
											if (iLocal_74 == 0)
											{
												unk_0x8F65948C5AFB744E(0, unk_0xA19140A5C42D8715(), -1, 25f, 2f, 1073741824, 0);
											}
											else if (iLocal_74 == 1)
											{
		...
		if (((iLocal_85 == 0 && iLocal_98 == 0) && iLocal_109 == 0) && iLocal_86 == 0)
		{
			...
			while (iLocal_72 <= 1)
			{
				if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_72]))
				{
					if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_72]))
					{
						if (func_2(iLocal_32[iLocal_72], unk_0xA19140A5C42D8715(), 1) < 25f)
						{
							if (iLocal_101[iLocal_72] == 0)
							{
								if (!unk_0x1A8481A7E865EC7C(iLocal_32[iLocal_72]))
								{
									unk_0x836A6A722DEA63F1(iLocal_32[iLocal_72]);
								}
								else
								{
									unk_0x9568B1B58F78FF36(iLocal_32[iLocal_72]);
								}
								unk_0x9C24BCD3EFB3BF4C(iLocal_32[iLocal_72], unk_0xA19140A5C42D8715(), -1, 0);
								iLocal_101[iLocal_72] = 1;
							}
							if (iLocal_110 == 1)
							{
								if (unk_0xFD34717937104F1C() > iLocal_70 + 20000)
								{
									iLocal_109 = 1;
								}
							}
						}
						else if (func_2(iLocal_32[iLocal_72], unk_0xA19140A5C42D8715(), 1) > 30f)
						{
...
void func_232()
{
		...
		if (!unk_0xDC5D81351D6A4DDB(iLocal_35[0]))
		{
			if (unk_0xDC5D81351D6A4DDB(Global_89824[1]))
			{
				if (unk_0x1095F403F52B42E1(Global_89824[1], 0))
				{
					...
					unk_0x65CC6AA03C1AD35A(iLocal_35[0], 1);
					unk_0x98D1B1BD9C3AA456(iLocal_35[0], 1, 1);
					unk_0xB29E08C7AB729BAD(iLocal_35[0], false);
					unk_0xA95C9BC9CAF4C02D(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					unk_0xF0F3162A538A2D92(iLocal_35[0], 0);
				}
			}
	...
	if (iLocal_54 == 1)
	{
		if (unk_0x97AA049940DBD81F("ARMY_GUARD"))
		{
			...
			{
				unk_0xF10C7DDEAC709758("ARMY_GUARD", false);
			}
		}
		func_99();
		if (iLocal_86 == 0)
		{
			if (unk_0xFD34717937104F1C() > iLocal_61 + 3000)
			{
				iLocal_63 = 0;
				while (iLocal_63 <= 12)
				{
					if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_63]))
					{
						if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_63]))
						{
							if (func_2(unk_0xA19140A5C42D8715(), iLocal_32[iLocal_63], 1) < 40f)
							{
								if (unk_0x85E4CC19842B6048(iLocal_32[iLocal_63], unk_0xA19140A5C42D8715()))
								{
									...
									else if (!unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0) && !func_237(0))
									{
										if (func_236(unk_0xA19140A5C42D8715()) != joaat("weapon_unarmed"))
										{
											if (unk_0xFD34717937104F1C() > iLocal_73 + 3000)
											{
												unk_0x2958397D2A5C3E73("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", false);
												unk_0xB4378167DA4A5EC4("AZ_AFB_ALARM_SPEECH", 1, 1);
												iLocal_86 = 1;
		...
		if (unk_0xDC5D81351D6A4DDB(iLocal_34))
		{
			if (unk_0x1095F403F52B42E1(iLocal_34, 0))
			{
				if (func_2(unk_0xA19140A5C42D8715(), iLocal_34, 1) < 30f)
				{
					iLocal_87 = 1;
				}
				if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
	...
	if (unk_0xDC5D81351D6A4DDB(Global_96664.f_4))
	{
		if (unk_0x1095F403F52B42E1(Global_96664.f_4, 0))
		{
			if (func_249(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_246(unk_0xE2BBD32891C18569(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_250()
{
	if (iLocal_54 == 0)
	{
		...
		func_254(4, 0);
		func_254(12, 0);
		unk_0x94E87D83163B4BEB("MarineGroupHash", &iLocal_44);
		unk_0x80E7C4A78224C8F9(5, iLocal_44, 1862763509);
		unk_0x80E7C4A78224C8F9(5, -472287501, 1862763509);
		unk_0x80E7C4A78224C8F9(1, iLocal_44, -472287501);
		unk_0x80E7C4A78224C8F9(1, -472287501, iLocal_44);
		unk_0x80E7C4A78224C8F9(1, -1533126372, iLocal_44);
		unk_0x80E7C4A78224C8F9(1, iLocal_44, -1533126372);
...
void func_251()
{
	...
	if (!unk_0xDC5D81351D6A4DDB(iLocal_34))
	{
		...
		iLocal_34 = unk_0x48CFBECB146FD1A1(joaat("cargobob"), 1740.852f, 3263.161f, 40.2743f, 280.3712f, 1, 1, 0);
		unk_0x6B6894ACFD0185EF(iLocal_34, 0, 1);
		unk_0x6B6894ACFD0185EF(iLocal_34, 1, 1);
		unk_0x14293208022014FA(iLocal_34, 2);
		unk_0x071AF574B483D05F(iLocal_34, 1);
		unk_0xB29E08C7AB729BAD(iLocal_34, true);
		unk_0x73D0CBD6409B6E83(iLocal_34, 0);
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_34))
	{
		if (unk_0x1095F403F52B42E1(iLocal_34, 0))
		{
			if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
			{
				if (unk_0xE0FD180CD24C0B67(unk_0xA19140A5C42D8715(), iLocal_34, 0))
				{
					if (unk_0xB10F7FE89663CB5B(unk_0xA19140A5C42D8715(), iLocal_34))
					{
						if (func_257(unk_0xA19140A5C42D8715(), iLocal_34) == -1)
						{
...
void func_258()
{
	if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		...
		{
			if (func_231(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), 3, 200, 0) || iLocal_86 == 1)
			{
		...
		if (iLocal_28 == 4)
		{
			if (unk_0x91347D2A80F38492(unk_0xD4E735F4B6A956AC()) != 0 && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_118, true) > 1000f)
			{
				unk_0xF10B3BC4F73177E5(unk_0xD4E735F4B6A956AC(), 0, 0);
				unk_0xDF341226C0B8BAC3(unk_0xD4E735F4B6A956AC(), 0);
			}
...
void func_260()
{
	if (iLocal_98 == 0)
	{
		...
		while (iLocal_64 <= 12)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_64]))
			{
				if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_64]))
				{
					if (unk_0x85E4CC19842B6048(iLocal_32[iLocal_64], unk_0xA19140A5C42D8715()))
					{
						if (func_2(iLocal_32[iLocal_64], unk_0xA19140A5C42D8715(), 1) < 40f)
						{
						...
						if (func_2(iLocal_32[iLocal_64], unk_0xA19140A5C42D8715(), 1) < 25f)
						{
							if (func_236(unk_0xA19140A5C42D8715()) != joaat("weapon_unarmed"))
							{
	...
	if (iLocal_85 == 0)
	{
		...
		while (iLocal_71 <= 1)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_71]))
			{
				if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_71]))
				{
					if (iLocal_99 == 0 && iLocal_100 == 0)
					{
						if (!func_124())
						{
							if (!unk_0x8187CC9EB2D7CFE6() || !unk_0x1BB77F49EA9C72A3())
							{
								if (func_2(unk_0xA19140A5C42D8715(), iLocal_32[iLocal_71], 1) < 25f)
								{
									if (unk_0x85E4CC19842B6048(iLocal_32[iLocal_71], unk_0xA19140A5C42D8715()))
									{
										if (!unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0) && !func_237(0))
										{
											if (func_236(unk_0xA19140A5C42D8715()) != joaat("weapon_unarmed"))
											{
												if (unk_0xDC5D81351D6A4DDB(iLocal_32[0]))
												{
													if (!unk_0x4915F4759304D5CF(iLocal_32[0]))
													{
														if (func_2(unk_0xA19140A5C42D8715(), iLocal_32[0], 1) < 30f)
														{
												...
												if (unk_0xDC5D81351D6A4DDB(iLocal_32[1]))
												{
													if (!unk_0x4915F4759304D5CF(iLocal_32[1]))
													{
														if (func_2(unk_0xA19140A5C42D8715(), iLocal_32[1], 1) < 30f)
														{
					...
					if (iLocal_99 == 1 || iLocal_100 == 1)
					{
						if (iLocal_98 == 0 && iLocal_85 == 0)
						{
							if (iLocal_117 == 0)
							{
								if (unk_0xFD34717937104F1C() > iLocal_65 + 8000)
								{
									if (!func_124())
									{
										if (!unk_0x8187CC9EB2D7CFE6() || !unk_0x1BB77F49EA9C72A3())
							...
							if (unk_0xFD34717937104F1C() > iLocal_66 + 8000)
							{
								if (!func_124())
								{
									if (!unk_0x8187CC9EB2D7CFE6() || !unk_0x1BB77F49EA9C72A3())
	...
	if (unk_0xFD34717937104F1C() > iLocal_56 + 12000)
	{
		if (iLocal_85 == 1 || iLocal_98 == 1)
		{
			if (!unk_0x8187CC9EB2D7CFE6() || !unk_0x1BB77F49EA9C72A3())
			{
				if (!func_124())
				{
					if (func_264())
					{
						iLocal_60 = unk_0x22C775856F4633CA(0, 6);
						if (iLocal_60 == 0)
						{
...
{
	unk_0xE85BD4A26C0DFACA(iParam0, sParam1, func_262(iParam2), 1);
}
...
int func_263()
{
	...
	if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		unk_0x00A7785CBA069915(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), 30f, 0, 1, &iVar0, 0, 1, -1);
	}
	iLocal_58 = 0;
	while (iLocal_58 <= 9)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_58]))
		{
			if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_58]))
			{
...
int func_264()
{
	...
	while (iLocal_59 <= 9)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_32[iLocal_59]))
		{
			if (!unk_0x4915F4759304D5CF(iLocal_32[iLocal_59]))
			{
				if (func_2(unk_0xA19140A5C42D8715(), iLocal_32[iLocal_59], 1) < 25f)
				{
					return 1;
				}
			}
...
void func_266()
{
	if (unk_0x97AA049940DBD81F("ARMY_HELI"))
	{
		...
		{
			unk_0xF10C7DDEAC709758("ARMY_HELI", false);
		}
	}
}
...
void func_268()
{
	...
	unk_0x413F34FCFABEDE4B(-2024.2f, 2968f, 30.2f, -2004f, 2921.5f, 37.6f, false, 1);
	unk_0x413F34FCFABEDE4B(-2133.3f, 2993.7f, 41.1f, -2152.7f, 3039.4f, 31.6f, false, 1);
	unk_0x413F34FCFABEDE4B(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, false, 1);
	iLocal_50 = unk_0xF66A39BBE7B3C278(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, 0, 1, 1, 1);
	iLocal_52 = unk_0xF66A39BBE7B3C278(-2168.3f, 3223.6f, 52.8f, -2156.2f, 3205f, 29f, 0, 1, 1, 1);
	unk_0xFDD15D670AD33E10(-1876.8f, 2806.1f, 32.3f, 8f, 1, 0, 0, false);
	unk_0xFDD15D670AD33E10(-1857.7f, 2797.9f, 32.4f, 8f, 1, 0, 0, false);
	unk_0x0B756FF7161B9AB0("WantedMusicOnMission", 1);
	unk_0xFC00A668AFC2126D(joaat("buzzard"), 1);
	unk_0x413F34FCFABEDE4B(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, false, 1);
	unk_0xF54514EACB543898(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, 0);
	unk_0x413F34FCFABEDE4B(-2050.8f, 3139.5f, 41f, -2018.5f, 3160f, 27f, false, 1);
...
void func_270()
{
	...
	unk_0x3EB542A43FE0FAF7(1);
	unk_0x413F34FCFABEDE4B(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, true, 1);
	unk_0x413F34FCFABEDE4B(-2050.8f, 3139.5f, 41f, -2018.5f, 3160f, 27f, true, 1);
	unk_0x783C742AEB66A134();
	unk_0xE70AC26DFC59863A(iLocal_50, 0);
	unk_0xE70AC26DFC59863A(iLocal_51, 0);
	unk_0xE70AC26DFC59863A(iLocal_52, 0);
	func_254(1, 1);
	func_254(2, 1);
	func_254(7, 1);
	func_254(8, 1);
	...
	if (unk_0x97AA049940DBD81F("ARMY_GUARD"))
	{
		if (!unk_0x63D3995CEC2213BA("ARMY_GUARD"))
		{
			unk_0xF10C7DDEAC709758("ARMY_GUARD", true);
		}
	}
	unk_0x17DA1A0960D972AE("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 1);
	unk_0xB4378167DA4A5EC4("AZ_AFB_ALARM_SPEECH", 0, 0);
	...
	if (unk_0x97AA049940DBD81F("ARMY_HELI"))
	{
		if (!unk_0x63D3995CEC2213BA("ARMY_HELI"))
		{
			unk_0xF10C7DDEAC709758("ARMY_HELI", true);
		}
	}
	unk_0x3E11F609741642B7(iLocal_44);
