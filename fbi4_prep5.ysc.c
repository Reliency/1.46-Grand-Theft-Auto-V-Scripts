...
void func_1()
{
	switch (iLocal_82)
	{
		case 0:
			...
			func_20();
			if (!unk_0x429D45A6C6520026(sLocal_189))
			{
				if (unk_0x3CAC2741CC1A631F(sLocal_189, "PRE_FKICKOFF"))
				{
					while ((unk_0xFD34717937104F1C() - iLocal_373) < 2000)
					{
						wait(0);
					}
				}
...
int func_89(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_37(unk_0xA19140A5C42D8715(), vLocal_200, 354.7487f);
				bLocal_28 = false;
				func_23(1, 1, 1);
			}
			else
...
int func_90(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0x6A633E13B2A856AE(sLocal_190, 0);
			unk_0x6A633E13B2A856AE(sLocal_202, 6);
	...
	switch (iLocal_82)
	{
		case 0:
			if (func_89(iLocal_81, bLocal_28))
			{
				...
				if (unk_0xCE3CB618AFE55EFB(iLocal_197))
				{
					unk_0x570128B7829A8EAA(iLocal_197, 2);
					unk_0x75C0882FDDA09D2B(iLocal_197, 2);
				}
		...
		case 1:
			func_100();
			if (func_99(unk_0xA19140A5C42D8715(), vLocal_200, 2f) && func_98(28))
			{
				if (!iLocal_196)
				{
					unk_0xDEE4574BA71257AB(unk_0xD4E735F4B6A956AC());
			...
			else
			{
				...
				else
				{
					...
					if (!func_99(unk_0xA19140A5C42D8715(), vLocal_200, 75f))
					{
						if (!iLocal_195)
						{
							func_21(&iLocal_197);
					...
					else if (func_99(unk_0xA19140A5C42D8715(), vLocal_200, 12f))
					{
						if (iLocal_195)
						{
							func_21(&iLocal_197);
...
int func_172(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_141(unk_0x8F474E419F56E48D(*iParam0), 1) && unk_0x22D95AF01E737CA1(*iParam0, 24) != func_175(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x1EE56D43DA30ADC6(*iParam0, 24, func_175(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_174(iParam0);
	if (func_173(*iParam0))
	{
...
int func_193(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_194(iParam0, uVar1[iVar3], 1) && func_91(unk_0xE2BBD32891C18569(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_189(vParam1, 0f, 0f, 0f, 0)) || unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iParam0, true), unk_0xE2BBD32891C18569(uVar1[iVar3], true), true) < 10f)
					{
...
void func_218()
{
	if (!bLocal_28 && iLocal_81 != 3)
	{
		if (iLocal_81 > 0)
		{
			...
			if (!bLocal_193)
			{
				if (!func_99(unk_0xA19140A5C42D8715(), vLocal_200, 150f))
				{
					func_225(2);
				}
				else if (!func_99(unk_0xA19140A5C42D8715(), vLocal_200, 75f))
				{
					if (!bLocal_201)
					{
						unk_0x4F93066CECE72793();
...
void func_288(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x3B61940560400F58(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_281(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x4BE6499482BEE1D8(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_281(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x4BE6499482BEE1D8(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x6182A22F4D99005E(iVar1, 6, -1, 0, -1, func_289(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_355(bool bParam0)
{
	...
	if (unk_0x37B568B777BC65F9(iLocal_198))
	{
		unk_0x8E88E73F74A9FF79(false, false, 3000, 1, 0, 0);
		unk_0x77F0486CE0E598D5(iLocal_198, 0);
	}
}
