...
void func_1()
{
	...
	if (func_102(unk_0xA19140A5C42D8715()))
	{
		if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
		{
			...
			{
				iLocal_49 = unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0);
				func_118(1);
				func_13(0);
				if (func_102(unk_0xA19140A5C42D8715()))
				{
					if (func_11(&Local_42, &Local_48, unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), &iLocal_54))
					{
						func_8();
					}
				}
			...
			{
				if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), unk_0xE2BBD32891C18569(iLocal_49, 1)) > 62500f)
				{
					func_5();
				}
				else if (!unk_0xCE3CB618AFE55EFB(iLocal_50))
				{
					iLocal_50 = func_2(iLocal_49, 0, 0);
					unk_0x7DB79A42AADE120F(iLocal_50, 308);
				}
			}
			else
			{
...
int func_3(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_4(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_4(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
...
void func_5()
{
	...
	{
		unk_0x792676988A48387F(&iLocal_49);
	}
}
...
void func_83(int iParam0, bool bParam1)
{
	...
	if (iLocal_58[iParam0] == -1)
	{
		...
		{
			if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), Local_48[iParam0 /*11*/].f_3) < (100f * 100f))
			{
				if (func_84(&iVar0))
				{
					unk_0xE48C09EB69BD0CD5(iVar0, Local_48[iParam0 /*11*/].f_3, 8f);
	...
	{
		if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), Local_48[iParam0 /*11*/].f_3) > (105f * 105f))
		{
			if (iLocal_58[iParam0] >= 0 && iLocal_58[iParam0] < 8)
			{
				unk_0xB069C0317474A8BD(iLocal_58[iParam0]);
				iLocal_58[iParam0] = -1;
			}
		}
	}
...
int func_86(var uParam0, var uParam1, vector3 vParam2)
{
	...
	{
		if ((vdist2(vParam2, unk_0x40C0A7A7BE434951((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_17(13)) || func_17(14))
		{
...
void func_120()
{
	...
	while (iVar0 < Local_48)
	{
		...
		{
			unk_0xB069C0317474A8BD(iLocal_58[iVar0]);
		}
		iVar0++;
	}
