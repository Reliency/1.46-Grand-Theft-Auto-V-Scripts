...
void __EntryFunction__()
{
	...
	iLocal_62 = unk_0xEE978C39384D834F(unk_0xD4E735F4B6A956AC());
	iLocal_68 = 0;
	...
	if (unk_0x8B1574454E8C2421(unk_0xB09979570758BDAD()) > 1 && !func_179(uLocal_67, 4194304))
	{
		if (iLocal_78 != 263)
		{
	...
	while (true)
	{
		...
		if (unk_0xDC5D81351D6A4DDB(iLocal_62) && !unk_0x7112137033807390(iLocal_62, 0))
		{
			vLocal_64 = { unk_0xE2BBD32891C18569(iLocal_62, true) };
			...
			switch (iLocal_68)
			{
				...
				case 3:
					...
					if (!func_177(iLocal_73))
					{
						...
						{
							bVar1 = true;
							if (unk_0x3CAC2741CC1A631F(&(Global_93232.f_3), &cLocal_53))
							{
								cLocal_53 = { Local_52 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (!func_164(3) && !Global_93266)
						{
							...
							{
								if ((!func_179(uLocal_67, 1) || !unk_0xDC5D81351D6A4DDB(func_163())) && !Global_93266)
								{
									func_172(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_86, vLocal_87, fLocal_88, 1, false, iLocal_76) || (fLocal_90 > 0f && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), func_138(vLocal_86, vLocal_87, 0.5f), false) > fLocal_90))
							{
								bVar2 = false;
							}
							else if (fLocal_89 > 0f)
							{
								if (unk_0x69C0BB7D03EE045D((vLocal_64.z - vLocal_86.z)) > fLocal_89)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_137(uLocal_63))
								{
									...
									else if (!func_179(uLocal_67, 2048) || !unk_0xE06AA0996C4E4E03())
									{
										func_135(&iLocal_69);
									...
									if (func_133(iLocal_69, 1))
									{
										...
										func_135(&iLocal_69);
										func_185(&uLocal_67, 2048);
										unk_0xD75A4240F0AD8613(&cLocal_53);
				...
				case 5:
					unk_0x9EA8CBEA7355649E(0, 51);
					if (unk_0xB1FDFCECA75CE4A7(&cLocal_53))
					{
						if (iLocal_69 != -1)
						{
							func_135(&iLocal_69);
						...
						if (iVar3 == 1)
						{
							...
							unk_0x4659F4154D948B01(&cLocal_53);
							Local_52 = { cLocal_53 };
				...
				case 6:
					...
					if (func_179(uLocal_67, 2097152))
					{
						if (!func_164(3) && !unk_0x2BCD0524CDEE1FD2(iLocal_51))
						{
							func_172(10);
						}
					}
					if (!unk_0x2BCD0524CDEE1FD2(iLocal_51))
					{
						unk_0x4CA80915EDAE5C7E(round((func_11(&iLocal_80) * 1000f)), iLocal_72, 0);
						func_10(&iLocal_80);
						...
						if (iLocal_72 != -1)
						{
							if (func_179(Global_104721, 0))
							{
								unk_0x5D84F5C14E1207BE(func_19(iLocal_72), 0, Global_93269, 0);
				...
				case 7:
					...
					if (!unk_0x429D45A6C6520026(sLocal_74))
					{
						if (func_1(sLocal_74))
						{
...
void func_44(int iParam0, int iParam1, var uParam2)
{
	...
	while (iVar0 <= 11)
	{
		...
		{
			unk_0x1D7FD491D1DD3BD9(iParam0, iVar0, Var1.f_3, Var1.f_4);
		}
		iVar0++;
	}
	...
	while (iVar2 <= 8)
	{
		...
		if (uVar6[iVar2] != iVar5)
		{
			...
			{
				unk_0xC0C1D93ACE393843(iParam0, iVar4, Var1.f_3, Var1.f_4);
			}
		}
		iVar2++;
	}
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_51(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x3B61940560400F58(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_57(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x4BE6499482BEE1D8(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_57(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x4BE6499482BEE1D8(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x6182A22F4D99005E(iVar1, 6, -1, 0, -1, func_51(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_145()
{
	if (func_166(6) || func_166(7))
	{
		...
		{
			switch (func_146(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true)))
			{
				case 1:
					return func_165(96);
					break;
...
void func_168()
{
	...
	if (bLocal_93 && unk_0x8B1574454E8C2421(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_92 == 1)
		{
			iVar1 = unk_0x22C775856F4633CA(1, 4);
			iVar2[0] = unk_0x22C775856F4633CA(2, 8);
			iVar3 = 1;
...
void func_188()
{
	...
	if (unk_0x2BCD0524CDEE1FD2(iLocal_51))
	{
		unk_0xD64F781E7AD4BE57(iLocal_51, 3);
	}
	if (!unk_0x7032042E5696FFD7(&cLocal_53))
	{
		if (unk_0x245B8CF1349B3FDF(&cLocal_53) != 0)
		{
			unk_0x4659F4154D948B01(&cLocal_53);
		}
	}
