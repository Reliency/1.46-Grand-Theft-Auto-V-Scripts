...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			iLocal_212 = unk_0xFD34717937104F1C();
		}
		func_1();
	}
}
...
void func_1()
{
	...
	switch (iLocal_36)
	{
		case 0:
			...
			if (unk_0xD744813D9841CA9A(0))
			{
				...
				while (iVar1 <= 5)
				{
					if (unk_0xDC5D81351D6A4DDB(Global_104780.f_225[iVar1]))
					{
						uLocal_221[iVar1] = Global_104780.f_225[iVar1];
						Global_104780.f_225[iVar1] = 0;
						unk_0x1F7948851FB36E88(uLocal_221[iVar1], true, 1);
						if (iLocal_226 == 0)
						{
							iLocal_226 = unk_0x8F474E419F56E48D(uLocal_221[iVar1]);
						}
						if (!unk_0x4915F4759304D5CF(uLocal_221[iVar1]))
						{
							unk_0xDFA901280292A2FB(uLocal_221[iVar1], iLocal_224);
							unk_0x8AA21BBDA4DB2C4F(uLocal_221[iVar1], 1);
							unk_0xF63074D1E750B871(uLocal_221[iVar1], 0);
							unk_0xD461381B293D9B46(uLocal_221[iVar1], 5);
							unk_0xB4F2B588B54261BF(uLocal_221[iVar1], 1);
							func_46(uLocal_221[iVar1], 20f, 5f, 90f, -80f, 80f);
							if (iLocal_45 == 0)
							{
								unk_0x8AA21BBDA4DB2C4F(uLocal_221[iVar1], 2);
							}
				...
				while (iVar1 <= 1)
				{
					if (unk_0xDC5D81351D6A4DDB(Global_104780.f_222[iVar1]))
					{
						uLocal_220[iVar1] = Global_104780.f_222[iVar1];
						Global_104780.f_222[iVar1] = 0;
						unk_0x1F7948851FB36E88(uLocal_220[iVar1], true, 1);
						if (iLocal_225 == 0)
						{
							iLocal_225 = unk_0x8F474E419F56E48D(uLocal_220[iVar1]);
						}
					}
					iVar1++;
				}
		...
		case 1:
			...
			while (iVar1 <= 5)
			{
				...
				if (unk_0xDC5D81351D6A4DDB(uLocal_221[iVar1]) && !unk_0x4915F4759304D5CF(uLocal_221[iVar1]))
				{
					bVar3 = false;
				}
				iVar1++;
	...
	while (iVar1 <= 5)
	{
		if (unk_0xDC5D81351D6A4DDB(uLocal_221[iVar1]))
		{
			if (unk_0x4915F4759304D5CF(uLocal_221[iVar1]))
			{
				unk_0x7E4E83D33161D01A(&(uLocal_221[iVar1]));
			}
			else if (func_6(uLocal_221[iVar1], func_7(func_8()), 1) > 100f && func_5(unk_0xA19140A5C42D8715(), uLocal_221[iVar1], 1) > 300f)
			{
				func_4();
			}
		...
		if (unk_0xCE3CB618AFE55EFB(uLocal_223[iVar1]))
		{
			if (!unk_0xDC5D81351D6A4DDB(uLocal_221[iVar1]) || unk_0x4915F4759304D5CF(uLocal_221[iVar1]))
			{
				unk_0xE1623437A3194332(&(uLocal_223[iVar1]));
			}
		}
		iVar1++;
	}
...
void func_9()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0xDC5D81351D6A4DDB(uLocal_221[iVar0]) && !unk_0x4915F4759304D5CF(uLocal_221[iVar0]))
		{
			...
			{
				iVar3 = 0;
				unk_0xF990CFC0F1D94A39(uLocal_221[iVar0], &iVar3, 1);
				if (iVar3 == joaat("weapon_molotov"))
				{
					if (unk_0x22B3625D717A4563(uLocal_221[iVar0], joaat("weapon_microsmg"), 0))
					{
						unk_0xB20B772FD9DE1847(uLocal_221[iVar0], joaat("weapon_microsmg"), true);
					}
					else
					{
						unk_0xF0188A1B49D79AF7(uLocal_221[iVar0], joaat("weapon_microsmg"), -1, true, true);
					}
				}
			}
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					{
						unk_0xDA4D3941AFF8EF12(uLocal_221[iVar0], unk_0xA19140A5C42D8715(), 0, 16);
					}
					break;
				...
				case 2:
					...
					{
						unk_0x33B5487515BD13D5(uLocal_221[iVar0], unk_0xA19140A5C42D8715(), 1000f, -1, 1, 0);
					}
					break;
				}
		}
	...
	switch (iLocal_211)
	{
		case 0:
			...
			{
				iVar4 = func_30();
				if (iVar4 != -1 && !unk_0xF59ACE94F067B46D(uLocal_221[iVar4]))
				{
		...
		case 3:
			if ((func_31() && (unk_0xFD34717937104F1C() - iLocal_212) > 3000) && !unk_0xF59ACE94F067B46D(unk_0xA19140A5C42D8715()))
			{
		...
		case 4:
			if (func_31() && (unk_0xFD34717937104F1C() - iLocal_212) > 1000)
			{
				iVar4 = func_30();
				if (iVar4 != -1 && !unk_0xF59ACE94F067B46D(uLocal_221[iVar4]))
				{
...
{
	unk_0xE85BD4A26C0DFACA(iParam0, sParam1, func_29(iParam2), 1);
}
...
int func_30()
{
	...
	while (iVar1 <= 5)
	{
		if (unk_0xDC5D81351D6A4DDB(uLocal_221[iVar1]) && !unk_0x4915F4759304D5CF(uLocal_221[iVar1]))
		{
			fVar3 = func_5(uLocal_221[iVar1], unk_0xA19140A5C42D8715(), 1);
...
void func_33(int iParam0, vector3 vParam1)
{
	...
	if (!func_36(vParam1))
	{
		...
		if (iVar0 == joaat("weapon_molotov"))
		{
			...
			{
				unk_0xB20B772FD9DE1847(iParam0, joaat("weapon_molotov"), true);
			}
			if (unk_0xF9D4EF1338E38AFB(iParam0, 242628503) != 1 && unk_0xF9D4EF1338E38AFB(iParam0, 242628503) != 0)
			{
				...
				unk_0x01BDF74D6C74605B(0, func_34(vParam1, 1f), 0, 0);
				unk_0xB3E1967E66494060(0, unk_0x22C775856F4633CA(1000, 6000));
				unk_0x01BDF74D6C74605B(0, func_34(vParam1, 1f), 0, 0);
				unk_0xB3E1967E66494060(0, unk_0x22C775856F4633CA(1000, 6000));
				unk_0x01BDF74D6C74605B(0, func_34(vParam1, 1f), 0, 0);
				...
				unk_0xE1072FA2FECBAD96(iParam0, iVar2);
		...
		{
			unk_0xAF36EFD37EE8B02A(iParam0, vParam1, -1, -687903391);
		}
	}
...
Vector3 func_34(vector3 vParam0, float fParam1)
{
	...
	return vParam0 + func_35(vVar0, unk_0xF59B9063EDAC7451(0f, fParam1));
}
...
int func_37(int iParam0)
{
	...
	while (iVar0 <= 5)
	{
		if ((unk_0xDC5D81351D6A4DDB(uLocal_221[iVar0]) && !unk_0x4915F4759304D5CF(uLocal_221[iVar0])) && uLocal_222[iVar0] > 0)
		{
			iLocal_219 = 1;
		}
		iVar0++;
	}
	if (((((((((((func_38(Global_104780.f_35, 134217728) || unk_0x85E4CC19842B6048(uLocal_221[iParam0], unk_0xA19140A5C42D8715())) || unk_0xCCF89CDD3583210D(unk_0xD4E735F4B6A956AC(), uLocal_221[iParam0])) || unk_0x80C8B831B972D6A0(uLocal_221[iParam0])) || unk_0x9809FE4B550B1EFE(unk_0xE2BBD32891C18569(uLocal_221[iParam0], true), 15f, 1)) || unk_0xB3CB9098064F83A7(unk_0xE2BBD32891C18569(uLocal_221[iParam0], true), 15f, 1, 1)) || unk_0x6D7FFF527E125F24(21, unk_0xE2BBD32891C18569(uLocal_221[iParam0], true), 15f)) || unk_0x6D7FFF527E125F24(10, unk_0xE2BBD32891C18569(uLocal_221[iParam0], true), 15f)) || unk_0x6D7FFF527E125F24(7, unk_0xE2BBD32891C18569(uLocal_221[iParam0], true), 15f)) || unk_0x6D7FFF527E125F24(0, unk_0xE2BBD32891C18569(uLocal_221[iParam0], true), 15f)) || unk_0x6D7FFF527E125F24(1, unk_0xE2BBD32891C18569(uLocal_221[iParam0], true), 15f)) || iLocal_219)
	{
		return 1;
	}
	return 0;
...
void func_39()
{
	...
	while (iVar0 <= 1)
	{
		if (unk_0xDC5D81351D6A4DDB(uLocal_220[iVar0]) && unk_0x1095F403F52B42E1(uLocal_220[iVar0], 0))
		{
			iVar2 = 0;
			while (iVar2 <= 5)
			{
				if (unk_0xDC5D81351D6A4DDB(uLocal_221[iVar2]) && !unk_0x4915F4759304D5CF(uLocal_221[iVar2]))
				{
					if (Local_37[iVar2 /*10*/].f_8 != -1 && Local_37[iVar2 /*10*/].f_8 == iVar0)
					{
						if (!unk_0xE0FD180CD24C0B67(uLocal_221[iVar2], uLocal_220[iVar0], 0))
						{
							uVar1[iVar0]++;
						}
					}
		...
		unk_0x73B1F715F502CBFC(&cVar3, 0.05f, (0.25f + (IntToFloat(iVar0) * 0.025f)), 0f, 255, 255, 255, 255);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
		...
		if (unk_0xDC5D81351D6A4DDB(uLocal_221[iVar0]) && !unk_0x4915F4759304D5CF(uLocal_221[iVar0]))
		{
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					{
						if (!unk_0x70F79B0BFBB1E7AC(uLocal_221[iVar0], 286, 1))
						{
							unk_0x13E0A8160525AE55(uLocal_221[iVar0], 286, true);
						}
					}
					else
					{
						bVar5 = false;
						if (unk_0x5D7DFE2058701942(uLocal_221[iVar0], 0))
						{
							iVar6 = unk_0xCAEB6CE71A2C7212(uLocal_221[iVar0], 0);
							iVar4 = 0;
							while (iVar4 <= 1)
							{
								if (!bVar5)
				...
				case 2:
					if (iLocal_215 != -1)
					{
						...
						if (unk_0xDC5D81351D6A4DDB(uLocal_221[iLocal_215]))
						{
							if (unk_0x5D7DFE2058701942(uLocal_221[iLocal_215], 0))
							{
								iVar7 = unk_0xCAEB6CE71A2C7212(uLocal_221[iLocal_215], 0);
							}
						}
					}
					if ((((((((iLocal_215 == -1 || !unk_0xDC5D81351D6A4DDB(uLocal_221[iLocal_215])) || unk_0x4915F4759304D5CF(uLocal_221[iLocal_215])) || !unk_0xDC5D81351D6A4DDB(iVar7)) || !unk_0x1095F403F52B42E1(iVar7, 0)) || unk_0xB7223494EA10AF2F(iVar7, 0, 1)) || unk_0xB7223494EA10AF2F(iVar7, 1, 1)) || unk_0xB7223494EA10AF2F(iVar7, 4, 1)) || unk_0xB7223494EA10AF2F(iVar7, 5, 1))
					{
						iVar8 = -1;
						bVar9 = false;
						iVar4 = 0;
						while (iVar4 <= 5)
						{
							if (unk_0xDC5D81351D6A4DDB(uLocal_221[iVar4]) && !unk_0x4915F4759304D5CF(uLocal_221[iVar4]))
							{
			...
			{
				iVar10 = 0;
				unk_0xF990CFC0F1D94A39(uLocal_221[iVar0], &iVar10, 1);
			...
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					else if (!unk_0xE0FD180CD24C0B67(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0))
					{
						if (func_5(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 1) > 4f)
						{
							if (!func_32(uLocal_221[iVar0], 780511057, 1))
							{
								unk_0x69B24912FFBEB2B0(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0f, 0f, 0f, 4f, 0);
								unk_0xDA4D3941AFF8EF12(uLocal_221[iVar0], unk_0xA19140A5C42D8715(), 0, 16);
							}
						}
						else if (!func_32(uLocal_221[iVar0], -1794415470, 1))
						{
							unk_0xA2EBCD9385E56019(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], -1, Local_37[iVar0 /*10*/].f_9, 2f, 1, 0);
						}
					}
					else if (!func_32(uLocal_221[iVar0], 538064912, 1))
					{
						unk_0x66A9EE60A465A328(uLocal_221[iVar0], unk_0xA19140A5C42D8715(), 1101004800);
					}
					break;
					...
					if (unk_0x5D7DFE2058701942(uLocal_221[iVar0], 0))
					{
						if (iLocal_215 == iVar0)
						{
							if (func_40(uLocal_221[iVar0], 0) != -1)
							{
								...
								{
									unk_0x9F76F280DA42821D(uLocal_221[iVar0], unk_0xCAEB6CE71A2C7212(uLocal_221[iVar0], 0), 0);
								}
							}
							else if (!func_32(uLocal_221[iVar0], -1273030092, 1) || iLocal_215 != iLocal_216)
							{
								unk_0x5175E271E03B40D8(uLocal_221[iVar0], unk_0xCAEB6CE71A2C7212(uLocal_221[iVar0], 0), unk_0xA19140A5C42D8715(), 8, 40f, 786468, 1000f, 0f, 1);
							}
							else if (unk_0xF9D4EF1338E38AFB(uLocal_221[iVar0], -1273030092) == 1)
							{
								if (!unk_0x5CEAC7C46CA2644F(uLocal_221[iVar0]))
								{
									unk_0xF486A07743D53969(uLocal_221[iVar0], unk_0xA19140A5C42D8715(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
								}
							}
						}
						else if (func_40(uLocal_221[iVar0], 0) == -1)
						{
							...
							{
								unk_0x4D32DFDD33A9C5C3(uLocal_221[iVar0], unk_0xCAEB6CE71A2C7212(uLocal_221[iVar0], 0), unk_0xCAEB6CE71A2C7212(uLocal_221[iLocal_215], 0), -1, 40f, 786468, -1f, 20, 20f);
							}
							else if (unk_0xF9D4EF1338E38AFB(uLocal_221[iVar0], -1273030092) == 1)
							{
								if (!unk_0x5CEAC7C46CA2644F(uLocal_221[iVar0]))
						...
						{
							iVar11 = unk_0xB0D49A1F9F054602(unk_0xCAEB6CE71A2C7212(uLocal_221[iVar0], 0), -1, 0);
							if (!unk_0xDC5D81351D6A4DDB(iVar11) || unk_0x4915F4759304D5CF(iVar11))
							{
								if (!func_32(uLocal_221[iVar0], 355471868, 1))
								{
									unk_0x9F76F280DA42821D(uLocal_221[iVar0], unk_0xCAEB6CE71A2C7212(uLocal_221[iVar0], 0), 0);
	...
	switch (iLocal_211)
	{
		case 0:
			...
			{
				iVar12 = func_30();
				if (iVar12 != -1 && !unk_0xF59ACE94F067B46D(uLocal_221[iVar12]))
				{
		...
		case 4:
			if (func_31() && (unk_0xFD34717937104F1C() - iLocal_212) > 1000)
			{
				...
				if (iVar12 != -1 && !unk_0xF59ACE94F067B46D(uLocal_221[iVar12]))
				{
					if (unk_0x5D7DFE2058701942(uLocal_221[iVar12], 0))
					{
...
int func_44(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_45(unk_0x4C9BACA8D249CB13(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x575CF00E129E0CE1(iVar0, func_45(unk_0x4C9BACA8D249CB13(), 0.7f, 0.7f));
		unk_0xF46EDCACB3804F87(iVar0, bParam1);
	}
...
void func_48()
{
	...
	{
		case 0:
			func_54(&uLocal_46, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
			break;
		
		case 1:
			func_54(&uLocal_46, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
			break;
		
		case 2:
			func_54(&uLocal_46, 2, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
			break;
	}
	...
	unk_0x94E87D83163B4BEB("relGang", &iLocal_224);
	unk_0x80E7C4A78224C8F9(5, 1862763509, iLocal_224);
	unk_0x80E7C4A78224C8F9(5, iLocal_224, 1862763509);
	unk_0x80E7C4A78224C8F9(5, iLocal_224, -1533126372);
	switch (iVar0)
	{
		case 0:
			unk_0x80E7C4A78224C8F9(5, 1862763509, 296331235);
			unk_0x80E7C4A78224C8F9(1, iLocal_224, 296331235);
			unk_0x80E7C4A78224C8F9(1, 296331235, iLocal_224);
			break;
		
		case 1:
			unk_0x80E7C4A78224C8F9(5, 1862763509, -1033021910);
			unk_0x80E7C4A78224C8F9(1, iLocal_224, -1033021910);
			unk_0x80E7C4A78224C8F9(1, -1033021910, iLocal_224);
			break;
		
		case 2:
			unk_0x80E7C4A78224C8F9(5, 1862763509, 1782292358);
			unk_0x80E7C4A78224C8F9(1, iLocal_224, 1782292358);
			unk_0x80E7C4A78224C8F9(1, 1782292358, iLocal_224);
			break;
	}
}
...
void func_55()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0xDC5D81351D6A4DDB(uLocal_221[iVar0]))
		{
			if (!unk_0x4915F4759304D5CF(uLocal_221[iVar0]) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
			{
				unk_0x33B5487515BD13D5(uLocal_221[iVar0], unk_0xA19140A5C42D8715(), 1000f, -1, 0, 1);
			}
			unk_0x7E4E83D33161D01A(&(uLocal_221[iVar0]));
		}
		if (unk_0xCE3CB618AFE55EFB(uLocal_223[iVar0]))
		{
			unk_0xE1623437A3194332(&(uLocal_223[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		if (unk_0xDC5D81351D6A4DDB(uLocal_220[iVar0]))
		{
			unk_0x792676988A48387F(&(uLocal_220[iVar0]));
		}
		iVar0++;
	}
	unk_0x8DB49F2EDD326F53(iLocal_225, false);
	unk_0xFC00A668AFC2126D(iLocal_226, false);
