...
int func_20(int iParam0, int iParam1)
{
	...
	while (func_21(&Var7, iParam1, iVar6, 0))
	{
		...
		if (unk_0x15763A17141CD6EE(iParam0, iParam1, Var7))
		{
			if (Var7.f_4 == joaat("WAPClip"))
			{
				iVar5 = Var7.f_6;
	...
	if (unk_0xB0D321650C1598FF(iParam1) > 0 && unk_0x52AB19133B083547(iParam0, iParam1) == 0)
	{
		return 0;
	}
	return 1;
...
int func_22(int iParam0, int iParam1)
{
	...
	if (unk_0x4C9BACA8D249CB13() && func_66())
	{
		...
		func_60(&sVar10, Var11, unk_0x8F474E419F56E48D(unk_0xA19140A5C42D8715()), 3, 1, func_62(iParam0), func_61(iParam0), -1, 0, 0);
...
{
	return (shift_right(iParam0, 26) & 31 * func_36(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
bool func_74(int iParam0, int iParam1, int iParam2)
{
	...
	return unk_0x05EFB6A616B6FADE(iVar0, func_75(iVar1));
}
...
void func_87(int iParam0, var uParam1)
{
	...
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x3D2A81E3C295D501(iParam0, func_90(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x8798F3E6AE76AF63(iVar5, &Var7) && !func_88(Var7.f_1)) && iVar9 < 50)
			{
...
int func_118(bool bParam0)
{
	...
	unk_0x2AD48F3CEBA882E9(joaat("num_discipline_gold_earned"), &iVar3, -1);
	if (iVar1 > iVar3 && iVar1 > 0)
	{
		unk_0x93180BE33E7149EF(joaat("num_discipline_gold_earned"), iVar1, 1);
		func_132(17, iVar1);
	}
	if (bParam0)
	{
...
void func_148()
{
	...
	if (unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
	{
		iVar0 = unk_0xAFAA7D018FC27569(unk_0xA19140A5C42D8715());
