...
void func_1()
{
	switch (iLocal_80)
	{
		...
		case 1:
			...
			func_215(&uLocal_83, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
...
int func_303(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_273(unk_0x8F474E419F56E48D(*iParam0), 1) && unk_0x22D95AF01E737CA1(*iParam0, 24) != func_306(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x1EE56D43DA30ADC6(*iParam0, 24, func_306(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_305(iParam0);
	if (func_304(*iParam0))
	{
...
int func_321(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_323(iParam0, uVar1[iVar3], 1) && func_322(unk_0xE2BBD32891C18569(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_317(vParam1, 0f, 0f, 0f, 0)) || unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iParam0, 1), unk_0xE2BBD32891C18569(uVar1[iVar3], 1), true) < 10f)
					{
...
int func_365(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_371())
	{
		...
		{
			iVar2 = func_366(unk_0x61D2332983ACC05C());
			if (iVar2 > -1)
			{
