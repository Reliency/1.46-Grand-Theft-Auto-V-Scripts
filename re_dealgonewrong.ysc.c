...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if ((unk_0x1F85F8C7CC4639AE() || unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -1503.54f, 4934.923f, 114.2284f, 100f, 100f, 100f, false, true, 0)) || iLocal_45 == 2)
		{
			if (!func_124())
			{
				if (func_123())
				...
				case 2:
					switch (iLocal_44)
					{
						...
						case 1:
								...
								if (!func_75())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_110)
										{
											...
											func_69(iLocal_88[0], unk_0xD1A189C6C27EE0CA(unk_0xA19140A5C42D8715()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_69(iLocal_88[1], unk_0xD1A189C6C27EE0CA(unk_0xA19140A5C42D8715()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 2f, 0f, 1000, 0f);
										...
										else if (bLocal_107)
										{
											...
											func_69(iLocal_86[0], unk_0xD1A189C6C27EE0CA(unk_0xA19140A5C42D8715()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_69(iLocal_86[1], unk_0xD1A189C6C27EE0CA(unk_0xA19140A5C42D8715()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
										...
										else if (bLocal_108)
										{
											...
											func_69(iLocal_87[0], unk_0xD1A189C6C27EE0CA(unk_0xA19140A5C42D8715()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_69(iLocal_87[1], unk_0xD1A189C6C27EE0CA(unk_0xA19140A5C42D8715()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
							...
							if (((unk_0x2206F47E5C82D52C(unk_0xA19140A5C42D8715()) || unk_0x47A53E3686340604(unk_0xA19140A5C42D8715())) && !unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_100, 100f, 100f, 100f, false, true, 0)) && iLocal_46 < 2)
							{
								func_41();
							}
							break;
...
void func_1()
{
	...
	if (iLocal_282 && !iLocal_105)
	{
		...
		while (iVar0 < 4)
		{
			if (unk_0xCE3CB618AFE55EFB(iLocal_93[iVar0]))
			{
				unk_0xE1623437A3194332(&(iLocal_93[iVar0]));
			}
			if (unk_0xCE3CB618AFE55EFB(uLocal_95[iVar0]))
			{
				unk_0xE1623437A3194332(&(uLocal_95[iVar0]));
			}
			if (iLocal_46 >= 6)
			{
				if (unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
				{
					if (!unk_0x4915F4759304D5CF(iLocal_83[iVar0]))
					{
						if (unk_0x10E54C268D1B3FED(iLocal_83[iVar0], unk_0xA19140A5C42D8715(), 100f, 100f, 100f, 0, 1, 0))
						{
							bLocal_109 = true;
						}
					}
		...
		while (iVar0 < 4)
		{
			if (unk_0xCE3CB618AFE55EFB(iLocal_94[iVar0]))
			{
				unk_0xE1623437A3194332(&(iLocal_94[iVar0]));
			}
			if (unk_0xCE3CB618AFE55EFB(uLocal_96[iVar0]))
			{
				unk_0xE1623437A3194332(&(uLocal_96[iVar0]));
			}
			if (iLocal_46 >= 6)
			{
				if (unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
				{
					...
					{
						if (unk_0x10E54C268D1B3FED(iLocal_84[iVar0], unk_0xA19140A5C42D8715(), 100f, 100f, 100f, 0, 1, 0))
						{
							bLocal_109 = true;
						}
					}
	...
	if (!unk_0x317672E799676CA5(vLocal_100, 30f) && vdist(func_2(unk_0xD4E735F4B6A956AC()), vLocal_100) > 300f)
	{
		func_170();
	}
}
	...
	if (unk_0xDC5D81351D6A4DDB(*uParam2))
	{
		if (unk_0x1095F403F52B42E1(*uParam2, 0))
		{
			...
			if (!unk_0xCE3CB618AFE55EFB(*iParam3))
			{
				if (iVar0 == 1)
				{
					*iParam3 = func_65(unk_0xE2BBD32891C18569(*uParam2, true), 0);
			...
			else
			{
				...
				vVar2 = { unk_0xE2BBD32891C18569(*uParam2, true) };
...
void func_69(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, var uParam6, vector3 vParam7, int iParam8, float fParam9)
{
	...
	if (unk_0xDC5D81351D6A4DDB(iParam0) && unk_0x1095F403F52B42E1(iParam0, 0))
	{
		if (((((((unk_0xDC5D81351D6A4DDB(iParam1) && iParam0 != iParam1) && !unk_0x71852D4EBD08275F(unk_0x8F474E419F56E48D(iParam1))) && !unk_0xCA8C103FCD316F89(unk_0x8F474E419F56E48D(iParam1))) && !unk_0x7C197233F79C2CB8(unk_0x8F474E419F56E48D(iParam1))) && !unk_0x289FBFAD3E416C48(unk_0x8F474E419F56E48D(iParam1))) && unk_0x678F978B0FAD24D2(iParam1)) && func_73(iParam0))
		{
			...
			{
				if (func_71(iParam0, iParam1, 1) > fParam9 && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(iParam1, true), *uParam2, true) > 20f)
				{
					if (!func_70(*uParam2))
					{
						...
						{
							vVar0 = { unk_0x2F230B37E9FFF23F(vLocal_61, fLocal_60, vParam7) };
							if (!func_70(vVar0))
							{
								if (!unk_0x317672E799676CA5(vVar0, 2f))
								{
									...
									unk_0x92DDCF53AA47A63D(iParam0, fLocal_60);
									unk_0x99F546A9200EA026(iParam0, 1084227584);
									unk_0x625FB4B0328423D9(iParam0, 10f);
									unk_0xC19EDC1D7179164C(iParam0, true, true, 0);
									*uParam6 = unk_0xFD34717937104F1C();
...
int func_75()
{
	...
	while (iVar1 < 4)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_83[iVar1]))
		{
			if (!unk_0x4915F4759304D5CF(iLocal_83[iVar1]))
			{
				if (unk_0x10E54C268D1B3FED(iLocal_83[iVar1], unk_0xA19140A5C42D8715(), 200f, 200f, 200f, 0, 1, 0))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < 4)
	{
		if (unk_0xDC5D81351D6A4DDB(iLocal_84[iVar1]))
		{
			if (!unk_0x4915F4759304D5CF(iLocal_84[iVar1]))
			{
				if (unk_0x10E54C268D1B3FED(iLocal_84[iVar1], unk_0xA19140A5C42D8715(), 200f, 200f, 200f, 0, 1, 0))
				{
					iVar0 = 0;
				}
			}
...
void func_76()
{
	...
	if (bLocal_283)
	{
		...
		{
			if (!unk_0x4915F4759304D5CF(iLocal_83[0]) && !unk_0x7112137033807390(iLocal_86[0], 0))
			{
			}
			if (!unk_0x4915F4759304D5CF(iLocal_83[1]) && !unk_0x7112137033807390(iLocal_86[1], 0))
			{
			}
		}
		else
		{
			if (!unk_0x4915F4759304D5CF(iLocal_84[0]) && !unk_0x7112137033807390(iLocal_87[0], 0))
			{
			}
			if (!unk_0x4915F4759304D5CF(iLocal_84[1]) && !unk_0x7112137033807390(iLocal_87[1], 0))
			{
			}
		}
		iVar0 = 0;
		while (iVar0 < 4)
		{
			unk_0x5F87F858033E86C8(iLocal_99[iVar0]);
			if (unk_0x4915F4759304D5CF(iLocal_83[iVar0]))
			{
				if (unk_0xCE3CB618AFE55EFB(iLocal_93[iVar0]))
				{
			...
			else if (!unk_0x5D7DFE2058701942(iLocal_83[iVar0], 0))
			{
				if (!unk_0xCE3CB618AFE55EFB(iLocal_93[iVar0]))
				{
		...
		while (iVar0 < 4)
		{
			...
			else if (!unk_0x5D7DFE2058701942(iLocal_84[iVar0], 0))
			{
				if (!unk_0xCE3CB618AFE55EFB(iLocal_94[iVar0]))
				{
	...
	{
		case 0:
			if (((unk_0xCDB904F469555646(unk_0xD4E735F4B6A956AC()) || !unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_100 + Vector(0f, 20f, 0f), 170f, 270f, 50f, false, true, 0)) || unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, false, true, 0)) || unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, false, true, 0))
			{
				if (!bLocal_110)
				{
					if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, false, true, 0) || unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, false, true, 0))
					{
						bLocal_110 = true;
					}
				}
				if (unk_0xA177613398FB538B(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), &vLocal_102, 1, 1077936128, 0))
				{
					if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_102, 20f, 20f, 20f, false, true, 0))
					{
						unk_0x60DEFBFF740D4C09(5, true);
						unk_0x60DEFBFF740D4C09(3, true);
						settimera(0);
		...
		case 2:
			if (bLocal_110)
			{
				if (timera() > 3500)
				{
					if (((!unk_0x7112137033807390(iLocal_88[0], 0) && !unk_0x7112137033807390(iLocal_88[1], 0)) && !unk_0x4915F4759304D5CF(iLocal_83[0])) && !unk_0x4915F4759304D5CF(iLocal_83[1]))
					{
						unk_0x692D5500D82E4F5D(iLocal_83[0], iLocal_88[0], -1);
						unk_0x692D5500D82E4F5D(iLocal_83[1], iLocal_88[1], -1);
						unk_0x3B7A32E04BBE59A5(iLocal_83[0], 3, false);
						unk_0x3B7A32E04BBE59A5(iLocal_83[1], 3, false);
						unk_0x241F3D2BEEB0124B(iLocal_83[0], 0);
						unk_0x241F3D2BEEB0124B(iLocal_83[1], 0);
						iLocal_46 = 5;
					}
				}
			}
		...
		case 3:
			vLocal_103 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
			iLocal_76 = unk_0x22C775856F4633CA(10, 15);
			if (!unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, false, true, 0))
			{
				if (unk_0x5D260ECB08BF5B88(vLocal_103, iLocal_76, &(vLocal_280[0 /*3*/]), 1, 3f, 0f))
				{
					vLocal_280[1 /*3*/] = { vLocal_280[0 /*3*/] + Vector(0f, 5f, 0f) };
					if (!unk_0x317672E799676CA5(vLocal_280[0 /*3*/], 7f) && !unk_0x317672E799676CA5(vLocal_280[1 /*3*/], 7f))
					{
						if (unk_0x1095F403F52B42E1(iLocal_86[0], 0))
						{
							unk_0x4299736016AECE26(iLocal_86[0], vLocal_280[0 /*3*/], 1, false, 0, 1);
							func_88(iLocal_86[0], iLocal_83[0]);
						}
						if (unk_0x1095F403F52B42E1(iLocal_86[1], 0))
						{
							unk_0x4299736016AECE26(iLocal_86[1], vLocal_280[1 /*3*/], 1, false, 0, 1);
		...
		case 4:
			vLocal_103 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
			iLocal_76 = unk_0x22C775856F4633CA(30, 35);
			if (!unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, false, true, 0))
			{
				if (unk_0x5D260ECB08BF5B88(vLocal_103, iLocal_76, &(vLocal_280[0 /*3*/]), 1, 3f, 0f))
				{
					...
					if (!unk_0x317672E799676CA5(vLocal_280[0 /*3*/], 7f) && !unk_0x317672E799676CA5(vLocal_280[1 /*3*/], 7f))
					{
						if (unk_0x1095F403F52B42E1(iLocal_87[0], 0))
						{
							unk_0x4299736016AECE26(iLocal_87[0], vLocal_280[0 /*3*/], 1, false, 0, 1);
							func_88(iLocal_87[0], iLocal_84[0]);
						}
						if (unk_0x1095F403F52B42E1(iLocal_87[1], 0))
						{
							unk_0x4299736016AECE26(iLocal_87[1], vLocal_280[1 /*3*/], 1, false, 0, 1);
		...
		case 5:
			vLocal_103 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
			iLocal_76 = unk_0x22C775856F4633CA(5, 10);
			if (unk_0x5D260ECB08BF5B88(vLocal_103, iLocal_76, &(vLocal_280[0 /*3*/]), 1, 3f, 0f))
			{
				vLocal_280[1 /*3*/] = { vLocal_280[0 /*3*/] + Vector(0f, 5f, 0f) };
				if (!unk_0x317672E799676CA5(vLocal_280[0 /*3*/], 7f) && !unk_0x317672E799676CA5(vLocal_280[1 /*3*/], 7f))
				{
					if (unk_0x1095F403F52B42E1(iLocal_88[0], 0))
					{
						unk_0x4299736016AECE26(iLocal_88[0], vLocal_280[0 /*3*/], 1, false, 0, 1);
						func_88(iLocal_88[0], iLocal_83[0]);
					}
					if (unk_0x1095F403F52B42E1(iLocal_88[1], 0))
					{
						unk_0x4299736016AECE26(iLocal_88[1], vLocal_280[1 /*3*/], 1, false, 0, 1);
		...
		case 6:
			if (func_63())
			{
				fLocal_64 = unk_0xF59B9063EDAC7451(1.5f, 2.5f);
				fLocal_65 = unk_0xF59B9063EDAC7451(2f, 4f);
				fLocal_66 = unk_0xF59B9063EDAC7451(0.1f, 2f);
				if (iLocal_78 < 5 && iLocal_79 < unk_0xFD34717937104F1C())
				{
					vLocal_50 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
					unk_0x1E368F42D982FEE0((vLocal_50.x + fLocal_64), (vLocal_50.y + fLocal_65), (vLocal_50.z + fLocal_66), (vLocal_50.x - fLocal_64), (vLocal_50.y - fLocal_65), vLocal_50.z, 10, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
					iLocal_79 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(200, 500));
					iLocal_78++;
				}
			}
			if (iLocal_78 > 4)
...
void func_88(int iParam0, int iParam1)
{
	...
	unk_0x99F546A9200EA026(iParam0, 1084227584);
	vLocal_279 = { unk_0xE2BBD32891C18569(iParam0, true) };
	vLocal_281 = { vLocal_103 - vLocal_279 };
	unk_0x92DDCF53AA47A63D(iParam0, unk_0x0C1B8F3F6EFDC58B(vLocal_281.x, vLocal_281.y));
	if (bLocal_110)
	{
		if (!unk_0x4915F4759304D5CF(iParam1))
		{
			if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
			{
				unk_0x12ECD81B688FFCAB(iParam1, unk_0xA19140A5C42D8715());
				wait(1);
				if (!unk_0x4915F4759304D5CF(iParam1))
				{
					unk_0x12E737663A23689F(iParam1, 32, 1);
				}
			}
			else
			{
				unk_0x5175E271E03B40D8(iParam1, iParam0, unk_0xA19140A5C42D8715(), 6, 20f, 786469, -1f, -1f, 1);
			}
			if (!unk_0x7112137033807390(iParam0, 0))
			{
	...
	else if (!unk_0x4915F4759304D5CF(iParam1))
	{
		if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			unk_0x12ECD81B688FFCAB(iParam1, unk_0xA19140A5C42D8715());
		...
		{
			unk_0x5175E271E03B40D8(iParam1, iParam0, unk_0xA19140A5C42D8715(), 2, 100f, 786469, -1f, -1f, 1);
		}
		unk_0x625FB4B0328423D9(iParam0, unk_0xEAA5CEF8875FEEED(unk_0xA19140A5C42D8715()));
	}
}
...
void func_89()
{
	...
	iLocal_86[0] = unk_0x48CFBECB146FD1A1(joaat("rebel"), -1595.964f, 4732.479f, 0f, 305f, true, true, false);
	unk_0x1F7948851FB36E88(iLocal_86[0], true, 0);
	unk_0xC19EDC1D7179164C(iLocal_86[0], true, true, 0);
	unk_0x6EB2D9504928F849(iLocal_86[0], 2);
	unk_0x83055D7E96024509(iLocal_86[0], true);
	unk_0xB29E08C7AB729BAD(iLocal_86[0], true);
	unk_0xAA8C8977AD74EDE5(iLocal_86[0], "49GNL112");
	iLocal_86[1] = unk_0x48CFBECB146FD1A1(joaat("rebel"), -1570.34f, 4733.755f, 0f, 305f, true, true, false);
	unk_0x1F7948851FB36E88(iLocal_86[1], true, 0);
	unk_0xC19EDC1D7179164C(iLocal_86[1], true, true, 0);
	unk_0x6EB2D9504928F849(iLocal_86[1], 2);
	unk_0x83055D7E96024509(iLocal_86[1], true);
	unk_0xB29E08C7AB729BAD(iLocal_86[1], true);
	unk_0xAA8C8977AD74EDE5(iLocal_86[1], "47TMS703");
	iLocal_88[0] = unk_0x48CFBECB146FD1A1(joaat("sanchez"), Vector(0f, 4732.479f, -1595.964f) + Vector(10f, 10f, 10f), 305f, true, true, false);
	unk_0x1F7948851FB36E88(iLocal_88[0], true, 0);
	unk_0xC19EDC1D7179164C(iLocal_88[0], true, true, 0);
	unk_0x6EB2D9504928F849(iLocal_88[0], 2);
	unk_0x83055D7E96024509(iLocal_88[0], true);
	unk_0xB29E08C7AB729BAD(iLocal_88[0], true);
	unk_0xAA8C8977AD74EDE5(iLocal_88[0], "49GNL112");
	iLocal_88[1] = unk_0x48CFBECB146FD1A1(joaat("sanchez"), Vector(0f, 4733.755f, -1570.34f) + Vector(10f, 10f, 10f), 305f, true, true, false);
	unk_0x1F7948851FB36E88(iLocal_88[1], true, 0);
	unk_0xC19EDC1D7179164C(iLocal_88[1], true, true, 0);
	unk_0x6EB2D9504928F849(iLocal_88[1], 2);
	unk_0x83055D7E96024509(iLocal_88[1], true);
	unk_0xB29E08C7AB729BAD(iLocal_88[1], true);
	unk_0xAA8C8977AD74EDE5(iLocal_88[1], "47TMS703");
	iLocal_83[0] = unk_0x91A7C8CA5E332C03(iLocal_86[0], 26, joaat("g_m_m_chigoon_02"), -1, 1, true);
	iLocal_83[1] = unk_0x91A7C8CA5E332C03(iLocal_86[1], 26, joaat("g_m_m_chigoon_02"), -1, 1, true);
	if (!bLocal_110)
	{
		iLocal_83[2] = unk_0x91A7C8CA5E332C03(iLocal_86[0], 26, joaat("g_m_m_chigoon_02"), 0, 1, true);
		iLocal_83[3] = unk_0x91A7C8CA5E332C03(iLocal_86[1], 26, joaat("g_m_m_chigoon_02"), 0, 1, true);
	}
	iLocal_87[0] = unk_0x48CFBECB146FD1A1(joaat("bobcatxl"), -1356.281f, 5000f, 0f, 125.2811f, true, true, false);
	unk_0x1F7948851FB36E88(iLocal_87[0], true, 0);
	unk_0xC19EDC1D7179164C(iLocal_87[0], true, true, 0);
	unk_0x6EB2D9504928F849(iLocal_87[0], 2);
	unk_0x83055D7E96024509(iLocal_87[0], true);
	unk_0xB29E08C7AB729BAD(iLocal_87[0], true);
	unk_0xAA8C8977AD74EDE5(iLocal_87[0], "49GNL112");
	iLocal_87[1] = unk_0x48CFBECB146FD1A1(joaat("bobcatxl"), -1373.589f, 5000f, 0f, 125.459f, true, true, false);
	unk_0x1F7948851FB36E88(iLocal_87[1], true, 0);
	unk_0xC19EDC1D7179164C(iLocal_87[1], true, true, 0);
	unk_0x6EB2D9504928F849(iLocal_87[1], 2);
	unk_0x83055D7E96024509(iLocal_87[1], true);
	unk_0xB29E08C7AB729BAD(iLocal_87[1], true);
	unk_0xAA8C8977AD74EDE5(iLocal_87[1], "47TMS703");
	iLocal_84[0] = unk_0x91A7C8CA5E332C03(iLocal_87[0], 26, joaat("g_m_y_salvagoon_03"), -1, 1, true);
	iLocal_84[1] = unk_0x91A7C8CA5E332C03(iLocal_87[1], 26, joaat("g_m_y_salvagoon_03"), -1, 1, true);
	iLocal_84[2] = unk_0x91A7C8CA5E332C03(iLocal_87[0], 26, joaat("g_m_y_salvagoon_03"), 0, 1, true);
	iLocal_84[3] = unk_0x91A7C8CA5E332C03(iLocal_87[1], 26, joaat("g_m_y_salvagoon_03"), 0, 1, true);
	unk_0x94E87D83163B4BEB("RE_deal1", &iLocal_111);
	unk_0x94E87D83163B4BEB("RE_deal2", &iLocal_112);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!unk_0x4915F4759304D5CF(iLocal_83[iVar0]))
		{
			unk_0xDFA901280292A2FB(iLocal_83[iVar0], iLocal_111);
			unk_0x1F7948851FB36E88(iLocal_83[iVar0], true, 0);
			if (bLocal_110)
			{
				unk_0xF0188A1B49D79AF7(iLocal_83[0], joaat("weapon_sawnoffshotgun"), -1, true, true);
				if (!unk_0x4915F4759304D5CF(iLocal_83[1]))
				{
					unk_0xF0188A1B49D79AF7(iLocal_83[1], joaat("weapon_pistol"), -1, true, true);
				}
				unk_0xD461381B293D9B46(iLocal_83[iVar0], 15);
				unk_0x3B7A32E04BBE59A5(iLocal_83[iVar0], 3, false);
			}
			else
			{
				unk_0xF0188A1B49D79AF7(iLocal_83[iVar0], joaat("weapon_pistol"), -1, true, true);
				unk_0xD461381B293D9B46(iLocal_83[iVar0], 13);
			}
			unk_0x3B7A32E04BBE59A5(iLocal_83[iVar0], 13, true);
			unk_0x3B7A32E04BBE59A5(iLocal_83[iVar0], 2, true);
			unk_0x3B7A32E04BBE59A5(iLocal_83[iVar0], 1, true);
	...
	while (iVar0 < 4)
	{
		if (!unk_0x4915F4759304D5CF(iLocal_83[iVar0]))
		{
			unk_0xDFA901280292A2FB(iLocal_84[iVar0], iLocal_112);
			unk_0x1F7948851FB36E88(iLocal_84[iVar0], true, 0);
			if (bLocal_110)
			{
				unk_0xF0188A1B49D79AF7(iLocal_83[0], joaat("weapon_sawnoffshotgun"), -1, true, true);
				if (!unk_0x4915F4759304D5CF(iLocal_83[1]))
			...
			{
				unk_0xF0188A1B49D79AF7(iLocal_84[iVar0], joaat("weapon_pistol"), -1, true, true);
				unk_0xD461381B293D9B46(iLocal_84[iVar0], 13);
				func_90(&uLocal_114, 5, iLocal_84[iVar0], "REDGWSalvadoran", 0, 1);
			}
			unk_0x3B7A32E04BBE59A5(iLocal_84[iVar0], 13, true);
			unk_0x3B7A32E04BBE59A5(iLocal_84[iVar0], 2, true);
			unk_0x3B7A32E04BBE59A5(iLocal_84[iVar0], 1, true);
		}
		iVar0++;
	}
	unk_0x80E7C4A78224C8F9(3, iLocal_111, iLocal_112);
	unk_0x80E7C4A78224C8F9(3, iLocal_112, iLocal_111);
	unk_0x80E7C4A78224C8F9(3, iLocal_111, 1862763509);
	unk_0x80E7C4A78224C8F9(3, iLocal_112, 1862763509);
...
void func_91()
{
	...
	switch (iLocal_74)
	{
		case 0:
			if (bLocal_107)
			{
				...
				while (iVar0 < 4)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_83[iVar0]))
					{
						if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_83[iVar0], 100f, 100f, 20f, 0, 1, 0))
						{
							iLocal_74 = 3;
						}
					}
			...
			if (bLocal_108)
			{
				...
				while (iVar1 < 4)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_84[iVar1]))
					{
						if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_84[iVar1], 100f, 100f, 20f, 0, 1, 0))
						{
							iLocal_74 = 3;
						}
					}
		...
		case 3:
			unk_0x80E7C4A78224C8F9(5, iLocal_111, iLocal_112);
			unk_0x80E7C4A78224C8F9(5, iLocal_112, iLocal_111);
			unk_0x80E7C4A78224C8F9(5, iLocal_111, 1862763509);
			unk_0x80E7C4A78224C8F9(5, iLocal_112, 1862763509);
			if (bLocal_107)
			{
				iVar2 = 0;
				while (iVar2 < 4)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_83[iVar2]))
					{
						if ((!unk_0x967743032563101F(iLocal_83[iVar2], 0) && unk_0xF9D4EF1338E38AFB(iLocal_83[iVar2], 579380604) != 1) && unk_0xF9D4EF1338E38AFB(iLocal_83[iVar2], 579380604) != 0)
						{
							unk_0x9568B1B58F78FF36(iLocal_83[iVar2]);
							unk_0xDA4D3941AFF8EF12(iLocal_83[iVar2], unk_0xA19140A5C42D8715(), 0, 16);
							unk_0xD738221C247C8B71(iLocal_83[iVar2], true);
						}
					}
					iVar2++;
				}
			...
			if (bLocal_108)
			{
				...
				while (iVar3 < 4)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_84[iVar3]))
					{
						if ((!unk_0x967743032563101F(iLocal_84[iVar3], 0) && unk_0xF9D4EF1338E38AFB(iLocal_84[iVar3], 579380604) != 1) && unk_0xF9D4EF1338E38AFB(iLocal_84[iVar3], 579380604) != 0)
						{
							unk_0x9568B1B58F78FF36(iLocal_84[iVar3]);
							unk_0xDA4D3941AFF8EF12(iLocal_84[iVar3], unk_0xA19140A5C42D8715(), 0, 16);
							unk_0xD738221C247C8B71(iLocal_84[iVar3], true);
						}
					}
					iVar3++;
				}
...
void func_92()
{
	...
	{
		case 0:
			if (!unk_0x4915F4759304D5CF(iLocal_80))
			{
				if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_101, 7f, 7f, 10f, false, true, 0))
				{
					func_94();
					wait(0);
					func_77(&uLocal_114, "REDGWAU", "REDGW_NTOUCH", 4, 0, 0, 0);
					unk_0x22DD1D053CFF9707(iLocal_80, unk_0xA19140A5C42D8715(), -1, 2048, 2);
					if (!unk_0xCE3CB618AFE55EFB(iLocal_90))
					{
	...
	switch (iLocal_73)
	{
		case 1:
			if (!unk_0x4915F4759304D5CF(iLocal_80))
			{
				if (unk_0x10E54C268D1B3FED(unk_0xA19140A5C42D8715(), iLocal_80, 10f, 10f, 6f, 0, 1, 0))
				{
					if (!func_63())
					{
		...
		case 2:
			if (!func_63() || timerb() > 4000)
			{
				if (!unk_0x4915F4759304D5CF(iLocal_80))
				{
					unk_0x6259CDB47862A4F3(iLocal_80, 0, 0);
					unk_0xE1623437A3194332(&iLocal_91);
				}
				if (timerb() > 7000)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_81[6]))
					{
						unk_0x6259CDB47862A4F3(iLocal_81[6], 0, 0);
						unk_0xE1623437A3194332(&(iLocal_92[6]));
					}
				}
				if (timerb() > 9000)
				{
					if (!unk_0x4915F4759304D5CF(iLocal_81[7]))
					{
						unk_0x6259CDB47862A4F3(iLocal_81[7], 0, 0);
						unk_0xE1623437A3194332(&(iLocal_92[7]));
					}
					iLocal_73++;
				}
			}
...
void func_96()
{
	...
	if (unk_0xF50DEC6BB250D7FD(iLocal_97))
	{
		if (unk_0xCE3CB618AFE55EFB(iLocal_89))
		{
			unk_0xE1623437A3194332(&iLocal_89);
	...
	else
	{
		...
		while (iVar0 < 9)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_81[iVar0]))
			{
				if (!unk_0x4915F4759304D5CF(iLocal_81[iVar0]))
				{
					if (iVar0 == 0)
					{
					}
				}
				else if (unk_0xCE3CB618AFE55EFB(iLocal_92[iVar0]))
				{
					unk_0xE1623437A3194332(&(iLocal_92[iVar0]));
				}
			}
			iVar0++;
		}
		...
		{
			if (!unk_0x4915F4759304D5CF(iLocal_82[iVar0]))
			{
			}
			iVar0++;
		}
		if (!func_124())
		{
			if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_48[7 /*3*/], 110f, 95f, 40f, false, true, 0))
			{
				if (unk_0xCE3CB618AFE55EFB(iLocal_89))
				{
					unk_0xE1623437A3194332(&iLocal_89);
				}
				if ((!unk_0xCE3CB618AFE55EFB(iLocal_91) && !unk_0xCE3CB618AFE55EFB(iLocal_92[6])) && !unk_0xCE3CB618AFE55EFB(iLocal_92[7]))
				{
					iLocal_91 = func_67(iLocal_80, 1, 145);
					iLocal_92[6] = func_67(iLocal_81[6], 1, 145);
					iLocal_92[7] = func_67(iLocal_81[7], 1, 145);
				}
				unk_0x264E87C905AE790B(iLocal_91, false);
				unk_0x264E87C905AE790B(iLocal_92[6], false);
				unk_0x264E87C905AE790B(iLocal_92[7], false);
				func_97(1);
			}
		}
		if (!unk_0x4915F4759304D5CF(iLocal_81[6]))
		{
			if (((((unk_0xF9D4EF1338E38AFB(iLocal_81[6], 1785177548) != 1 && unk_0xF9D4EF1338E38AFB(iLocal_81[6], 1785177548) != 0) || unk_0x463E3A48A46C9195(iLocal_81[6])) || unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), iLocal_81[6])) || unk_0x80C8B831B972D6A0(iLocal_81[6])) || unk_0xAD001F5D569438EC(iLocal_81[6]))
			{
				unk_0x6259CDB47862A4F3(iLocal_81[6], 0, 0);
			}
		}
		if (!unk_0x4915F4759304D5CF(iLocal_81[7]))
		{
			if (((((unk_0xF9D4EF1338E38AFB(iLocal_81[7], 1785177548) != 1 && unk_0xF9D4EF1338E38AFB(iLocal_81[7], 1785177548) != 0) || unk_0x463E3A48A46C9195(iLocal_81[7])) || unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), iLocal_81[7])) || unk_0x80C8B831B972D6A0(iLocal_81[7])) || unk_0xAD001F5D569438EC(iLocal_81[7]))
			{
				unk_0x6259CDB47862A4F3(iLocal_81[7], 0, 0);
			}
		}
		if (!unk_0x4915F4759304D5CF(iLocal_80))
		{
			if (((((unk_0xF9D4EF1338E38AFB(iLocal_80, 1785177548) != 1 && unk_0xF9D4EF1338E38AFB(iLocal_80, 1785177548) != 0) || unk_0x463E3A48A46C9195(iLocal_80)) || unk_0xC556072C29E00F04(unk_0xA19140A5C42D8715(), iLocal_80)) || unk_0x80C8B831B972D6A0(iLocal_80)) || unk_0xAD001F5D569438EC(iLocal_80))
			{
				unk_0x6259CDB47862A4F3(iLocal_80, 0, 0);
			}
		}
	...
	switch (iLocal_75)
	{
		case 0:
			if (!unk_0x4915F4759304D5CF(iLocal_81[6]))
			{
				if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), unk_0xE2BBD32891C18569(iLocal_81[6], true) + Vector(0f, 2.5f, 0f), 9f, 5f, 5f, false, true, 0) && unk_0x581D3C560D601491(unk_0xA19140A5C42D8715(), iLocal_81[6]))
				{
					unk_0x22DD1D053CFF9707(iLocal_81[6], unk_0xA19140A5C42D8715(), -1, 2048, 2);
					unk_0x22DD1D053CFF9707(unk_0xA19140A5C42D8715(), iLocal_81[6], 4000, 2048, 2);
			...
			if (!unk_0x4915F4759304D5CF(iLocal_81[7]))
			{
				if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), unk_0xE2BBD32891C18569(iLocal_81[7], true) + Vector(0f, 3f, 0f), 9f, 7f, 5f, false, true, 0) && unk_0x581D3C560D601491(unk_0xA19140A5C42D8715(), iLocal_81[7]))
				{
					unk_0x22DD1D053CFF9707(iLocal_81[7], unk_0xA19140A5C42D8715(), -1, 2048, 2);
					unk_0x22DD1D053CFF9707(unk_0xA19140A5C42D8715(), iLocal_81[7], 4000, 2048, 2);
					func_77(&uLocal_114, "REDGWAU", "REDGW_NDIE1", 4, 0, 0, 0);
					iLocal_71 = unk_0xFD34717937104F1C();
					iLocal_75 = 1;
				}
			}
			if (unk_0x4915F4759304D5CF(iLocal_81[6]) && unk_0x4915F4759304D5CF(iLocal_81[7]))
			{
				iLocal_75 = 2;
			}
			break;
		...
		case 1:
			if (unk_0xCE3CB618AFE55EFB(iLocal_91))
			{
				unk_0x264E87C905AE790B(iLocal_91, true);
			}
			if (unk_0xCE3CB618AFE55EFB(iLocal_92[6]))
			{
				unk_0x264E87C905AE790B(iLocal_92[6], true);
			}
			if (unk_0xCE3CB618AFE55EFB(iLocal_92[7]))
			{
				unk_0x264E87C905AE790B(iLocal_92[7], true);
			}
...
void func_107()
{
	...
	if (!unk_0x7112137033807390(iLocal_85[0], 0))
	{
		if (unk_0xB0D49A1F9F054602(iLocal_85[0], -1, 0) == iLocal_81[8])
		{
			unk_0x3CC9147E361DE531(iLocal_85[0], 60000f);
			unk_0xD5362A43A608808B(iLocal_85[0]);
		}
	}
	if (!unk_0x4915F4759304D5CF(iLocal_80))
	{
		if (unk_0x685AE6AF34B35D3B(iLocal_80))
		{
			unk_0x6259CDB47862A4F3(iLocal_80, 0, 0);
		}
	}
	else if (unk_0xCE3CB618AFE55EFB(iLocal_91))
	{
		unk_0xE1623437A3194332(&iLocal_91);
	}
	iVar0 = 0;
	while (iVar0 < 9)
	{
		if (!unk_0x317672E799676CA5(vLocal_100, 30f) && vdist(func_2(unk_0xD4E735F4B6A956AC()), vLocal_100) > 300f)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_81[iVar0]))
			{
				unk_0x7E4E83D33161D01A(&(iLocal_81[iVar0]));
			}
		}
		if (unk_0x4915F4759304D5CF(iLocal_81[iVar0]))
		{
			if (unk_0xCE3CB618AFE55EFB(iLocal_92[iVar0]))
			{
				unk_0xE1623437A3194332(&(iLocal_92[iVar0]));
			}
		}
...
void func_108()
{
	...
	{
		unk_0xF66A39BBE7B3C278(vLocal_100 - Vector(150f, 150f, 150f), vLocal_100 + Vector(150f, 150f, 150f), 0, 1, 1, 1);
		unk_0xFC00A668AFC2126D(joaat("bobcatxl"), true);
		unk_0xFC00A668AFC2126D(joaat("rebel"), true);
		unk_0x60DEFBFF740D4C09(5, false);
		unk_0x60DEFBFF740D4C09(3, false);
		iLocal_85[0] = unk_0x48CFBECB146FD1A1(joaat("bobcatxl"), -1626.94f, 4729.889f, 51.3463f, 347.1188f, true, true, false);
		unk_0x1F7948851FB36E88(iLocal_85[0], true, 0);
		unk_0x99F546A9200EA026(iLocal_85[0], 1084227584);
		unk_0xC19EDC1D7179164C(iLocal_85[0], true, true, 0);
		unk_0x6EB2D9504928F849(iLocal_85[0], 2);
		unk_0x70B1045E099298C1(iLocal_85[0], 500f);
		unk_0xD27FC0157E8C1AD1(iLocal_85[0], 500f);
		unk_0x6202B241A8864FC2(iLocal_85[0], 1, true);
		unk_0x458DBC59CD481A5B(iLocal_85[0], 0, 0, 1148846080);
		unk_0xD682ADA156B20909(iLocal_85[0], 6);
		unk_0x11D8017AF1DF991E(iLocal_85[0], "RADIO_06_COUNTRY");
		unk_0xAA8C8977AD74EDE5(iLocal_85[0], "76JON418");
		unk_0xDDDEEC84F4F95674(iLocal_85[0], true);
		iLocal_85[1] = unk_0x48CFBECB146FD1A1(joaat("rebel"), -1619.432f, 4747.792f, 52.7502f, 146.6017f, true, true, false);
		unk_0x1F7948851FB36E88(iLocal_85[1], true, 0);
		unk_0x99F546A9200EA026(iLocal_85[1], 1084227584);
		unk_0xC19EDC1D7179164C(iLocal_85[1], true, true, 0);
		unk_0x6EB2D9504928F849(iLocal_85[1], 2);
		unk_0x70B1045E099298C1(iLocal_85[1], 600f);
		unk_0xD27FC0157E8C1AD1(iLocal_85[1], 400f);
		unk_0x6202B241A8864FC2(iLocal_85[1], 1, true);
		unk_0x6202B241A8864FC2(iLocal_85[1], 2, true);
		unk_0x6202B241A8864FC2(iLocal_85[1], 3, false);
		unk_0x6202B241A8864FC2(iLocal_85[1], 4, false);
		unk_0xD682ADA156B20909(iLocal_85[1], 6);
		unk_0x11D8017AF1DF991E(iLocal_85[1], "RADIO_06_COUNTRY");
		unk_0xAA8C8977AD74EDE5(iLocal_85[1], "79ERK121");
		unk_0xDDDEEC84F4F95674(iLocal_85[1], true);
		unk_0xF0EA91023169ED28(iLocal_85[1], 1);
		iLocal_85[2] = unk_0x48CFBECB146FD1A1(joaat("bobcatxl"), -1636.216f, 4748.061f, 51.5484f, 199.3236f, true, true, false);
		unk_0xAA8C8977AD74EDE5(iLocal_85[2], "83JOH802");
		unk_0x1F7948851FB36E88(iLocal_85[2], true, 0);
		unk_0x99F546A9200EA026(iLocal_85[2], 1084227584);
		unk_0xC19EDC1D7179164C(iLocal_85[2], true, true, 0);
		unk_0x6EB2D9504928F849(iLocal_85[2], 2);
		unk_0x70B1045E099298C1(iLocal_85[2], 60f);
		unk_0xD27FC0157E8C1AD1(iLocal_85[2], 1000f);
		unk_0x6202B241A8864FC2(iLocal_85[2], 1, false);
		unk_0x458DBC59CD481A5B(iLocal_85[2], 1, 0, 1148846080);
		iLocal_85[3] = unk_0x48CFBECB146FD1A1(joaat("rebel"), -1641.578f, 4736.783f, 52.5984f, 278.1865f, true, true, false);
		unk_0xAA8C8977AD74EDE5(iLocal_85[3], "85TOR114");
		unk_0x1F7948851FB36E88(iLocal_85[3], true, 0);
		unk_0x99F546A9200EA026(iLocal_85[3], 1084227584);
		unk_0xC19EDC1D7179164C(iLocal_85[3], true, true, 0);
		unk_0x6EB2D9504928F849(iLocal_85[3], 2);
		unk_0x70B1045E099298C1(iLocal_85[3], 500f);
		unk_0xD27FC0157E8C1AD1(iLocal_85[3], 500f);
		unk_0x6202B241A8864FC2(iLocal_85[3], 1, false);
		unk_0x6202B241A8864FC2(iLocal_85[3], 2, false);
		unk_0x6202B241A8864FC2(iLocal_85[3], 3, false);
		unk_0x6202B241A8864FC2(iLocal_85[3], 4, false);
		unk_0x458DBC59CD481A5B(iLocal_85[3], 0, 0, 1148846080);
		unk_0x458DBC59CD481A5B(iLocal_85[3], 5, 0, 1148846080);
		if (!unk_0xF93654E07E20E3CF(iLocal_97))
		{
			iVar0 = 0;
			unk_0x2BCFB39E86340DAA(&iVar0, 1);
			unk_0x2BCFB39E86340DAA(&iVar0, 3);
			unk_0x2BCFB39E86340DAA(&iVar0, 4);
			iLocal_97 = unk_0x4B3DFBACE939C0B8(joaat("pickup_money_case"), vLocal_101, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
		...
		while (iVar1 < 5)
		{
			if (!unk_0xF93654E07E20E3CF(iLocal_98[iVar1]))
			{
				iVar2 = 0;
				...
				if (iVar1 < 2)
				{
					iLocal_98[iVar1] = unk_0xCFD2D70854568658(joaat("pickup_weapon_sawnoffshotgun"), vLocal_104[iVar1 /*3*/], iVar2, -1, 1, 0);
				}
				else if (iVar1 == 4)
				{
					iLocal_98[iVar1] = unk_0x4B3DFBACE939C0B8(joaat("pickup_weapon_assaultrifle"), vLocal_104[iVar1 /*3*/], 90f, 50f, 0f, 0, 50, 2, 1, 0);
				}
				else
				{
					iLocal_98[iVar1] = unk_0xCFD2D70854568658(joaat("pickup_weapon_pistol"), vLocal_104[iVar1 /*3*/], iVar2, -1, 1, 0);
				}
			}
			iVar1++;
		}
		...
		while (iVar1 < 6)
		{
			if (iVar1 <= 3)
			{
				iLocal_81[iVar1] = unk_0x35C6E06B120EB2E3(22, joaat("g_m_y_salvagoon_03"), vLocal_48[iVar1 /*3*/], fLocal_49[iVar1], 1, true);
				unk_0x13E0A8160525AE55(iLocal_81[iVar1], 227, true);
			}
			else
			{
				iLocal_81[iVar1] = unk_0x35C6E06B120EB2E3(22, joaat("g_m_m_chigoon_02"), vLocal_48[iVar1 /*3*/], fLocal_49[iVar1], 1, true);
			}
			iVar1++;
		}
		iLocal_82[0] = unk_0x35C6E06B120EB2E3(26, joaat("a_c_rottweiler"), -1635.005f, 4737.181f, 53.4995f, 33.4155f, 1, true);
		iLocal_82[1] = unk_0x35C6E06B120EB2E3(26, joaat("a_c_rottweiler"), -1625.215f, 4741.119f, 52.5762f, 316.2733f, 1, true);
		iVar1 = 0;
		while (iVar1 < iLocal_82)
		{
			unk_0x2D2E827C6C3D6D26(iLocal_82[iVar1], 1);
			unk_0xDCFB67537602326F(iLocal_82[iVar1], true, 0);
			unk_0x13E0A8160525AE55(iLocal_82[iVar1], 227, true);
			vLocal_50 = { unk_0xE2BBD32891C18569(iLocal_82[iVar1], true) };
			vLocal_51 = { vLocal_50.x, (vLocal_50.y - 2f), (vLocal_50.z - 0.5f) };
			vLocal_52 = { vLocal_50.x, (vLocal_50.y + 50f), (vLocal_50.z - 0.5f) };
			unk_0x1E368F42D982FEE0(vLocal_51, vLocal_52, 100, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			iVar1++;
		}
		unk_0xE3A372256B081BD7(iLocal_81[0], "random@dealgonewrongdead_peds", "ped_b", -1635.928f, 4707.941f, 46.383f, -29.25f, 12.25f, 171.75f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0xE3A372256B081BD7(iLocal_81[1], "random@dealgonewrongdead_peds", "ped_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0xE3A372256B081BD7(iLocal_81[2], "random@dealgonewrongdead_peds", "ped_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0xE3A372256B081BD7(iLocal_81[3], "random@dealgonewrongdead_peds", "ped_c", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0xE3A372256B081BD7(iLocal_81[4], "random@dealgonewrongdead_peds", "ped_d", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0xE3A372256B081BD7(iLocal_81[5], "random@dealgonewrongdead_peds", "ped_e", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0xE3A372256B081BD7(iLocal_82[0], "random@dealgonewrongdead_peds", "dog_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0xE3A372256B081BD7(iLocal_82[1], "random@dealgonewrongdead_peds", "dog_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0x319BD2A393814198(50f);
		func_110();
		unk_0x319BD2A393814198(1f);
		if (unk_0x1095F403F52B42E1(iLocal_85[0], 0))
		{
			iLocal_81[8] = unk_0x91A7C8CA5E332C03(iLocal_85[0], 26, joaat("g_m_y_salvagoon_03"), -1, 1, true);
			unk_0x1F7948851FB36E88(iLocal_81[8], true, 0);
			unk_0x30DEB5348F88A3F8(iLocal_81[8], 1);
			unk_0x6259CDB47862A4F3(iLocal_81[8], 0, 0);
		}
		if (!unk_0xCE3CB618AFE55EFB(iLocal_89))
		{
		}
		unk_0x94E87D83163B4BEB("re_DealGoneWrong", &iLocal_113);
		iLocal_81[6] = unk_0x35C6E06B120EB2E3(22, joaat("g_m_m_chigoon_02"), vLocal_48[6 /*3*/], fLocal_49[6], 1, true);
		func_90(&uLocal_114, 4, iLocal_81[6], "REDGWChinese", 0, 1);
		unk_0x1F4E5EFBFE503FB3(iLocal_81[6], true);
		unk_0x83055D7E96024509(iLocal_81[6], true);
		unk_0xDFA901280292A2FB(iLocal_81[6], iLocal_113);
		iVar3 = unk_0x70788DC3D80C9DEB(vLocal_48[6 /*3*/] + Vector(1.05f, 0f, 0f), -7f, 0f, 34.1111f, 0);
		unk_0xE5565DEAABF9D588(iLocal_81[6], iVar3, "random@dealgonewrong", "base", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xDA16255FBFC16B28(iVar3, true);
		unk_0xD738221C247C8B71(iLocal_81[6], true);
		unk_0x13E0A8160525AE55(iLocal_81[6], 227, true);
		iLocal_81[7] = unk_0x35C6E06B120EB2E3(22, joaat("g_m_y_salvagoon_03"), -1640.311f, 4738.4f, 50.2f, fLocal_49[7], 1, true);
		func_90(&uLocal_114, 5, iLocal_81[7], "REDGWSalvadoran", 0, 1);
		unk_0x1F4E5EFBFE503FB3(iLocal_81[7], true);
		unk_0x83055D7E96024509(iLocal_81[7], true);
		unk_0xDFA901280292A2FB(iLocal_81[7], iLocal_113);
		iVar4 = unk_0x70788DC3D80C9DEB(vLocal_48[7 /*3*/] + Vector(0.92f, 0.65f, -0.65f), 0f, 0f, 34.1111f, 0);
		unk_0xE5565DEAABF9D588(iLocal_81[7], iVar4, "random@dealgonewrong", "idle_a", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xDA16255FBFC16B28(iVar4, true);
		unk_0x71ABFE3795D5D0C2(iVar4, 0.5f);
		unk_0xD738221C247C8B71(iLocal_81[7], true);
		unk_0x13E0A8160525AE55(iLocal_81[7], 227, true);
		iLocal_80 = unk_0x35C6E06B120EB2E3(22, joaat("g_m_m_chigoon_02"), vLocal_63, fLocal_67, 1, true);
		func_90(&uLocal_114, 4, iLocal_80, "REDGWChinese", 0, 1);
		unk_0x1F4E5EFBFE503FB3(iLocal_80, true);
		unk_0xDFA901280292A2FB(iLocal_80, iLocal_113);
		iVar5 = unk_0x70788DC3D80C9DEB(vLocal_63, 7.5f, -12.75f, 51.5f, 0);
		unk_0xE5565DEAABF9D588(iLocal_80, iVar5, "random@dealgonewrong", "idle_b", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xDA16255FBFC16B28(iVar5, true);
		unk_0x76D3D51F5F66367F(iLocal_80, 4f, 18f, 326.7277f, 0, 1);
		unk_0xD738221C247C8B71(iLocal_80, true);
		unk_0x13E0A8160525AE55(iLocal_80, 227, true);
		unk_0x80E7C4A78224C8F9(5, iLocal_113, 1862763509);
		if (func_36() == 0)
		{
			func_90(&uLocal_114, 0, unk_0xA19140A5C42D8715(), "MICHAEL", 0, 1);
		}
		if (func_36() == 1)
		{
			func_90(&uLocal_114, 1, unk_0xA19140A5C42D8715(), "FRANKLIN", 0, 1);
		}
		if (func_36() == 2)
		{
			func_90(&uLocal_114, 2, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
		}
		iLocal_99[0] = unk_0xED8C70B0CB9CE0B4(1110, -1632.953f, 4745.359f, 51.7876f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[1] = unk_0xED8C70B0CB9CE0B4(1110, -1634.87f, 4744.458f, 51.8233f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[2] = unk_0xED8C70B0CB9CE0B4(1110, -1636.971f, 4736.595f, 52.2814f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[3] = unk_0xED8C70B0CB9CE0B4(1110, -1625.561f, 4741.241f, 51.7102f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[4] = unk_0xED8C70B0CB9CE0B4(1110, -1621.533f, 4744.576f, 51.9093f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[5] = unk_0xED8C70B0CB9CE0B4(1110, -1621.963f, 4737.039f, 51.4174f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[6] = unk_0xED8C70B0CB9CE0B4(1110, -1628.517f, 4736.906f, 51.8207f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[7] = unk_0xED8C70B0CB9CE0B4(1110, -1629.324f, 4732.146f, 51.6947f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[8] = unk_0xED8C70B0CB9CE0B4(1110, -1640.287f, 4738.437f, 52.1756f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[9] = unk_0xED8C70B0CB9CE0B4(1110, -1640.055f, 4701.995f, 41.2428f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		wait(0);
		iLocal_99[10] = unk_0xED8C70B0CB9CE0B4(1110, -1641.924f, 4692.236f, 38.3762f, 0f, 0f, -1f, func_109(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar1 = 0;
		while (iVar1 < 6)
		{
			if (!unk_0x7112137033807390(iLocal_81[iVar1], 0))
			{
				unk_0x2D2E827C6C3D6D26(iLocal_81[iVar1], 1);
				unk_0x786985E3CB4F1F52(iLocal_81[iVar1], 0, 0.3f, 0.6f, 3);
				unk_0x786985E3CB4F1F52(iLocal_81[iVar1], 0, 0.65f, 0.6f, 3);
				wait(unk_0x22C775856F4633CA(100, 500));
				if (iVar1 <= 5)
				{
					if (unk_0xCE3CB618AFE55EFB(iLocal_92[iVar1]))
					{
						unk_0xE1623437A3194332(&(iLocal_92[iVar1]));
					}
				}
			}
			iVar1++;
...
void func_110()
{
	...
	{
		wait(0);
		if (unk_0xDC5D81351D6A4DDB(iLocal_85[iVar0]))
		{
			vLocal_53 = { unk_0x3201284584C7CD83(iLocal_85[iVar0], 0f, 0f, 0.5f) };
		}
		iLocal_77 = 0;
		while (iLocal_77 < 5)
		{
			...
			unk_0x1E368F42D982FEE0(vLocal_54, vLocal_55, 1, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			vLocal_54 = { (vLocal_53.x + fLocal_64), (vLocal_53.y + fLocal_65), (vLocal_53.z + fLocal_66) };
			vLocal_55 = { (vLocal_53.x - fLocal_64), (vLocal_53.y - fLocal_65), vLocal_53.z };
			unk_0x1E368F42D982FEE0(vLocal_54, vLocal_55, 1, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			vLocal_54 = { (vLocal_53.x + fLocal_64), (vLocal_53.y - fLocal_65), (vLocal_53.z + fLocal_66) };
