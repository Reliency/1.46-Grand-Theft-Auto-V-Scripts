...
int func_1()
{
	...
	if ((vdist2(vVar0, vVar1) > 10000f || unk_0x7112137033807390(iLocal_38, 0)) || func_4())
	{
		...
		case 0:
			if (unk_0xDC5D81351D6A4DDB(iLocal_38) && !unk_0x7112137033807390(iLocal_38, 0))
			{
				if (unk_0xA60C975CBAB69F34(iLocal_38, vLocal_49, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0xE1072FA2FECBAD96(iLocal_38, uVar2);
					unk_0x3A95A0A3221D4208(&uVar2);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0xDC5D81351D6A4DDB(iLocal_38) && !unk_0x7112137033807390(iLocal_38, 0))
			{
				if (unk_0x5100CFEF9EA1B0E5(iLocal_38) == 1)
				{
					if (!unk_0xDC5D81351D6A4DDB(iLocal_39))
					{
						...
						{
							fVar3 = unk_0xE5B5A1FFAA0834BD(iLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar3 >= 0.157f)
							{
				...
				{
					iVar4 = (unk_0x22C775856F4633CA(0, 65535) % 2);
					if (iVar4 == 0)
					{
