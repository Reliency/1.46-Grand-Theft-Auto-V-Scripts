...
void func_1()
{
	switch (iLocal_87)
	{
		case 0:
			...
			{
				if (unk_0x411C28019DEA5CEF(iLocal_83, "rcmabigail", "loop_talk", 3) || unk_0x411C28019DEA5CEF(iLocal_83, "rcmabigail", "loop_look", 3))
				{
					unk_0x3F01127ECD227890(iLocal_83, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
		...
		case 1:
			func_293();
			if ((func_297(iLocal_83) && unk_0x411C28019DEA5CEF(iLocal_83, "rcmabigail", "loop_2_cs", 3)) && unk_0xE5B5A1FFAA0834BD(iLocal_83, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_87++;
			}
			break;
		...
		case 2:
			...
			if (func_284(1, 1093140480, 0))
			{
				if (func_297(iLocal_83))
				{
					unk_0xE216F8B2802ABABF(iLocal_83, "ABIGAIL", 0, 0, 0);
				}
				func_283();
		...
		case 4:
			if (unk_0x5CA3186381FC012C())
			{
				...
				{
					uLocal_84 = unk_0x57FC10C74CC15F22("DEFAULT_SCRIPTED_CAMERA", 1);
					unk_0x1D7183E3760DB4E5(uLocal_84, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f, 0, 1, 1, 2);
					unk_0x1D7183E3760DB4E5(uLocal_84, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f, 10000, 1, 1, 2);
					unk_0x8E88E73F74A9FF79(1, 0, 3000, 1, 0, 0);
					unk_0xBC1542DDC31676C2(uLocal_84, "HAND_SHAKE", 0.3f);
				}
				...
				if (func_297(iLocal_83) && unk_0x0FFE9FEDC2E0AC88("Abigail", 0))
				{
					unk_0x9568B1B58F78FF36(iLocal_83);
					unk_0x956B3CF461C0C1C9(iLocal_83, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
				iLocal_86 = unk_0xFD34717937104F1C() + 10000;
				iLocal_87++;
			}
			break;
		
		case 5:
			if ((iLocal_89 == 0 && unk_0x06EBD57CD6085DD1() == 4) && unk_0xFD34717937104F1C() > (iLocal_86 - 300))
			{
			...
			if (func_218(1000) || unk_0xFD34717937104F1C() > iLocal_86)
			{
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		iVar4 = 0;
		iVar5 = unk_0xDE2FA336A2CE65DB(uVar1, 0);
		iVar3 = 0;
		while (iVar3 < iVar5)
		{
...
int func_199(char* sParam0, int iParam1)
{
	...
	iVar2 = unk_0xFEB6EEC0545AF7AA(uParam0);
	iVar3 = 0;
	iVar3 = 0;
	while (iVar3 < 63)
	{
		...
		if (unk_0xFEB6EEC0545AF7AA(uVar1) == iVar2)
		{
			return iVar0;
		}
		iVar3++;
	...
	if (unk_0xDC5D81351D6A4DDB(Global_96664.f_4))
	{
		if (unk_0x1095F403F52B42E1(Global_96664.f_4, 0))
		{
			if (func_275(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_272(unk_0xE2BBD32891C18569(Global_96664.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	return (shift_right(uParam0, 26) & 31 * func_254(unk_0x05EFB6A616B6FADE(uParam0, 31), -1, 1)) + 2011;
}
...
void func_293()
{
	if (func_297(unk_0xA19140A5C42D8715()))
	{
		...
		if (iLocal_88 == 0)
		{
			if (func_297(iLocal_83))
			{
				if (func_294(unk_0xA19140A5C42D8715(), iLocal_83, 1) < 4f || (unk_0xEAA5CEF8875FEEED(unk_0xA19140A5C42D8715()) > 2f && func_294(unk_0xA19140A5C42D8715(), iLocal_83, 1) < 6f))
				{
...
int func_338(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_344())
	{
		...
		{
			iVar2 = func_339(unk_0x61D2332983ACC05C());
			if (iVar2 > -1)
			{
