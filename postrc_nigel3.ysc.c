...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0xFD34717937104F1C() - iLocal_187) > 5000 && unk_0xDEAEC99031DCB92A(iLocal_188, unk_0xA19140A5C42D8715(), 1))
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					unk_0xDCB46BFC2265476A(iLocal_188);
					iLocal_21 = 1;
				}
			}
			else if ((unk_0xFD34717937104F1C() - iLocal_187) > 12000 && vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), unk_0xE2BBD32891C18569(iLocal_188, true)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
int func_17()
{
	...
	fVar0 = 200f;
	if (vdist2(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), unk_0xE2BBD32891C18569(iLocal_188, true)) >= (fVar0 * fVar0) && !unk_0x1A8481A7E865EC7C(iLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_19()
{
	...
	{
		if (!unk_0x4915F4759304D5CF(iLocal_188))
		{
			return 1;
		}
	}
...
int func_25()
{
	...
	if (unk_0xDC5D81351D6A4DDB(unk_0xA19140A5C42D8715()) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		...
		while (iVar2 <= (iVar1 - 1))
		{
			if (uVar0[iVar2] != 0 && unk_0xDC5D81351D6A4DDB(uVar0[iVar2]))
			{
				if (unk_0x8F474E419F56E48D(uVar0[iVar2]) == joaat("u_m_m_aldinapoli"))
				{
...
void func_26()
{
	...
	if (unk_0xDC5D81351D6A4DDB(iLocal_188))
	{
		unk_0x7E4E83D33161D01A(&iLocal_188);
	}
