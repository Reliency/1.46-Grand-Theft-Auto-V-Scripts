...
void __EntryFunction__()
{
	...
	else if (func_429(0))
	{
		...
		{
			func_427(unk_0xA19140A5C42D8715(), vLocal_333, fLocal_117, 0, 0);
	...
	while (true)
	{
		if (!unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
		{
			...
			vLocal_331 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1) };
			func_416();
			func_415();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_70())
					{
						func_19(unk_0xA19140A5C42D8715(), vLocal_334, fLocal_118, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_70())
					{
						func_19(unk_0xA19140A5C42D8715(), vLocal_335, fLocal_119, 0, 1);
						unk_0xD87B76260C547F31(0f);
						unk_0xAA32DD4848CF93E0(0f, 1065353216);
						if (iLocal_104 == 0)
						{
				...
				if (iLocal_60 == 1)
				{
					...
					if (iLocal_132 > 0)
					{
						...
						while (iVar0 <= (iLocal_132 - 1))
						{
							...
							{
								unk_0xAD4E103DE4780207(Local_69[iVar0 /*19*/], joaat("weapon_sniperrifle"));
								unk_0x6259CDB47862A4F3(Local_69[iVar0 /*19*/], 0, 0);
							}
							iVar0++;
						}
					}
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					...
					if (!func_70())
					{
						func_427(unk_0xA19140A5C42D8715(), vLocal_330, 254.9762f, 0, 0);
						unk_0xD87B76260C547F31(0f);
						unk_0xAA32DD4848CF93E0(0f, 1065353216);
						if (iLocal_104 == 0)
						{
...
void func_66()
{
	if (func_428(Local_68.f_9))
	{
		...
		{
			unk_0x034CA621E59C939F(sLocal_152, Local_68.f_9, 0);
		}
	}
	if (func_428(Local_75))
	{
		if (unk_0x2686487E572FE93A())
		{
			unk_0x034CA621E59C939F(sLocal_151, Local_75, 0);
		}
	}
}
	...
	if (iLocal_132 > 0)
	{
		...
		while (iVar0 <= (iLocal_132 - 1))
		{
			if (iLocal_67 == 4)
			{
				if (func_22(Local_69[iVar0 /*19*/]))
				{
					unk_0xDFA901280292A2FB(Local_69[iVar0 /*19*/], -2065892691);
					unk_0x1F4E5EFBFE503FB3(Local_69[iVar0 /*19*/], 0);
					if (Global_104779 == 0)
					{
						unk_0xD738221C247C8B71(Local_69[iVar0 /*19*/], 0);
					}
					else
					{
						unk_0xD738221C247C8B71(Local_69[iVar0 /*19*/], 1);
					}
				}
			}
...
void func_114(int iParam0)
{
	...
	{
		if (unk_0x35546CE87C5336BC(Local_69[iParam0 /*19*/]) == iLocal_320)
		{
			unk_0x3677CB0D846A1308(Local_69[iParam0 /*19*/], 30f);
			unk_0xF26F4E13A8AEC5EB(Local_69[iParam0 /*19*/], 30f);
			unk_0x326A31228591B95C(Local_69[iParam0 /*19*/], 30f);
			unk_0xF63074D1E750B871(Local_69[iParam0 /*19*/], 0);
			unk_0x3B7A32E04BBE59A5(Local_69[iParam0 /*19*/], 1, 0);
			unk_0x3B7A32E04BBE59A5(Local_69[iParam0 /*19*/], 3, 1);
			unk_0x3B7A32E04BBE59A5(Local_69[iParam0 /*19*/], 0, 1);
			unk_0x22DD1D053CFF9707(Local_69[iParam0 /*19*/], unk_0xA19140A5C42D8715(), -1, 0, 2);
			if (!unk_0x8B9D3A1A7C2D3C6B(Local_69[iParam0 /*19*/]))
			{
				if (unk_0xB112D23B8518DD40(Local_69[iParam0 /*19*/]))
				{
					unk_0x57BAE9F63852E6FF(Local_69[iParam0 /*19*/]);
				}
				unk_0x53FF9BDD8529ACD2(Local_69[iParam0 /*19*/]);
				unk_0x3F29BBC16DCB8A23(Local_69[iParam0 /*19*/]);
				unk_0x9568B1B58F78FF36(Local_69[iParam0 /*19*/]);
				unk_0xABC4374E9189E483(Local_69[iParam0 /*19*/], -1, unk_0xA19140A5C42D8715(), -1, 0);
			}
			unk_0x1F4E5EFBFE503FB3(Local_69[iParam0 /*19*/], 1);
			Local_69[iParam0 /*19*/].f_14 = 2;
		}
		else
		{
			unk_0x3B7A32E04BBE59A5(Local_69[iParam0 /*19*/], 13, 0);
			unk_0x3B7A32E04BBE59A5(Local_69[iParam0 /*19*/], 5, 0);
			unk_0x3B7A32E04BBE59A5(Local_69[iParam0 /*19*/], 17, 1);
			unk_0x3B7A32E04BBE59A5(Local_69[iParam0 /*19*/], 0, 1);
			unk_0x1F4E5EFBFE503FB3(Local_69[iParam0 /*19*/], 0);
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (func_36())
			{
				...
				{
					unk_0xE216F8B2802ABABF(unk_0xA19140A5C42D8715(), sLocal_150, 0, 0, 0);
					if (func_428(Local_75))
					{
						unk_0xE216F8B2802ABABF(Local_75, sLocal_151, 0, 0, 0);
					}
					if (func_428(Local_68.f_9))
					{
						unk_0xE216F8B2802ABABF(Local_68.f_9, sLocal_152, 0, 0, 0);
					}
					if (func_428(Local_77))
					{
						unk_0xE216F8B2802ABABF(Local_77, sLocal_153, 0, 0, 0);
					}
					if (func_428(Local_78))
					{
						unk_0xE216F8B2802ABABF(Local_78, sLocal_154, 0, 0, 0);
					}
		...
		case 1:
			if (func_428(Local_77))
			{
				if (func_22(Local_75))
				{
					if (unk_0x0FFE9FEDC2E0AC88(sLocal_151, 0) && unk_0x0FFE9FEDC2E0AC88(sLocal_153, 0))
					{
						func_48();
					}
				}
			}
			if (unk_0x0FFE9FEDC2E0AC88(sLocal_150, 0))
			{
...
void func_308()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		{
			case 0:
				unk_0x80E7C4A78224C8F9(5, 1862763509, iLocal_320);
				unk_0x80E7C4A78224C8F9(5, iLocal_320, 1862763509);
				iLocal_137 = unk_0x24A1A7BF4ED94B71(Local_68.f_9);
				vLocal_336 = { unk_0xE2BBD32891C18569(Local_68.f_9, 0) };
				...
				if (!iLocal_107)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_122, unk_0x22C775856F4633CA(5000, 12000)))
								{
									if (func_105(Local_68.f_9, vLocal_331, 30f))
									{
			...
			case 2:
				...
				iLocal_82 = 1;
				func_319();
				unk_0xAB8B90F57910509D(5, 1862763509, iLocal_320);
				unk_0xAB8B90F57910509D(5, iLocal_320, 1862763509);
				func_110(&(Local_68.f_8));
				iLocal_82 = 1;
				Local_68.f_17 = unk_0xFD34717937104F1C();
				func_317(&uLocal_44, 0, 0);
...
void func_354(int iParam0)
{
	...
	unk_0x13E0A8160525AE55(iParam0, 118, true);
	unk_0x80B6201B269FC581(iParam0, true);
			...
			switch (Local_68.f_10)
			{
				...
				case 30:
					if (!func_63(Local_68.f_9, 242628503))
					{
						...
						unk_0x2F89329397A277BC(&uLocal_143);
						unk_0x59FFABF16840EEA1(0, unk_0xA19140A5C42D8715(), fVar3, 30f);
						unk_0x9C24BCD3EFB3BF4C(0, unk_0xA19140A5C42D8715(), 2000, 0);
						unk_0x301F42EEE3C40328(uLocal_143);
						unk_0xE1072FA2FECBAD96(Local_68.f_9, uLocal_143);
						unk_0x3A95A0A3221D4208(&uLocal_143);
						unk_0x1F4E5EFBFE503FB3(Local_68.f_9, 1);
					}
					break;
				...
				case 31:
					if (func_113(Local_68.f_18, unk_0x22C775856F4633CA(250, 500)))
					{
						unk_0xD461381B293D9B46(Local_68.f_9, 50);
						unk_0xF990CFC0F1D94A39(Local_68.f_9, &iVar0, 1);
						if (iVar0 == joaat("weapon_unarmed"))
						{
							unk_0xF0188A1B49D79AF7(Local_68.f_9, joaat("weapon_pistol"), -1, false, true);
						...
						unk_0xBB2EBD7F469C8767(0, vLocal_332, unk_0xA19140A5C42D8715(), 1f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
						...
						unk_0xA3AF02B3B4D4A74C(0, vLocal_332, 50f);
						unk_0x301F42EEE3C40328(uLocal_143);
						unk_0xE1072FA2FECBAD96(Local_68.f_9, uLocal_143);
						unk_0x3A95A0A3221D4208(&uLocal_143);
						unk_0x1F4E5EFBFE503FB3(Local_68.f_9, 1);
				...
				case 33:
					if (func_113(Local_68.f_18, unk_0x22C775856F4633CA(250, 500)))
					{
						unk_0xD461381B293D9B46(Local_68.f_9, 10);
						unk_0xF990CFC0F1D94A39(Local_68.f_9, &iVar0, 1);
						if (iVar0 == joaat("weapon_unarmed"))
						{
							unk_0xF0188A1B49D79AF7(Local_68.f_9, joaat("weapon_pistol"), -1, false, true);
						...
						unk_0xBB2EBD7F469C8767(0, vLocal_332, unk_0xA19140A5C42D8715(), 2f, 1, 0.5f, 4f, 1, 0, 0, -687903391, 20000);
				...
				case 35:
					if (func_113(Local_68.f_18, unk_0x22C775856F4633CA(250, 500)))
					{
						...
						unk_0x2F89329397A277BC(&uLocal_143);
						unk_0x9C24BCD3EFB3BF4C(0, unk_0xA19140A5C42D8715(), 750, 0);
						unk_0xBB2EBD7F469C8767(0, vLocal_332, unk_0xA19140A5C42D8715(), 2f, 1, 0.75f, 4f, 1, 0, 0, -687903391, 20000);
						unk_0x301F42EEE3C40328(uLocal_143);
						unk_0xE1072FA2FECBAD96(Local_68.f_9, uLocal_143);
						unk_0x3A95A0A3221D4208(&uLocal_143);
						unk_0x1F4E5EFBFE503FB3(Local_68.f_9, 1);
				...
				case 37:
					if (func_113(Local_68.f_18, unk_0x22C775856F4633CA(250, 750)))
					{
						...
						unk_0xF63074D1E750B871(Local_68.f_9, 1);
				...
				case 13:
					if (func_113(Local_68.f_18, unk_0x22C775856F4633CA(0, 500)))
					{
						if (unk_0xB112D23B8518DD40(Local_68.f_9))
						{
							unk_0x25669F63E9DAC7F9(Local_68.f_9, vLocal_331);
						}
						unk_0xF990CFC0F1D94A39(Local_68.f_9, &iVar0, 1);
						if (iVar0 != joaat("weapon_unarmed"))
						{
						...
						unk_0x3B7A32E04BBE59A5(Local_68.f_9, 5, 0);
						unk_0x3B7A32E04BBE59A5(Local_68.f_9, 17, 1);
						unk_0x33B5487515BD13D5(Local_68.f_9, unk_0xA19140A5C42D8715(), 200f, -1, 0, 0);
						unk_0x1F4E5EFBFE503FB3(Local_68.f_9, 1);
						unk_0xD738221C247C8B71(Local_68.f_9, 1);
						Local_68.f_10 = 14;
					}
...
void func_377()
{
	if (func_58(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), vLocal_330, 100f))
	{
		if (!func_378())
		{
			unk_0x9D7A6D81C3BE2AAE(&vLocal_325, 8);
			func_66();
			iLocal_111 = 1;
		}
	}
	...
	{
		if (!func_58(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), 1), vLocal_330, 120f))
		{
			if (unk_0x7974D616EF03E483())
			{
				unk_0xFB35B0BAD6F5AD8F();
			...
			if (unk_0x5D7DFE2058701942(Local_68.f_9, 0) && unk_0xCAEB6CE71A2C7212(Local_68.f_9, 0) == iVar0)
			{
				if (!unk_0x122A8778D4027A82(unk_0xD4E735F4B6A956AC(), 0))
				{
					if (!iLocal_106)
					{
						if (!func_61())
						{
							iLocal_121 = unk_0xFD34717937104F1C();
							iLocal_106 = 1;
						}
					}
					else if (!iLocal_86[0])
					{
						if ((unk_0xFD34717937104F1C() - iLocal_121) > 7500)
						{
							func_385(0);
						}
					}
					...
					{
						if ((unk_0xFD34717937104F1C() - iLocal_121) > 10000)
						{
							func_385(1);
						}
					}
			...
			else
			{
				...
				else if (Local_68.f_10 == 24 && func_63(Local_68.f_9, -1519143300))
				{
					if (func_105(Local_68.f_9, vLocal_331, 25f))
					{
						...
						{
							if (func_113(iLocal_123, unk_0x22C775856F4633CA(2500, 5000)))
							{
								if (func_61())
								{
									func_5();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_113(iLocal_122, unk_0x22C775856F4633CA(3000, 6000)))
						{
							if (!func_105(Local_68.f_9, vLocal_331, 20f))
							{
			...
			case 1:
				if (!iLocal_108)
				{
					...
					else
					{
						...
						if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_330, 4f, 4f, 2f, 1, 1, 0))
						{
						}
						...
						if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
						{
							if (func_105(unk_0xA19140A5C42D8715(), vLocal_330, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_105(unk_0xA19140A5C42D8715(), vLocal_330, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
		...
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			...
			switch (Local_69[iVar0 /*19*/].f_14)
			{
				...
				case 2:
					...
					{
						if (!func_22(Local_68.f_9) || (unk_0x8B9D3A1A7C2D3C6B(Local_68.f_9) && unk_0xE51A575102B2A3C7(Local_68.f_9) > 1f))
						{
							if (unk_0xF9D4EF1338E38AFB(Local_69[iVar0 /*19*/], -1519143300) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
								...
								unk_0x97C31CC449F6B9DF(Local_69[iVar0 /*19*/], iVar2);
							}
							else
							{
								unk_0x9568B1B58F78FF36(Local_69[iVar0 /*19*/]);
								unk_0x3F29BBC16DCB8A23(Local_69[iVar0 /*19*/]);
							}
							Local_69[iVar0 /*19*/].f_14 = 4;
							func_109(&(Local_69[iVar0 /*19*/].f_6));
						}
					...
					else if (!func_63(Local_69[iVar0 /*19*/], 780511057))
					{
						...
						if (func_105(Local_69[iVar0 /*19*/], vLocal_331, 5f))
						{
							...
							{
								unk_0xF4A4E46DFA28BFDE(Local_69[iVar0 /*19*/], unk_0xE2BBD32891C18569(Local_69[iVar0 /*19*/], 1), 5f, 0, 0);
								unk_0xDA4D3941AFF8EF12(Local_69[iVar0 /*19*/], unk_0xA19140A5C42D8715(), 0, 16);
								unk_0x1F4E5EFBFE503FB3(Local_69[iVar0 /*19*/], 1);
							}
						}
					}
					else
					{
						...
						{
							unk_0x9568B1B58F78FF36(Local_69[iVar0 /*19*/]);
							unk_0x22DD1D053CFF9707(Local_69[iVar0 /*19*/], unk_0xA19140A5C42D8715(), -1, 0, 2);
							unk_0x0177431263151C4E(Local_69[iVar0 /*19*/], unk_0xA19140A5C42D8715(), -1);
							unk_0x1F4E5EFBFE503FB3(Local_69[iVar0 /*19*/], 0);
						}
				...
				case 4:
					...
					{
						if (!unk_0x8B9D3A1A7C2D3C6B(Local_69[iVar0 /*19*/]))
						{
...
int func_395(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)
{
	...
	if (func_22(iParam0))
	{
		...
		{
			vVar0 = { unk_0xE2BBD32891C18569(iParam0, 1) };
			if (unk_0x9809FE4B550B1EFE(vVar0, fParam5, 1))
			{
				return 1;
			}
			if (func_105(iParam0, vLocal_331, fParam2))
			...
			if (unk_0x6D7FFF527E125F24(-1, vVar0, fParam6))
			{
				return 1;
			}
			vVar1 = { vVar0 };
...
void func_396(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			Local_69[iVar0 /*19*/].f_15 = unk_0xFD34717937104F1C();
	...
	if (!iLocal_92)
	{
		if (!func_61())
		{
			if (func_105(Local_68.f_9, vLocal_331, (25f + 5f)))
			{
				...
				if (unk_0x429D45A6C6520026(&Local_329))
				{
...
void func_432(bool bParam0, bool bParam1)
{
	...
	unk_0xE70AC26DFC59863A(iLocal_141, 0);
	unk_0xD9F4F897224699B4();
...
int func_478(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_469(unk_0x8F474E419F56E48D(*iParam0), 1) && unk_0x22D95AF01E737CA1(*iParam0, 24) != func_481(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x1EE56D43DA30ADC6(*iParam0, 24, func_481(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_480(iParam0);
	if (func_479(*iParam0))
	{
...
int func_491(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_493(iParam0, uVar1[iVar3], 1) && func_492(unk_0xE2BBD32891C18569(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_516()
{
	...
	unk_0x94E87D83163B4BEB("ENEMIES", &iLocal_320);
	unk_0x80E7C4A78224C8F9(5, 1862763509, iLocal_320);
	unk_0x80E7C4A78224C8F9(5, iLocal_320, 1862763509);
	vVar0 = { func_523(Local_63) };
	vVar1 = { func_522(Local_63) };
	unk_0xFF54548CCE498035(vVar0, vVar1);
	iLocal_141 = unk_0xF66A39BBE7B3C278(vVar0, vVar1, 0, 1, 1, 1);
	...
	if (func_22(unk_0xA19140A5C42D8715()))
	{
		func_90(&uLocal_155, 2, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
...
void func_517()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		if (Local_68.f_12 != 0)
		{
			unk_0xF0188A1B49D79AF7(Local_68.f_9, Local_68.f_12, -1, false, true);
		}
		func_354(Local_68.f_9);
		func_518(Local_68.f_9, "TARGET_", 0);
		Local_68.f_10 = 0;
		unk_0x72A0FF8C49CFFC0D(Local_68.f_9, 0, 1, 1, 0);
		unk_0x72A0FF8C49CFFC0D(Local_68.f_9, 2, 1, 1, 0);
		...
		unk_0x3F01127ECD227890(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		unk_0x3F01127ECD227890(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		unk_0x4C9989F866EF6731(uLocal_143, 1);
		unk_0x301F42EEE3C40328(uLocal_143);
		unk_0xE1072FA2FECBAD96(Local_68.f_9, uLocal_143);
		unk_0x3A95A0A3221D4208(&uLocal_143);
	}
	...
	while (iVar0 <= 2)
	{
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			...
			if (iVar0 == 0 || iVar0 == 2)
			{
				unk_0xDFA901280292A2FB(Local_69[iVar0 /*19*/], iLocal_320);
			}
			...
			switch (iVar0)
			{
				case 0:
					...
					unk_0x4C9989F866EF6731(uLocal_143, 1);
					unk_0x301F42EEE3C40328(uLocal_143);
					unk_0xE1072FA2FECBAD96(Local_69[iVar0 /*19*/], uLocal_143);
					unk_0x3A95A0A3221D4208(&uLocal_143);
					break;
...
int func_519()
{
	...
	if (iVar1 == iLocal_132)
	{
		...
		while (iVar2 <= (iLocal_132 - 1))
		{
			unk_0xA5DE74AE39867B03(Local_69[iVar2 /*19*/].f_18);
			iVar2++;
		}
	}
	if (iLocal_129 > 0)
...
int func_550(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_561())
	{
		...
		{
			iVar2 = func_551(unk_0x61D2332983ACC05C());
			if (iVar2 > -1)
			{
