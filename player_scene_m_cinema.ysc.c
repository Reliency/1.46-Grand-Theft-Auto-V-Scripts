...
int func_2()
{
	...
	if (vdist(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), vLocal_72) > 100f)
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_70[iParam1])
		{
			case 0:
				...
				if (unk_0xF9D4EF1338E38AFB(iParam0, -1146898486) != 1)
				{
					...
					unk_0xD738221C247C8B71(iLocal_68[iParam1], true);
				}
				break;
			...
			case 1:
				...
				if (!unk_0x429D45A6C6520026(&(Local_71[iParam1 /*4*/])))
				{
			...
			case 3:
				...
				if (vdist2(unk_0xE2BBD32891C18569(iParam0, true), unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!unk_0x429D45A6C6520026(&(Local_71[iVar0 /*4*/])))
			{
				unk_0xD75A4240F0AD8613(&(Local_71[iVar0 /*4*/]));
				if (!unk_0xB1FDFCECA75CE4A7(&(Local_71[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0x35C6E06B120EB2E3(4, iLocal_69[iVar0], vLocal_72 + vLocal_74[iVar0 /*3*/], 0f, 1, true);
			unk_0x92DDCF53AA47A63D(iLocal_68[iVar0], (fLocal_73 + fLocal_75[iVar0]));
			...
			unk_0x2D2E827C6C3D6D26(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			vLocal_74[3 /*3*/] = { Vector(45.5004f, unk_0xF59B9063EDAC7451(-205.8167f, -210.4254f), unk_0xF59B9063EDAC7451(-1416.54f, -1428.501f)) - vLocal_72 };
