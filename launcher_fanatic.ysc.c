...
void func_185(int iParam0)
{
	...
	if ((unk_0xFD34717937104F1C() - iLocal_57) >= 900)
	{
		if (func_196(iParam0->f_28[0]))
		{
			if (!func_144())
...
{
	unk_0x85AF6DC3641E2442(iParam0, sParam1, sParam2, func_187(iParam3), 0);
}
...
int func_188(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_196(unk_0xA19140A5C42D8715()) && func_196(iParam0->f_28[0])) && !func_144()) && (unk_0xFD34717937104F1C() - iParam0->f_60) > iParam6) && func_192(unk_0xA19140A5C42D8715(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_176(2))
	{
		if (!func_144())
		{
			if (((func_196(unk_0xA19140A5C42D8715()) && func_196(iParam0->f_28[0])) && (unk_0xFD34717937104F1C() - iParam0->f_60) > iParam6) && func_192(unk_0xA19140A5C42D8715(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_191(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_189(&uVar0, cParam2, sParam3, 7, 0, 0);
		...
		else if (func_194(sParam3))
		{
			...
			{
				if (func_192(unk_0xA19140A5C42D8715(), vParam1, 1) >= 20f)
				{
					func_142();
				}
			}
...
void func_197(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (!unk_0x429D45A6C6520026(sParam1))
		{
			...
			{
				if (func_192(unk_0xA19140A5C42D8715(), vParam2, 1) <= 100f)
				{
					func_200(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_192(unk_0xA19140A5C42D8715(), vParam2, 1) > 120f)
				{
					func_202(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !unk_0x411C28019DEA5CEF(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true), unk_0xE2BBD32891C18569(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_225(unk_0xE2BBD32891C18569(iParam1, true) - unk_0xE2BBD32891C18569(iParam0, true)) };
	...
	{
		vVar1 = { func_225(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_232(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_225(vParam1 - unk_0xE2BBD32891C18569(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_41[0]))
			{
				...
				uParam0->f_41[0] = unk_0xFCFC8CC5FF74580D(iVar0[1], vVar3, true, true, false);
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_41[1]))
			{
				...
				uParam0->f_41[1] = unk_0xFCFC8CC5FF74580D(iVar0[2], vVar3, true, true, false);
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_41[2]))
			{
				...
				uParam0->f_41[2] = unk_0xFCFC8CC5FF74580D(iVar0[3], vVar3, true, true, false);
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_41[3]))
			{
				...
				uParam0->f_41[3] = unk_0xFCFC8CC5FF74580D(iVar0[4], vVar3, true, true, false);
...
void func_272(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 22)
	{
		unk_0xE70AC26DFC59863A(iLocal_53, 0);
	}
	if (iLocal_54 != -1)
	{
