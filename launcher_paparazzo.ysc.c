...
void func_186(int iParam0, char* sParam1, vector3 vParam2)
{
	if (unk_0x58E3CCF930D23BD5(unk_0xD4E735F4B6A956AC()))
	{
		if (!unk_0x429D45A6C6520026(sParam1))
		{
			...
			{
				if (func_190(unk_0xA19140A5C42D8715(), vParam2, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_190(unk_0xA19140A5C42D8715(), vParam2, 1) > 120f)
				{
					func_192(iParam0);
				}
			}
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(unk_0xA19140A5C42D8715()) && func_126(iParam0->f_28[0])) && !func_145()) && (unk_0xFD34717937104F1C() - iParam0->f_60) > iParam6) && func_190(unk_0xA19140A5C42D8715(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_219(unk_0xE2BBD32891C18569(iParam1, true) - unk_0xE2BBD32891C18569(iParam0, true)) };
	...
	{
		vVar1 = { func_219(unk_0x505186370955851F(iParam0, 31086, 0f, 5f, 0f) - unk_0x505186370955851F(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_226(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_219(vParam1 - unk_0xE2BBD32891C18569(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_239(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !unk_0x39C2D9AB77873F84(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_251(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !unk_0x39C2D9AB77873F84(sVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			if (func_126(uParam0->f_41[0]))
			{
				iLocal_54 = unk_0x70788DC3D80C9DEB(unk_0xE2BBD32891C18569(uParam0->f_41[0], true), unk_0x288B716F47E9BBBC(uParam0->f_41[0], 2), 2);
				unk_0x341C49A9159E80FB(uParam0->f_41[0], iLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				unk_0xDA16255FBFC16B28(iLocal_54, true);
				if (func_126(uParam0->f_28[0]))
				{
					unk_0xE5565DEAABF9D588(uParam0->f_28[0], iLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_126(uParam0->f_41[1]))
				{
					unk_0x341C49A9159E80FB(uParam0->f_41[1], iLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_126(uParam0->f_41[2]))
				{
					unk_0x341C49A9159E80FB(uParam0->f_41[2], iLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_126(uParam0->f_28[0]) && func_126(unk_0xA19140A5C42D8715()))
			{
				...
				iLocal_54 = unk_0x70788DC3D80C9DEB(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				unk_0xDA16255FBFC16B28(iLocal_54, true);
				unk_0xE5565DEAABF9D588(uParam0->f_28[0], iLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
		...
		case 3:
			if (func_126(uParam0->f_28[0]))
			{
				if (unk_0x39C2D9AB77873F84("rcmpaparazzo1beckon"))
				{
					...
					unk_0x3F01127ECD227890(0, sVar4, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sVar4, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sVar4, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x3F01127ECD227890(0, sVar4, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
void func_254(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 46:
			if (bParam1)
			{
				unk_0x413F34FCFABEDE4B(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, false, 1);
				unk_0xF54514EACB543898(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0);
			}
			else
			{
				unk_0x413F34FCFABEDE4B(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, true, 1);
			}
			break;
	}
}
...
void func_268(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		{
			case 46:
				unk_0xA5DE74AE39867B03(iLocal_53);
				func_270(iParam0, 0, 0, 0);
				break;
			
			case 47:
				unk_0x66E6A13BAFFFB63C("WORLD_HUMAN_PAPARAZZI", 1);
				unk_0xE70AC26DFC59863A(iLocal_56, 0);
				func_270(iParam0, 0, 0, 0);
				break;
			
			case 48:
				unk_0x8FAC08959C2D32F8(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), true);
				unk_0x8FAC08959C2D32F8(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), true);
				unk_0x8FAC08959C2D32F8(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), true);
