...
void __EntryFunction__()
{
	...
	iLocal_80 = unk_0x410D194E9495C303(joaat("weapon_sniperrifle"));
	iLocal_81 = unk_0x73929A7BB3EF0A64(joaat("component_at_scope_large"));
	iLocal_82 = unk_0x73929A7BB3EF0A64(joaat("component_at_ar_supp_02"));
	...
	func_505(25);
	func_504();
	func_503(&uLocal_89, 2, unk_0xA19140A5C42D8715(), "TREVOR", 0, 1);
...
void func_1()
{
	switch (iLocal_257)
	{
		case 0:
			...
			func_7();
			if (unk_0x429D45A6C6520026(sLocal_352))
			{
				func_531(1);
			}
			else
...
void func_14()
{
	...
	{
		func_16(13, floor(Global_106070.f_10166.f_3853));
	}
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_82(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x6182A22F4D99005E(iParam3, 6, -1, 0, -1, func_82(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_60(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_60(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 1) || unk_0x4BE6499482BEE1D8(func_60(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x4BE6499482BEE1D8(iParam3, -1757550583, 0) || unk_0x4BE6499482BEE1D8(func_60(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x3B61940560400F58(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_93(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x4BE6499482BEE1D8(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_93(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x4BE6499482BEE1D8(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0x6182A22F4D99005E(iVar1, 6, -1, 0, -1, func_82(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_218()
{
	if (iLocal_274)
	{
		...
		unk_0x3CB081F41F423663(unk_0xA19140A5C42D8715(), 1285032059, iLocal_337);
	}
	else
	{
		...
		case 1:
			if (unk_0x71364F510A1CB69F())
			{
				...
				if (func_302(unk_0xA19140A5C42D8715()))
				{
					...
					if (!func_211())
					{
						func_223(unk_0xA19140A5C42D8715(), vLocal_415, fLocal_416, 0, 1);
					}
					if (func_302(iLocal_348))
					{
						unk_0x22DD1D053CFF9707(unk_0xA19140A5C42D8715(), iLocal_348, -1, 0, 2);
					}
					func_222(1);
					func_220(0);
				}
...
void func_220(bool bParam0)
{
	if (func_302(iLocal_348))
	{
		if (bParam0)
		{
			...
			{
				if (!unk_0x097A982B0640FA32(iLocal_348, func_221()))
				{
					unk_0x9568B1B58F78FF36(iLocal_348);
					unk_0x9854E4DB9C72017F(iLocal_348, func_221());
					unk_0xC860991D1C5AD4F0(iLocal_348, 1);
					unk_0xB29E08C7AB729BAD(iLocal_348, false);
				}
			}
		}
		else if (unk_0x097A982B0640FA32(iLocal_348, func_221()))
		{
			unk_0x9568B1B58F78FF36(iLocal_348);
			unk_0xF8136E11BE4BEAC3(iLocal_348);
		}
	}
}
...
void func_222(bool bParam0)
{
	...
	if (func_302(iVar0))
	{
		...
		{
			unk_0xF0188A1B49D79AF7(iVar0, joaat("weapon_sniperrifle"), -1, bParam0, true);
		}
		...
		unk_0xB20B772FD9DE1847(iVar0, joaat("weapon_sniperrifle"), bParam0);
	}
}
...
void func_225(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_208(unk_0x61D2332983ACC05C(), 1);
			if (iVar4 != -1)
			{
...
void func_251(int iParam0, var uParam1)
{
	...
	if (!unk_0x4915F4759304D5CF(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x3D2A81E3C295D501(iParam0, func_256(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x8798F3E6AE76AF63(iVar5, &Var7) && !func_253(Var7.f_1)) && iVar9 < 50)
			{
...
int func_262(var uParam0)
{
	if (!unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		if (func_284())
		{
			*uParam0 = func_267(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false), 6, -1, 0, 1, -1);
...
int func_267(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_283(iVar0))
		{
			...
			{
				fVar1 = unk_0x499324B3EF19C288(vParam0, func_268(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_291(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_304()
{
	...
	if (iLocal_338 < 3)
	{
		if (!bLocal_294)
		{
			if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_365, vLocal_366, 20f, 0, true, 0))
			{
				func_315();
				if (iLocal_301[17])
				{
...
void func_305()
{
	...
	while (iVar3 < 4)
	{
		if (unk_0xE59B461FD3AB95B5(iVar2[iVar3], vVar0[iVar3 /*3*/], 1))
		{
			iLocal_425[iVar3] = unk_0x48CFBECB146FD1A1(iVar2[iVar3], vVar0[iVar3 /*3*/], fVar1[iVar3], true, true, false);
		}
		iVar3++;
	}
...
void func_306()
{
	unk_0xA5DE74AE39867B03(iLocal_343);
	unk_0xA5DE74AE39867B03(iLocal_344);
}
...
{
	if (!unk_0xCE3CB618AFE55EFB(iLocal_263))
	{
	...
	if (unk_0xCE3CB618AFE55EFB(iLocal_263))
	{
		if (!bParam0)
		{
			unk_0x575CF00E129E0CE1(iLocal_263, 0.75f);
		}
		unk_0x0798CD089167D3C1(iLocal_263, iParam1);
	}
}
		...
		while (iVar1 < 3)
		{
			if (((Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_260[iVar0 /*54*/].f_52 != 4) && Local_260[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_302(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						vLocal_421[iVar0 /*3*/] = { unk_0xE2BBD32891C18569(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, true) };
						iLocal_303[iVar0] = 1;
						Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1 = 1;
						if (Local_260[iVar0 /*54*/][0 /*17*/].f_1 == 1)
						{
							if (!unk_0x7112137033807390(Local_260[iVar0 /*54*/][1 /*17*/].f_6, 0))
							{
								Local_260[iVar0 /*54*/][1 /*17*/].f_4 = 0;
								iLocal_329 = 1;
							}
							else if (!unk_0x7112137033807390(Local_260[iVar0 /*54*/][2 /*17*/].f_6, 0))
							{
				...
				else if (unk_0x9809FE4B550B1EFE(unk_0xE2BBD32891C18569(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, true), 2f, 0))
				{
					iLocal_277 = 0;
					iLocal_281 = 1;
					iLocal_330 = 0;
					...
					while (iLocal_330 < 3)
					{
						...
						{
							Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_14 = { unk_0xE2BBD32891C18569(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, true) };
							Local_260[iVar0 /*54*/].f_52 = 4;
						}
			...
			switch (Local_260[iVar0 /*54*/].f_52)
			{
				...
				case 4:
					...
					while (iLocal_330 < 3)
					{
						if ((unk_0xDC5D81351D6A4DDB(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0)) && !unk_0x4915F4759304D5CF(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6))
						{
				...
				case 2:
					...
					while (iLocal_330 < 3)
					{
						...
						{
							if (unk_0xDC5D81351D6A4DDB(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0))
							{
								unk_0xBF83D5CD662ABC16(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, vLocal_421[iVar0 /*3*/], unk_0xF59B9063EDAC7451(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_317(int iParam0, int iParam1)
{
	...
	{
		if (!unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
		{
			unk_0x3EE01DAA2DCBF34D(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
		}
	...
	switch (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 = (unk_0xFD34717937104F1C() + unk_0x22C775856F4633CA(3000, 8000));
		...
		case 4:
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0xFD34717937104F1C() > Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
					...
					while (iVar0 < 3)
					{
						if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6, 0))
						{
		...
		case 5:
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 = unk_0x22C775856F4633CA(0, 8);
				if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						unk_0x956B3CF461C0C1C9(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, unk_0xF59B9063EDAC7451(0f, 359.9f));
					}
					else if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
					{
						unk_0x3A7AFBF6BE5F0981(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && unk_0xA60C975CBAB69F34(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_320(iParam0), false, false, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							unk_0x9568B1B58F78FF36(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
							unk_0x9E0C8614EFFB96CB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					unk_0x1659AF2827EC9D40(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					unk_0x1659AF2827EC9D40(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
				unk_0xD738221C247C8B71(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
		...
		case 12:
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_303[iParam0])
				{
					...
					{
						unk_0xBF83D5CD662ABC16(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], unk_0xF59B9063EDAC7451(1f, 2.5f), 0, 0, 786603, -1082130432);
		...
		case 8:
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
				{
					unk_0x3A7AFBF6BE5F0981(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
		...
		case 13:
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
				{
				...
				unk_0xDCB46BFC2265476A(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
			}
...
int func_318(int iParam0)
{
	...
	if (unk_0xDC5D81351D6A4DDB(iParam0))
	{
		...
		if (unk_0x6D7FFF527E125F24(-1, vVar0, 20f))
		{
			return 0;
		}
		if (func_302(unk_0xA19140A5C42D8715()))
...
{
	if ((((unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_365, vLocal_366, 20f, 0, true, 0) && unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_286) && iLocal_338 < 3)
	{
		if (!unk_0xCE3CB618AFE55EFB(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/] = func_309(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (unk_0xCE3CB618AFE55EFB(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
			{
				unk_0x575CF00E129E0CE1(Local_260[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
			}
			if (!unk_0x7112137033807390(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				unk_0x92B3AAAC52CC36E1(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
			}
		}
	}
	else
...
void func_336(int iParam0, int iParam1)
{
	...
	if (!func_302(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0x35C6E06B120EB2E3(26, iLocal_341, vVar0, unk_0xF59B9063EDAC7451(0f, 359.9f), 1, true);
		if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
			unk_0x6259CDB47862A4F3(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
			unk_0x1F4E5EFBFE503FB3(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3 = 8;
		}
	}
}
...
void func_337(int iParam0, int iParam1)
{
	if (!func_302(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5 = unk_0xF59B9063EDAC7451(0f, 359.9f);
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0x35C6E06B120EB2E3(26, iLocal_341, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, true);
			if (unk_0xDC5D81351D6A4DDB(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				unk_0x6259CDB47862A4F3(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
				unk_0x1F4E5EFBFE503FB3(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
...
void func_338(int iParam0, int iParam1)
{
	if (func_339())
	{
		unk_0x6020229E34827A69(-1, "COYOTE_BARK_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
	else
	{
		unk_0x6020229E34827A69(-1, "COYOTE_CRY_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0x71364F510A1CB69F())
			{
				...
				if (!func_211())
				{
					func_223(unk_0xA19140A5C42D8715(), vLocal_377, fLocal_378, 0, 1);
					func_342();
				}
				iLocal_257 = 2;
			}
...
void func_346()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0xCE3CB618AFE55EFB(Local_258[iVar0 /*10*/].f_9))
		{
			unk_0xE1623437A3194332(&(Local_258[iVar0 /*10*/].f_9));
		}
	...
	if (iLocal_271)
	{
		unk_0xA5DE74AE39867B03(iLocal_340);
	}
}
...
void func_349()
{
	unk_0xCACEBBBEAD8F262E(iLocal_343);
	unk_0xCACEBBBEAD8F262E(iLocal_344);
	while (!unk_0x7FC99CCC73354033(iLocal_343) || !unk_0x7FC99CCC73354033(iLocal_344))
	{
		wait(0);
	}
}
...
int func_351()
{
	if (unk_0xDC5D81351D6A4DDB(iLocal_348) && !unk_0x7112137033807390(unk_0xA19140A5C42D8715(), 0))
	{
		if (!unk_0x10E54C268D1B3FED(iLocal_348, unk_0xA19140A5C42D8715(), vLocal_367, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_353()
{
	...
	func_354();
	if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) || iLocal_301[16])
	{
		func_348();
		func_341();
		iLocal_254 = 15;
...
void func_354()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_368(iVar0);
			if (unk_0xDC5D81351D6A4DDB(Local_259[iVar0 /*29*/].f_28))
			{
				if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_363, vLocal_364, 10f, 0, true, 0))
				{
					if (!bLocal_289)
					{
						if (unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
						{
							bLocal_289 = true;
							func_312(6);
						}
		...
		switch (Local_259[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				Local_259[iVar0 /*29*/].f_7 = unk_0x22C775856F4633CA(0, 5);
				if ((!unk_0x85A65397E2224648(Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) && iLocal_319 < 3) && unk_0xE59B461FD3AB95B5(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, 1))
				{
					Local_259[iVar0 /*29*/].f_28 = unk_0x48CFBECB146FD1A1(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, Local_259[iVar0 /*29*/].f_4, true, true, false);
					if (unk_0xDC5D81351D6A4DDB(Local_259[iVar0 /*29*/].f_28) && !unk_0x7112137033807390(Local_259[iVar0 /*29*/].f_28, 0))
					{
						unk_0x83055D7E96024509(Local_259[iVar0 /*29*/].f_28, true);
						unk_0xAB9FD40CC0E419E3(Local_259[iVar0 /*29*/].f_28, true);
						Local_259[iVar0 /*29*/].f_7 = unk_0x22C775856F4633CA(0, 5);
						Local_259[iVar0 /*29*/].f_12 = unk_0x91A7C8CA5E332C03(Local_259[iVar0 /*29*/].f_28, 26, Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, true);
						if (unk_0xDC5D81351D6A4DDB(Local_259[iVar0 /*29*/].f_12))
						{
							Local_259[iVar0 /*29*/].f_11 = unk_0xFCFC8CC5FF74580D(iLocal_345, Local_259[iVar0 /*29*/].f_16, true, true, false);
							if (unk_0xDC5D81351D6A4DDB(Local_259[iVar0 /*29*/].f_11))
							{
								unk_0x96B71B23D409A3DB(Local_259[iVar0 /*29*/].f_11, Local_259[iVar0 /*29*/].f_12, unk_0xF622A022C26057AA(Local_259[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								unk_0x7C73A424F1117528(Local_259[iVar0 /*29*/].f_11, false, 0);
								unk_0x98D1B1BD9C3AA456(Local_259[iVar0 /*29*/].f_12, true, 1);
								unk_0x83055D7E96024509(Local_259[iVar0 /*29*/].f_12, true);
								Local_259[iVar0 /*29*/].f_2 = 0;
								Local_259[iVar0 /*29*/].f_1 = 0;
								Local_259[iVar0 /*29*/].f_3 = 0;
								unk_0x1F4E5EFBFE503FB3(Local_259[iVar0 /*29*/].f_12, true);
								unk_0xE49301B2B6F420DE(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_319++;
			...
			case 4:
				...
				{
					if (!unk_0xA60C975CBAB69F34(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 10f, 10f, 10f, false, false, 0))
					{
							...
							if (func_318(Local_259[iVar0 /*29*/].f_28))
							{
								if (func_365(iVar0))
								{
									if (!Local_259[iVar0 /*29*/].f_1)
									{
										...
										func_364(iVar0);
										unk_0xDCB46BFC2265476A(Local_259[iVar0 /*29*/].f_28);
						...
						{
							if (unk_0x9809FE4B550B1EFE(unk_0xE2BBD32891C18569(Local_259[iVar0 /*29*/].f_28, true), 5f, 1))
							{
								iLocal_282 = 1;
							}
						}
					...
					{
						unk_0x9568B1B58F78FF36(Local_259[iVar0 /*29*/].f_12);
						unk_0xAB9FD40CC0E419E3(Local_259[iVar0 /*29*/].f_28, false);
						unk_0x731722E696597BD1(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 8f, 786599);
						unk_0xD738221C247C8B71(Local_259[iVar0 /*29*/].f_12, true);
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
				else
			...
			case 5:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && func_367(Local_259[iVar0 /*29*/].f_28))
				{
					...
					{
						unk_0xACD687595DC10DD1(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, vVar1, unk_0x552C823E1D2A019C(Local_259[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_339())
					{
						unk_0x95015EE4AAC98495(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 5, 2000);
					}
					else
					{
						unk_0x95015EE4AAC98495(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_224(Local_259[iVar0 /*29*/].f_28) && func_302(Local_259[iVar0 /*29*/].f_12)) && !unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
				{
					if (unk_0x097275D546C9735F(Local_259[iVar0 /*29*/].f_28))
					{
						unk_0x9568B1B58F78FF36(Local_259[iVar0 /*29*/].f_12);
						unk_0x1F4E5EFBFE503FB3(Local_259[iVar0 /*29*/].f_12, true);
						if (!unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
							unk_0xFBA5AC89E66201B2(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 1);
						}
						else
						{
							func_359(iVar0);
			...
			case 7:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
				{
					if (!unk_0x5D7DFE2058701942(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
					...
					else if (unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
					{
						func_359(iVar0);
					}
				}
			...
			case 8:
				if ((func_302(Local_259[iVar0 /*29*/].f_12) && !unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1)) && func_367(Local_259[iVar0 /*29*/].f_28))
				{
					vVar2 = { unk_0xE2BBD32891C18569(Local_259[iVar0 /*29*/].f_12, true) };
					if (!unk_0x5D7DFE2058701942(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1) && !unk_0x9809FE4B550B1EFE(vVar2, 3f, 1))
						{
							Local_259[iVar0 /*29*/].f_25 = { unk_0x3201284584C7CD83(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_22) };
							Local_259[iVar0 /*29*/].f_6 = (unk_0x552C823E1D2A019C(Local_259[iVar0 /*29*/].f_28) + Local_259[iVar0 /*29*/].f_5);
							unk_0x9568B1B58F78FF36(Local_259[iVar0 /*29*/].f_12);
							unk_0x1F4E5EFBFE503FB3(Local_259[iVar0 /*29*/].f_12, true);
							unk_0x956B3CF461C0C1C9(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_259[iVar0 /*29*/].f_6);
			...
			case 9:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
				{
					...
					if (!unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1) && !unk_0x9809FE4B550B1EFE(vVar2, 3f, 1))
					{
						if (unk_0xA60C975CBAB69F34(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, 1f, 1f, false, false, 1))
						{
							unk_0x9568B1B58F78FF36(Local_259[iVar0 /*29*/].f_12);
							unk_0x1F4E5EFBFE503FB3(Local_259[iVar0 /*29*/].f_12, true);
							unk_0x0177431263151C4E(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 0);
			...
			case 10:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
				{
					...
					if (!unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1) && !unk_0x9809FE4B550B1EFE(vVar2, 3f, 1))
					{
						Local_259[iVar0 /*29*/].f_15 = unk_0xF9D4EF1338E38AFB(Local_259[iVar0 /*29*/].f_12, -875674219);
			...
			case 11:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
				{
					...
					if (!unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1) && !unk_0x9809FE4B550B1EFE(vVar2, 3f, 1))
					{
						unk_0x2F89329397A277BC(&(Local_259[iVar0 /*29*/].f_14));
						...
						unk_0x301F42EEE3C40328(Local_259[iVar0 /*29*/].f_14);
						unk_0xE1072FA2FECBAD96(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_14);
						unk_0x3A95A0A3221D4208(&(Local_259[iVar0 /*29*/].f_14));
						Local_259[iVar0 /*29*/].f_8 = unk_0xFD34717937104F1C() + 20000;
			...
			case 12:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
				{
					...
					if (!unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1) && !unk_0x9809FE4B550B1EFE(vVar2, 3f, 1))
					{
						if (unk_0xFD34717937104F1C() > Local_259[iVar0 /*29*/].f_8)
						{
							if (unk_0x7E65E323A95E4187(Local_259[iVar0 /*29*/].f_11))
							{
								unk_0x7C73A424F1117528(Local_259[iVar0 /*29*/].f_11, false, 0);
							}
							else
						...
						else if (unk_0x411C28019DEA5CEF(Local_259[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !unk_0x7E65E323A95E4187(Local_259[iVar0 /*29*/].f_11))
						{
							unk_0x7C73A424F1117528(Local_259[iVar0 /*29*/].f_11, true, 0);
						}
					}
					else
					{
			...
			case 13:
				if (!unk_0xDEAEC99031DCB92A(Local_259[iVar0 /*29*/].f_28, unk_0xA19140A5C42D8715(), 1))
				{
					if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(Local_259[iVar0 /*29*/].f_28, false), unk_0xE2BBD32891C18569(Local_259[iVar0 /*29*/].f_12, true), false) > 100f)
					{
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
			...
			case 15:
				...
				if (unk_0xDC5D81351D6A4DDB(Local_259[iVar0 /*29*/].f_12))
				{
					if (!unk_0x7112137033807390(Local_259[iVar0 /*29*/].f_12, 0))
					{
						unk_0xD738221C247C8B71(Local_259[iVar0 /*29*/].f_12, true);
					}
		...
		{
			if (unk_0x499324B3EF19C288(vLocal_376, unk_0xE2BBD32891C18569(Local_259[iVar0 /*29*/].f_28, true), true) > 450f)
			{
				Local_259[iVar0 /*29*/].f_13 = 15;
			}
		}
...
void func_357(int iParam0)
{
	...
	if (func_302(iVar0))
	{
		if (func_367(Local_259[iParam0 /*29*/].f_28))
		{
			...
			unk_0x2F89329397A277BC(&(Local_259[iParam0 /*29*/].f_14));
			unk_0xA2EBCD9385E56019(0, Local_259[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
			unk_0x731722E696597BD1(0, Local_259[iParam0 /*29*/].f_28, 60f, 786468);
			unk_0x301F42EEE3C40328(Local_259[iParam0 /*29*/].f_14);
			unk_0xE1072FA2FECBAD96(iVar0, Local_259[iParam0 /*29*/].f_14);
			unk_0xD738221C247C8B71(iVar0, true);
			unk_0x3A95A0A3221D4208(&(Local_259[iParam0 /*29*/].f_14));
		}
...
Vector3 func_358(int iParam0)
{
	...
	if (func_367(iParam0))
	{
		vVar0 = { unk_0x3201284584C7CD83(iParam0, 5f, 25f, 0f) };
		if (unk_0xA177613398FB538B(vVar0, &vVar1, 1, 1077936128, 0))
		{
			if (unk_0xF3DFF37E04D42116(vVar1, 0, &vVar1))
			{
				if (!unk_0x85A65397E2224648(vVar1, 2f) && !unk_0xC980951B35C111AE(vVar1, 2f, 0))
				{
					return vVar1;
				}
			}
...
void func_359(int iParam0)
{
	...
	{
		unk_0x9568B1B58F78FF36(Local_259[iParam0 /*29*/].f_12);
		unk_0x1F4E5EFBFE503FB3(Local_259[iParam0 /*29*/].f_12, true);
		if (func_367(Local_259[iParam0 /*29*/].f_28))
		{
			if (unk_0xE0FD180CD24C0B67(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, 0))
			{
				unk_0xE49301B2B6F420DE(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, Local_259[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_259[iParam0 /*29*/].f_13 = 14;
			}
			else
			{
				unk_0x1659AF2827EC9D40(Local_259[iParam0 /*29*/].f_12, vLocal_358, 10000f, -1, 0, 0);
				Local_259[iParam0 /*29*/].f_13 = 13;
			}
		}
		Local_259[iParam0 /*29*/].f_2 = 1;
		unk_0xD738221C247C8B71(Local_259[iParam0 /*29*/].f_12, true);
	}
	else
	{
...
void func_360()
{
	if (!iLocal_278)
	{
		if (func_339())
		{
			iLocal_318 = unk_0xFD34717937104F1C() + 1000;
			iLocal_278 = 1;
		}
	}
	else if (unk_0xFD34717937104F1C() > iLocal_318)
	{
...
int func_362()
{
	...
	if (func_302(unk_0xA19140A5C42D8715()))
	{
		...
		if (func_302(iLocal_348))
		{
			vVar1 = { unk_0xE2BBD32891C18569(iLocal_348, true) };
			if (func_363(unk_0xA19140A5C42D8715(), iLocal_348, 0) <= 10f && unk_0x69C0BB7D03EE045D((vVar0.z - vVar1.z)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_364(int iParam0)
{
	...
	if (!unk_0x7112137033807390(Local_259[iParam0 /*29*/].f_28, 0))
	{
		unk_0x92B3AAAC52CC36E1(Local_259[iParam0 /*29*/].f_28, false);
	}
...
{
	if (unk_0xDC5D81351D6A4DDB(Local_259[iParam0 /*29*/].f_28) && !unk_0x7112137033807390(Local_259[iParam0 /*29*/].f_28, 0))
	{
		if (unk_0xB7223494EA10AF2F(Local_259[iParam0 /*29*/].f_28, 1, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0xB7223494EA10AF2F(Local_259[iParam0 /*29*/].f_28, 5, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0xB7223494EA10AF2F(Local_259[iParam0 /*29*/].f_28, 4, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
		}
		else if (unk_0xB7223494EA10AF2F(Local_259[iParam0 /*29*/].f_28, 0, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
...
{
	if (unk_0xDC5D81351D6A4DDB(Local_259[iParam0 /*29*/].f_12))
	{
		if (unk_0x7112137033807390(Local_259[iParam0 /*29*/].f_12, 0) || !unk_0x7112137033807390(Local_259[iParam0 /*29*/].f_12, 0))
		{
			if (unk_0xDEAEC99031DCB92A(Local_259[iParam0 /*29*/].f_12, unk_0xA19140A5C42D8715(), 1))
			{
				func_359(iParam0);
			}
		}
...
void func_371()
{
	if (bLocal_292)
	{
		unk_0xA5DE74AE39867B03(Local_259[0 /*29*/].f_9);
		unk_0xA5DE74AE39867B03(Local_259[1 /*29*/].f_9);
		unk_0xA5DE74AE39867B03(Local_259[2 /*29*/].f_9);
		unk_0xA5DE74AE39867B03(Local_259[3 /*29*/].f_9);
		unk_0xA5DE74AE39867B03(Local_259[4 /*29*/].f_9);
		unk_0xA5DE74AE39867B03(Local_259[0 /*29*/].f_10);
		unk_0xA5DE74AE39867B03(Local_259[1 /*29*/].f_10);
		unk_0xA5DE74AE39867B03(Local_259[2 /*29*/].f_10);
		unk_0xA5DE74AE39867B03(Local_259[3 /*29*/].f_10);
		unk_0xA5DE74AE39867B03(Local_259[4 /*29*/].f_10);
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0x71364F510A1CB69F())
			{
				...
				iLocal_255 = 13;
				unk_0x01AF8CB960828C2B(vLocal_376, 50f, 0, 0, 0, 0, false, 0);
				unk_0x01AF8CB960828C2B(vLocal_374, 50f, 0, 0, 0, 0, false, 0);
				unk_0x01AF8CB960828C2B(vLocal_375, 50f, 0, 0, 0, 0, false, 0);
				unk_0x836A6A722DEA63F1(unk_0xA19140A5C42D8715());
				func_370();
				func_344();
				func_343();
				...
				if (!func_211())
				{
					func_223(unk_0xA19140A5C42D8715(), vLocal_358, fLocal_305, 0, 1);
					func_342();
				}
				iLocal_257 = 2;
			}
...
{
	func_377();
	unk_0xCACEBBBEAD8F262E(Local_259[0 /*29*/].f_9);
	unk_0xCACEBBBEAD8F262E(Local_259[1 /*29*/].f_9);
	unk_0xCACEBBBEAD8F262E(Local_259[2 /*29*/].f_9);
	unk_0xCACEBBBEAD8F262E(Local_259[3 /*29*/].f_9);
	unk_0xCACEBBBEAD8F262E(Local_259[4 /*29*/].f_9);
	unk_0xCACEBBBEAD8F262E(Local_259[0 /*29*/].f_10);
	unk_0xCACEBBBEAD8F262E(Local_259[1 /*29*/].f_10);
	unk_0xCACEBBBEAD8F262E(Local_259[2 /*29*/].f_10);
	unk_0xCACEBBBEAD8F262E(Local_259[3 /*29*/].f_10);
	unk_0xCACEBBBEAD8F262E(Local_259[4 /*29*/].f_10);
	unk_0xCACEBBBEAD8F262E(iLocal_345);
	while ((((((((((!unk_0x7FC99CCC73354033(Local_259[0 /*29*/].f_9) || !unk_0x7FC99CCC73354033(Local_259[1 /*29*/].f_9)) || !unk_0x7FC99CCC73354033(Local_259[2 /*29*/].f_9)) || !unk_0x7FC99CCC73354033(Local_259[3 /*29*/].f_9)) || !unk_0x7FC99CCC73354033(Local_259[4 /*29*/].f_9)) || !unk_0x7FC99CCC73354033(Local_259[0 /*29*/].f_10)) || !unk_0x7FC99CCC73354033(Local_259[1 /*29*/].f_10)) || !unk_0x7FC99CCC73354033(Local_259[2 /*29*/].f_10)) || !unk_0x7FC99CCC73354033(Local_259[3 /*29*/].f_10)) || !unk_0x7FC99CCC73354033(Local_259[4 /*29*/].f_10)) || !unk_0x7FC99CCC73354033(iLocal_345))
	{
		wait(0);
	}
	bLocal_292 = true;
...
void func_379()
{
	...
	unk_0x399F85E7A13D849F(vLocal_359, fLocal_315);
	unk_0x399F85E7A13D849F(vLocal_360, fLocal_315);
	unk_0x5FEB5D55B0DE217B(0f);
	unk_0x9F7E14E0AE70CCBB(0f, 0f);
	if (unk_0x06EBD57CD6085DD1() == 4)
	{
...
void func_380()
{
	if (!unk_0x4915F4759304D5CF(iLocal_348) && !unk_0x4915F4759304D5CF(unk_0xA19140A5C42D8715()))
	{
		if (!bLocal_283)
		{
			if (!unk_0x10E54C268D1B3FED(iLocal_348, unk_0xA19140A5C42D8715(), vLocal_384, 0, 1, 0) || unk_0xDA3A4E46D189F555(unk_0xA19140A5C42D8715()) != 0)
			{
				if (!unk_0x68477FE20127AEDA(iLocal_348))
				{
					bLocal_283 = true;
				}
			}
		}
		else if (unk_0x10E54C268D1B3FED(iLocal_348, unk_0xA19140A5C42D8715(), vLocal_385, 0, 1, 0) && unk_0xDA3A4E46D189F555(unk_0xA19140A5C42D8715()) == 0)
		{
...
void func_383()
{
	...
	if (!iLocal_293)
	{
		if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_357, 50f, 50f, 50f, false, true, 0))
		{
			func_385();
			iLocal_293 = 1;
		}
	...
	if (!bLocal_283)
	{
		if (unk_0xA60C975CBAB69F34(unk_0xA19140A5C42D8715(), vLocal_357, 5f, 5f, 5f, false, true, 0) && func_384(1077936128, 1))
		{
			unk_0x413F34FCFABEDE4B(vLocal_374, vLocal_375, false, 1);
			func_8(&iLocal_262);
			func_375();
			func_2();
			func_341();
...
void func_385()
{
	unk_0xF66A39BBE7B3C278(vLocal_401, vLocal_402, 0, 1, 1, 1);
	unk_0xFF54548CCE498035(vLocal_401, vLocal_402);
	unk_0x3521B10FB737CE36(vLocal_412, 5f, 0);
}
...
void func_386()
{
	...
	if (iLocal_301[3])
	{
		...
		{
			func_225(2, "Player has finished shooting all the satellite dishes", 0, 0, 0, 1);
			if (unk_0xDC5D81351D6A4DDB(iLocal_426))
			{
				unk_0x14293208022014FA(iLocal_426, 1);
			}
			if (iLocal_336 <= 3)
			{
				func_372(769, 3, 1);
...
void func_387()
{
	...
	unk_0x399F85E7A13D849F(vLocal_359, fLocal_315);
	unk_0x399F85E7A13D849F(vLocal_360, fLocal_315);
	if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_361, vLocal_362, 7f, 1, true, 0))
	{
		if (iLocal_301[1])
		{
			iLocal_290 = 0;
...
void func_389()
{
	...
	unk_0x399F85E7A13D849F(vLocal_359, fLocal_315);
	unk_0x399F85E7A13D849F(vLocal_360, fLocal_315);
	if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_361, vLocal_362, 7f, 0, true, 0))
	{
		func_315();
		func_394();
		func_373();
		...
		if (!unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0) && (unk_0xA60C975CBAB69F34(iLocal_348, vLocal_368, 2f, 2f, 2f, false, true, 0) || iLocal_338 >= 3))
		{
			if (!bLocal_294)
			{
				if (iLocal_338 >= 3)
				{
					if (!unk_0xA60C975CBAB69F34(iLocal_348, vLocal_368, 2f, 2f, 2f, false, true, 0))
					{
						func_220(1);
					}
					iLocal_254 = 8;
		...
		if (!unk_0xCE3CB618AFE55EFB(Local_258[iVar0 /*10*/].f_9))
		{
			if (func_224(Local_258[iVar0 /*10*/]))
			{
				if (!Local_258[iVar0 /*10*/].f_7)
				{
					...
					unk_0x570128B7829A8EAA(Local_258[iVar0 /*10*/].f_9, 1);
				}
			}
		}
		iVar0++;
	...
	while (iVar0 < 3)
	{
		...
		if (Local_258[iVar0 /*10*/].f_7 == 1)
		{
			if (!Local_258[iVar0 /*10*/].f_8)
			{
				...
				{
					unk_0xDCB46BFC2265476A(Local_258[iVar0 /*10*/]);
					iLocal_338++;
				}
				else
				{
...
{
	if (unk_0xDC5D81351D6A4DDB(Local_258[iParam0 /*10*/]) && !Local_258[iParam0 /*10*/].f_7)
	{
		Local_258[iParam0 /*10*/].f_5 = unk_0x24A1A7BF4ED94B71(Local_258[iParam0 /*10*/]);
		if (Local_258[iParam0 /*10*/].f_5 < 100)
		{
			...
			unk_0x8D5247FDD68E4EC4(Local_258[iParam0 /*10*/], 1, 0);
		}
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0x71364F510A1CB69F())
			{
				...
				if (!func_211())
				{
					func_223(unk_0xA19140A5C42D8715(), vLocal_356, fLocal_304, 0, 1);
				}
				func_8(&iLocal_262);
				func_222(1);
...
void func_397()
{
	unk_0x3521B10FB737CE36(vLocal_403, 3f, 0);
	unk_0xFF54548CCE498035(vLocal_404, vLocal_405);
	unk_0x3521B10FB737CE36(vLocal_406, 3f, 0);
	unk_0xFF54548CCE498035(vLocal_407, vLocal_408);
	unk_0x3521B10FB737CE36(vLocal_409, 3f, 0);
	unk_0xFF54548CCE498035(vLocal_410, vLocal_411);
}
...
int func_398()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			unk_0x39F8A3E01BC1A69B(Local_258[iVar0 /*10*/].f_1, 2f, 0);
			Local_258[iVar0 /*10*/] = unk_0xFCFC8CC5FF74580D(iLocal_340, Local_258[iVar0 /*10*/].f_1, true, true, false);
			if (unk_0xDC5D81351D6A4DDB(Local_258[iVar0 /*10*/]))
			{
				unk_0x92DDCF53AA47A63D(Local_258[iVar0 /*10*/], Local_258[iVar0 /*10*/].f_4);
				unk_0x32E86184ECA604B8(Local_258[iVar0 /*10*/], 0);
				unk_0x6259CDB47862A4F3(Local_258[iVar0 /*10*/], 100, 0);
				unk_0x9018100BC4DCB099(Local_258[iVar0 /*10*/], 1);
				Local_258[iVar0 /*10*/].f_7 = 0;
				Local_258[iVar0 /*10*/].f_8 = 0;
			}
			iVar0++;
		}
		if (((unk_0xDC5D81351D6A4DDB(Local_258[0 /*10*/]) && unk_0xDC5D81351D6A4DDB(Local_258[1 /*10*/])) && unk_0xDC5D81351D6A4DDB(Local_258[2 /*10*/])) && func_399())
		{
			unk_0xA5DE74AE39867B03(iLocal_340);
			iLocal_271 = 0;
			return 1;
...
int func_399()
{
	iLocal_335 = unk_0x22C775856F4633CA(0, 3);
	if (unk_0xDC5D81351D6A4DDB(Local_258[iLocal_335 /*10*/]))
	{
...
void func_400()
{
	unk_0xCACEBBBEAD8F262E(iLocal_340);
	while (!unk_0x7FC99CCC73354033(iLocal_340))
	{
		wait(0);
	}
	iLocal_271 = 1;
...
void func_401()
{
	...
	else
	{
		...
		if (unk_0xCE3CB618AFE55EFB(iLocal_263))
		{
			if (!unk_0x14511C666640BEEB(iLocal_263))
			{
				if (!unk_0x10E54C268D1B3FED(iLocal_348, unk_0xA19140A5C42D8715(), vLocal_384, 0, 1, 0))
				{
					func_2();
					func_308(1, 0);
					func_313("HT_BKHTER");
			...
			else
			{
				...
				if (unk_0x10E54C268D1B3FED(iLocal_348, unk_0xA19140A5C42D8715(), vLocal_385, 0, 1, 0))
				{
					func_308(1, 0);
					if (func_388("HT_BKHTER", 0, 0))
					{
		...
		case 1:
			if (unk_0x71364F510A1CB69F())
			{
				if (unk_0x5CA3186381FC012C())
				{
					...
					if (unk_0xDC5D81351D6A4DDB(iLocal_347))
					{
						unk_0xC0AC848E56940C34(&iLocal_347);
					}
				}
				...
				if (!func_211())
				{
					func_223(unk_0xA19140A5C42D8715(), vLocal_380, fLocal_381, 0, 1);
					func_342();
				}
				func_222(1);
				unk_0x01AF8CB960828C2B(vLocal_379, 2f, 0, 0, 0, 0, false, 0);
				func_7();
				iLocal_257 = 2;
			}
			break;
			...
			switch (iLocal_320)
			{
				case 0:
					if (func_430(1, 1093140480, 0))
					{
						...
						{
							unk_0xE216F8B2802ABABF(unk_0xA19140A5C42D8715(), sLocal_354, 0, 0, 0);
						}
						if (func_224(iLocal_348))
						{
							unk_0xE216F8B2802ABABF(iLocal_348, sLocal_355, 0, 0, 0);
							unk_0x034CA621E59C939F(sLocal_355, unk_0xA19140A5C42D8715(), 0);
							iLocal_347 = func_426(iLocal_348, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0, 0, 0);
						}
						if (unk_0xDC5D81351D6A4DDB(iLocal_347))
						{
							unk_0xE216F8B2802ABABF(iLocal_347, "Daves_Rifle", 0, 0, 0);
						}
						func_425();
						...
						{
							unk_0x4299736016AECE26(iLocal_426, 1806.732f, 3934.353f, 33.3275f, 1, false, 0, 1);
							unk_0x92DDCF53AA47A63D(iLocal_426, 76.1155f);
						}
				...
				case 1:
					if (unk_0x0FFE9FEDC2E0AC88(sLocal_355, joaat("p_cletus_necklace_s")))
					{
						if (!bLocal_276)
						{
					...
					{
						unk_0xE2C0081C99CB2618(iLocal_347, unk_0xA19140A5C42D8715());
					}
					if (unk_0x0FFE9FEDC2E0AC88(sLocal_354, 0))
					{
						unk_0xF757C0D3A087F145(unk_0xA19140A5C42D8715(), -668482597, false, 1, 0);
			...
			if (unk_0x71364F510A1CB69F())
			{
				if (func_398())
				{
					if (func_302(iLocal_348))
					{
						...
						{
							func_223(iLocal_348, vLocal_373, fLocal_312, 0, 1);
							unk_0x581CF279D6A7E3D6(iLocal_348, joaat("weapon_sniperrifle"));
							unk_0x9568B1B58F78FF36(iLocal_348);
							iLocal_255 = 2;
						}
					}
...
int func_426(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	vVar5 = { unk_0xE2BBD32891C18569(iParam0, false) - Vector(10f, 0f, 0f) };
	if (bParam3)
	{
	...
	while (func_254(iVar2, iVar6) != 0)
	{
		if (!unk_0x7112137033807390(iParam0, 0))
		{
			if (unk_0x15763A17141CD6EE(iParam0, iVar2, func_254(iVar2, iVar6)))
			{
				if (func_429(func_254(iVar2, iVar6)))
				{
					iVar7 = unk_0x73929A7BB3EF0A64(func_254(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_254(iVar2, iVar6) != 0)
	{
		if (!unk_0x7112137033807390(iParam0, 0))
		{
			if (unk_0x15763A17141CD6EE(iParam0, iVar2, func_254(iVar2, iVar6)))
			{
				unk_0x9D1B97F26237B39F(iVar1, func_254(iVar2, iVar6));
...
int func_430(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		...
		{
			if (!func_433(unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_436()
{
	if (!unk_0xECD112E8A7AB2E8A() && func_363(unk_0xA19140A5C42D8715(), iLocal_348, 1) > 3f)
	{
		iLocal_325 = unk_0xFD34717937104F1C() + 2000;
		if (func_302(iLocal_348))
		{
			if (func_302(unk_0xA19140A5C42D8715()))
			{
			}
			unk_0x39102BE90DA2BED2(iLocal_348, 0f, 0f, 0f, 1, 13000, 2000, 2000, 0);
			unk_0x438EC2D9415DDEC6(fLocal_306);
			unk_0x78F2A4FA52D7AF0F(fLocal_307);
			unk_0x0E886D94980531CA(fLocal_308);
			unk_0x374E4DFFB92FA338(fLocal_309);
			unk_0x27C4490DD2F94D33(fLocal_310);
			unk_0x3845F59E3D59157F(1);
		}
	}
	else if (func_302(iLocal_348) && func_302(unk_0xA19140A5C42D8715()))
	{
		if (unk_0xFD34717937104F1C() > iLocal_325 || func_363(unk_0xA19140A5C42D8715(), iLocal_348, 1) <= 3f)
		{
			if (func_363(unk_0xA19140A5C42D8715(), iLocal_348, 1) <= 3f)
			{
			}
			iLocal_320 = 0;
			iLocal_257 = 0;
...
void func_437()
{
	...
	if (func_302(iLocal_348))
	{
		unk_0xA45E1AA8B9CF45AD(iLocal_348, 200);
		unk_0x973EE9E4D51ED35B(iLocal_348, 0);
		unk_0x9EA5DDDDB1899B3B(iLocal_348, 0);
		unk_0x13E0A8160525AE55(iLocal_348, 169, true);
		unk_0x13E0A8160525AE55(iLocal_348, 206, true);
		unk_0x13E0A8160525AE55(iLocal_348, 32, false);
		unk_0x1CCA743B14705812(iLocal_348, 0);
		unk_0xA0DEC6E1399EE624(iLocal_348);
		unk_0xA78BBA5574A997CD(iLocal_348, 1);
		unk_0xC35C0EB12F3FFC86(iLocal_348, 0);
		unk_0x83055D7E96024509(iLocal_348, true);
		unk_0xCB6F83EEDBCC77C4(iLocal_348, 0);
		unk_0x9D01B1015AD5A3C8(iLocal_348, 1);
		unk_0x6AEE0EBD7CA3D63F(iLocal_348, 1);
	}
	iLocal_257 = 0;
	if (func_518())
	{
...
void func_440()
{
	...
	{
		iLocal_274 = 1;
		iLocal_337 = unk_0x4C62B1A93B2409FA(unk_0xA19140A5C42D8715(), 1285032059);
	}
}
...
void func_442()
{
	unk_0xCACEBBBEAD8F262E(iLocal_341);
	unk_0xD8AB2973F1352912("SCRIPT\HUNTING_1_COYOTE_VOCALS", 0, -1);
	while (!unk_0x7FC99CCC73354033(iLocal_341))
	{
		wait(0);
	}
}
...
void func_446()
{
	if (unk_0x06EBD57CD6085DD1() != 4)
	{
		if ((unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_397, vLocal_398, 16f, 0, true, 0) || unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_399, vLocal_400, 19f, 0, true, 0)) || unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_401, vLocal_402, 19f, 0, true, 0))
		{
			if (!unk_0x6D6FD221326F0FEB(unk_0xA19140A5C42D8715()))
			{
				unk_0x90683BECDF939A74(unk_0xA19140A5C42D8715(), true, -1, 0);
			}
		}
...
void func_447()
{
	...
	if (func_302(unk_0xA19140A5C42D8715()))
	{
		...
		switch (iLocal_255)
		{
			...
			case 3:
				func_308(1, 0);
				iLocal_334 = unk_0xFD34717937104F1C() + 2000;
				unk_0x4299736016AECE26(iLocal_348, vLocal_373, 1, false, 0, 1);
				unk_0x92DDCF53AA47A63D(iLocal_348, fLocal_312);
				iLocal_255 = 2;
				break;
			...
			case 2:
				if (func_302(iLocal_348))
				{
					...
					{
						bLocal_276 = true;
						iLocal_334 = unk_0xFD34717937104F1C() + 5000;
						unk_0x581CF279D6A7E3D6(iLocal_348, joaat("weapon_sniperrifle"));
						unk_0x956B3CF461C0C1C9(iLocal_348, vLocal_368, 1f, 60000, 0.25f, 512, Local_258[iLocal_335 /*10*/].f_6);
						unk_0xCB6F83EEDBCC77C4(iLocal_348, 0);
						iLocal_255 = 4;
					}
				}
			...
			case 4:
				if (unk_0xF9D4EF1338E38AFB(iLocal_348, 713668775) == 7)
				{
					if (unk_0xA60C975CBAB69F34(iLocal_348, vLocal_368, 1.5f, 1.5f, 1.5f, false, true, 0))
					{
						unk_0x9568B1B58F78FF36(iLocal_348);
						unk_0x22DD1D053CFF9707(iLocal_348, unk_0xA19140A5C42D8715(), -1, 1024, 2);
						unk_0xCB6F83EEDBCC77C4(iLocal_348, 1);
						unk_0x1F4E5EFBFE503FB3(iLocal_348, true);
						iLocal_255 = 6;
					}
				}
				else if (!iLocal_301[0])
				{
					if (unk_0xFD34717937104F1C() > iLocal_334)
					{
			...
			case 5:
				if (!unk_0x4915F4759304D5CF(iLocal_348))
				{
					if (unk_0x22B3625D717A4563(iLocal_348, joaat("weapon_sniperrifle"), 0))
					{
						unk_0x581CF279D6A7E3D6(iLocal_348, joaat("weapon_sniperrifle"));
					}
					if (func_478())
					{
						if (unk_0x7E65E323A95E4187(iLocal_346))
						{
							unk_0x7C73A424F1117528(iLocal_346, false, 0);
						}
						func_344();
						func_343();
						func_8(&iLocal_263);
						unk_0x836A6A722DEA63F1(iLocal_348);
						unk_0x4299736016AECE26(iLocal_348, vLocal_368, 1, false, 0, 1);
						unk_0x92DDCF53AA47A63D(iLocal_348, fLocal_304);
						iLocal_288 = 0;
						iLocal_255 = 6;
					}
				}
			...
			case 6:
				...
				else if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_361, vLocal_362, 7f, 0, true, 0) && func_362())
				{
					if (func_475())
					{
						func_370();
			...
			case 12:
				if (func_361(&uLocal_89, cLocal_353, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_333 == -1)
					{
						iLocal_333 = unk_0xFAFCEBFB311E0625(vLocal_395, vLocal_396, 0f, 0, 7);
					}
					func_370();
					iLocal_301[9] = 1;
					func_220(0);
					...
					iLocal_328 = 0;
					unk_0x22DD1D053CFF9707(iLocal_348, unk_0xA19140A5C42D8715(), -1, 1024, 2);
					unk_0x956B3CF461C0C1C9(iLocal_348, vLocal_369, 1f, 60000, 0.25f, 512, fLocal_305);
					unk_0xCB6F83EEDBCC77C4(iLocal_348, 0);
					iLocal_255 = 14;
				}
				break;
			...
			case 13:
				if (!unk_0x4915F4759304D5CF(iLocal_348))
				{
					if (func_478())
					{
						...
						unk_0x836A6A722DEA63F1(iLocal_348);
						unk_0x4299736016AECE26(iLocal_348, vLocal_369, 1, false, 0, 1);
						unk_0x92DDCF53AA47A63D(iLocal_348, fLocal_305);
						func_370();
						func_343();
						func_344();
						func_8(&iLocal_263);
			...
			case 14:
				if (unk_0xF9D4EF1338E38AFB(iLocal_348, 713668775) == 7)
				{
					if (unk_0xA60C975CBAB69F34(iLocal_348, vLocal_369, 1.25f, 1.25f, 2.5f, false, true, 0) && unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_363, vLocal_364, 10f, 0, true, 0))
					{
						if (func_475())
						{
							if (func_361(&uLocal_89, cLocal_353, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_328 == 1)
							{
								...
								if (iLocal_333 != -1)
								{
									unk_0x308B3DBB8CA58E54(iLocal_333);
									iLocal_333 = -1;
								}
								func_343();
								iLocal_301[11] = 1;
			...
			case 16:
				if (func_467())
				{
					iLocal_331 = 0;
					func_448();
					unk_0x956B3CF461C0C1C9(iLocal_348, vLocal_420[0 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
					unk_0xCB6F83EEDBCC77C4(iLocal_348, 1);
					func_308(0, 0);
					iLocal_255 = 17;
				}
			...
			case 17:
				unk_0x06FE8ECBF0B8333F(iLocal_348, 1.4f);
				if (!iLocal_301[15])
				{
					if (func_362())
					{
						if (!func_217())
						{
							if (unk_0x499324B3EF19C288(unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false), vLocal_358, true) > 10f)
							{
				...
				switch (iLocal_331)
				{
					case 0:
						...
						{
							unk_0x956B3CF461C0C1C9(iLocal_348, vLocal_420[1 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					...
					case 1:
						...
						{
							unk_0x956B3CF461C0C1C9(iLocal_348, vLocal_420[2 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					...
					case 2:
						...
						{
							unk_0x956B3CF461C0C1C9(iLocal_348, vLocal_420[3 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					...
					case 3:
						...
						{
							unk_0x956B3CF461C0C1C9(iLocal_348, vLocal_370, 1f, 60000, 0.25f, 512, fLocal_311);
							iLocal_331++;
						}
						break;
					
					case 4:
						if (unk_0xF9D4EF1338E38AFB(iLocal_348, 713668775) == 7 || (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) && unk_0x54F6F5A823224519(iLocal_348, vLocal_413, vLocal_414, 3.5f, 0, true, 0)))
						{
							unk_0xCB6F83EEDBCC77C4(iLocal_348, 0);
							iLocal_255 = 18;
						}
			...
			case 20:
				if (!unk_0x4915F4759304D5CF(iLocal_348))
				{
					if (func_478())
					{
						...
						unk_0x836A6A722DEA63F1(iLocal_348);
						unk_0x4299736016AECE26(iLocal_348, vLocal_370, 1, false, 0, 1);
						unk_0x92DDCF53AA47A63D(iLocal_348, fLocal_371);
						func_343();
						func_344();
						func_308(1, 0);
						iLocal_255 = 18;
			...
			case 18:
				...
				{
					vVar0 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), true) };
					if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) || vVar0.z > 41f)
					{
						if (func_361(&uLocal_89, cLocal_353, "HUNT_ROOF", 7, 0, 0, 0))
						{
							unk_0x9568B1B58F78FF36(iLocal_348);
							unk_0x956B3CF461C0C1C9(iLocal_348, vLocal_372, 1f, 60000, 0.25f, 512, fLocal_313);
							iLocal_301[16] = 1;
							unk_0xCB6F83EEDBCC77C4(iLocal_348, 0);
							iLocal_255 = 21;
						}
					}
					else if (unk_0xF9D4EF1338E38AFB(iLocal_348, -875674219) != 1)
					{
						unk_0x0177431263151C4E(iLocal_348, unk_0xA19140A5C42D8715(), -1);
					}
				}
				break;
			...
			case 22:
				...
				if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_365, vLocal_366, 20f, 0, true, 0))
				{
					...
					{
						func_310();
						iLocal_322 = unk_0xFD34717937104F1C() + 2000;
						bLocal_279 = true;
					}
					if (func_475())
					{
				...
				if (bLocal_279)
				{
					if (unk_0xFD34717937104F1C() > iLocal_322)
					{
						func_310();
			...
			case 24:
				...
				{
					unk_0x836A6A722DEA63F1(iLocal_348);
					unk_0x4299736016AECE26(iLocal_348, vLocal_417, 1, false, 0, 1);
					unk_0x92DDCF53AA47A63D(iLocal_348, fLocal_418);
					unk_0x22DD1D053CFF9707(iLocal_348, unk_0xA19140A5C42D8715(), -1, 0, 2);
					if (unk_0xDC5D81351D6A4DDB(iLocal_346))
					{
						unk_0x7C73A424F1117528(iLocal_346, false, 0);
					}
				}
				...
				if (!func_217())
				{
					...
					else if (!func_217())
					{
						if (func_302(iLocal_348))
						{
							unk_0x9568B1B58F78FF36(iLocal_348);
							unk_0x973EE9E4D51ED35B(iLocal_348, 0);
							unk_0x2F89329397A277BC(&iLocal_351);
							unk_0x956B3CF461C0C1C9(0, vLocal_422, 1f, 60000, 0.25f, 0, 1193033728);
							unk_0x956B3CF461C0C1C9(0, vLocal_423, 1f, 60000, 0.25f, 0, 1193033728);
							unk_0x956B3CF461C0C1C9(0, vLocal_424, 1f, 60000, 0.25f, 0, 1193033728);
							unk_0x1CBE3F8ED90509B2(0, 1193033728, 0);
							unk_0x301F42EEE3C40328(iLocal_351);
							unk_0xE1072FA2FECBAD96(iLocal_348, iLocal_351);
							unk_0x3A95A0A3221D4208(&iLocal_351);
							unk_0xD738221C247C8B71(iLocal_348, true);
						}
						iLocal_255 = 0;
					}
				}
		...
		if (((iLocal_254 != 21 && !iLocal_301[20]) && iLocal_255 != 25) && iLocal_255 != 0)
		{
			if (!iLocal_280)
			{
				...
				{
					if (unk_0x685AE6AF34B35D3B(iLocal_348))
					{
						func_2();
						iLocal_324 = unk_0xFD34717937104F1C() + 2400;
						iLocal_280 = 1;
					}
				}
				if (((unk_0x7112137033807390(iLocal_348, 0) || unk_0xDEAEC99031DCB92A(iLocal_348, unk_0xA19140A5C42D8715(), 1)) || unk_0xDAA9E4FC4EBF1081(iLocal_348, 0, 2)) || unk_0x6D7FFF527E125F24(-1, unk_0xE2BBD32891C18569(iLocal_348, false), 10f))
				{
					func_2();
					iLocal_324 = unk_0xFD34717937104F1C() + 2400;
					iLocal_280 = 1;
			...
			else if (unk_0xFD34717937104F1C() > iLocal_324)
			{
				if (unk_0xDC5D81351D6A4DDB(iLocal_348))
				{
					if (!unk_0x7112137033807390(iLocal_348, 0))
					{
						unk_0x9568B1B58F78FF36(iLocal_348);
						unk_0x33B5487515BD13D5(iLocal_348, unk_0xA19140A5C42D8715(), 100f, -1, 0, 0);
						unk_0xD738221C247C8B71(iLocal_348, true);
						func_312(2);
					}
					else
	...
	if (func_452())
	{
		...
		while (iVar1 < func_451())
		{
			if (unk_0xDC5D81351D6A4DDB(func_450(iVar1)))
			{
				...
				{
					if (unk_0x934175823EA79DA0(iVar0, iLocal_341))
					{
...
void func_453()
{
	if (!unk_0x5D7DFE2058701942(iLocal_348, 0) && !unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		if (!iLocal_433)
		{
			iLocal_434 = unk_0xFD34717937104F1C() + 3000;
			iLocal_433 = 1;
		}
		else if (unk_0xFD34717937104F1C() > iLocal_434)
		{
			if (func_362())
			{
...
void func_454()
{
	if (!unk_0xD61D0CA14AE902DF(iLocal_348, 1) && !unk_0xD61D0CA14AE902DF(unk_0xA19140A5C42D8715(), 1))
	{
		if (unk_0x5D7DFE2058701942(iLocal_348, 0) && unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			if (!iLocal_291)
			{
				iLocal_317 = unk_0xFD34717937104F1C() + 3000;
				iLocal_291 = 1;
			}
			else if (unk_0xFD34717937104F1C() > iLocal_317)
			{
				if (!func_217())
				{
					if (!iLocal_301[8])
					{
						...
						{
							if (!unk_0x429D45A6C6520026(&Local_428))
							{
								Local_428 = { func_455() };
							}
							else
...
void func_457()
{
	...
	if (func_302(unk_0xA19140A5C42D8715()) && func_302(iLocal_348))
	{
		if (unk_0x5D7DFE2058701942(iLocal_348, 0) && unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
		{
			if (func_224(iLocal_426))
			{
				if (unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0) == iLocal_426 && unk_0xCAEB6CE71A2C7212(iLocal_348, 0) == iLocal_426)
				{
					if (!iLocal_431)
					{
						iLocal_432 = unk_0x24A1A7BF4ED94B71(iLocal_426);
						iLocal_431 = 1;
					}
					else
					{
						iVar0 = unk_0x24A1A7BF4ED94B71(iLocal_426);
						if (iVar0 < iLocal_432)
						{
							func_458();
	...
	if (unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 0))
	{
		if (!iLocal_301[7])
		{
			if (!func_217())
			{
				if (func_362())
				{
					if (unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0) == iLocal_426)
					{
...
void func_461()
{
	if (!unk_0xD61D0CA14AE902DF(iLocal_348, 1) && !unk_0xD61D0CA14AE902DF(unk_0xA19140A5C42D8715(), 1))
	{
		if (!unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_361, vLocal_362, 7f, 0, true, 0))
		{
			if (!unk_0x5D7DFE2058701942(iLocal_348, 0) && !unk_0x5D7DFE2058701942(unk_0xA19140A5C42D8715(), 1))
			{
				if (!iLocal_297)
				{
					if (!func_388("HT_NXTLOC", 0, 0) && iLocal_301[4])
					{
						iLocal_332 = unk_0xFD34717937104F1C() + 20000;
						iLocal_297 = 1;
					}
				}
				else if (unk_0xFD34717937104F1C() > iLocal_332)
				{
...
void func_464()
{
	if (!unk_0xD61D0CA14AE902DF(iLocal_348, 1) && !unk_0xD61D0CA14AE902DF(unk_0xA19140A5C42D8715(), 1))
	{
		if (!iLocal_429)
		{
			...
			{
				iLocal_430 = unk_0xFD34717937104F1C() + 3000;
				iLocal_429 = 1;
			}
		}
		else if (unk_0xFD34717937104F1C() > iLocal_430)
		{
			if (!func_217() && func_362())
			{
				if (!iLocal_301[4])
...
void func_465()
{
	if (unk_0x54F6F5A823224519(unk_0xA19140A5C42D8715(), vLocal_361, vLocal_362, 16f, 0, true, 0))
	{
		if ((iLocal_302[1] && !func_388("HT_NXTLOC", 0, 0)) && !func_217())
		{
			if (!iLocal_296)
			{
				iLocal_316 = unk_0xFD34717937104F1C() + 15000;
				iLocal_296 = 1;
			}
			else if (unk_0xFD34717937104F1C() > iLocal_316)
			{
...
void func_466()
{
	if (unk_0x8A29BBDF4603E52B(unk_0xA19140A5C42D8715()))
	{
		if (!iLocal_273)
		{
			iLocal_435 = unk_0xCAEB6CE71A2C7212(unk_0xA19140A5C42D8715(), 0);
			if (!unk_0x5D7DFE2058701942(iLocal_348, 1))
			{
				if (!unk_0x9FF3E42974FB3263(iLocal_435))
				{
					if (func_362())
					{
						if (!func_217())
...
int func_467()
{
	if (!unk_0x411C28019DEA5CEF(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) && !unk_0x411C28019DEA5CEF(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3))
	{
		if (!unk_0xDC5D81351D6A4DDB(iLocal_346))
		{
			unk_0x9568B1B58F78FF36(iLocal_348);
		...
		{
			unk_0xC0AC848E56940C34(&iLocal_346);
		}
	}
	else if (!unk_0xDC5D81351D6A4DDB(iLocal_346))
	{
		unk_0x9568B1B58F78FF36(iLocal_348);
		return 1;
	}
...
void func_468()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x9809FE4B550B1EFE(Local_258[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_217())
			{
...
void func_470(int iParam0)
{
	...
	if (((iLocal_338 < 3 && !func_388("HT_SHDISH", 0, 0)) && !func_388("HT_SHTYRE", 0, 0)) && !func_388("HT_SHCOY", 0, 0))
	{
		if (iLocal_277)
		{
			if (unk_0xFD34717937104F1C() > iLocal_326)
			{
		...
		{
			iLocal_327 = unk_0x22C775856F4633CA(10000, 15000);
			iLocal_326 = (unk_0xFD34717937104F1C() + iLocal_327);
			iLocal_277 = 1;
		}
	}
}
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_269)
						{
							if (!unk_0xA60C975CBAB69F34(iLocal_348, vLocal_368, 1.5f, 1.5f, 1.5f, false, true, 0) || !unk_0x5393F5210E66E1B6(iLocal_348, Local_258[iLocal_335 /*10*/].f_1, 30f))
							{
								if (unk_0xF9D4EF1338E38AFB(iLocal_348, 713668775) != 1 || unk_0xF9D4EF1338E38AFB(iLocal_348, 713668775) != 7)
								{
									iLocal_328 = 1;
								}
							}
					...
					case 1:
						if (!unk_0xA60C975CBAB69F34(iLocal_348, vLocal_369, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_472(iLocal_348, fLocal_305, 30f))
						{
							iLocal_328 = 1;
						}
						break;
					...
					case 2:
						if (!unk_0xA60C975CBAB69F34(iLocal_348, vLocal_372, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_472(iLocal_348, fLocal_313, 30f))
						{
							iLocal_328 = 1;
						}
						break;
	...
	if (!bParam1 || iLocal_269)
	{
		if (func_478())
		{
			...
			if (func_302(iLocal_348))
			{
				...
				if (bParam1)
				{
					unk_0xD87AD31611110768(0, Local_258[iLocal_335 /*10*/].f_1, 0);
				}
				if (bParam0)
				{
				...
				unk_0xE1072FA2FECBAD96(iLocal_348, iVar0);
...
int func_475()
{
	if (func_302(unk_0xA19140A5C42D8715()))
	{
		if (unk_0xAB21F086A17D0CAA(func_476(unk_0xA19140A5C42D8715())) == -1212426201)
		{
			return 1;
		}
	}
...
int func_478()
{
	if (unk_0xDC5D81351D6A4DDB(iLocal_346) && unk_0x0F393FB075B30EB5(iLocal_346, iLocal_348))
	{
		return 1;
	}
	if (!iLocal_265)
...
void func_479()
{
	unk_0xCACEBBBEAD8F262E(iLocal_342);
	while (!unk_0x7FC99CCC73354033(iLocal_342))
	{
		wait(0);
	}
	iLocal_265 = 1;
...
void func_480(bool bParam0)
{
	...
	if (func_302(iLocal_348))
	{
		if (unk_0x411C28019DEA5CEF(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) || unk_0x411C28019DEA5CEF(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_INTRO", 3))
		{
			unk_0x1F4E5EFBFE503FB3(iLocal_348, true);
			unk_0x53FF9BDD8529ACD2(iLocal_348);
			unk_0x2F89329397A277BC(&iVar0);
...
void func_481(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_302(iLocal_348) && func_302(unk_0xA19140A5C42D8715()))
	{
		if (func_452())
		{
			iVar1 = 0;
			while (iVar1 < func_451())
			{
				...
				{
					iVar0 = unk_0xA2EA4BA455370F3C(func_450(iVar1));
					if (iVar0 != unk_0xA19140A5C42D8715() && iVar0 != iLocal_348)
					{
			...
			while (iVar1 < 5)
			{
				if (unk_0xDC5D81351D6A4DDB(Local_259[iVar1 /*29*/].f_12))
				{
					if (unk_0xDEAEC99031DCB92A(Local_259[iVar1 /*29*/].f_12, unk_0xA19140A5C42D8715(), 1))
					{
						unk_0xDCB46BFC2265476A(Local_259[iVar1 /*29*/].f_12);
						iLocal_321++;
					}
				}
				iVar1++;
...
void func_482()
{
	if (!unk_0x4915F4759304D5CF(iLocal_348))
	{
		if (((unk_0x7D4400F91582CA08(unk_0xE2BBD32891C18569(iLocal_348, false) + Vector(2f, 2f, 2f), unk_0xE2BBD32891C18569(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || unk_0x7D4400F91582CA08(unk_0xE2BBD32891C18569(iLocal_348, false) + Vector(2f, 2f, 2f), unk_0xE2BBD32891C18569(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || unk_0x7D4400F91582CA08(unk_0xE2BBD32891C18569(iLocal_348, false) + Vector(2f, 2f, 2f), unk_0xE2BBD32891C18569(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || unk_0x6D7FFF527E125F24(-1, unk_0xE2BBD32891C18569(iLocal_348, false), 10f))
		{
			unk_0xAB8B90F57910509D(1, iLocal_261, 1862763509);
		}
		if (!iLocal_272)
		{
			if (func_484() || unk_0x669ABFB25D991447(unk_0xD4E735F4B6A956AC(), iLocal_348))
			{
				if (func_217())
				{
					func_310();
		...
		if (!bLocal_298)
		{
			if (unk_0x68477FE20127AEDA(iLocal_348))
			{
				unk_0x83055D7E96024509(iLocal_348, false);
				bLocal_298 = true;
			}
		}
		else if (unk_0xC35EE16DB41A098F(iLocal_348))
		{
			unk_0x83055D7E96024509(iLocal_348, true);
			bLocal_298 = false;
		}
...
int func_484()
{
	if (func_302(iLocal_348))
	{
		if (iLocal_255 != 25)
		{
			if ((!unk_0x852B8F739A2072BE(unk_0xA19140A5C42D8715(), 6) && unk_0x6625F609B391348E(unk_0xA19140A5C42D8715())) && func_363(iLocal_348, unk_0xA19140A5C42D8715(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!unk_0x852B8F739A2072BE(unk_0xA19140A5C42D8715(), 6) && unk_0x6625F609B391348E(unk_0xA19140A5C42D8715())) && unk_0xC42DE41AEED00E7B(unk_0xA19140A5C42D8715(), iLocal_348, 30f)) && func_363(iLocal_348, unk_0xA19140A5C42D8715(), 1) <= 2f)
		{
			return 1;
		}
	}
...
void func_485()
{
	if (!unk_0x4915F4759304D5CF(iLocal_348))
	{
		if ((unk_0x411C28019DEA5CEF(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) && unk_0xE5B5A1FFAA0834BD(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >= 0.68f) || iLocal_328 == 1)
		{
			if (unk_0xDC5D81351D6A4DDB(iLocal_346))
			{
				unk_0xC0AC848E56940C34(&iLocal_346);
		...
		if (!unk_0xDC5D81351D6A4DDB(iLocal_346))
		{
			if (unk_0x411C28019DEA5CEF(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro", 3) && unk_0xE5B5A1FFAA0834BD(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro") >= 0.242f)
			{
				iLocal_346 = unk_0xFCFC8CC5FF74580D(iLocal_342, unk_0xE2BBD32891C18569(iLocal_348, true), false, false, false);
			}
		}
		else if (!unk_0x0F393FB075B30EB5(iLocal_346, iLocal_348))
		{
			unk_0x96B71B23D409A3DB(iLocal_346, iLocal_348, unk_0xF622A022C26057AA(iLocal_348, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_504()
{
	if (!iLocal_284)
	{
		unk_0x94E87D83163B4BEB("FRIENDLIES", &iLocal_261);
		unk_0xDFA901280292A2FB(iLocal_348, iLocal_261);
		unk_0x80E7C4A78224C8F9(1, iLocal_261, 1862763509);
		unk_0x80E7C4A78224C8F9(1, 1862763509, iLocal_261);
		unk_0x80E7C4A78224C8F9(2, iLocal_261, -2065892691);
		unk_0x80E7C4A78224C8F9(2, 1862763509, -2065892691);
		iLocal_284 = 1;
	}
}
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_28[0]))
			{
				...
				{
					unk_0xF0188A1B49D79AF7(uParam0->f_28[0], joaat("weapon_sniperrifle"), 0, true, true);
				}
				else
				{
					bVar2 = false;
			...
			if (!unk_0xDC5D81351D6A4DDB(uParam0->f_35[0]))
			{
				...
				unk_0x01AF8CB960828C2B(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, false, 0);
			}
			if (bVar2)
			{
				iLocal_77 = 3;
		...
		case 3:
			if (func_224(uParam0->f_28[0]))
			{
				...
				unk_0x13E0A8160525AE55(uParam0->f_28[0], 104, true);
				unk_0xB20B772FD9DE1847(uParam0->f_28[0], joaat("weapon_sniperrifle"), true);
...
void func_508(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	if (unk_0xDC5D81351D6A4DDB(*iParam0))
	{
		...
		unk_0x6202B241A8864FC2(*iParam0, 2, false);
		unk_0x6202B241A8864FC2(*iParam0, 3, true);
	...
	if (func_512(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (unk_0xDC5D81351D6A4DDB(*iParam0))
		{
			if (!unk_0x7112137033807390(*iParam0, 0))
			{
				...
				if (iParam5 == 1)
				{
					unk_0x96BFF0680C7B6FD5(*iParam0, false);
				}
			}
			unk_0xC4C22DDB26872744(*iParam0, sParam4);
		}
		return 1;
	}
	return 0;
...
void func_519()
{
	...
	if (iLocal_265)
	{
		unk_0xA5DE74AE39867B03(iLocal_342);
	}
	if (bLocal_264)
	{
		unk_0xE70AC26DFC59863A(iLocal_349, 0);
	}
	if (iLocal_293)
	{
		unk_0xE70AC26DFC59863A(iLocal_350, 0);
	}
	unk_0xD9F4F897224699B4();
	func_520(&Local_88, 0, 0, 0);
	unk_0x93DA13E8C75A3B00(6, true);
}
...
void func_530()
{
	unk_0xA5DE74AE39867B03(iLocal_341);
}
...
int func_533(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_536())
	{
		...
		{
			iVar2 = func_296(unk_0x61D2332983ACC05C());
			if (iVar2 > -1)
			{
