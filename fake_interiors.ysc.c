...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			iLocal_31 = unk_0xA19140A5C42D8715();
		}
		if (unk_0x7112137033807390(iLocal_31, 0))
		{
		}
		func_1();
	}
...
void func_1()
{
	...
	{
		vVar0 = { unk_0xE2BBD32891C18569(iLocal_31, false) };
		...
		if (vdist2(vVar1, vVar0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			while (iVar3 < func_17(iLocal_29))
			{
				if (!bVar2)
				{
					if (unk_0x54F6F5A823224519(iLocal_31, func_16(iLocal_29, iVar3), func_15(iLocal_29, iVar3), func_14(iLocal_29, iVar3), 0, true, 0))
					{
						bVar2 = true;
					}
				}
			...
			if (bVar2)
			{
				unk_0xEC7287BE660E16F9(unk_0xFEB6EEC0545AF7AA(func_13(iLocal_29)), vVar1.x, vVar1.y, func_12(iLocal_29), func_11(iLocal_29));
				func_10(iLocal_29);
			}
		}
	}
	if (unk_0x4C9BACA8D249CB13())
	{
		if (func_2())
		{
			if (unk_0x05EFB6A616B6FADE(iLocal_32, 1))
			{
				unk_0xFA57C719261AA55D(&iLocal_32, 1);
			}
			if (unk_0xD1ABB20CFF127CCC())
			{
				if (!unk_0x05EFB6A616B6FADE(iLocal_32, 0))
				{
					unk_0x9996588CCDE8877E(15, 1, -1);
					unk_0x2BCFB39E86340DAA(&iLocal_32, 0);
				}
			}
			else if (unk_0x05EFB6A616B6FADE(iLocal_32, 0))
			{
				unk_0x9996588CCDE8877E(15, 0, -1);
				unk_0xFA57C719261AA55D(&iLocal_32, 0);
			}
		}
		else if (!unk_0x05EFB6A616B6FADE(iLocal_32, 1))
		{
			unk_0x9996588CCDE8877E(15, 0, -1);
			unk_0xFA57C719261AA55D(&iLocal_32, 0);
			unk_0x2BCFB39E86340DAA(&iLocal_32, 1);
		}
	}
}
...
void func_10(int iParam0)
{
	...
	vVar0 = { unk_0xE2BBD32891C18569(iLocal_31, false) };
	unk_0x8507F53B553E59F8(vVar0.x, vVar0.y);
	switch (iParam0)
	{
		case 0:
			break;
