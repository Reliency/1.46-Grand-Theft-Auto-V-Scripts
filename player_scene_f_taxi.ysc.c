...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { unk_0xE2BBD32891C18569(iLocal_68, false) };
		fVar2 = vdist2(vLocal_170 + vLocal_173, vVar1);
		if (fVar2 < (4.5f * 4.5f))
		{
			unk_0x731722E696597BD1(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0xFE5DE0C3200E00F2(Global_90657))
		{
			...
			if (!func_5(Global_93018, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0x692D5500D82E4F5D(Global_93018, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0xB29E08C7AB729BAD(iLocal_68, false);
				iLocal_172 = 1;
			}
			unk_0x95015EE4AAC98495(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_93018, iLocal_70, 2))
			...
			unk_0x6AE6C20282990E48(iLocal_70, -8f, 1);
			wait(100);
			if (!func_3(&uVar0))
			{
				unk_0x2F89329397A277BC(&iVar2);
				unk_0x95015EE4AAC98495(0, iLocal_70, 24, 50);
				unk_0x4AABC2A9FCCE3C8F(0, 2000);
				unk_0xE49301B2B6F420DE(0, iLocal_70, vLocal_170 + vLocal_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0x301F42EEE3C40328(iVar2);
				unk_0xE1072FA2FECBAD96(iLocal_68, iVar2);
...
void func_21()
{
	...
	unk_0xFC00A668AFC2126D(iLocal_69, true);
	iLocal_70 = unk_0x4C059EBFED753303(vLocal_173 + vLocal_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0xDC5D81351D6A4DDB(Global_93018) || !unk_0xDC5D81351D6A4DDB(iLocal_70)) || (!unk_0x7FC99CCC73354033(iLocal_69) && iVar0 < 400))
	{
	...
	{
		unk_0xC19EDC1D7179164C(iLocal_70, true, true, 0);
		unk_0x14293208022014FA(iLocal_70, 2);
		unk_0x99F546A9200EA026(iLocal_70, 1084227584);
		iLocal_68 = unk_0x91A7C8CA5E332C03(iLocal_70, 4, iLocal_69, -1, 1, true);
		unk_0x8695E04AA104690A(iLocal_68, 0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 17, 1785177548, 1785177548, unk_0xF59B9063EDAC7451(-5f, 5f), unk_0xF59B9063EDAC7451(-5f, 5f), 0f, unk_0xF59B9063EDAC7451(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 144, 1785177548, 1785177548, unk_0xF59B9063EDAC7451(-5f, 5f), unk_0xF59B9063EDAC7451(-5f, 5f), 0f, unk_0xF59B9063EDAC7451(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 43, 1785177548, 1785177548, unk_0xF59B9063EDAC7451(-5f, 5f), unk_0xF59B9063EDAC7451(-5f, 5f), 0f, unk_0xF59B9063EDAC7451(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_49()
{
	if (!unk_0x7112137033807390(iLocal_68, 0) && unk_0x82384F63D814C864(iLocal_68, 1))
	{
		unk_0x7E4E83D33161D01A(&iLocal_68);
	}
	if (!unk_0x7112137033807390(iLocal_70, 0) && unk_0x82384F63D814C864(iLocal_70, 1))
	{
		unk_0x792676988A48387F(&iLocal_70);
	}
	unk_0xFC00A668AFC2126D(iLocal_69, false);
	unk_0xA5DE74AE39867B03(iLocal_69);
