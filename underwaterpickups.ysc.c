...
void __EntryFunction__()
{
	...
	func_24(vVar0);
	bLocal_4 = func_4();
	vLocal_5 = { unk_0xE2BBD32891C18569(unk_0xA19140A5C42D8715(), false) };
	func_1();
	while (true)
	{
		wait(0);
		...
		if (func_3(iVar0, &iVar1, &vVar2, &vVar3, &iVar5))
		{
			if (func_2(vVar3, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0xCFD2D70854568658(iVar1, vVar2, iVar4, iVar5, 1, 0);
					}
				}
				else if (vdist2(vVar2, vLocal_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0xCFD2D70854568658(iVar1, vVar2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x4B3DFBACE939C0B8(iVar1, vVar2, vVar3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (vdist2(vVar2, vLocal_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0x4B3DFBACE939C0B8(iVar1, vVar2, vVar3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	return (shift_right(iParam0, 26) & 31 * func_12(unk_0x05EFB6A616B6FADE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_27()
{
	...
	while (iVar0 < 20)
	{
		if (unk_0xF93654E07E20E3CF(iLocal_3[iVar0]))
		{
			unk_0xBCFB7F2BD32812C6(iLocal_3[iVar0]);
		}
		iVar0++;
	}
}
